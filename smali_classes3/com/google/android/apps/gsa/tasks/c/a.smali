...
.field public final oBR:Ljava/util/Map;
...
# direct methods
.method constructor <init>(Ljava/util/Map;Lcom/google/android/apps/gsa/search/core/service/z;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/tasks/c/a;->oBR:Ljava/util/Map;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/tasks/c/a;->cAa:Lcom/google/android/apps/gsa/search/core/service/z;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/tasks/c/a;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
...
.method public final a(JLcom/google/android/apps/gsa/search/shared/service/ClientEventData;Lcom/google/android/apps/gsa/search/core/service/c/a;)V
    ...
    .line 11
    :cond_0
    sget-object v0, Lcom/google/android/apps/gsa/search/shared/service/a/a/q;->gFm:Lcom/google/ac/a/g;
    ...
    .line 14
    iget-object v6, v0, Lcom/google/android/apps/gsa/search/shared/service/a/a/r;->gFn:Ljava/lang/String;

    .line 16
    iget-object v1, v0, Lcom/google/android/apps/gsa/search/shared/service/a/a/r;->gFo:Lcom/google/android/apps/gsa/tasks/b/g;
    ...
    .line 19
    :goto_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/c/a;->oBR:Ljava/util/Map;

    invoke-interface {v0, v6}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lh/a/a;

    .line 20
    if-eqz v4, :cond_2

    .line 21
    iget-object v7, p0, Lcom/google/android/apps/gsa/tasks/c/a;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/apps/gsa/tasks/c/b;-><init>(Ljava/lang/String;IILh/a/a;Lcom/google/android/apps/gsa/tasks/TaskParametersHolder;Ljava/lang/String;)V
    ...
    .line 28
    :goto_2
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/c/a;->cAa:Lcom/google/android/apps/gsa/search/core/service/z;
    ...
    .line 18
    :cond_1
    iget-object v0, v0, Lcom/google/android/apps/gsa/search/shared/service/a/a/r;->gFo:Lcom/google/android/apps/gsa/tasks/b/g;
