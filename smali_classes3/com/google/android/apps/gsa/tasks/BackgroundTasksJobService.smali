...
.field public oAi:Lcom/google/android/apps/gsa/tasks/k;

.field public final oAj:Ljava/util/Set;
...
.field public ozG:Lcom/google/android/apps/gsa/tasks/bi;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->oAj:Ljava/util/Set;
...
.method final a(Landroid/os/PersistableBundle;I)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->oAi:Lcom/google/android/apps/gsa/tasks/k;

    .line 39
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/tasks/k;->bqU()Lcom/google/android/apps/gsa/tasks/bc;
    ...
    const-class v1, Lcom/google/android/apps/gsa/tasks/af;
    ...
    check-cast v0, Lcom/google/android/apps/gsa/tasks/af;

    .line 43
    iget-object v1, v0, Lcom/google/android/apps/gsa/tasks/af;->oAx:Landroid/app/job/JobScheduler;
    ...
    .line 48
    iget-object v1, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->oAj:Ljava/util/Set;
    ...
    .line 49
    invoke-virtual {v0, p2}, Lcom/google/android/apps/gsa/tasks/af;->uc(I)V
...
.method final bqW()Z
    ...
    .prologue
    .line 33
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 9
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->oAe:Lcom/google/android/apps/gsa/tasks/bf;
    ...
    .line 17
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->bqW()Z
    ...
    .line 19
    :cond_1
    invoke-virtual {p0, v2}, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->ug(I)V
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 21
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->oAj:Ljava/util/Set;
    ...
    .line 25
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->ozG:Lcom/google/android/apps/gsa/tasks/bi;

    const/16 v2, 0x16b

    .line 26
    iget-object v1, v1, Lcom/google/android/apps/gsa/tasks/bi;->fxj:Lcom/google/android/apps/gsa/q/a;

    const/4 v3, 0x7

    .line 27
    invoke-static {v0}, Lcom/google/android/apps/gsa/tasks/bi;->om(Ljava/lang/String;)I

    move-result v0

    invoke-interface {v1, v3, v0, v2}, Lcom/google/android/apps/gsa/q/a;->w(III)Lcom/google/android/apps/gsa/q/b;
    ...
    .line 29
    iget-object v0, p0, Lcom/google/android/apps/gsa/tasks/BackgroundTasksJobService;->ozG:Lcom/google/android/apps/gsa/tasks/bi;

    .line 30
    iget-object v0, v0, Lcom/google/android/apps/gsa/tasks/bi;->oBl:Lb/a;
