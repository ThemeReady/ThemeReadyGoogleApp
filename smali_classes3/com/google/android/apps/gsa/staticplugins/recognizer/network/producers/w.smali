...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/concurrent/Future;Ljava/util/concurrent/Future;Ljava/util/concurrent/Future;Ljava/util/concurrent/Future;Lcom/google/speech/f/b/h;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/apps/gsa/shared/config/b/f;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->ngz:Ljava/util/concurrent/Future;

    .line 3
    iput-object p5, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->ngA:Ljava/util/concurrent/Future;

    .line 4
    move-object/from16 v0, p9

    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->cAC:Lcom/google/android/apps/gsa/shared/config/b/f;
...
.method public final um()Lcom/google/speech/f/b/au;
    ...
    .line 7
    :try_start_0
    sget-object v2, Lcom/google/speech/g/a/a/t;->yTO:Lcom/google/ac/a/g;

    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->eTh:Lcom/google/android/apps/gsa/s3/b/ab;

    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->ngA:Ljava/util/concurrent/Future;
    ...
    .line 13
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->cAC:Lcom/google/android/apps/gsa/shared/config/b/f;

    invoke-interface {v0}, Lcom/google/android/apps/gsa/shared/config/b/f;->aqp()Z

    move-result v0

    invoke-virtual {v1, v0}, Lcom/google/speech/f/b/au;->py(Z)Lcom/google/speech/f/b/au;

    .line 14
    sget-object v0, Lcom/google/speech/f/b/ab;->yQf:Lcom/google/ac/a/g;

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->ngz:Ljava/util/concurrent/Future;

    const v3, 0x2000f

    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/google/android/apps/gsa/staticplugins/recognizer/network/producers/w;->a(Lcom/google/speech/f/b/au;Lcom/google/ac/a/g;Ljava/util/concurrent/Future;I)V
