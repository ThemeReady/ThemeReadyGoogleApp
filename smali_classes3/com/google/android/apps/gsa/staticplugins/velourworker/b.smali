...
.field public final mZp:Ljava/lang/Class;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/Class",
            "<TEntryPointType;>;"
...
.field public final mZq:Lcom/google/android/apps/gsa/staticplugins/velourworker/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final mZr:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method public constructor <init>(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/apps/gsa/staticplugins/velourworker/a;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->mZr:Ljava/util/Map;

    .line 4
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->mZp:Ljava/lang/Class;

    .line 5
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->eki:Ljava/lang/String;

    .line 6
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->eOY:Ljava/lang/String;

    .line 7
    iput-object p4, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->mZq:Lcom/google/android/apps/gsa/staticplugins/velourworker/a;
...
# virtual methods
.method public final a(Lcom/google/android/apps/gsa/search/core/service/bg;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 9
    invoke-interface {p1}, Lcom/google/android/apps/gsa/search/core/service/bg;->xB()Lcom/google/android/apps/gsa/shared/velour/ai;
    ...
    .line 10
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->mZp:Ljava/lang/Class;

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->eki:Ljava/lang/String;
    ...
    .line 13
    invoke-interface {p1}, Lcom/google/android/apps/gsa/search/core/service/bg;->uV()Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/gsa/staticplugins/velourworker/c;-><init>(Lcom/google/android/apps/gsa/staticplugins/velourworker/b;Ljava/lang/String;IILcom/google/android/apps/gsa/search/core/service/bg;)V
...
.method public final a(Lcom/google/android/apps/gsa/search/core/service/worker/Worker;)V
    ...
    .line 17
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/velourworker/b;->mZr:Ljava/util/Map;
    ...
    .line 22
    :cond_0
    iget-object v1, v0, Lcom/google/android/apps/gsa/staticplugins/velourworker/d;->mZt:Lcom/google/android/apps/gsa/search/core/service/worker/WorkerApi;

    .line 23
    invoke-interface {v1}, Lcom/google/android/apps/gsa/search/core/service/worker/WorkerApi;->Pa()Lcom/google/android/libraries/velour/b;
    ...
    .line 25
    iget-object v0, v0, Lcom/google/android/apps/gsa/staticplugins/velourworker/d;->hrX:Lcom/google/android/libraries/velour/dynloader/Plugin;
