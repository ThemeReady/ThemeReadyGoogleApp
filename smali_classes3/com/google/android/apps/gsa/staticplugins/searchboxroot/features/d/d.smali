...
.field public final nxa:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public final nxd:Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxc:Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;

    .line 105
    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/f;Lb/a;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Ljava/util/List;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->ntt:Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;

    .line 3
    move-object/from16 v0, p4

    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->ntq:Lb/a;

    .line 4
    move-object/from16 v0, p5

    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->eIc:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;

    .line 5
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxb:Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/f;

    .line 6
    new-instance v1, Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;

    sget v2, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/k;->fYq:I
    ...
    iput-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxd:Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;

    .line 10
    move-object/from16 v0, p6

    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxa:Ljava/util/List;
...
.method final declared-synchronized amC()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxb:Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/f;

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxd:Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;

    sget-object v3, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxc:Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;
    ...
    .line 70
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->nxa:Ljava/util/List;
    ...
    .line 71
    invoke-interface {v0}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/c;->amC()V
    :try_end_0
...
.method public final b(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    ...
    .prologue
    .line 12
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    .line 13
    return-void
.end method

.method final declared-synchronized cw(Ljava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 76
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->eIc:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 78
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->ntq:Lb/a;
    ...
    .line 94
    invoke-interface {v0, p1}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/c;->cw(Ljava/util/List;)V

    .line 95
    invoke-interface {v0}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/c;->bkn()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public fetchSuggestionsThrottled(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->gYF:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/CompleteServerResponseCache;
    ...
    .line 20
    iget-object v7, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
...
.method final declared-synchronized s(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootResponse;
    ...
    .line 22
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->ntt:Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;

    invoke-virtual {v3}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;->aaH()I
    ...
    .line 30
    invoke-interface {v0}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/c;->bkl()Z
    ...
    .line 32
    invoke-interface {v0}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/c;->bkm()Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootSuggestion;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->ntt:Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;

    .line 39
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;->bjN()I
    ...
    invoke-virtual {v11, v0}, Lcom/google/common/collect/db;->cw(Ljava/lang/Object;)Lcom/google/common/collect/db;
    ...
    invoke-virtual {v11}, Lcom/google/common/collect/db;->cjq()Lcom/google/common/collect/cz;
    ...
    .line 58
    invoke-virtual {v11, v3}, Lcom/google/common/collect/db;->cw(Ljava/lang/Object;)Lcom/google/common/collect/db;
    ...
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/SearchboxHelper;->bjM()Ljava/lang/String;
...
.method public synthetic setDependencies(Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/searchboxroot/features/d/d;->gYF:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/CompleteServerResponseCache;
