.class public Lcom/google/android/apps/gsa/staticplugins/g/r;
.super Lcom/google/android/apps/gsa/speech/audio/am;
.source "SourceFile"


# instance fields
.field public final kuN:Ljava/util/Map;
...
.method public constructor <init>(IIIILcom/google/android/apps/gsa/speech/audio/g;Lcom/google/android/apps/gsa/shared/util/bb;Lcom/google/android/apps/gsa/speech/j/b;ZLcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->kuN:Ljava/util/Map;

    .line 14
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->kuN:Ljava/util/Map;

    iget v1, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtB:I
...
# virtual methods
.method public final nO(I)Lcom/google/android/apps/gsa/speech/audio/q;
    .locals 10

    .prologue
    .line 16
    iget v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtB:I

    if-ne p1, v0, :cond_0

    .line 17
    invoke-super {p0, p1}, Lcom/google/android/apps/gsa/speech/audio/am;->nO(I)Lcom/google/android/apps/gsa/speech/audio/q;
    ...
    .line 19
    :try_start_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/g/r;->aJA()V
    ...
    .line 22
    iget v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtq:I

    iget v1, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->hSG:I
    ...
    iget v2, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->hSG:I

    iget v3, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtr:I

    iget v4, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtq:I

    new-instance v5, Lcom/google/android/apps/gsa/staticplugins/g/s;

    invoke-direct {v5, p0, p1, v1}, Lcom/google/android/apps/gsa/staticplugins/g/s;-><init>(Lcom/google/android/apps/gsa/staticplugins/g/r;II)V

    const/4 v6, 0x0

    const/4 v7, 0x0

    iget-boolean v8, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtx:Z

    iget-object v9, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->cuk:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    .line 25
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->kuN:Ljava/util/Map;
    ...
    .line 27
    invoke-virtual {v0, p1}, Lcom/google/android/apps/gsa/speech/audio/am;->nO(I)Lcom/google/android/apps/gsa/speech/audio/q;

    move-result-object v1

    .line 28
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/g/r;->aJz()Z
    ...
    .line 32
    iget v4, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->hSG:I

    iget v5, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtr:I
...
.method public final declared-synchronized nQ(I)Z
    .locals 2
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jsz:Ljava/util/Set;
...
.method public final declared-synchronized shutdown()V
    ...
    :try_start_0
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/g/r;->jtw:Lcom/google/android/apps/gsa/speech/audio/g;
