...
# static fields
.field public static final lbG:Landroid/view/animation/Interpolator;

.field public static final lbH:Landroid/view/animation/Interpolator;

.field public static final lbI:Landroid/view/animation/Interpolator;

.field public static final lbJ:Landroid/view/animation/Interpolator;
...
.method static constructor <clinit>()V
    ...
    .line 90
    invoke-static {v0, v2, v1, v3}, Lcom/google/android/apps/gsa/shared/util/l/i;->f(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v0

    sput-object v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbG:Landroid/view/animation/Interpolator;
    ...
    .line 92
    invoke-static {v0, v1, v4, v3}, Lcom/google/android/apps/gsa/shared/util/l/i;->f(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v0

    sput-object v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbH:Landroid/view/animation/Interpolator;
    ...
    .line 94
    invoke-static {v4, v2, v0, v1}, Lcom/google/android/apps/gsa/shared/util/l/i;->f(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v0

    sput-object v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbI:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbJ:Landroid/view/animation/Interpolator;
...
.method public static varargs a(Landroid/content/res/Resources;[Ljava/lang/Object;)Landroid/transition/TransitionSet;
    ...
    .line 1
    .line 2
    sget v0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/ds;->klj:I
    ...
    sget-object v2, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbI:Landroid/view/animation/Interpolator;

    sget-object v3, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbH:Landroid/view/animation/Interpolator;
...
.method static varargs a(ZILandroid/util/DisplayMetrics;[Ljava/lang/Object;)Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;
    ...
    .line 10
    invoke-static {p1, v0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;->bT(II)Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;
    ...
    .line 17
    sget-object v1, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbI:Landroid/view/animation/Interpolator;
    ...
    .line 18
    :cond_3
    sget-object v1, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbH:Landroid/view/animation/Interpolator;
...
.method public static a(Ljava/util/List;Landroid/transition/TransitionSet;Landroid/util/DisplayMetrics;)V
    ...
    invoke-static {v5, v4}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;->bT(II)Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;
...
.method public static b(Landroid/content/Context;Landroid/view/ViewGroup;Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cq;)Landroid/transition/Transition;
    .locals 2
    .annotation build Landroid/annotation/TargetApi;
        value = 0x15
    .end annotation
    ...
    .line 87
    new-instance v1, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ck;

    invoke-direct {v1, p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ck;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cq;)V
...
.method public static f(Landroid/view/View;Landroid/view/View;)Landroid/transition/Transition;
    ...
    .line 35
    :cond_1
    sget v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcF:I
    ...
    .line 37
    sget v2, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcG:I
    ...
    .line 38
    sget v3, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcL:I
    ...
    .line 40
    sget v4, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcO:I
    ...
    .line 42
    sget v5, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcH:I
    ...
    .line 44
    sget v6, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/di;->lcI:I
    ...
    new-instance v6, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ci;

    invoke-direct {v6, p0}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ci;-><init>(Landroid/view/View;)V
    ...
    sget-object v6, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbJ:Landroid/view/animation/Interpolator;
    ...
    sget-object v5, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ch;->lbJ:Landroid/view/animation/Interpolator;
    ...
    new-instance v5, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cj;

    invoke-direct {v5, p1, v3}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cj;-><init>(Landroid/view/View;Landroid/view/View;)V
