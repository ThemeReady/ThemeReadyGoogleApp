...
.field public mvm:Landroid/text/SpannableStringBuilder;
...
.method public constructor <init>(Ljava/lang/CharSequence;Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvn:Ljava/lang/CharSequence;
...
.method public final a(Lcom/google/android/apps/gsa/staticplugins/opa/chatui/bf;Lcom/google/android/apps/gsa/staticplugins/opa/chatui/bc;)V
    ...
    .line 7
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvm:Landroid/text/SpannableStringBuilder;

    if-nez v0, :cond_0

    .line 8
    iget-object v0, p1, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/bf;->mwY:Landroid/widget/TextView;
    ...
    .line 9
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvn:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvn:Ljava/lang/CharSequence;
    :try_end_0
    ...
    iput-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvm:Landroid/text/SpannableStringBuilder;

    .line 15
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvm:Landroid/text/SpannableStringBuilder;
    ...
    .line 17
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvm:Landroid/text/SpannableStringBuilder;
    ...
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvn:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->mvm:Landroid/text/SpannableStringBuilder;
...
.method final bdd()I
    ...
    .prologue
    .line 6
    sget v0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/dt;->mAg:I
...
.method public final bdf()Lcom/google/android/libraries/j/j;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/opa/chatui/m;->clf:Lcom/google/android/libraries/j/i;
