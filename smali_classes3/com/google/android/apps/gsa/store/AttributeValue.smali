...
.field public final oDP:Ljava/lang/Long;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field public final oDQ:Ljava/lang/Double;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field

.field public final oDR:Ljava/lang/Boolean;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method private constructor <init>(Lcom/google/android/apps/gsa/store/AttributeId;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Double;Ljava/lang/Boolean;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDO:Lcom/google/android/apps/gsa/store/AttributeId;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->mText:Ljava/lang/String;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDP:Ljava/lang/Long;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDQ:Ljava/lang/Double;

    .line 6
    iput-object p5, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDR:Ljava/lang/Boolean;
...
.method public getAttributeId()Lcom/google/android/apps/gsa/store/AttributeId;
    ...
    .prologue
    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDO:Lcom/google/android/apps/gsa/store/AttributeId;
...
.method public getBooleanValue()Ljava/lang/Boolean;
    ...
    .prologue
    .line 9
    iget-object v0, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDR:Ljava/lang/Boolean;
...
.method public getDoubleValue()Ljava/lang/Double;
    ...
    .prologue
    .line 12
    iget-object v0, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDQ:Ljava/lang/Double;
...
.method public getLongValue()Ljava/lang/Long;
    ...
    .prologue
    .line 11
    iget-object v0, p0, Lcom/google/android/apps/gsa/store/AttributeValue;->oDP:Ljava/lang/Long;
