...
.field public oNH:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public oNI:Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;
...
.method protected final aM(Landroid/os/Bundle;)V
    ...
    iget-wide v2, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNG:J

    invoke-virtual {p1, v0, v2, v3}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V

    .line 3
    iget-object v0, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNH:Ljava/util/List;
    ...
    .line 7
    invoke-virtual {v0, v3}, Lcom/google/android/gearhead/sdk/assistant/MessagingInfo;->aM(Landroid/os/Bundle;)V
    ...
    .line 13
    iget-object v1, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNI:Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;

    invoke-virtual {v1, v0}, Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;->aM(Landroid/os/Bundle;)V
...
.method protected final aN(Landroid/os/Bundle;)V
    ...
    iput-wide v0, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNG:J
    ...
    iput-object v1, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNH:Ljava/util/List;
    ...
    .line 22
    invoke-virtual {v4, v1}, Lcom/google/android/gearhead/sdk/assistant/MessagingInfo;->aN(Landroid/os/Bundle;)V

    .line 23
    iget-object v1, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNH:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNI:Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;

    .line 28
    iget-object v1, p0, Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;->oNI:Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;

    invoke-virtual {v1, v0}, Lcom/google/android/gearhead/sdk/assistant/GearheadStateSnapshot;->aN(Landroid/os/Bundle;)V
