...
.field public cXy:Lcom/google/android/apps/gsa/now/shared/ui/h;

.field public cXz:Lcom/google/android/apps/gsa/now/shared/ui/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/android/apps/gsa/now/shared/ui/g",
            "<",
            "Lcom/google/android/apps/gsa/now/shared/ui/e;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    .line 2
    iput p2, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAH:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXz:Lcom/google/android/apps/gsa/now/shared/ui/g;

    .line 8
    sget-object v0, Lcom/google/android/apps/gsa/now/shared/ui/d;->bxT:[I
    ...
    .line 9
    sget v1, Lcom/google/android/apps/gsa/now/shared/ui/d;->cXp:I
    ...
    iput v1, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAI:I

    .line 10
    sget v1, Lcom/google/android/apps/gsa/now/shared/ui/d;->cXq:I
    ...
    iput v1, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAH:I
...
.method public final Dh()V
    ...
    .line 18
    iget-object v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXz:Lcom/google/android/apps/gsa/now/shared/ui/g;

    invoke-virtual {p0, v1}, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/google/android/apps/gsa/now/shared/ui/g;->bd(Landroid/view/View;)Lcom/google/android/apps/gsa/now/shared/ui/h;

    move-result-object v0

    check-cast v0, Lcom/google/android/apps/gsa/now/shared/ui/e;
    ...
    .line 22
    iget-object v2, v0, Lcom/google/android/apps/gsa/now/shared/ui/e;->view:Landroid/view/View;
    ...
    .line 23
    iget-object v2, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXz:Lcom/google/android/apps/gsa/now/shared/ui/g;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXy:Lcom/google/android/apps/gsa/now/shared/ui/h;
...
.method public final inflate()Landroid/view/View;
    ...
    .line 43
    iget-object v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXy:Lcom/google/android/apps/gsa/now/shared/ui/h;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->cXy:Lcom/google/android/apps/gsa/now/shared/ui/h;

    iget v0, v0, Lcom/google/android/apps/gsa/now/shared/ui/h;->viewType:I

    iget v1, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAH:I
    ...
    iget-object v0, v0, Lcom/google/android/apps/gsa/now/shared/ui/h;->view:Landroid/view/View;
    ...
    .line 45
    :cond_0
    iget v0, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAH:I
    ...
    .line 47
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->Dh()V
    ...
    .line 55
    new-instance v0, Lcom/google/android/apps/gsa/now/shared/ui/e;

    iget v2, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAH:I

    invoke-direct {v0, v1, v2}, Lcom/google/android/apps/gsa/now/shared/ui/e;-><init>(Landroid/view/View;I)V

    .line 57
    :cond_2
    iget v1, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAI:I
    ...
    .line 58
    iget-object v1, v0, Lcom/google/android/apps/gsa/now/shared/ui/h;->view:Landroid/view/View;

    iget v2, p0, Lcom/google/android/apps/gsa/now/shared/ui/RecyclerViewStub;->aAI:I
    ...
    .line 63
    iget-object v2, v0, Lcom/google/android/apps/gsa/now/shared/ui/h;->view:Landroid/view/View;
