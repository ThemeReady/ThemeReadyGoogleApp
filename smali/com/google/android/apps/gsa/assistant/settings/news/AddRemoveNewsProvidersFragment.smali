...
.field public bYs:Lcom/google/android/apps/gsa/assistant/settings/news/a;

.field public bYt:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;

.field public bYu:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYt:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYk:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYu:Ljava/util/List;
    ...
    .line 14
    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYk:Ljava/util/List;

    invoke-interface {v5, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 15
    iget-object v3, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYu:Ljava/util/List;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 18
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->bZn:I
    ...
    .line 20
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/aj;->bZi:I
    ...
    sget v4, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->YC:I

    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYu:Ljava/util/List;
    ...
    .line 24
    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYs:Lcom/google/android/apps/gsa/assistant/settings/news/a;

    .line 25
    iput-object v0, v2, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYl:Landroid/widget/Spinner;

    .line 26
    invoke-virtual {v0, v2}, Landroid/widget/Spinner;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 27
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYs:Lcom/google/android/apps/gsa/assistant/settings/news/a;

    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->bYk:Ljava/util/List;

    .line 28
    iput-object v2, v0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYk:Ljava/util/List;

    .line 29
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/aj;->bZk:I
