...
# instance fields
.field public eBq:Lcom/google/common/util/concurrent/cb;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public eBs:Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TT;"
        }
...
.field public gNA:Lcom/google/android/libraries/gsa/monet/ui/AbstractRendererScope;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    ...
    iput v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBr:I
...
# virtual methods
.method final declared-synchronized De()V
    .locals 1
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBq:Lcom/google/common/util/concurrent/cb;

    .line 30
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBs:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBs:Ljava/lang/Object;

    .line 33
    :cond_0
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->gNA:Lcom/google/android/libraries/gsa/monet/ui/AbstractRendererScope;
    :try_end_0
...
.method public declared-synchronized bootstrapFeature(Ljava/lang/String;Lcom/google/android/libraries/gsa/monet/shared/FeatureModelApi;Lcom/google/android/libraries/gsa/monet/shared/ChildApi;Lcom/google/android/libraries/gsa/monet/shared/ProtoParcelable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->gNA:Lcom/google/android/libraries/gsa/monet/ui/AbstractRendererScope;
...
.method protected declared-synchronized onLock(Lcom/google/android/libraries/gsa/monet/shared/MonetType;Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    :try_start_0
    iget v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBr:I
    ...
    .line 6
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->eBq:Lcom/google/common/util/concurrent/cb;
    ...
    new-instance v2, Lcom/google/android/apps/gsa/shared/monet/aq;

    const-string v3, "Load MonetServiceEntryPoint"

    invoke-direct {v2, p0, v3}, Lcom/google/android/apps/gsa/shared/monet/aq;-><init>(Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/google/android/apps/gsa/shared/monet/ap;

    invoke-direct {v1, p1, p2}, Lcom/google/android/apps/gsa/shared/monet/ap;-><init>(Lcom/google/android/libraries/gsa/monet/shared/MonetType;Ljava/lang/String;)V
    ...
    .line 15
    new-instance v1, Lcom/google/android/apps/gsa/shared/monet/ar;

    .line 16
    invoke-direct {v1, p0}, Lcom/google/android/apps/gsa/shared/monet/ar;-><init>(Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;)V
...
.method protected declared-synchronized onUnlock(Lcom/google/android/libraries/gsa/monet/shared/ScopeLock;)V
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/shared/monet/ResourceBasedRendererScope;->De()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
