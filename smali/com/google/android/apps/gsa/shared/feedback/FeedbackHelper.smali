...
.field public final huf:Lcom/google/android/apps/gsa/shared/feedback/AdditionalFeedbackData;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/logger/p;Lcom/google/android/apps/gsa/search/shared/multiuser/v;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Landroid/content/Context;Lb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/logger/p;Lcom/google/android/apps/gsa/shared/feedback/AdditionalFeedbackData;Lcom/google/android/apps/gsa/search/shared/multiuser/v;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iput-object p2, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->bHi:Lb/a;
    ...
    .line 7
    iput-object p4, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->cJr:Lcom/google/android/apps/gsa/shared/logger/p;

    .line 8
    iput-object p5, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->huf:Lcom/google/android/apps/gsa/shared/feedback/AdditionalFeedbackData;

    .line 9
    iput-object p6, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->cRS:Lcom/google/android/apps/gsa/search/shared/multiuser/v;
...
.method public static a(Landroid/view/Menu;Landroid/app/Activity;Ljava/lang/String;Landroid/accounts/Account;Landroid/net/Uri;Landroid/view/View;ZZLjava/util/List;Ljava/util/List;ILb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/logger/p;Lcom/google/android/apps/gsa/search/shared/multiuser/v;)V
    ...
    .line 17
    :cond_0
    sget v1, Lcom/google/android/apps/gsa/shared/feedback/h;->cQl:I
    ...
    .line 20
    sget v1, Lcom/google/android/apps/gsa/shared/feedback/e;->huj:I
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;-><init>(Landroid/content/Context;Lb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/logger/p;Lcom/google/android/apps/gsa/search/shared/multiuser/v;)V
    ...
    .line 28
    iput-object p3, v2, Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;->ceM:Landroid/accounts/Account;
    ...
    .line 33
    iput-boolean p6, v2, Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;->htV:Z
    ...
    iput v0, v4, Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;->htY:I

    .line 41
    if-eqz p2, :cond_2

    .line 43
    iput-object p2, v4, Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;->htP:Ljava/lang/String;
    ...
    invoke-virtual {v4, v3, v2}, Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;->ak(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;

    goto :goto_2

    .line 21
    :cond_3
    sget v1, Lcom/google/android/apps/gsa/shared/feedback/e;->hui:I
...
.method public static a(Landroid/view/Menu;Landroid/app/Activity;Ljava/lang/String;Landroid/accounts/Account;Landroid/net/Uri;ZLb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/logger/p;Lcom/google/android/apps/gsa/search/shared/multiuser/v;Z)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final a(Lcom/google/android/apps/gsa/shared/feedback/FeedbackDataBuilder;ILjava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    .line 56
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->bHi:Lb/a;
    ...
    .line 57
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->huf:Lcom/google/android/apps/gsa/shared/feedback/AdditionalFeedbackData;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->cJr:Lcom/google/android/apps/gsa/shared/logger/p;

    iget-object v5, p0, Lcom/google/android/apps/gsa/shared/feedback/FeedbackHelper;->cRS:Lcom/google/android/apps/gsa/search/shared/multiuser/v;
