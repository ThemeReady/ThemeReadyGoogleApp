...
# instance fields
.field public final ipg:Lcom/google/android/apps/gsa/shared/util/starter/h;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;Lcom/google/android/apps/gsa/shared/util/starter/h;Landroid/content/pm/PackageManager;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->mIntentStarter:Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->ipg:Lcom/google/android/apps/gsa/shared/util/starter/h;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method private final ad(Landroid/content/Intent;)V
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method public bindDynamicService(Landroid/content/Intent;Lcom/google/android/libraries/velour/api/DynamicServiceConnection;)V
    ...
    .line 33
    iput-object v1, p2, Lcom/google/android/libraries/velour/api/DynamicServiceConnection;->tNc:Lcom/google/android/libraries/velour/services/g;

    .line 34
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->ipg:Lcom/google/android/apps/gsa/shared/util/starter/h;

    const/4 v2, 0x0

    .line 35
    iget-object v0, v0, Lcom/google/android/apps/gsa/shared/util/starter/h;->mContext:Landroid/content/Context;
...
.method public startActivity(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/apps/gsa/shared/util/starter/i;->startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
...
.method public startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->mIntentStarter:Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;
...
.method public startService(Landroid/content/Intent;)V
    ...
    .prologue
    .line 13
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/shared/util/starter/i;->ad(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/apps/gsa/shared/util/starter/h;->startService(Landroid/content/Intent;)V
...
.method public unbindDynamicService(Lcom/google/android/libraries/velour/api/DynamicServiceConnection;)V
    ...
    .line 37
    .line 38
    iget-object v0, p1, Lcom/google/android/libraries/velour/api/DynamicServiceConnection;->tNc:Lcom/google/android/libraries/velour/services/g;
    ...
    .line 42
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/util/starter/i;->ipg:Lcom/google/android/apps/gsa/shared/util/starter/h;

    .line 43
    iget-object v1, v1, Lcom/google/android/apps/gsa/shared/util/starter/h;->mContext:Landroid/content/Context;
