...
# direct methods
.method public constructor <init>(Ljava/lang/String;Ldagger/Lazy;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->hyc:Ljava/lang/String;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->buT:Ldagger/Lazy;
...
.method public recordError(ILjava/lang/Throwable;)V
    ...
    .line 10
    :goto_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->buT:Ldagger/Lazy;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->hyc:Ljava/lang/String;
...
.method public recordEvent(I[B)V
    ...
    .prologue
    .line 12
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->hyc:Ljava/lang/String;

    invoke-static {v0, p1, p2}, Lcom/google/android/apps/gsa/shared/logger/g;->a(Ljava/lang/String;I[B)V
...
.method public recordGsaClientEvent(ILjava/util/Map;)V
    ...
    .line 36
    invoke-virtual {v3, p1}, Lcom/google/common/k/c/er;->Dx(I)Lcom/google/common/k/c/er;

    .line 37
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/api/Logger;->hyc:Ljava/lang/String;

    invoke-virtual {v3, v0}, Lcom/google/common/k/c/er;->ze(Ljava/lang/String;)Lcom/google/common/k/c/er;

    .line 38
    invoke-virtual {v3}, Lcom/google/common/k/c/er;->getSerializedSize()I
    ...
    invoke-static {v1, v0}, Lcom/google/aa/a/c;->g(I[B)I
    ...
    invoke-static {v2, v0, v1}, Lcom/google/aa/a/c;->B([BII)Lcom/google/aa/a/c;

    move-result-object v4

    .line 46
    :try_start_0
    invoke-virtual {v3, v4}, Lcom/google/common/k/c/er;->writeTo(Lcom/google/aa/a/c;)V
    ...
    invoke-virtual {v4, v1, v0}, Lcom/google/aa/a/c;->f(I[B)V
    :try_end_0
    ...
    :cond_1
    :try_start_1
    invoke-static {v2}, Lcom/google/common/k/c/er;->bJ([B)Lcom/google/common/k/c/er;
...
.method public recordGsaClientEvent(I[B)V
    ...
    .line 23
    :try_start_0
    invoke-static {p2}, Lcom/google/common/k/c/er;->bJ([B)Lcom/google/common/k/c/er;
    ...
    invoke-virtual {v0, v1}, Lcom/google/common/k/c/er;->ze(Ljava/lang/String;)Lcom/google/common/k/c/er;

    .line 25
    invoke-virtual {v0, p1}, Lcom/google/common/k/c/er;->Dx(I)Lcom/google/common/k/c/er;
...
.method public recordGsaClientEvent(Lcom/google/android/libraries/gsa/logging/GsaClientEventProtoHolder;)V
    ...
    .prologue
    .line 31
    invoke-static {p1}, Lcom/google/android/libraries/gsa/logging/a;->a(Lcom/google/android/libraries/gsa/logging/GsaClientEventProtoHolder;)Lcom/google/common/k/c/er;
...
.method public recordVisualElements([B)V
    ...
    invoke-static {v0, p1}, Lcom/google/android/apps/gsa/shared/logger/g;->c(Lcom/google/common/k/c/er;[B)V
...
.method public recordVisualElements([B[B)V
    ...
    .line 18
    invoke-static {v0, p2}, Lcom/google/android/apps/gsa/shared/logger/g;->c(Lcom/google/common/k/c/er;[B)V
    :try_end_0
    .catch Lcom/google/aa/a/n; {:try_start_0 .. :try_end_0} :catch_0
