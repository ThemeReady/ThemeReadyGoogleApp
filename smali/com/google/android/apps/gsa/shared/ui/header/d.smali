...
.field public heY:Lcom/google/android/apps/gsa/shared/ui/header/a;
...
.field public hfd:Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;

.field public final hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;

.field public hff:Z

.field public final hfg:Z
...
.field public final hfk:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field public final hfm:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/ui/header/i;Lcom/google/android/apps/gsa/shared/ui/header/br;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfk:Ljava/util/Set;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfm:Ljava/util/Map;

    .line 4
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;

    .line 5
    iput-object p2, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfj:Lcom/google/android/apps/gsa/shared/ui/header/br;

    .line 6
    iput-boolean p3, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfg:Z
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfi:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfh:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->heY:Lcom/google/android/apps/gsa/shared/ui/header/a;

    .line 11
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;

    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->heY:Lcom/google/android/apps/gsa/shared/ui/header/a;
...
.method private final h(Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    ...
    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bg;->hhR:I
...
.method public final a(Lcom/google/android/apps/gsa/shared/ui/header/h;)V
    ...
    .prologue
    .line 13
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfk:Ljava/util/Set;
...
.method public final atA()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 18
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfc:Ljava/util/List;
...
.method public final atB()V
    ...
    invoke-interface {v0}, Lcom/google/android/apps/gsa/shared/ui/header/i;->aty()V

    .line 34
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;

    invoke-interface {v0}, Lcom/google/android/apps/gsa/shared/ui/header/i;->atz()Lcom/google/android/apps/gsa/shared/ui/header/CorpusBarSelector;
    ...
    .line 40
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfm:Ljava/util/Map;
    ...
    .line 43
    iget-boolean v1, v0, Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;->gRP:Z
    ...
    sget v8, Lcom/google/android/apps/gsa/shared/ui/header/bg;->hhB:I
    ...
    .line 51
    :goto_1
    iget-object v8, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfm:Ljava/util/Map;
    ...
    .line 52
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;
    ...
    .line 55
    iget-object v8, v0, Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;->aYe:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfc:Ljava/util/List;
    ...
    invoke-virtual {v1, v8}, Lcom/google/android/libraries/j/i;->xD(I)Lcom/google/android/libraries/j/i;
    ...
    .line 64
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfi:Landroid/view/View$OnClickListener;
    ...
    .line 71
    iget-boolean v2, v0, Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;->gRO:Z
    ...
    sget v4, Lcom/google/android/apps/gsa/shared/ui/header/bg;->hhV:I
    ...
    .line 78
    :cond_5
    iget-boolean v0, v0, Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;->gRO:Z
    ...
    .line 50
    :cond_6
    invoke-direct {p0, v6}, Lcom/google/android/apps/gsa/shared/ui/header/d;->h(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 67
    :cond_7
    invoke-static {v5}, Lcom/google/android/libraries/j/l;->dk(Landroid/view/View;)V
    ...
    .line 82
    :cond_8
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hff:Z
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/shared/ui/header/d;->h(Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 90
    iget-object v2, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->cOZ:Ljava/lang/String;
    ...
    .line 92
    iget-boolean v2, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfl:Z
    ...
    sget v3, Lcom/google/android/apps/gsa/shared/ui/header/bc;->cLy:I
    ...
    .line 99
    const-string/jumbo v2, "ve=20920;track:click"
    ...
    sget v2, Lcom/google/android/apps/gsa/shared/ui/header/be;->hhu:I
    ...
    .line 105
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfh:Landroid/view/View$OnClickListener;
    ...
    invoke-interface {v1}, Lcom/google/android/apps/gsa/shared/ui/header/i;->atz()Lcom/google/android/apps/gsa/shared/ui/header/CorpusBarSelector;
    ...
    .line 109
    :cond_a
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->eZP:Z

    if-eqz v0, :cond_d

    .line 110
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfd:Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfd:Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;
    ...
    :cond_b
    :goto_3
    iget-object v0, v6, Lcom/google/android/apps/gsa/shared/ui/header/CorpusBarSelector;->heS:Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;
...
.method public final c(Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;)V
    ...
    .prologue
    .line 15
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfd:Lcom/google/android/apps/gsa/shared/search/corpus/Corpus;
...
.method public final fZ(Z)V
    ...
    .line 22
    iput-boolean p1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->eZP:Z

    .line 23
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfe:Lcom/google/android/apps/gsa/shared/ui/header/i;

    iget-boolean v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfg:Z

    invoke-interface {v0, p1, v1}, Lcom/google/android/apps/gsa/shared/ui/header/i;->y(ZZ)V

    .line 24
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/d;->hfj:Lcom/google/android/apps/gsa/shared/ui/header/br;

    invoke-interface {v0, p1}, Lcom/google/android/apps/gsa/shared/ui/header/br;->bF(Z)V
