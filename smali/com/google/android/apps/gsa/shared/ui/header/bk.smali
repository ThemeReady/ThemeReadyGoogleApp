...
.field public final hYL:Landroid/graphics/drawable/Drawable;

.field public final hYM:I

.field public final hYN:I

.field public final hYO:I

.field public final hYP:Landroid/view/View;

.field public final hYQ:Landroid/widget/LinearLayout;

.field public hYR:Ld/b/k;

.field public hYS:Ld/b/k;

.field public hYT:Landroid/graphics/drawable/Drawable;
...
# direct methods
.method public constructor <init>(Ld/b/k;Lcom/google/android/apps/gsa/shared/ui/header/bo;Landroid/app/Activity;Landroid/view/View;)V
    .locals 2
    ...
    .line 3
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYR:Ld/b/k;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->pS:Landroid/app/Activity;
    ...
    .line 6
    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bg;->hYE:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYP:Landroid/view/View;
    ...
    .line 9
    iput-object p2, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->cTR:Lcom/google/android/apps/gsa/shared/ui/header/bo;

    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYP:Landroid/view/View;

    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bf;->hYx:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYQ:Landroid/widget/LinearLayout;

    .line 12
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->mResources:Landroid/content/res/Resources;

    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/be;->hYe:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYL:Landroid/graphics/drawable/Drawable;

    .line 13
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->mResources:Landroid/content/res/Resources;

    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bd;->hXV:I
    ...
    iput v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYM:I

    .line 15
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->mResources:Landroid/content/res/Resources;

    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bc;->cPD:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getColor(I)I

    move-result v0

    iput v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYN:I

    .line 16
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->mResources:Landroid/content/res/Resources;

    sget v1, Lcom/google/android/apps/gsa/shared/ui/header/bd;->hXW:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYO:I

    .line 17
    return-void
.end method

.method private final ayf()Z
    .locals 11
    ...
    .line 79
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYQ:Landroid/widget/LinearLayout;
    ...
    .line 80
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYR:Ld/b/k;

    iget-object v4, v0, Ld/b/k;->zjR:[Ld/b/l;
    ...
    iget-object v2, v2, Ld/b/l;->zjV:Ld/b/h;

    iget-object v5, v2, Ld/b/h;->zjy:[Ld/b/i;
    ...
    iget-object v8, v8, Ld/b/i;->zjI:Ld/b/j;

    .line 93
    iget-object v8, v8, Ld/b/j;->zjJ:Ljava/lang/String;
    ...
    iget-object v9, v9, Ld/b/i;->zjI:Ld/b/j;

    .line 96
    iget-object v9, v9, Ld/b/j;->zjK:Ljava/lang/String;

    .line 98
    aget-object v10, v5, v2

    iget-object v10, v10, Ld/b/i;->zjI:Ld/b/j;

    .line 99
    iget-boolean v10, v10, Ld/b/j;->zjM:Z
    ...
    iget-object v5, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->pS:Landroid/app/Activity;
    ...
    .line 113
    iget-object v3, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYQ:Landroid/widget/LinearLayout;
...
# virtual methods
.method public final aye()Landroid/view/View;
    .locals 13
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYS:Ld/b/k;

    iget-object v4, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYR:Ld/b/k;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYS:Ld/b/k;

    .line 21
    iget-object v3, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYP:Landroid/view/View;
    ...
    iget-object v5, v0, Ld/b/k;->zjR:[Ld/b/l;
    ...
    .line 26
    iget-object v7, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYQ:Landroid/widget/LinearLayout;

    iget-object v8, v0, Ld/b/l;->zjV:Ld/b/h;

    iget-object v8, v8, Ld/b/h;->zjx:Ld/b/m;

    .line 28
    iget-object v8, v8, Ld/b/m;->bCS:Ljava/lang/String;

    .line 29
    iget-object v0, v0, Ld/b/l;->zjV:Ld/b/h;

    iget-object v0, v0, Ld/b/h;->zjx:Ld/b/m;

    .line 31
    iget-boolean v0, v0, Ld/b/m;->zjX:Z
    ...
    .line 35
    iget v8, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYM:I

    iget v10, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYM:I

    invoke-virtual {v9, v8, v2, v10, v2}, Landroid/widget/TextView;->setPadding(IIII)V

    .line 36
    iget v8, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYN:I

    invoke-virtual {v9, v8}, Landroid/widget/TextView;->setTextColor(I)V

    .line 37
    iget v8, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYO:I
    ...
    .line 41
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYL:Landroid/graphics/drawable/Drawable;
    ...
    sget v8, Lcom/google/android/apps/gsa/shared/ui/header/be;->hYg:I

    invoke-virtual {v0, v8}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYT:Landroid/graphics/drawable/Drawable;

    .line 47
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYT:Landroid/graphics/drawable/Drawable;
    ...
    sget v6, Lcom/google/android/apps/gsa/shared/ui/header/bh;->hYK:I
    ...
    .line 55
    iget v5, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYM:I

    iget v6, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYM:I

    invoke-virtual {v4, v5, v2, v6, v2}, Landroid/widget/TextView;->setPadding(IIII)V

    .line 56
    iget v5, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYN:I

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setTextColor(I)V

    .line 57
    iget v5, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYO:I
    ...
    sget v5, Lcom/google/android/apps/gsa/shared/ui/header/be;->hYg:I

    invoke-virtual {v1, v5}, Landroid/content/res/Resources;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYT:Landroid/graphics/drawable/Drawable;

    .line 64
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/ui/header/bk;->hYT:Landroid/graphics/drawable/Drawable;
    ...
    .line 73
    :goto_3
    invoke-direct {p0}, Lcom/google/android/apps/gsa/shared/ui/header/bk;->ayf()Z
