...
# instance fields
.field public bvP:Lcom/google/common/util/concurrent/ListenableFuture;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public hry:Lcom/google/common/util/concurrent/ListenableFuture;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/util/concurrent/ListenableFuture",
            "<",
...
.field public hrz:Lcom/google/common/util/concurrent/ListenableFuture;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/util/concurrent/ListenableFuture",
            "<TObjectT;>;"
...
# direct methods
.method public constructor <init>(Lc/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Ljava/lang/Class;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p3, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrw:Ljava/lang/Class;

    .line 3
    iput-object p1, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrx:Lc/a;
    ...
    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/shared/velour/m;->eki:Ljava/lang/String;
...
.method private final a(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/common/base/Function;Ljava/lang/String;I)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 24
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/shared/velour/m;->avk()Z
...
.method public final declared-synchronized avl()Z
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrz:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final declared-synchronized avm()Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final declared-synchronized bt(II)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(II)",
    ...
    .line 14
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrx:Lc/a;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrw:Ljava/lang/Class;

    iget-object v3, p0, Lcom/google/android/apps/gsa/shared/velour/m;->eki:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->bvP:Lcom/google/common/util/concurrent/ListenableFuture;

    .line 16
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->bvP:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 18
    iget-object v2, p0, Lcom/google/android/apps/gsa/shared/velour/m;->bvP:Lcom/google/common/util/concurrent/ListenableFuture;

    const-string v3, "ObjectCreationCallback_"

    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->eki:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hry:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 21
    iget-object v2, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hry:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hrz:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final declared-synchronized stop()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hry:Lcom/google/common/util/concurrent/ListenableFuture;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    :try_start_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/shared/velour/m;->hry:Lcom/google/common/util/concurrent/ListenableFuture;
