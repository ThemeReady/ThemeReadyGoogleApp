...
# static fields
.field public static final eZo:Lcom/google/common/base/Supplier;
...
.field public static final eZp:Lcom/google/common/base/Supplier;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/base/Supplier",
            "<",
...
.field public static eZq:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field public final eZr:Lcom/google/android/apps/gsa/search/core/config/s;

.field public final eZs:Lcom/google/android/apps/gsa/search/core/y/ar;

.field public final eZt:Lb/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb/a",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/search/core/config/q;->eZo:Lcom/google/common/base/Supplier;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/search/core/config/q;->eZp:Lcom/google/common/base/Supplier;

    .line 112
    const/4 v0, 0x0

    sput-object v0, Lcom/google/android/apps/gsa/search/core/config/q;->eZq:Ljava/util/HashSet;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;Lcom/google/android/apps/gsa/shared/util/concurrent/bc;Lcom/google/android/apps/gsa/search/core/config/s;Lb/a;Lcom/google/android/apps/gsa/shared/util/debug/DumpableRegistry;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bBl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;

    .line 5
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bqZ:Lcom/google/android/apps/gsa/shared/util/concurrent/bc;

    .line 6
    iput-object p4, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZr:Lcom/google/android/apps/gsa/search/core/config/s;

    .line 7
    iput-object p5, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZt:Lb/a;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bsX:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

    .line 10
    new-instance v0, Lcom/google/android/apps/gsa/search/core/y/ar;

    invoke-direct {v0, p1}, Lcom/google/android/apps/gsa/search/core/y/ar;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZs:Lcom/google/android/apps/gsa/search/core/y/ar;
...
.method private final NS()V
    ...
    .prologue
    .line 57
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eUS:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bBl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;

    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bqZ:Lcom/google/android/apps/gsa/shared/util/concurrent/bc;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eUS:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

    .line 60
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZv:Ljava/util/ArrayList;
    ...
    .line 62
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eUS:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZv:Ljava/util/ArrayList;

    .line 65
    :cond_1
    iget v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZw:I
...
.method private final NT()V
    ...
    .line 77
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZu:Z

    if-nez v0, :cond_1

    .line 78
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bsX:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    .line 80
    invoke-direct {p0}, Lcom/google/android/apps/gsa/search/core/config/q;->NS()V

    .line 81
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZr:Lcom/google/android/apps/gsa/search/core/config/s;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/config/q;->bsX:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

    iget-object v2, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eUS:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

    const-string v3, "settings_version"

    iget-object v6, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZt:Lb/a;
    ...
    iput-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/config/q;->eZu:Z
...
.method private static a(Ljava/lang/String;Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;Lcom/google/android/apps/gsa/shared/util/concurrent/bc;)Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    .locals 5
    ...
    .line 73
    invoke-static {v2, v0, p2}, Lcom/google/android/apps/gsa/search/core/preferences/bf;->a(Ljava/io/File;Ljava/util/concurrent/Executor;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;)Lcom/google/android/apps/gsa/search/core/preferences/bf;
    :try_end_0
...
.method private final a(Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;Ljava/lang/String;Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;)V
    ...
    .line 97
    sget-object v2, Lcom/google/android/apps/gsa/search/core/config/q;->eZp:Lcom/google/common/base/Supplier;

    invoke-interface {v2}, Lcom/google/common/base/Supplier;->get()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/google/common/collect/eb;
    ...
    .line 101
    :cond_0
    sget-object v2, Lcom/google/android/apps/gsa/search/core/config/q;->eZo:Lcom/google/common/base/Supplier;
...
.method public static dU(Ljava/lang/String;)Z
    ...
    .line 45
    :try_start_0
    sget-object v1, Lcom/google/android/apps/gsa/search/core/config/q;->eZq:Ljava/util/HashSet;
    ...
    sput-object v1, Lcom/google/android/apps/gsa/search/core/config/q;->eZq:Ljava/util/HashSet;
    ...
    .line 50
    sget-object v5, Lcom/google/android/apps/gsa/search/core/config/q;->eZq:Ljava/util/HashSet;
    ...
    .line 56
    sget-object v0, Lcom/google/android/apps/gsa/search/core/config/q;->eZq:Ljava/util/HashSet;
...
# virtual methods
.method public final NQ()Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    .locals 2
    ...
    .line 15
    invoke-direct {p0}, Lcom/google/android/apps/gsa/search/core/config/q;->NT()V
...
.method public final NR()Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    .locals 2
...
.method public final a(Landroid/content/SharedPreferences$OnSharedPreferenceChangeListener;)V
    ...
    .line 29
    :try_start_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/core/config/q;->NQ()Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
...
.method public dump(Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/core/config/q;->NR()Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
