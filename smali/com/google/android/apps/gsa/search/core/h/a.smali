...
.field public final fcN:Ljava/util/Map;

.field public fcO:Lcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/search/core/config/x;Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;Lcom/google/android/libraries/c/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/core/h/a;->dbt:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/h/a;->cxg:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/h/a;->bmA:Lcom/google/android/libraries/c/a;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/search/core/h/a;->cym:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    .line 8
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcN:Ljava/util/Map;
    ...
    .line 14
    iget-object v9, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcN:Ljava/util/Map;

    new-instance v0, Lcom/google/android/apps/gsa/shared/util/aa;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/h/a;->bmA:Lcom/google/android/libraries/c/a;

    iget-object v2, p0, Lcom/google/android/apps/gsa/search/core/h/a;->dbt:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 15
    invoke-virtual {v2}, Lcom/google/android/apps/gsa/search/core/config/x;->Oa()J
...
.method private final NK()V
    .locals 4

    .prologue
    .line 54
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcP:Z
    ...
    iput-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcP:Z

    .line 56
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcO:Lcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcO:Lcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;

    .line 58
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->cym:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcO:Lcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;
...
# virtual methods
.method public final declared-synchronized NJ()Ljava/util/Map;
    .locals 6
    ...
    .line 39
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcN:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/shared/util/aa;->ayI()I

    move-result v1

    .line 41
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/h/a;->dbt:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 42
    sget v5, Lcom/google/android/apps/gsa/search/core/config/v;->fel:I
...
.method final declared-synchronized NL()V
    .locals 6
    ...
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/shared/util/aa;->ayL()Ljava/lang/String;
    ...
    .line 64
    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/h/a;->cxg:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
...
.method public final declared-synchronized c(Ljava/lang/String;J)V
    ...
    .line 50
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcN:Ljava/util/Map;

    invoke-interface {v1, p1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 51
    :cond_0
    invoke-virtual {v0, p2, p3}, Lcom/google/android/apps/gsa/shared/util/aa;->bm(J)V

    .line 52
    invoke-direct {p0}, Lcom/google/android/apps/gsa/search/core/h/a;->NK()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized e(Ljava/util/Map;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/core/h/a;->cxg:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/h/a;->bmA:Lcom/google/android/libraries/c/a;

    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/h/a;->dbt:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 30
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/search/core/config/x;->Oa()J
    ...
    .line 31
    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/h/a;->fcN:Ljava/util/Map;
