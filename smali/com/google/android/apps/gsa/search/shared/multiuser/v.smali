...
# interfaces
.implements Lcom/google/android/apps/gsa/shared/util/bw;
...
.field public fIU:Lcom/google/android/apps/gsa/shared/util/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public fIV:Lcom/google/android/apps/gsa/search/shared/multiuser/i;

.field public fIW:Lcom/google/common/util/concurrent/ListenableFuture;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;Lcom/google/android/apps/gsa/shared/util/h/a;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIR:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIS:Ljava/util/Set;

    .line 4
    sget v0, Landroid/support/v4/content/ModernAsyncTask$Status;->zb:I

    iput v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIT:I

    .line 5
    const/4 v0, 0x0

    iput v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->aYq:I

    .line 6
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->mContext:Landroid/content/Context;

    .line 7
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;

    .line 8
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->egc:Lcom/google/android/apps/gsa/shared/util/h/a;
...
.method private final a(Landroid/content/Context;Ljava/util/List;Lcom/google/android/apps/gsa/shared/util/h/a;)I
    ...
    .prologue
    .line 128
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIR:Ljava/lang/Object;

    monitor-enter v1

    .line 129
    :try_start_0
    iget v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIT:I

    sget v2, Landroid/support/v4/content/ModernAsyncTask$Status;->ze:I

    if-eq v0, v2, :cond_0

    iget v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIT:I

    sget v2, Landroid/support/v4/content/ModernAsyncTask$Status;->zf:I
    ...
    .line 132
    invoke-virtual {p3}, Lcom/google/android/apps/gsa/shared/util/h/a;->avb()Z
    ...
    .line 143
    :cond_5
    invoke-static {p1}, Lcom/google/android/apps/gsa/shared/util/br;->aH(Landroid/content/Context;)Ljava/util/List;
...
.method public final C(Landroid/net/Uri;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 89
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->agq()Lcom/google/android/apps/gsa/search/shared/multiuser/i;
...
.method public final a(Lcom/google/android/apps/sidekick/a/a/c;)V
    ...
    .prologue
    .line 101
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->agr()Lcom/google/android/apps/gsa/search/shared/multiuser/y;
...
.method final ago()V
    ...
    :try_start_0
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIU:Lcom/google/android/apps/gsa/shared/util/h;

    .line 53
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIV:Lcom/google/android/apps/gsa/search/shared/multiuser/i;
...
.method final agp()V
    ...
    .prologue
    .line 55
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIW:Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIW:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final agq()Lcom/google/android/apps/gsa/search/shared/multiuser/i;
    .locals 2
    ...
    .line 61
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIV:Lcom/google/android/apps/gsa/search/shared/multiuser/i;
...
.method public final agr()Lcom/google/android/apps/gsa/search/shared/multiuser/y;
    .locals 1
...
.method public final synthetic ags()Lcom/google/android/apps/gsa/shared/util/bx;
    .locals 1
...
.method final connect()Z
    ...
    .line 10
    iget-object v5, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIR:Ljava/lang/Object;

    monitor-enter v5

    .line 11
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIU:Lcom/google/android/apps/gsa/shared/util/h;
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->egc:Lcom/google/android/apps/gsa/shared/util/h/a;
    ...
    sget v7, Landroid/support/v4/content/ModernAsyncTask$Status;->zc:I
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIU:Lcom/google/android/apps/gsa/shared/util/h;

    iget-object v4, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIU:Lcom/google/android/apps/gsa/shared/util/h;

    .line 39
    iget-object v4, v4, Lcom/google/android/apps/gsa/shared/util/h;->hln:Lcom/google/common/util/concurrent/cb;

    .line 40
    iget-object v6, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    .line 41
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
...
.method final disconnect()V
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->fIU:Lcom/google/android/apps/gsa/shared/util/h;

    invoke-virtual {v0, v2}, Landroid/content/Context;->unbindService(Landroid/content/ServiceConnection;)V

    .line 48
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->ago()V

    .line 49
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/shared/multiuser/v;->agp()V
