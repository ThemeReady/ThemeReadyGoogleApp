...
.field public gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

.field public gAs:Landroid/view/TouchDelegate;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lcom/google/android/apps/gsa/search/shared/overlay/i;->gAz:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAq:Ljava/lang/String;

    .line 6
    return-void
.end method

.method private final iD(I)V
    .locals 1
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAs:Landroid/view/TouchDelegate;
...
.method public final iC(I)V
    ...
    .line 34
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->iD(I)V

    .line 35
    if-nez p1, :cond_1

    .line 36
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAq:Ljava/lang/String;
...
.method protected onFinishInflate()V
    ...
    .line 8
    sget v0, Lcom/google/android/apps/gsa/search/shared/overlay/h;->byv:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    .line 9
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    iget-object v2, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAq:Ljava/lang/String;
    ...
    .line 13
    sget v2, Lcom/google/android/apps/gsa/search/shared/overlay/h;->cPQ:I
    ...
    .line 16
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAr:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;
    ...
    iput-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gAs:Landroid/view/TouchDelegate;

    .line 28
    iget v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->mMode:I

    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->iD(I)V
