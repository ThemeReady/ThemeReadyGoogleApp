...
# instance fields
.field public final gGk:Ljava/lang/String;

.field public gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

.field public gGm:Landroid/view/TouchDelegate;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lcom/google/android/apps/gsa/search/shared/overlay/i;->gGt:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGk:Ljava/lang/String;

    .line 6
    return-void
.end method

.method private final iK(I)V
    .locals 1
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGm:Landroid/view/TouchDelegate;
...
.method public final iJ(I)V
    ...
    .line 34
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->iK(I)V

    .line 35
    if-nez p1, :cond_1

    .line 36
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGk:Ljava/lang/String;
...
.method protected onFinishInflate()V
    ...
    .prologue
    .line 7
    sget v0, Lcom/google/android/apps/gsa/search/shared/overlay/h;->cLk:I
    ...
    .line 8
    sget v0, Lcom/google/android/apps/gsa/search/shared/overlay/h;->bxp:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    .line 9
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;

    iget-object v2, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGk:Ljava/lang/String;
    ...
    .line 10
    new-instance v0, Lcom/google/android/apps/gsa/search/shared/overlay/f;

    .line 11
    invoke-direct {v0, p0}, Lcom/google/android/apps/gsa/search/shared/overlay/f;-><init>(Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;)V

    .line 13
    sget v2, Lcom/google/android/apps/gsa/search/shared/overlay/h;->cPU:I
    ...
    .line 14
    new-instance v3, Lcom/google/android/apps/gsa/search/shared/overlay/e;

    invoke-direct {v3, v2}, Lcom/google/android/apps/gsa/search/shared/overlay/e;-><init>(Landroid/view/View;)V
    ...
    .line 16
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGl:Lcom/google/android/apps/gsa/searchplate/ClearOrVoiceButton;
    ...
    iput-object v1, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->gGm:Landroid/view/TouchDelegate;

    .line 28
    iget v0, p0, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->mMode:I

    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/search/shared/overlay/OverlaySearchPlateContainer;->iK(I)V
