...
# instance fields
.field public final synthetic gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

.field public gVm:Lcom/google/android/apps/gsa/searchbox/ui/DynamicUiComponents;
...
.method constructor <init>(Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;Ljava/lang/String;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

    .line 3
    iget-object v0, p1, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->gUW:Lcom/google/android/apps/gsa/shared/velour/aj;
    ...
    invoke-direct {p0, v0, v1, v2, p2}, Lcom/google/android/apps/gsa/shared/velour/m;-><init>(Lb/a;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Ljava/lang/Class;Ljava/lang/String;)V
...
.method protected final synthetic a(Lcom/google/android/libraries/velour/dynloader/Plugin;)Lcom/google/android/apps/gsa/shared/api/SharedApi;
    ...
    .line 30
    .line 31
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

    .line 32
    iget-object v0, v0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->bxJ:Lcom/google/android/apps/gsa/shared/velour/b/a;

    .line 33
    new-instance v1, Lcom/google/android/apps/gsa/searchbox/ui/h;

    iget-object v2, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

    .line 34
    iget-object v2, v2, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->gUU:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/h;
...
.method protected final synthetic a(Lcom/google/android/libraries/velour/dynloader/Plugin;Lcom/google/android/apps/gsa/shared/api/SharedApi;)Ljava/lang/Object;
    ...
    .line 16
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/searchbox/ui/DynamicUiComponents$Builder;->anB()Lcom/google/android/apps/gsa/searchbox/ui/DynamicUiComponents;

    move-result-object v0

    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

    .line 18
    iget-object v1, v1, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->gVf:Lcom/google/android/apps/gsa/shared/searchbox/components/e;

    .line 19
    iget-object v2, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVm:Lcom/google/android/apps/gsa/searchbox/ui/DynamicUiComponents;
    ...
    .line 20
    iput-object v0, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVm:Lcom/google/android/apps/gsa/searchbox/ui/DynamicUiComponents;

    .line 21
    iget-object v1, p0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->gVl:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;

    .line 22
    iget-object v1, v1, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->gUU:Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/h;

    .line 24
    iget-object v2, p0, Lcom/google/android/apps/gsa/shared/velour/m;->fbC:Ljava/lang/String;

    .line 26
    iget-object v3, v1, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/h;->gVp:Ljava/util/Set;

    invoke-interface {v3, v2}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    .line 27
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/h;->amE()V
...
.method final amI()Z
    ...
    .line 11
    iget-boolean v0, v0, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/c;->gVc:Z

    .line 12
    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/google/android/apps/gsa/searchbox/client/gsa/ui/e;->azy()Z
