...
# static fields
.field public static final ryy:Lcom/google/android/apps/gsa/search/shared/service/ClientEventData;
...
.field public eLm:Lcom/google/android/apps/gsa/search/shared/service/ClientConfig;

.field public hJc:Lcom/google/android/apps/gsa/search/core/z/ah;

.field public mIntentStarter:Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;

.field public mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

.field public ryA:Lc/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lc/a",
            "<",
...
.field public ryB:Lcom/google/android/apps/gsa/shared/d/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public ryC:Lcom/google/android/remotesearch/a;

.field public ryD:Lcom/google/android/apps/gsa/search/shared/actions/VoiceAction;

.field public ryE:Landroid/content/Context;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/remotesearch/RemoteSearchService;->ryy:Lcom/google/android/apps/gsa/search/shared/service/ClientEventData;
...
.method constructor <init>(Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lc/a;Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lcom/google/android/remotesearch/RemoteSearchService;->blO:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 5
    iput-object p3, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryA:Lc/a;
...
# virtual methods
.method protected final b(Lcom/google/android/apps/gsa/shared/search/Query;Lcom/google/ad/a/a/s;)V
    .locals 3
    ...
    invoke-direct {v0, p0, p2, p1}, Lcom/google/android/remotesearch/g;-><init>(Lcom/google/android/remotesearch/RemoteSearchService;Lcom/google/ad/a/a/s;Lcom/google/android/apps/gsa/shared/search/Query;)V

    iput-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryB:Lcom/google/android/apps/gsa/shared/d/a;

    .line 64
    iget-object v1, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryB:Lcom/google/android/apps/gsa/shared/d/a;

    iget-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryA:Lc/a;
    ...
    .line 66
    invoke-interface {v0, p2, p1, v2}, Lcom/google/android/apps/gsa/s/d/a;->b(Lcom/google/ad/a/a/s;Lcom/google/android/apps/gsa/shared/search/Query;Lcom/google/android/apps/gsa/search/shared/media/PlaybackStatus;)Ljava/util/List;

    move-result-object v0

    .line 67
    invoke-interface {v1, v0}, Lcom/google/android/apps/gsa/shared/d/a;->aa(Ljava/lang/Object;)V
...
.method final bMI()V
    ...
    .prologue
    .line 78
    iget-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->buG:Lcom/google/android/apps/gsa/search/shared/service/SearchServiceClient;
...
.method final bd(Landroid/os/Bundle;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getResources()Landroid/content/res/Resources;
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryE:Landroid/content/Context;
    ...
    :cond_0
    invoke-super {p0}, Lcom/google/android/apps/gsa/shared/u/b;->getResources()Landroid/content/res/Resources;
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    .line 18
    :goto_0
    iput-boolean v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryz:Z

    .line 19
    iget-boolean v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryz:Z
    ...
    .line 34
    iput-object v0, v2, Lcom/google/android/apps/gsa/search/shared/service/h;->duy:Ljava/lang/String;
    ...
    .line 48
    :goto_1
    iput-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->eLm:Lcom/google/android/apps/gsa/search/shared/service/ClientConfig;

    .line 49
    iput-object v4, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryC:Lcom/google/android/remotesearch/a;

    .line 50
    iput-object v4, p0, Lcom/google/android/remotesearch/RemoteSearchService;->ryB:Lcom/google/android/apps/gsa/shared/d/a;
    ...
    iget-object v4, p0, Lcom/google/android/remotesearch/RemoteSearchService;->eLm:Lcom/google/android/apps/gsa/search/shared/service/ClientConfig;
    ...
    iput-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->buG:Lcom/google/android/apps/gsa/search/shared/service/SearchServiceClient;

    .line 53
    iget-object v0, p0, Lcom/google/android/remotesearch/RemoteSearchService;->buG:Lcom/google/android/apps/gsa/search/shared/service/SearchServiceClient;

    invoke-virtual {v0, v6}, Lcom/google/android/apps/gsa/search/shared/service/SearchServiceClient;->hY(I)V
...
.method public onUnbind(Landroid/content/Intent;)Z
    ...
    .line 57
    invoke-virtual {p0}, Lcom/google/android/remotesearch/RemoteSearchService;->bMI()V
