...
.method constructor <init>(Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :sswitch_1
    const-string v6, "com.google.android.googlequicksearchbox.ALWAYS_ON_DSP_INTERACTOR_FLAG_CHANGED"
    ...
    .line 3
    :pswitch_0
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;
    ...
    .line 7
    iget-object v1, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 8
    iget-object v1, v1, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->rAW:Ljava/lang/Object;
    ...
    .line 10
    :try_start_0
    iget-object v2, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    iget-object v2, v2, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->bYS:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->mJ(Z)Z

    .line 12
    iget-object v2, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    invoke-virtual {v2, v0}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tb(Ljava/lang/String;)Z
    ...
    .line 15
    invoke-virtual {v0}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->bNH()Z
    ...
    .line 22
    iget-boolean v0, v0, Lcom/google/android/hotword/service/HotwordInformation;->qfX:Z
    ...
    .line 25
    iget-boolean v0, v0, Lcom/google/android/hotword/service/HotwordInformation;->qfV:Z
    ...
    .line 31
    iget-boolean v5, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->jdp:Z

    if-eqz v5, :cond_4

    iget-boolean v5, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->rBb:Z
    ...
    .line 40
    :cond_5
    iget-object v2, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->rAZ:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$ServiceHandler;
    ...
    invoke-virtual {v0}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->bNu()V

    .line 51
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$9;->rBf:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 52
    iget-boolean v0, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->rAO:Z
    ...
    :sswitch_data_0
    .sparse-switch
        -0x664a6eb6 -> :sswitch_4
        -0x53dcd3ff -> :sswitch_1
        -0x42dc497e -> :sswitch_2
        0xd4d933b -> :sswitch_6
        0xdbfa384 -> :sswitch_0
        0x20e80214 -> :sswitch_3
        0x49d32a33 -> :sswitch_5
    .end sparse-switch
