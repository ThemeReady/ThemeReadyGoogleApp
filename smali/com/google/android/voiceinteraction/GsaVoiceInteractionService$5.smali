...
.method constructor <init>(Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;
...
.method public onAvailabilityChanged(I)V
    ...
    .prologue
    .line 134
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 135
    iput p1, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFp:I

    .line 137
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 138
    invoke-virtual {v0}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->cdc()V
...
.method public onDetected(Landroid/service/voice/AlwaysOnHotwordDetector$EventPayload;)V
    ...
    iput-boolean v8, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFs:Z
    ...
    .line 7
    iget-object v2, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;
    ...
    .line 10
    iget-object v5, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 11
    invoke-virtual {v5}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->cdf()Z
    ...
    .line 16
    iget-object v3, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;
    ...
    .line 37
    iget-object v1, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 38
    iget-object v1, v1, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->sgj:Ljava/lang/Object;
    ...
    .line 41
    invoke-virtual {v0}, Lcom/google/android/libraries/assistant/hotword/dsp/DspAudioData;->avE()I

    move-result v3

    .line 42
    iput v3, v2, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->hLF:I

    .line 44
    const/4 v3, 0x1

    .line 46
    iput-boolean v3, v2, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->hLt:Z

    .line 48
    const/4 v3, 0x1

    .line 50
    iput v3, v2, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->hLH:I

    .line 52
    const/high16 v3, 0x3f800000    # 1.0f

    .line 54
    iput v3, v2, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->hLx:F

    .line 57
    invoke-virtual {v0}, Lcom/google/android/libraries/assistant/hotword/dsp/DspAudioData;->bQg()Lcom/google/common/base/ax;
    ...
    .line 59
    iput-object v0, v2, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->hKD:[B

    .line 60
    :cond_1
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    invoke-virtual {v2}, Lcom/google/android/apps/gsa/shared/speech/hotword/b;->avS()Lcom/google/android/apps/gsa/shared/speech/hotword/HotwordResult;

    move-result-object v2

    iput-object v2, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->goW:Lcom/google/android/apps/gsa/shared/speech/hotword/HotwordResult;
    ...
    .line 89
    iget-object v2, v2, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->sgj:Ljava/lang/Object;
    ...
    .line 91
    :try_start_2
    iget-object v4, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    iget-object v4, v4, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFh:Lcom/google/android/apps/gsa/voiceinteraction/hotword/a;
    ...
    iget-object v2, v2, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->ptM:Lcom/google/android/hotword/service/HotwordInformation;
    ...
    .line 100
    iget-object v2, v2, Lcom/google/android/hotword/service/HotwordInformation;->hLJ:Lcom/google/android/apps/gsa/shared/speech/speakerid/SpeakerIdModel;

    .line 102
    if-eqz v2, :cond_5

    .line 103
    iget-object v2, v2, Lcom/google/android/apps/gsa/shared/speech/speakerid/SpeakerIdModel;->hMb:Lcom/google/common/base/ax;
    ...
    iget-object v1, v1, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFq:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$ServiceHandler;
...
.method public onError()V
    ...
    .line 118
    invoke-virtual {v0}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->ccU()I
    ...
    invoke-virtual {v1}, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->cde()Lcom/google/android/apps/gsa/search/shared/service/ClientEventData;
    ...
    iput-boolean v1, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFa:Z
...
.method public onRecognitionResumed()V
    ...
    iput-boolean v1, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFs:Z

    .line 142
    iget-object v0, p0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$5;->tFw:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;

    .line 144
    iget-object v1, v0, Lcom/google/android/voiceinteraction/GsaVoiceInteractionService;->tFq:Lcom/google/android/voiceinteraction/GsaVoiceInteractionService$ServiceHandler;
