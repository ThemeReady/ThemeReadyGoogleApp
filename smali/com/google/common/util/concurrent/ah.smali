...
.field public final synthetic vDa:Lcom/google/common/util/concurrent/ag;
...
.method constructor <init>(Lcom/google/common/util/concurrent/ag;Lcom/google/common/collect/cr;Z)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/common/util/concurrent/ah;->vDa:Lcom/google/common/util/concurrent/ag;
    ...
    .line 7
    :goto_0
    iput-object v0, p0, Lcom/google/common/util/concurrent/ah;->bhe:Ljava/util/List;
    ...
    .line 9
    iget-object v1, p0, Lcom/google/common/util/concurrent/ah;->bhe:Ljava/util/List;
...
.method final a(ZILjava/lang/Object;)V
    ...
    .prologue
    .line 12
    iget-object v0, p0, Lcom/google/common/util/concurrent/ah;->bhe:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/common/util/concurrent/ah;->vDa:Lcom/google/common/util/concurrent/ag;
...
.method final cmB()V
    ...
    .line 21
    iget-object v1, p0, Lcom/google/common/util/concurrent/ah;->vDa:Lcom/google/common/util/concurrent/ag;

    invoke-virtual {p0, v0}, Lcom/google/common/util/concurrent/ah;->dO(Ljava/util/List;)Ljava/lang/Object;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/google/common/util/concurrent/ag;->ax(Ljava/lang/Object;)Z
...
.method abstract dO(Ljava/util/List;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
