...
# static fields
.field public static aRG:Ljava/util/HashMap;

.field public static aRH:Lcom/android/b/c/n;

.field public static aRL:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/b/c/m;->aRG:Ljava/util/HashMap;
    ...
    sput-object v0, Lcom/android/b/c/m;->aRH:Lcom/android/b/c/n;
...
.method protected constructor <init>(Z)V
    ...
    .line 4
    iput-boolean v2, p0, Lcom/android/b/c/m;->aRI:Z

    .line 5
    iput-boolean v1, p0, Lcom/android/b/c/m;->aRJ:Z

    .line 6
    iput-boolean v2, p0, Lcom/android/b/c/m;->mOpaque:Z

    .line 7
    iput-boolean v1, p0, Lcom/android/b/c/m;->aRK:Z

    .line 8
    if-eqz p1, :cond_0

    .line 10
    iput-boolean v2, p0, Lcom/android/b/c/a;->aQT:Z

    .line 11
    iput v2, p0, Lcom/android/b/c/m;->aRM:I
...
.method private static a(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    .line 13
    sget-object v1, Lcom/android/b/c/m;->aRH:Lcom/android/b/c/n;

    .line 14
    iput-boolean p0, v1, Lcom/android/b/c/n;->aRN:Z

    .line 15
    iput-object p1, v1, Lcom/android/b/c/n;->aRO:Landroid/graphics/Bitmap$Config;

    .line 16
    iput p2, v1, Lcom/android/b/c/n;->length:I

    .line 17
    sget-object v0, Lcom/android/b/c/m;->aRG:Ljava/util/HashMap;
    ...
    .line 22
    :goto_0
    sget-object v2, Lcom/android/b/c/m;->aRG:Ljava/util/HashMap;

    invoke-virtual {v1}, Lcom/android/b/c/n;->iR()Lcom/android/b/c/n;
...
.method private final iO()Landroid/graphics/Bitmap;
    .locals 4
    ...
    .line 25
    invoke-virtual {p0}, Lcom/android/b/c/m;->iK()Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Lcom/android/b/c/m;->aRM:I
    ...
    iget v2, p0, Lcom/android/b/c/m;->aRM:I
...
.method protected final a(Lcom/android/b/c/c;)Z
    ...
    .line 89
    invoke-virtual {p0}, Lcom/android/b/c/m;->iQ()Z
...
.method public final b(Lcom/android/b/c/c;)V
    ...
    .line 41
    iget-boolean v1, p0, Lcom/android/b/c/m;->aRK:Z

    if-eqz v1, :cond_1

    sget v1, Lcom/android/b/c/m;->aRL:I

    add-int/lit8 v1, v1, 0x1

    sput v1, Lcom/android/b/c/m;->aRL:I
    ...
    .line 44
    :cond_1
    invoke-direct {p0}, Lcom/android/b/c/m;->iO()Landroid/graphics/Bitmap;
    ...
    .line 49
    invoke-virtual {p0}, Lcom/android/b/c/m;->iH()I
    ...
    .line 51
    invoke-interface {p1}, Lcom/android/b/c/c;->iL()Lcom/android/b/c/i;

    move-result-object v0

    invoke-interface {v0}, Lcom/android/b/c/i;->iN()I

    move-result v0

    iput v0, p0, Lcom/android/b/c/m;->dR:I
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Lcom/android/b/c/m;->iP()V

    .line 75
    iput-object p1, p0, Lcom/android/b/c/a;->aQU:Lcom/android/b/c/c;

    .line 76
    iput v7, p0, Lcom/android/b/c/m;->mState:I

    .line 77
    iput-boolean v7, p0, Lcom/android/b/c/m;->aRI:Z
    ...
    iget v3, p0, Lcom/android/b/c/m;->aRM:I
    ...
    .line 60
    iget v0, p0, Lcom/android/b/c/m;->aRM:I
    ...
    .line 80
    :cond_8
    iget-boolean v0, p0, Lcom/android/b/c/m;->aRI:Z
...
.method public abstract iK()Landroid/graphics/Bitmap;
.end method
