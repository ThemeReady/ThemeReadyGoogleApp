...
.method public constructor <init>(Lcom/android/launcher3/allapps/AllAppsGridAdapter;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2, v1, v1, v0}, Landroid/support/v7/widget/cw;-><init>(Landroid/content/Context;IIZ)V
...
.method public final getRowCountForAccessibility(Landroid/support/v7/widget/fe;Landroid/support/v7/widget/fl;)I
    ...
    .prologue
    .line 37
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/cw;->getRowCountForAccessibility(Landroid/support/v7/widget/fe;Landroid/support/v7/widget/fl;)I
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .prologue
    .line 4
    invoke-super {p0, p1}, Landroid/support/v7/widget/cw;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 15
    iget-object v0, v0, Landroid/support/v4/view/a/ac;->Sb:Landroid/view/accessibility/AccessibilityRecord;
...
.method public final onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/fe;Landroid/support/v7/widget/fl;Landroid/view/View;Landroid/support/v4/view/a/e;)V
    ...
    .line 17
    .line 18
    invoke-static {p3}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroid/support/v7/widget/fo;
    ...
    .line 22
    :cond_0
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/cw;->onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/fe;Landroid/support/v7/widget/fl;Landroid/view/View;Landroid/support/v4/view/a/e;)V
    ...
    invoke-virtual {v4, v6}, Landroid/support/v4/view/a/o;->E(Ljava/lang/Object;)Z
