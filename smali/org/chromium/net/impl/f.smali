...
.method constructor <init>(Lorg/chromium/net/impl/CronetBidirectionalStream;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lorg/chromium/net/impl/f;->zOx:Lorg/chromium/net/impl/CronetBidirectionalStream;
...
.method public run()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lorg/chromium/net/impl/f;->zOx:Lorg/chromium/net/impl/CronetBidirectionalStream;

    .line 3
    iget-object v0, v0, Lorg/chromium/net/impl/CronetBidirectionalStream;->zOe:Lorg/chromium/net/impl/cl;

    .line 4
    iget-object v1, p0, Lorg/chromium/net/impl/f;->zOx:Lorg/chromium/net/impl/CronetBidirectionalStream;

    iget-object v2, p0, Lorg/chromium/net/impl/f;->zOx:Lorg/chromium/net/impl/CronetBidirectionalStream;

    .line 5
    iget-object v2, v2, Lorg/chromium/net/impl/CronetBidirectionalStream;->zOt:Lorg/chromium/net/impl/ci;

    .line 6
    invoke-virtual {v0, v1, v2}, Lorg/chromium/net/impl/cl;->c(Lorg/chromium/net/c;Lorg/chromium/net/bd;)V
    :try_end_0
