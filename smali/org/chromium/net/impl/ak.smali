...
.field public final zSP:Ljava/util/concurrent/ExecutorService;
...
.method public constructor <init>(Lorg/chromium/net/impl/k;)V
    ...
    .line 3
    invoke-virtual {p1, v0}, Lorg/chromium/net/impl/k;->Kl(I)I

    move-result v0

    .line 5
    iget-object v1, p1, Lorg/chromium/net/impl/k;->eXE:Ljava/lang/String;

    .line 6
    iput-object v1, p0, Lorg/chromium/net/impl/ak;->eXE:Ljava/lang/String;
    ...
    iput-object v0, p0, Lorg/chromium/net/impl/ak;->zSP:Ljava/util/concurrent/ExecutorService;
...
.method public final a(Ljava/lang/String;Lorg/chromium/net/ba;Ljava/util/concurrent/Executor;ILjava/util/Collection;ZZZ)Lorg/chromium/net/impl/cg;
    ...
    iget-object v2, p0, Lorg/chromium/net/impl/ak;->zSP:Ljava/util/concurrent/ExecutorService;

    iget-object v5, p0, Lorg/chromium/net/impl/ak;->eXE:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/chromium/net/impl/ao;-><init>(Lorg/chromium/net/ba;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/lang/String;Z)V
