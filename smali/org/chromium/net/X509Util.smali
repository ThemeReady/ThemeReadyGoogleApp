...
.field public static xZR:Ljava/security/cert/CertificateFactory;

.field public static xZS:Lorg/chromium/net/be;

.field public static xZT:Lorg/chromium/net/bc;

.field public static xZU:Lorg/chromium/net/be;

.field public static xZV:Ljava/security/KeyStore;

.field public static xZW:Ljava/security/KeyStore;

.field public static xZX:Ljava/io/File;

.field public static xZY:Ljava/util/Set;
...
.field public static xZZ:Z

.field public static yaa:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->sEO:[C
...
.method private static a(Ljavax/security/auth/x500/X500Principal;)Ljava/lang/String;
    ...
    sget-object v4, Lorg/chromium/net/X509Util;->sEO:[C
...
.method private static a(Ljava/security/KeyStore;)Lorg/chromium/net/be;
    .locals 9
    ...
    .line 50
    :cond_0
    new-instance v3, Lorg/chromium/net/bd;
    ...
    invoke-direct {v3, v1}, Lorg/chromium/net/bd;-><init>(Ljavax/net/ssl/X509TrustManager;)V
    :try_end_0
...
.method private static a(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 75
    sget-object v0, Lorg/chromium/net/X509Util;->xZW:Ljava/security/KeyStore;
    ...
    .line 77
    sget-object v0, Lorg/chromium/net/X509Util;->xZY:Ljava/util/Set;
    ...
    sget-object v7, Lorg/chromium/net/X509Util;->xZX:Ljava/io/File;
...
.method static aEN()V
    ...
    .line 4
    :try_start_0
    invoke-static {}, Lorg/chromium/net/X509Util;->cAT()V
...
.method private static cAT()V
    ...
    .line 6
    sget-object v0, Lorg/chromium/net/X509Util;->xZR:Ljava/security/cert/CertificateFactory;
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->xZR:Ljava/security/cert/CertificateFactory;

    .line 8
    :cond_0
    sget-object v0, Lorg/chromium/net/X509Util;->xZS:Lorg/chromium/net/be;

    if-nez v0, :cond_1

    .line 9
    invoke-static {v2}, Lorg/chromium/net/X509Util;->a(Ljava/security/KeyStore;)Lorg/chromium/net/be;

    move-result-object v0

    sput-object v0, Lorg/chromium/net/X509Util;->xZS:Lorg/chromium/net/be;

    .line 10
    :cond_1
    sget-boolean v0, Lorg/chromium/net/X509Util;->xZZ:Z
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->xZW:Ljava/security/KeyStore;
    :try_end_0
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->xZX:Ljava/io/File;
    :try_end_2
    .catch Ljava/security/KeyStoreException; {:try_start_2 .. :try_end_2} :catch_1

    .line 18
    :goto_1
    sget-boolean v0, Lorg/chromium/net/X509Util;->yaa:Z
    ...
    .line 20
    :cond_2
    sput-boolean v1, Lorg/chromium/net/X509Util;->xZZ:Z
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->xZY:Ljava/util/Set;

    .line 23
    :cond_4
    sget-object v0, Lorg/chromium/net/X509Util;->xZV:Ljava/security/KeyStore;
    ...
    sput-object v0, Lorg/chromium/net/X509Util;->xZV:Ljava/security/KeyStore;
    ...
    :cond_5
    :goto_3
    sget-object v0, Lorg/chromium/net/X509Util;->xZU:Lorg/chromium/net/be;
    ...
    invoke-static {v0}, Lorg/chromium/net/X509Util;->a(Ljava/security/KeyStore;)Lorg/chromium/net/be;

    move-result-object v0

    sput-object v0, Lorg/chromium/net/X509Util;->xZU:Lorg/chromium/net/be;
    ...
    sget-object v0, Lorg/chromium/net/X509Util;->xZT:Lorg/chromium/net/bc;

    if-nez v0, :cond_7

    .line 31
    new-instance v0, Lorg/chromium/net/bc;

    .line 32
    invoke-direct {v0}, Lorg/chromium/net/bc;-><init>()V

    .line 33
    sput-object v0, Lorg/chromium/net/X509Util;->xZT:Lorg/chromium/net/bc;
    ...
    .line 35
    invoke-static {}, Lorg/chromium/base/BuildInfo;->bG()Z
    ...
    .line 40
    :goto_4
    sget-object v1, Lorg/chromium/base/ContextUtils;->xXR:Landroid/content/Context;

    .line 41
    sget-object v2, Lorg/chromium/net/X509Util;->xZT:Lorg/chromium/net/bc;
...
.method public static cm([B)Ljava/security/cert/X509Certificate;
    .locals 2

    .prologue
    .line 66
    invoke-static {}, Lorg/chromium/net/X509Util;->aEN()V
...
.method public static verifyServerCertificates([[BLjava/lang/String;Ljava/lang/String;)Lorg/chromium/net/AndroidCertVerifyResult;
    ...
    invoke-static {v3}, Lorg/chromium/net/X509Util;->cm([B)Ljava/security/cert/X509Certificate;
    ...
    invoke-interface {v0, v2, p1, p2}, Lorg/chromium/net/be;->checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    :try_end_4
    ...
    .line 133
    :try_start_6
    sget-object v4, Lorg/chromium/net/X509Util;->xZU:Lorg/chromium/net/be;

    invoke-interface {v4, v2, p1, p2}, Lorg/chromium/net/be;->checkServerTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    :try_end_6
