...
# instance fields
.field public final zMX:Lorg/chromium/net/v;

.field public final synthetic zMY:Lorg/chromium/net/HttpNegotiateAuthenticator;
...
.method public constructor <init>(Lorg/chromium/net/HttpNegotiateAuthenticator;Lorg/chromium/net/v;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lorg/chromium/net/s;->zMY:Lorg/chromium/net/HttpNegotiateAuthenticator;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 2
    iput-object p2, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;
...
.method public run(Landroid/accounts/AccountManagerFuture;)V
    ...
    invoke-static {v0, v1, v2}, Lorg/chromium/base/i;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 12
    iget-object v0, p0, Lorg/chromium/net/s;->zMY:Lorg/chromium/net/HttpNegotiateAuthenticator;

    iget-object v1, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;

    iget-wide v2, v1, Lorg/chromium/net/v;->zNa:J
    ...
    invoke-static {v1, v2, v3}, Lorg/chromium/base/i;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 20
    :cond_1
    iget-object v1, p0, Lorg/chromium/net/s;->zMY:Lorg/chromium/net/HttpNegotiateAuthenticator;

    .line 21
    sget-object v2, Lorg/chromium/base/e;->zLJ:Landroid/content/Context;
    ...
    iput-object v0, v1, Lorg/chromium/net/v;->account:Landroid/accounts/Account;

    .line 27
    iget-object v0, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;
    ...
    iget-object v2, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;

    iget-object v2, v2, Lorg/chromium/net/v;->zNc:Ljava/lang/String;

    iget-object v3, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;

    iget-object v3, v3, Lorg/chromium/net/v;->zNb:Landroid/os/Bundle;

    new-instance v5, Lorg/chromium/net/t;

    iget-object v6, p0, Lorg/chromium/net/s;->zMY:Lorg/chromium/net/HttpNegotiateAuthenticator;

    iget-object v7, p0, Lorg/chromium/net/s;->zMX:Lorg/chromium/net/v;
