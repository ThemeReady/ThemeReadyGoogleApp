...
.method protected constructor <init>(JJ)V
    ...
    .line 2
    iput-wide p1, p0, Lorg/chromium/base/SystemMessageHandler;->xYq:J

    .line 3
    iput-wide p3, p0, Lorg/chromium/base/SystemMessageHandler;->xYr:J

    .line 4
    return-void
.end method

.method private final GZ(I)Landroid/os/Message;
    .locals 3
    ...
    .line 22
    sget-object v2, Lorg/chromium/base/o;->xYt:Lorg/chromium/base/r;

    invoke-interface {v2, v0, v1}, Lorg/chromium/base/r;->a(Landroid/os/Message;Z)V
...
.method private scheduleDelayedWork(JJ)V
    ...
    .line 11
    iget-wide v0, p0, Lorg/chromium/base/SystemMessageHandler;->xYs:J
    ...
    .line 13
    :cond_0
    iput-wide p1, p0, Lorg/chromium/base/SystemMessageHandler;->xYs:J

    .line 14
    invoke-direct {p0, v4}, Lorg/chromium/base/SystemMessageHandler;->GZ(I)Landroid/os/Message;
...
.method private scheduleWork()V
    ...
    invoke-direct {p0, v0}, Lorg/chromium/base/SystemMessageHandler;->GZ(I)Landroid/os/Message;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iput-wide v0, p0, Lorg/chromium/base/SystemMessageHandler;->xYs:J

    .line 7
    :cond_0
    iget-wide v2, p0, Lorg/chromium/base/SystemMessageHandler;->xYq:J

    iget-wide v4, p0, Lorg/chromium/base/SystemMessageHandler;->xYr:J

    iget-wide v6, p0, Lorg/chromium/base/SystemMessageHandler;->xYs:J
