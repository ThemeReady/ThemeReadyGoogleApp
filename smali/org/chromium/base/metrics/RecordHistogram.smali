...
# static fields
.field public static zPc:Ljava/lang/Throwable;

.field public static zPd:Ljava/util/Map;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/base/metrics/RecordHistogram;->zPd:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)V
    ...
    .line 5
    sget-object v4, Lorg/chromium/base/metrics/RecordHistogram;->zPc:Ljava/lang/Throwable;

    if-nez v4, :cond_0

    .line 7
    sget-object v4, Lorg/chromium/base/metrics/RecordHistogram;->zPd:Ljava/util/Map;
    ...
    .line 11
    :goto_0
    invoke-static {v8, v9}, Lorg/chromium/base/metrics/RecordHistogram;->gm(J)I

    move-result v8

    invoke-static {v12, v13}, Lorg/chromium/base/metrics/RecordHistogram;->gm(J)I

    move-result v9

    invoke-static {v14, v15}, Lorg/chromium/base/metrics/RecordHistogram;->gm(J)I
    ...
    sget-object v6, Lorg/chromium/base/metrics/RecordHistogram;->zPd:Ljava/util/Map;
