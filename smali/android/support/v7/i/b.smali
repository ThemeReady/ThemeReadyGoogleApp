...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/i/b;->amD:Ljava/util/Comparator;
...
.method public static a(Landroid/support/v7/i/d;Z)Landroid/support/v7/i/e;
    ...
    .line 2
    invoke-virtual {p0}, Landroid/support/v7/i/d;->eR()I
    ...
    .line 13
    iget v1, v8, Landroid/support/v7/i/h;->amQ:I

    iget v2, v8, Landroid/support/v7/i/h;->amR:I

    iget v3, v8, Landroid/support/v7/i/h;->amS:I

    iget v4, v8, Landroid/support/v7/i/h;->amT:I
    ...
    iget v2, v8, Landroid/support/v7/i/h;->amQ:I
    ...
    iget v2, v8, Landroid/support/v7/i/h;->amS:I
    ...
    iput v2, v0, Landroid/support/v7/i/h;->amQ:I

    .line 23
    iget v2, v8, Landroid/support/v7/i/h;->amS:I

    iput v2, v0, Landroid/support/v7/i/h;->amS:I

    .line 24
    iget-boolean v2, v1, Landroid/support/v7/i/i;->amU:Z
    ...
    iput v2, v0, Landroid/support/v7/i/h;->amR:I

    .line 26
    iget v2, v1, Landroid/support/v7/i/i;->y:I

    iput v2, v0, Landroid/support/v7/i/h;->amT:I
    ...
    .line 34
    iget-boolean v0, v1, Landroid/support/v7/i/i;->amU:Z

    if-eqz v0, :cond_5

    .line 35
    iget-boolean v0, v1, Landroid/support/v7/i/i;->amP:Z
    ...
    iput v0, v8, Landroid/support/v7/i/h;->amQ:I
    ...
    iput v0, v8, Landroid/support/v7/i/h;->amS:I
    ...
    .line 27
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/i/i;->amP:Z
    ...
    .line 46
    :cond_7
    sget-object v0, Landroid/support/v7/i/b;->amD:Ljava/util/Comparator;
...
.method private static a(Landroid/support/v7/i/d;IIII[I[II)Landroid/support/v7/i/i;
    ...
    .line 66
    invoke-virtual {p0, v11, v12}, Landroid/support/v7/i/d;->u(II)Z
    ...
    .line 76
    iput-boolean v2, v1, Landroid/support/v7/i/i;->amP:Z

    .line 77
    const/4 v2, 0x0

    iput-boolean v2, v1, Landroid/support/v7/i/i;->amU:Z
    ...
    .line 89
    invoke-virtual {p0, v12, v13}, Landroid/support/v7/i/d;->u(II)Z
