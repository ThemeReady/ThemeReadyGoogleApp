...
# instance fields
.field public agQ:Landroid/support/v7/preference/PreferenceGroup;

.field public agR:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public agS:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public agT:Landroid/support/v7/preference/p;

.field public agU:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->agT:Landroid/support/v7/preference/p;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->agU:Ljava/lang/Runnable;

    .line 5
    iput-object p1, p0, Landroid/support/v7/preference/m;->agQ:Landroid/support/v7/preference/PreferenceGroup;

    .line 6
    iget-object v0, p0, Landroid/support/v7/preference/m;->agQ:Landroid/support/v7/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->agR:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->agS:Ljava/util/List;
    ...
    .line 13
    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/preference/m;->er()V
...
.method private final a(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/p;)Landroid/support/v7/preference/p;
    ...
    .line 68
    iput v0, p2, Landroid/support/v7/preference/p;->agZ:I
    ...
    .line 71
    iput v0, p2, Landroid/support/v7/preference/p;->aha:I
...
.method private final a(Ljava/util/List;Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    .line 54
    iget-object v4, p0, Landroid/support/v7/preference/m;->agS:Ljava/util/List;
...
# virtual methods
.method public final aZ(I)Landroid/support/v7/preference/Preference;
    .locals 1
...
.method public final e(Landroid/support/v7/preference/Preference;)V
    ...
    .prologue
    .line 90
    iget-object v0, p0, Landroid/support/v7/preference/m;->agR:Ljava/util/List;
    ...
    .line 94
    iget-object v1, p0, Landroid/support/v7/preference/m;->agR:Ljava/util/List;
...
.method public final eq()V
    ...
    iget-object v1, p0, Landroid/support/v7/preference/m;->agU:Ljava/lang/Runnable;
...
.method final er()V
    ...
    .line 27
    iput-object v1, p0, Landroid/support/v7/preference/m;->agR:Ljava/util/List;

    .line 28
    iget-object v2, p0, Landroid/support/v7/preference/m;->agQ:Landroid/support/v7/preference/PreferenceGroup;
    ...
    .line 31
    iget-object v4, v2, Landroid/support/v7/preference/r;->ahm:Landroid/support/v7/preference/v;

    .line 32
    if-eqz v4, :cond_3

    .line 35
    iget-object v2, v2, Landroid/support/v7/preference/r;->ahm:Landroid/support/v7/preference/v;
...
.method public final getItemId(I)J
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/preference/m;->aZ(I)Landroid/support/v7/preference/Preference;
...
.method public final getItemViewType(I)I
    ...
    .line 110
    iget-object v1, p0, Landroid/support/v7/preference/m;->agT:Landroid/support/v7/preference/p;
    ...
    .line 111
    iget-object v0, p0, Landroid/support/v7/preference/m;->agS:Ljava/util/List;
    ...
    .line 115
    iget-object v1, p0, Landroid/support/v7/preference/m;->agS:Ljava/util/List;

    new-instance v2, Landroid/support/v7/preference/p;

    iget-object v3, p0, Landroid/support/v7/preference/m;->agT:Landroid/support/v7/preference/p;
...
.method public final synthetic onBindViewHolder(Landroid/support/v7/widget/fw;I)V
    ...
    .line 118
    invoke-virtual {p0, p2}, Landroid/support/v7/preference/m;->aZ(I)Landroid/support/v7/preference/Preference;
...
.method public final synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/fw;
    ...
    sget-object v4, Landroid/support/v7/preference/ac;->nf:[I
    ...
    .line 126
    sget v1, Landroid/support/v7/preference/ac;->ahH:I
    ...
    .line 132
    iget v3, v0, Landroid/support/v7/preference/p;->agZ:I
    ...
    .line 135
    invoke-static {v3, v1}, Landroid/support/v4/view/ae;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 139
    iget v4, v0, Landroid/support/v7/preference/p;->aha:I

    .line 140
    if-eqz v4, :cond_3

    .line 142
    iget v0, v0, Landroid/support/v7/preference/p;->aha:I
