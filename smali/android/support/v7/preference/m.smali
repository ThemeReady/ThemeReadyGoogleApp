...
# instance fields
.field public ajN:Landroid/support/v7/preference/PreferenceGroup;

.field public ajO:Ljava/util/List;

.field public ajP:Ljava/util/List;

.field public ajQ:Landroid/support/v7/preference/p;

.field public ajR:Ljava/lang/Runnable;
...
.method public constructor <init>(Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->ajQ:Landroid/support/v7/preference/p;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->ajR:Ljava/lang/Runnable;

    .line 5
    iput-object p1, p0, Landroid/support/v7/preference/m;->ajN:Landroid/support/v7/preference/PreferenceGroup;

    .line 6
    iget-object v0, p0, Landroid/support/v7/preference/m;->ajN:Landroid/support/v7/preference/PreferenceGroup;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->ajO:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v7/preference/m;->ajP:Ljava/util/List;
    ...
    .line 13
    :goto_0
    invoke-virtual {p0}, Landroid/support/v7/preference/m;->eQ()V
...
.method private final a(Landroid/support/v7/preference/Preference;Landroid/support/v7/preference/p;)Landroid/support/v7/preference/p;
    ...
    .line 68
    iput v0, p2, Landroid/support/v7/preference/p;->ajW:I
    ...
    .line 71
    iput v0, p2, Landroid/support/v7/preference/p;->ajX:I
...
.method private final a(Ljava/util/List;Landroid/support/v7/preference/PreferenceGroup;)V
    ...
    .line 54
    iget-object v4, p0, Landroid/support/v7/preference/m;->ajP:Ljava/util/List;
...
# virtual methods
.method public final bl(I)Landroid/support/v7/preference/Preference;
    .locals 1
...
.method public final d(Landroid/support/v7/preference/Preference;)V
    ...
    .line 85
    iget-object v1, p0, Landroid/support/v7/widget/ek;->mObservable:Landroid/support/v7/widget/el;

    const/4 v2, 0x1

    invoke-virtual {v1, v0, v2, p1}, Landroid/support/v7/widget/el;->c(IILjava/lang/Object;)V
...
.method public final e(Landroid/support/v7/preference/Preference;)V
    ...
    .prologue
    .line 90
    iget-object v0, p0, Landroid/support/v7/preference/m;->ajO:Ljava/util/List;
    ...
    .line 94
    iget-object v1, p0, Landroid/support/v7/preference/m;->ajO:Ljava/util/List;
...
.method public final eP()V
    ...
    iget-object v1, p0, Landroid/support/v7/preference/m;->ajR:Ljava/lang/Runnable;
...
.method final eQ()V
    ...
    .line 27
    iput-object v1, p0, Landroid/support/v7/preference/m;->ajO:Ljava/util/List;

    .line 28
    iget-object v2, p0, Landroid/support/v7/preference/m;->ajN:Landroid/support/v7/preference/PreferenceGroup;
    ...
    .line 31
    iget-object v4, v2, Landroid/support/v7/preference/r;->akj:Landroid/support/v7/preference/v;

    .line 32
    if-eqz v4, :cond_3

    .line 35
    iget-object v2, v2, Landroid/support/v7/preference/r;->akj:Landroid/support/v7/preference/v;
    ...
    invoke-direct {v2, v0, p0}, Landroid/support/v7/i/f;-><init>(Landroid/support/v7/i/e;Landroid/support/v7/widget/ek;)V
...
.method public final getItemId(I)J
    ...
    .line 77
    .line 78
    iget-boolean v0, p0, Landroid/support/v7/widget/ek;->mHasStableIds:Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/preference/m;->bl(I)Landroid/support/v7/preference/Preference;
...
.method public final getItemViewType(I)I
    ...
    .line 110
    iget-object v1, p0, Landroid/support/v7/preference/m;->ajQ:Landroid/support/v7/preference/p;
    ...
    .line 111
    iget-object v0, p0, Landroid/support/v7/preference/m;->ajP:Ljava/util/List;
    ...
    .line 115
    iget-object v1, p0, Landroid/support/v7/preference/m;->ajP:Ljava/util/List;

    new-instance v2, Landroid/support/v7/preference/p;

    iget-object v3, p0, Landroid/support/v7/preference/m;->ajQ:Landroid/support/v7/preference/p;
...
.method public final synthetic onBindViewHolder(Landroid/support/v7/widget/fo;I)V
    ...
    .line 118
    invoke-virtual {p0, p2}, Landroid/support/v7/preference/m;->bl(I)Landroid/support/v7/preference/Preference;
...
.method public final synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/fo;
    ...
    sget-object v4, Landroid/support/v7/preference/ac;->oq:[I
    ...
    .line 126
    sget v1, Landroid/support/v7/preference/ac;->akE:I
    ...
    .line 132
    iget v3, v0, Landroid/support/v7/preference/p;->ajW:I
    ...
    .line 135
    invoke-static {v3, v1}, Landroid/support/v4/view/ag;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 139
    iget v4, v0, Landroid/support/v7/preference/p;->ajX:I

    .line 140
    if-eqz v4, :cond_3

    .line 142
    iget v0, v0, Landroid/support/v7/preference/p;->ajX:I
