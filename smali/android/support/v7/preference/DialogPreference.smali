...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 2
    sget-object v0, Landroid/support/v7/preference/ac;->nh:[I
    ...
    .line 3
    sget v0, Landroid/support/v7/preference/ac;->ahX:I

    sget v2, Landroid/support/v7/preference/ac;->ahR:I
    ...
    .line 6
    :cond_0
    sget v0, Landroid/support/v7/preference/ac;->ahW:I

    sget v2, Landroid/support/v7/preference/ac;->ahQ:I
    ...
    .line 7
    sget v0, Landroid/support/v7/preference/ac;->ahU:I

    sget v2, Landroid/support/v7/preference/ac;->ahO:I
    ...
    .line 13
    sget v0, Landroid/support/v7/preference/ac;->ahZ:I

    sget v2, Landroid/support/v7/preference/ac;->ahT:I
    ...
    .line 14
    sget v0, Landroid/support/v7/preference/ac;->ahY:I

    sget v2, Landroid/support/v7/preference/ac;->ahS:I
    ...
    .line 15
    sget v0, Landroid/support/v7/preference/ac;->ahV:I

    sget v2, Landroid/support/v7/preference/ac;->ahP:I
...
.method public onClick()V
    ...
    .line 53
    iget-object v1, v0, Landroid/support/v7/preference/r;->aho:Landroid/support/v7/preference/s;

    if-eqz v1, :cond_0

    .line 54
    iget-object v0, v0, Landroid/support/v7/preference/r;->aho:Landroid/support/v7/preference/s;
