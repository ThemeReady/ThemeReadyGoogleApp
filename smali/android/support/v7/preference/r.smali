...
.field public ajH:Landroid/content/SharedPreferences$Editor;
...
.field public ajN:Landroid/support/v7/preference/v;

.field public ajO:Landroid/support/v7/preference/u;

.field public ajP:Landroid/support/v7/preference/s;

.field public ajQ:Landroid/support/v7/preference/t;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Landroid/support/v7/preference/r;->ajF:J

    .line 3
    const/4 v0, 0x0

    iput v0, p0, Landroid/support/v7/preference/r;->ajL:I
...
.method private final N(Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/preference/r;->ajH:Landroid/content/SharedPreferences$Editor;
    ...
    iget-object v1, p0, Landroid/support/v7/preference/r;->ajH:Landroid/content/SharedPreferences$Editor;

    invoke-virtual {v0, v1}, Landroid/support/v4/content/x;->a(Landroid/content/SharedPreferences$Editor;)V

    .line 44
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/preference/r;->ajI:Z
...
.method public final a(Landroid/content/Context;ILandroid/support/v7/preference/PreferenceScreen;)Landroid/support/v7/preference/PreferenceScreen;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/preference/r;->N(Z)V
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/preference/r;->N(Z)V
...
.method final eL()J
    ...
    .line 16
    :try_start_0
    iget-wide v0, p0, Landroid/support/v7/preference/r;->ajF:J

    const-wide/16 v2, 0x1

    add-long/2addr v2, v0

    iput-wide v2, p0, Landroid/support/v7/preference/r;->ajF:J
...
.method public final findPreference(Ljava/lang/CharSequence;)Landroid/support/v7/preference/Preference;
    ...
    .prologue
    .line 32
    iget-object v0, p0, Landroid/support/v7/preference/r;->ajM:Landroid/support/v7/preference/PreferenceScreen;
...
.method final getEditor()Landroid/content/SharedPreferences$Editor;
    ...
    .line 37
    :cond_0
    iget-boolean v0, p0, Landroid/support/v7/preference/r;->ajI:Z
    ...
    iput-object v0, p0, Landroid/support/v7/preference/r;->ajH:Landroid/content/SharedPreferences$Editor;
...
.method public final getSharedPreferences()Landroid/content/SharedPreferences;
    ...
    .line 25
    :cond_0
    iget-object v0, p0, Landroid/support/v7/preference/r;->ajG:Landroid/content/SharedPreferences;

    if-nez v0, :cond_1

    .line 26
    iget v0, p0, Landroid/support/v7/preference/r;->ajL:I
    ...
    .line 30
    :goto_1
    iget-object v1, p0, Landroid/support/v7/preference/r;->ajJ:Ljava/lang/String;

    iget v2, p0, Landroid/support/v7/preference/r;->ajK:I

    invoke-virtual {v0, v1, v2}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/preference/r;->ajG:Landroid/content/SharedPreferences;
    ...
    invoke-static {v0}, Landroid/support/v4/content/d;->k(Landroid/content/Context;)Landroid/content/Context;
...
.method public final setSharedPreferencesName(Ljava/lang/String;)V
    ...
    .prologue
    .line 18
    iput-object p1, p0, Landroid/support/v7/preference/r;->ajJ:Ljava/lang/String;
