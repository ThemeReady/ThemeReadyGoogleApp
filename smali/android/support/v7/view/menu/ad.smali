...
.field public apX:Landroid/support/v7/view/menu/ac;

.field public final apY:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/p;Landroid/view/View;ZII)V
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ad;->aot:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ad;->apY:Landroid/widget/PopupWindow$OnDismissListener;

    .line 6
    iput-object p1, p0, Landroid/support/v7/view/menu/ad;->mContext:Landroid/content/Context;

    .line 7
    iput-object p2, p0, Landroid/support/v7/view/menu/ad;->YC:Landroid/support/v7/view/menu/p;

    .line 8
    iput-object p3, p0, Landroid/support/v7/view/menu/ad;->mAnchorView:Landroid/view/View;

    .line 9
    iput-boolean p4, p0, Landroid/support/v7/view/menu/ad;->aol:Z

    .line 10
    iput p5, p0, Landroid/support/v7/view/menu/ad;->aoj:I

    .line 11
    iput p6, p0, Landroid/support/v7/view/menu/ad;->aok:I
...
.method public final P(Z)V
    ...
    .prologue
    .line 13
    iput-boolean p1, p0, Landroid/support/v7/view/menu/ad;->aoA:Z

    .line 14
    iget-object v0, p0, Landroid/support/v7/view/menu/ad;->apX:Landroid/support/v7/view/menu/ac;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/ac;->P(Z)V
...
.method final a(IIZZ)V
    ...
    .prologue
    .line 49
    invoke-virtual {p0}, Landroid/support/v7/view/menu/ad;->fC()Landroid/support/v7/view/menu/ac;

    move-result-object v0

    .line 50
    invoke-virtual {v0, p4}, Landroid/support/v7/view/menu/ac;->Q(Z)V

    .line 51
    if-eqz p3, :cond_1

    .line 52
    iget v1, p0, Landroid/support/v7/view/menu/ad;->aot:I
    ...
    .line 64
    iput-object v2, v0, Landroid/support/v7/view/menu/ac;->apW:Landroid/graphics/Rect;
...
.method public final b(Landroid/support/v7/view/menu/ag;)V
    ...
    .prologue
    .line 75
    iput-object p1, p0, Landroid/support/v7/view/menu/ad;->aoB:Landroid/support/v7/view/menu/ag;
...
.method public final fC()Landroid/support/v7/view/menu/ac;
    .locals 7
    ...
    sget v2, Landroid/support/v7/a/d;->YV:I
    ...
    iget v3, p0, Landroid/support/v7/view/menu/ad;->aoj:I

    iget v4, p0, Landroid/support/v7/view/menu/ad;->aok:I

    iget-boolean v5, p0, Landroid/support/v7/view/menu/ad;->aol:Z

    invoke-direct/range {v0 .. v5}, Landroid/support/v7/view/menu/g;-><init>(Landroid/content/Context;Landroid/view/View;IIZ)V

    .line 34
    :goto_2
    iget-object v1, p0, Landroid/support/v7/view/menu/ad;->YC:Landroid/support/v7/view/menu/p;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/ac;->f(Landroid/support/v7/view/menu/p;)V

    .line 35
    iget-object v1, p0, Landroid/support/v7/view/menu/ad;->apY:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    .line 37
    iget-object v1, p0, Landroid/support/v7/view/menu/ad;->aoB:Landroid/support/v7/view/menu/ag;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/ac;->a(Landroid/support/v7/view/menu/ag;)V

    .line 38
    iget-boolean v1, p0, Landroid/support/v7/view/menu/ad;->aoA:Z

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/ac;->P(Z)V
    ...
    .line 41
    iput-object v0, p0, Landroid/support/v7/view/menu/ad;->apX:Landroid/support/v7/view/menu/ac;
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ad;->YC:Landroid/support/v7/view/menu/p;

    iget-object v3, p0, Landroid/support/v7/view/menu/ad;->mAnchorView:Landroid/view/View;

    iget v4, p0, Landroid/support/v7/view/menu/ad;->aoj:I

    iget v5, p0, Landroid/support/v7/view/menu/ad;->aok:I

    iget-boolean v6, p0, Landroid/support/v7/view/menu/ad;->aol:Z
...
.method public onDismiss()V
    ...
    .line 71
    iget-object v0, p0, Landroid/support/v7/view/menu/ad;->aoD:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final show()V
    ...
    .prologue
    .line 17
    invoke-virtual {p0}, Landroid/support/v7/view/menu/ad;->fD()Z
