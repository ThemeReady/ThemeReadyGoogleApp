...
.field public alA:Landroid/support/v7/view/menu/ag;

.field public alC:I

.field public amu:Landroid/support/v7/view/menu/ExpandedMenuView;

.field public amv:I

.field public amw:I

.field public amx:Landroid/support/v7/view/menu/n;
...
.method public constructor <init>(II)V
    ...
    .line 6
    iput p1, p0, Landroid/support/v7/view/menu/m;->alC:I

    .line 7
    iput p2, p0, Landroid/support/v7/view/menu/m;->amw:I
...
.method public final H(Z)V
    ...
    .prologue
    .line 23
    iget-object v0, p0, Landroid/support/v7/view/menu/m;->amx:Landroid/support/v7/view/menu/n;
...
.method public final a(Landroid/content/Context;Landroid/support/v7/view/menu/p;)V
    ...
    .prologue
    .line 9
    iget v0, p0, Landroid/support/v7/view/menu/m;->amw:I
    ...
    iget v1, p0, Landroid/support/v7/view/menu/m;->amw:I
    ...
    :cond_0
    :goto_0
    iput-object p2, p0, Landroid/support/v7/view/menu/m;->VZ:Landroid/support/v7/view/menu/p;
...
.method public final a(Landroid/support/v7/view/menu/ag;)V
    ...
    .prologue
    .line 25
    iput-object p1, p0, Landroid/support/v7/view/menu/m;->alA:Landroid/support/v7/view/menu/ag;
...
.method public final a(Landroid/support/v7/view/menu/p;Z)V
    ...
    .prologue
    .line 70
    iget-object v0, p0, Landroid/support/v7/view/menu/m;->alA:Landroid/support/v7/view/menu/ag;
...
.method public final a(Landroid/support/v7/view/menu/ap;)Z
    ...
    .line 29
    iget-object v2, v0, Landroid/support/v7/view/menu/s;->VZ:Landroid/support/v7/view/menu/p;
    ...
    .line 34
    iget-object v5, v3, Landroid/support/v7/app/q;->Tb:Landroid/support/v7/app/i;

    iget-object v5, v5, Landroid/support/v7/app/i;->mContext:Landroid/content/Context;

    .line 35
    sget v6, Landroid/support/v7/a/g;->Yt:I

    invoke-direct {v4, v5, v6}, Landroid/support/v7/view/menu/m;-><init>(Landroid/content/Context;I)V

    iput-object v4, v0, Landroid/support/v7/view/menu/s;->ana:Landroid/support/v7/view/menu/m;

    .line 36
    iget-object v4, v0, Landroid/support/v7/view/menu/s;->ana:Landroid/support/v7/view/menu/m;

    .line 37
    iput-object v0, v4, Landroid/support/v7/view/menu/m;->alA:Landroid/support/v7/view/menu/ag;

    .line 38
    iget-object v4, v0, Landroid/support/v7/view/menu/s;->VZ:Landroid/support/v7/view/menu/p;

    iget-object v5, v0, Landroid/support/v7/view/menu/s;->ana:Landroid/support/v7/view/menu/m;
    ...
    iput-object v4, v5, Landroid/support/v7/app/i;->Sm:Landroid/widget/ListAdapter;

    .line 41
    iget-object v4, v3, Landroid/support/v7/app/q;->Tb:Landroid/support/v7/app/i;

    iput-object v0, v4, Landroid/support/v7/app/i;->SJ:Landroid/content/DialogInterface$OnClickListener;

    .line 43
    iget-object v4, v2, Landroid/support/v7/view/menu/p;->amP:Landroid/view/View;

    .line 45
    if-eqz v4, :cond_3

    .line 47
    iget-object v2, v3, Landroid/support/v7/app/q;->Tb:Landroid/support/v7/app/i;

    iput-object v4, v2, Landroid/support/v7/app/i;->Sl:Landroid/view/View;

    .line 58
    :goto_1
    iget-object v2, v3, Landroid/support/v7/app/q;->Tb:Landroid/support/v7/app/i;

    iput-object v0, v2, Landroid/support/v7/app/i;->SH:Landroid/content/DialogInterface$OnKeyListener;
    ...
    iput-object v2, v0, Landroid/support/v7/view/menu/s;->amZ:Landroid/support/v7/app/p;

    .line 60
    iget-object v2, v0, Landroid/support/v7/view/menu/s;->amZ:Landroid/support/v7/app/p;
    ...
    .line 66
    iget-object v0, v0, Landroid/support/v7/view/menu/s;->amZ:Landroid/support/v7/app/p;
    ...
    .line 50
    :cond_3
    iget-object v4, v2, Landroid/support/v7/view/menu/p;->amO:Landroid/graphics/drawable/Drawable;
    ...
    .line 55
    iget-object v2, v2, Landroid/support/v7/view/menu/p;->amN:Ljava/lang/CharSequence;
...
.method public final getAdapter()Landroid/widget/ListAdapter;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/m;->amx:Landroid/support/v7/view/menu/n;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v7/view/menu/m;->VZ:Landroid/support/v7/view/menu/p;

    iget-object v1, p0, Landroid/support/v7/view/menu/m;->amx:Landroid/support/v7/view/menu/n;

    invoke-virtual {v1, p3}, Landroid/support/v7/view/menu/n;->ba(I)Landroid/support/v7/view/menu/t;
