...
# instance fields
.field public alE:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field public alF:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method final a(Landroid/view/SubMenu;)Landroid/view/SubMenu;
    ...
    .line 16
    iget-object v0, p0, Landroid/support/v7/view/menu/e;->alF:Ljava/util/Map;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/e;->alF:Ljava/util/Map;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/view/menu/aq;-><init>(Landroid/content/Context;Landroid/support/v4/b/a/c;)V

    .line 23
    iget-object v1, p0, Landroid/support/v7/view/menu/e;->alF:Ljava/util/Map;
...
.method final b(Landroid/view/MenuItem;)Landroid/view/MenuItem;
    ...
    .line 6
    iget-object v1, p0, Landroid/support/v7/view/menu/e;->alE:Ljava/util/Map;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/e;->alE:Ljava/util/Map;
    ...
    invoke-static {v1, v0}, Landroid/support/v7/view/menu/aj;->a(Landroid/content/Context;Landroid/support/v4/b/a/b;)Landroid/view/MenuItem;

    move-result-object v1

    .line 11
    iget-object v2, p0, Landroid/support/v7/view/menu/e;->alE:Ljava/util/Map;
