...
.field public final aom:Landroid/os/Handler;

.field public final aon:Ljava/util/List;
...
.field public final aor:Landroid/support/v7/widget/ea;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aon:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aoo:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aop:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aoq:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aor:Landroid/support/v7/widget/ea;

    .line 7
    iput v1, p0, Landroid/support/v7/view/menu/g;->aos:I

    .line 8
    iput v1, p0, Landroid/support/v7/view/menu/g;->aot:I
    ...
    .line 11
    iput p3, p0, Landroid/support/v7/view/menu/g;->aoj:I

    .line 12
    iput p4, p0, Landroid/support/v7/view/menu/g;->aok:I

    .line 13
    iput-boolean p5, p0, Landroid/support/v7/view/menu/g;->aol:Z

    .line 14
    iput-boolean v1, p0, Landroid/support/v7/view/menu/g;->aoA:Z

    .line 15
    invoke-direct {p0}, Landroid/support/v7/view/menu/g;->ff()I

    move-result v0

    iput v0, p0, Landroid/support/v7/view/menu/g;->aov:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/g;->aoi:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aom:Landroid/os/Handler;
...
.method private final ff()I
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/view/aq;->C(Landroid/view/View;)I
...
.method private final g(Landroid/support/v7/view/menu/p;)V
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/g;->aol:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/view/menu/g;->aoA:Z
    ...
    .line 67
    iput-boolean v1, v0, Landroid/support/v7/view/menu/o;->aoA:Z
    ...
    iget v3, p0, Landroid/support/v7/view/menu/g;->aoi:I
    ...
    iget v3, p0, Landroid/support/v7/view/menu/g;->aoj:I

    iget v4, p0, Landroid/support/v7/view/menu/g;->aok:I

    invoke-direct {v8, v1, v2, v3, v4}, Landroid/support/v7/widget/eb;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 75
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->aor:Landroid/support/v7/widget/ea;

    .line 76
    iput-object v1, v8, Landroid/support/v7/widget/eb;->axU:Landroid/support/v7/widget/ea;

    .line 78
    iput-object p0, v8, Landroid/support/v7/widget/dq;->axB:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    .line 81
    iput-object v1, v8, Landroid/support/v7/widget/dq;->axz:Landroid/view/View;

    .line 82
    iget v1, p0, Landroid/support/v7/view/menu/g;->aot:I

    .line 83
    iput v1, v8, Landroid/support/v7/widget/dq;->aot:I
    ...
    .line 91
    iput v0, v8, Landroid/support/v7/widget/dq;->aot:I

    .line 92
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aoo:Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->aoo:Ljava/util/List;
    ...
    .line 95
    iget-object v3, v0, Landroid/support/v7/view/menu/l;->WU:Landroid/support/v7/view/menu/p;
    ...
    .line 135
    sget-object v1, Landroid/support/v7/widget/eb;->axT:Ljava/lang/reflect/Method;
    ...
    iget-object v2, v8, Landroid/support/v7/widget/eb;->axI:Landroid/widget/PopupWindow;
    ...
    .line 142
    iget-object v1, v8, Landroid/support/v7/widget/eb;->axI:Landroid/widget/PopupWindow;
    ...
    .line 151
    iget-object v5, p0, Landroid/support/v7/view/menu/g;->aou:Landroid/view/View;

    invoke-virtual {v5, v2}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    .line 152
    iget v5, p0, Landroid/support/v7/view/menu/g;->aov:I
    ...
    .line 162
    :goto_7
    iput v1, p0, Landroid/support/v7/view/menu/g;->aov:I
    ...
    .line 165
    iput-object v3, v8, Landroid/support/v7/widget/dq;->axz:Landroid/view/View;
    ...
    .line 174
    :goto_8
    iget v5, p0, Landroid/support/v7/view/menu/g;->aot:I
    ...
    .line 182
    :goto_9
    iput v0, v8, Landroid/support/v7/widget/dq;->axn:I
    ...
    iput-boolean v2, v8, Landroid/support/v7/widget/dq;->axs:Z

    .line 185
    iput-boolean v0, v8, Landroid/support/v7/widget/dq;->ats:Z
    ...
    iget v1, p0, Landroid/support/v7/view/menu/g;->aov:I
    ...
    .line 202
    iget-object v2, v8, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;
    ...
    iget-boolean v0, p0, Landroid/support/v7/view/menu/g;->UZ:Z

    if-eqz v0, :cond_3

    .line 206
    iget-object v0, p1, Landroid/support/v7/view/menu/p;->apo:Ljava/lang/CharSequence;

    .line 207
    if-eqz v0, :cond_3

    .line 208
    sget v0, Landroid/support/v7/a/g;->aaY:I
    ...
    .line 212
    iget-object v3, p1, Landroid/support/v7/view/menu/p;->apo:Ljava/lang/CharSequence;
    ...
    .line 106
    :cond_7
    iget-object v1, v0, Landroid/support/v7/view/menu/l;->aoK:Landroid/support/v7/widget/eb;

    .line 107
    iget-object v9, v1, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;
    ...
    .line 119
    invoke-virtual {v1, v3}, Landroid/support/v7/view/menu/o;->bh(I)Landroid/support/v7/view/menu/t;
    ...
    .line 188
    :cond_15
    iget-boolean v0, p0, Landroid/support/v7/view/menu/g;->aow:Z

    if-eqz v0, :cond_16

    .line 189
    iget v0, p0, Landroid/support/v7/view/menu/g;->aoy:I
    ...
    .line 191
    :cond_16
    iget-boolean v0, p0, Landroid/support/v7/view/menu/g;->aox:Z

    if-eqz v0, :cond_17

    .line 192
    iget v0, p0, Landroid/support/v7/view/menu/g;->aoz:I

    invoke-virtual {v8, v0}, Landroid/support/v7/widget/eb;->setVerticalOffset(I)V

    .line 194
    :cond_17
    iget-object v0, p0, Landroid/support/v7/view/menu/ac;->apW:Landroid/graphics/Rect;

    .line 197
    iput-object v0, v8, Landroid/support/v7/widget/dq;->apW:Landroid/graphics/Rect;
...
.method public final P(Z)V
    ...
    .prologue
    .line 22
    iput-boolean p1, p0, Landroid/support/v7/view/menu/g;->aoA:Z
...
.method public final Q(Z)V
    ...
    .prologue
    .line 324
    iput-boolean p1, p0, Landroid/support/v7/view/menu/g;->UZ:Z
...
.method public final a(Landroid/support/v7/view/menu/ag;)V
    ...
    .prologue
    .line 239
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->aoB:Landroid/support/v7/view/menu/ag;
...
.method public final a(Landroid/support/v7/view/menu/p;Z)V
    ...
    .line 266
    iget-object v4, p0, Landroid/support/v7/view/menu/g;->aoo:Ljava/util/List;
    ...
    .line 270
    iget-object v1, v0, Landroid/support/v7/view/menu/l;->WU:Landroid/support/v7/view/menu/p;

    invoke-virtual {v1, p0}, Landroid/support/v7/view/menu/p;->b(Landroid/support/v7/view/menu/af;)V

    .line 271
    iget-boolean v1, p0, Landroid/support/v7/view/menu/g;->aoE:Z
    ...
    .line 274
    iget-object v4, v1, Landroid/support/v7/widget/eb;->axI:Landroid/widget/PopupWindow;
    ...
    .line 284
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aoB:Landroid/support/v7/view/menu/ag;
    ...
    .line 286
    :cond_7
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aoC:Landroid/view/ViewTreeObserver;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->aop:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    .line 289
    :cond_8
    iput-object v2, p0, Landroid/support/v7/view/menu/g;->aoC:Landroid/view/ViewTreeObserver;

    .line 290
    :cond_9
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aou:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v7/view/menu/g;->aoq:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    .line 291
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aoD:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final dismiss()V
    ...
    .line 44
    iget-object v3, v2, Landroid/support/v7/view/menu/l;->aoK:Landroid/support/v7/widget/eb;

    .line 45
    iget-object v3, v3, Landroid/support/v7/widget/dq;->axI:Landroid/widget/PopupWindow;
    ...
    .line 47
    iget-object v2, v2, Landroid/support/v7/view/menu/l;->aoK:Landroid/support/v7/widget/eb;
...
.method public final f(Landroid/support/v7/view/menu/p;)V
    ...
    .line 61
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->aon:Ljava/util/List;
...
.method public final onDismiss()V
    ...
    .line 223
    iget-object v5, v0, Landroid/support/v7/view/menu/l;->aoK:Landroid/support/v7/widget/eb;

    .line 224
    iget-object v5, v5, Landroid/support/v7/widget/dq;->axI:Landroid/widget/PopupWindow;
...
.method public final setAnchorView(Landroid/view/View;)V
    ...
    .line 306
    iget v0, p0, Landroid/support/v7/view/menu/g;->aos:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/g;->aot:I
...
.method public final setGravity(I)V
    ...
    .line 298
    iput p1, p0, Landroid/support/v7/view/menu/g;->aos:I
...
.method public final setHorizontalOffset(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/g;->aow:Z

    .line 319
    iput p1, p0, Landroid/support/v7/view/menu/g;->aoy:I
...
.method public final setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .prologue
    .line 311
    iput-object p1, p0, Landroid/support/v7/view/menu/g;->aoD:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final setVerticalOffset(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/g;->aox:Z

    .line 322
    iput p1, p0, Landroid/support/v7/view/menu/g;->aoz:I
...
.method public final show()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->aou:Landroid/view/View;
    ...
    .line 33
    :goto_2
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->aou:Landroid/view/View;

    invoke-virtual {v1}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/view/menu/g;->aoC:Landroid/view/ViewTreeObserver;
