...
# instance fields
.field public aov:Landroid/content/Context;

.field public aow:Landroid/view/LayoutInflater;

.field public aox:I

.field public aoy:I

.field public aoz:Landroid/support/v7/view/menu/ah;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v7/view/menu/d;->aov:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/d;->aow:Landroid/view/LayoutInflater;

    .line 4
    iput p2, p0, Landroid/support/v7/view/menu/d;->aox:I

    .line 5
    iput p3, p0, Landroid/support/v7/view/menu/d;->aoy:I
...
.method public a(Landroid/support/v7/view/menu/t;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 52
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->aow:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/d;->aoy:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/p;)V
    ...
    .line 9
    iput-object p2, p0, Landroid/support/v7/view/menu/d;->dQ:Landroid/support/v7/view/menu/p;
...
.method public final a(Landroid/support/v7/view/menu/ag;)V
    ...
    .prologue
    .line 47
    iput-object p1, p0, Landroid/support/v7/view/menu/d;->dP:Landroid/support/v7/view/menu/ag;
...
.method public a(Landroid/support/v7/view/menu/p;Z)V
    ...
    .prologue
    .line 57
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->dP:Landroid/support/v7/view/menu/ag;
...
.method public b(Z)V
    ...
    .line 16
    iget-object v0, p0, Landroid/support/v7/view/menu/d;->aoz:Landroid/support/v7/view/menu/ah;
    ...
    .line 19
    :cond_1
    iget-object v1, p0, Landroid/support/v7/view/menu/d;->dQ:Landroid/support/v7/view/menu/p;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/p;->fw()V
    ...
    .line 25
    invoke-virtual {p0, v1}, Landroid/support/v7/view/menu/d;->d(Landroid/support/v7/view/menu/t;)Z
    ...
    .line 28
    invoke-interface {v2}, Landroid/support/v7/view/menu/ai;->c()Landroid/support/v7/view/menu/t;
    ...
    .line 38
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/d;->aoz:Landroid/support/v7/view/menu/ah;
    ...
    .line 42
    invoke-virtual {p0, v0, v4}, Landroid/support/v7/view/menu/d;->c(Landroid/view/ViewGroup;I)Z
...
.method public c(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/ah;
    ...
    iget v1, p0, Landroid/support/v7/view/menu/d;->aox:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/d;->aoz:Landroid/support/v7/view/menu/ah;
...
.method public final getId()I
    ...
    .prologue
    .line 66
    iget v0, p0, Landroid/support/v7/view/menu/d;->dR:I
