...
# instance fields
.field public final ake:Landroid/view/ActionMode$Callback;
...
.field public final akg:Landroid/support/v4/f/v;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ActionMode$Callback;)V
    ...
    .line 3
    iput-object p2, p0, Landroid/support/v7/view/h;->ake:Landroid/view/ActionMode$Callback;
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->akf:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->akg:Landroid/support/v4/f/v;
...
.method private final b(Landroid/view/Menu;)Landroid/view/Menu;
    ...
    .prologue
    .line 18
    iget-object v0, p0, Landroid/support/v7/view/h;->akg:Landroid/support/v4/f/v;
    ...
    invoke-static {v1, v0}, Landroid/support/v7/view/menu/aj;->a(Landroid/content/Context;Landroid/support/v4/b/a/a;)Landroid/view/Menu;

    move-result-object v0

    .line 21
    iget-object v1, p0, Landroid/support/v7/view/h;->akg:Landroid/support/v4/f/v;
...
.method public final a(Landroid/support/v7/view/b;)V
    ...
    .prologue
    .line 16
    iget-object v0, p0, Landroid/support/v7/view/h;->ake:Landroid/view/ActionMode$Callback;
...
.method public final a(Landroid/support/v7/view/b;Landroid/view/MenuItem;)Z
    ...
    .line 14
    invoke-static {v2, p2}, Landroid/support/v7/view/menu/aj;->a(Landroid/content/Context;Landroid/support/v4/b/a/b;)Landroid/view/MenuItem;
...
.method public final b(Landroid/support/v7/view/b;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroid/support/v7/view/h;->akf:Ljava/util/ArrayList;
    ...
    .line 24
    iget-object v0, p0, Landroid/support/v7/view/h;->akf:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Landroid/support/v7/view/g;->akd:Landroid/support/v7/view/b;
