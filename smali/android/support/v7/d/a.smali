...
# static fields
.field public static final ads:Ljava/util/Comparator;
...
.field public final ado:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public final adp:Landroid/util/TimingLogger;

.field public final adq:[Landroid/support/v7/d/h;

.field public final adr:[F
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/d/a;->ads:Ljava/util/Comparator;
...
.method constructor <init>([II[Landroid/support/v7/d/h;)V
    ...
    iput-object v0, p0, Landroid/support/v7/d/a;->adr:[F

    .line 3
    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/d/a;->adp:Landroid/util/TimingLogger;

    .line 4
    iput-object p3, p0, Landroid/support/v7/d/a;->adq:[Landroid/support/v7/d/h;

    .line 5
    new-array v5, v8, [I

    iput-object v5, p0, Landroid/support/v7/d/a;->adn:[I
    ...
    .line 19
    invoke-static {v2}, Landroid/support/v7/d/a;->aL(I)I

    move-result v3

    .line 20
    iget-object v4, p0, Landroid/support/v7/d/a;->adr:[F

    invoke-static {v3, v4}, Landroid/support/v4/graphics/a;->a(I[F)V
    ...
    iput-object v6, p0, Landroid/support/v7/d/a;->PZ:[I
    ...
    iput-object v0, p0, Landroid/support/v7/d/a;->ado:Ljava/util/List;
    ...
    .line 36
    iget-object v3, p0, Landroid/support/v7/d/a;->ado:Ljava/util/List;
    ...
    sget-object v2, Landroid/support/v7/d/a;->ads:Ljava/util/Comparator;
    ...
    iget-object v3, p0, Landroid/support/v7/d/a;->PZ:[I
...
.method private final a(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 62
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dA()Landroid/support/v7/d/j;

    move-result-object v0

    .line 65
    iget v3, v0, Landroid/support/v7/d/j;->adT:I

    .line 66
    invoke-virtual {v0}, Landroid/support/v7/d/j;->dE()[F
...
.method private final a(Ljava/util/PriorityQueue;I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dx()Z
    ...
    .line 51
    :cond_0
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dz()I
    ...
    iget-object v3, v0, Landroid/support/v7/d/c;->adC:Landroid/support/v7/d/a;

    add-int/lit8 v4, v1, 0x1

    iget v5, v0, Landroid/support/v7/d/c;->adu:I

    invoke-direct {v2, v3, v4, v5}, Landroid/support/v7/d/c;-><init>(Landroid/support/v7/d/a;II)V

    .line 53
    iput v1, v0, Landroid/support/v7/d/c;->adu:I

    .line 54
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dy()V
...
.method private final b(I[F)Z
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/d/a;->adq:[Landroid/support/v7/d/h;
    ...
    .line 101
    iget-object v3, p0, Landroid/support/v7/d/a;->adq:[Landroid/support/v7/d/h;
