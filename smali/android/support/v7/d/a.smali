...
# static fields
.field public static final ags:Ljava/util/Comparator;
...
.field public final ago:Ljava/util/List;

.field public final agp:Landroid/util/TimingLogger;

.field public final agq:[Landroid/support/v7/d/h;

.field public final agr:[F
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/d/a;->ags:Ljava/util/Comparator;
...
.method constructor <init>([II[Landroid/support/v7/d/h;)V
    ...
    iput-object v0, p0, Landroid/support/v7/d/a;->agr:[F

    .line 3
    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/d/a;->agp:Landroid/util/TimingLogger;

    .line 4
    iput-object p3, p0, Landroid/support/v7/d/a;->agq:[Landroid/support/v7/d/h;

    .line 5
    new-array v5, v8, [I

    iput-object v5, p0, Landroid/support/v7/d/a;->agn:[I
    ...
    .line 19
    invoke-static {v2}, Landroid/support/v7/d/a;->aX(I)I

    move-result v3

    .line 20
    iget-object v4, p0, Landroid/support/v7/d/a;->agr:[F
    ...
    iput-object v6, p0, Landroid/support/v7/d/a;->SS:[I
    ...
    iput-object v0, p0, Landroid/support/v7/d/a;->ago:Ljava/util/List;
    ...
    .line 36
    iget-object v3, p0, Landroid/support/v7/d/a;->ago:Ljava/util/List;
    ...
    sget-object v2, Landroid/support/v7/d/a;->ags:Ljava/util/Comparator;
    ...
    iget-object v3, p0, Landroid/support/v7/d/a;->SS:[I
...
.method private final a(Ljava/util/Collection;)Ljava/util/List;
    ...
    .line 62
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dZ()Landroid/support/v7/d/j;

    move-result-object v0

    .line 65
    iget v3, v0, Landroid/support/v7/d/j;->agT:I

    .line 66
    invoke-virtual {v0}, Landroid/support/v7/d/j;->ed()[F
...
.method private final a(Ljava/util/PriorityQueue;I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dW()Z
    ...
    .line 51
    :cond_0
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dY()I
    ...
    iget-object v3, v0, Landroid/support/v7/d/c;->agC:Landroid/support/v7/d/a;

    add-int/lit8 v4, v1, 0x1

    iget v5, v0, Landroid/support/v7/d/c;->agu:I

    invoke-direct {v2, v3, v4, v5}, Landroid/support/v7/d/c;-><init>(Landroid/support/v7/d/a;II)V

    .line 53
    iput v1, v0, Landroid/support/v7/d/c;->agu:I

    .line 54
    invoke-virtual {v0}, Landroid/support/v7/d/c;->dX()V
...
.method private final b(I[F)Z
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/d/a;->agq:[Landroid/support/v7/d/h;
    ...
    .line 101
    iget-object v3, p0, Landroid/support/v7/d/a;->agq:[Landroid/support/v7/d/h;
