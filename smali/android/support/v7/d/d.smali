...
# static fields
.field public static final agm:Landroid/support/v7/d/h;
...
.field public final agj:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field public final agk:Landroid/util/SparseBooleanArray;

.field public final agl:Landroid/support/v7/d/j;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/d/d;->agm:Landroid/support/v7/d/h;
...
.method constructor <init>(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 16
    iput-object p1, p0, Landroid/support/v7/d/d;->agh:Ljava/util/List;

    .line 17
    iput-object p2, p0, Landroid/support/v7/d/d;->agi:Ljava/util/List;
    ...
    iput-object v0, p0, Landroid/support/v7/d/d;->agk:Landroid/util/SparseBooleanArray;
    ...
    iput-object v0, p0, Landroid/support/v7/d/d;->agj:Ljava/util/Map;

    .line 20
    invoke-direct {p0}, Landroid/support/v7/d/d;->dS()Landroid/support/v7/d/j;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/d/d;->agl:Landroid/support/v7/d/j;
...
.method public static a(Landroid/graphics/Bitmap;ILandroid/support/v7/d/i;)Landroid/os/AsyncTask;
    ...
    .line 7
    iput p1, v0, Landroid/support/v7/d/f;->agn:I
...
.method public static a(Landroid/graphics/Bitmap;I)Landroid/support/v7/d/d;
    ...
    .line 5
    invoke-virtual {v0}, Landroid/support/v7/d/f;->dT()Landroid/support/v7/d/d;
...
.method private final dS()Landroid/support/v7/d/j;
    .locals 6
    ...
    iget-object v3, p0, Landroid/support/v7/d/d;->agh:Ljava/util/List;
    ...
    .line 26
    iget-object v0, p0, Landroid/support/v7/d/d;->agh:Ljava/util/List;
    ...
    .line 28
    iget v5, v0, Landroid/support/v7/d/j;->afZ:I

    .line 29
    if-le v5, v2, :cond_1

    .line 32
    iget v1, v0, Landroid/support/v7/d/j;->afZ:I
...
.method public final a(Landroid/support/v7/d/k;)Landroid/support/v7/d/j;
    ...
    .prologue
    .line 22
    iget-object v0, p0, Landroid/support/v7/d/d;->agj:Ljava/util/Map;
