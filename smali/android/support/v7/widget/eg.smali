...
.method public final aA(Landroid/view/View;)I
    ...
    .prologue
    .line 23
    iget-object v0, p0, Landroid/support/v7/widget/eg;->mLayoutManager:Landroid/support/v7/widget/fb;

    const/4 v1, 0x1

    iget-object v2, p0, Landroid/support/v7/widget/eg;->mTmpRect:Landroid/graphics/Rect;
    ...
    .line 24
    iget-object v0, p0, Landroid/support/v7/widget/eg;->mTmpRect:Landroid/graphics/Rect;
...
.method public final aC(Landroid/view/View;)I
    ...
    .line 13
    iget-object v1, p0, Landroid/support/v7/widget/eg;->mLayoutManager:Landroid/support/v7/widget/fb;
...
.method public final bx(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/fb;->offsetChildrenHorizontal(I)V
...
.method public final getEndPadding()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fb;->getPaddingRight()I
...
.method public final gt()I
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/fb;->getPaddingLeft()I
