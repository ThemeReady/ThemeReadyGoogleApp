...
.field public aod:Landroid/view/View;

.field public aoe:Landroid/widget/LinearLayout;

.field public aof:Landroid/widget/TextView;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    sget-object v0, Landroid/support/v7/a/j;->bV:[I
    ...
    .line 7
    sget v1, Landroid/support/v7/a/j;->Zi:I
    ...
    .line 8
    sget v1, Landroid/support/v7/a/j;->Zm:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/hl;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aog:I

    .line 9
    sget v1, Landroid/support/v7/a/j;->Zl:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/hl;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoh:I

    .line 10
    sget v1, Landroid/support/v7/a/j;->Zk:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/hl;->getLayoutDimension(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/ActionBarContextView;->anM:I

    .line 11
    sget v1, Landroid/support/v7/a/j;->Zj:I

    sget v2, Landroid/support/v7/a/g;->Ym:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/hl;->getResourceId(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoj:I
...
.method private final fn()V
    ...
    .line 38
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;
    ...
    .line 40
    sget v3, Landroid/support/v7/a/g;->Yj:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;

    .line 42
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;

    sget v3, Landroid/support/v7/a/f;->Xy:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->Sk:Landroid/widget/TextView;

    .line 43
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;

    sget v3, Landroid/support/v7/a/f;->Xx:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aof:Landroid/widget/TextView;

    .line 44
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aog:I

    if-eqz v0, :cond_0

    .line 45
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->Sk:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v3

    iget v5, p0, Landroid/support/v7/widget/ActionBarContextView;->aog:I

    invoke-virtual {v0, v3, v5}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    .line 46
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoh:I

    if-eqz v0, :cond_1

    .line 47
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aof:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v3

    iget v5, p0, Landroid/support/v7/widget/ActionBarContextView;->aoh:I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->aoc:Ljava/lang/CharSequence;
    ...
    .line 52
    :goto_1
    iget-object v5, p0, Landroid/support/v7/widget/ActionBarContextView;->aof:Landroid/widget/TextView;
    ...
    .line 53
    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;
...
.method public final R(Z)V
    ...
    .prologue
    .line 166
    iget-boolean v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aoi:Z
    ...
    .line 168
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoi:Z

    .line 169
    return-void
.end method

.method public final bridge synthetic b(IJ)Landroid/support/v4/view/bo;
    .locals 2

    .prologue
    .line 171
    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/a;->b(IJ)Landroid/support/v4/view/bo;
...
.method public final bb(I)V
    ...
    .prologue
    .line 20
    iput p1, p0, Landroid/support/v7/widget/ActionBarContextView;->anM:I
...
.method public final c(Landroid/support/v7/view/b;)V
    ...
    .prologue
    .line 57
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aod:Landroid/view/View;
    ...
    .line 59
    iget v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoj:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->aod:Landroid/view/View;
    ...
    sget v1, Landroid/support/v7/a/f;->XC:I
    ...
    .line 66
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->anL:Landroid/support/v7/widget/k;
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/k;->fw()Z
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->anL:Landroid/support/v7/widget/k;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/k;->S(Z)V
    ...
    .line 71
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->anL:Landroid/support/v7/widget/k;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->anJ:Landroid/content/Context;

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/view/menu/p;->a(Landroid/support/v7/view/menu/af;Landroid/content/Context;)V

    .line 72
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->anL:Landroid/support/v7/widget/k;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->anK:Landroid/support/v7/widget/ActionMenuView;

    .line 73
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->anK:Landroid/support/v7/widget/ActionMenuView;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/k;->fx()Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 148
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aod:Landroid/view/View;
    ...
    .line 151
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;
    ...
    .line 153
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->jq:Landroid/view/View;
    ...
    .line 156
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->anK:Landroid/support/v7/widget/ActionMenuView;
...
.method protected onMeasure(II)V
    ...
    .line 92
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->anM:I
    ...
    .line 98
    iget-object v9, p0, Landroid/support/v7/widget/ActionBarContextView;->aod:Landroid/view/View;
    ...
    .line 102
    :cond_2
    iget-object v9, p0, Landroid/support/v7/widget/ActionBarContextView;->anK:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 104
    :cond_3
    iget-object v9, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;
    ...
    .line 105
    iget-boolean v9, p0, Landroid/support/v7/widget/ActionBarContextView;->aoi:Z
    ...
    .line 107
    iget-object v10, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;

    invoke-virtual {v10, v9, v2}, Landroid/widget/LinearLayout;->measure(II)V

    .line 108
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->aoe:Landroid/widget/LinearLayout;
...
.method public final setSubtitle(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 35
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->aoc:Ljava/lang/CharSequence;

    .line 36
    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarContextView;->fn()V
