...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 1
    invoke-direct {p0, p1}, Landroid/support/v7/widget/da;-><init>(Landroid/content/Context;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 139
    iget v2, v0, Landroid/support/v7/widget/db;->gravity:I
    ...
    .line 143
    :cond_0
    sget-object v13, Landroid/support/v4/view/ag;->PD:Landroid/support/v4/view/ar;

    invoke-virtual {v13, p0}, Landroid/support/v4/view/ar;->D(Landroid/view/View;)I
    ...
    .line 151
    iget v2, v0, Landroid/support/v7/widget/db;->leftMargin:I

    add-int/2addr v2, v6

    .line 152
    :goto_3
    invoke-virtual {p0, v5}, Landroid/support/v7/widget/AlertDialogLayout;->bF(I)Z
    ...
    .line 154
    :cond_1
    iget v13, v0, Landroid/support/v7/widget/db;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v7/widget/db;->leftMargin:I

    add-int/2addr v2, v13

    iget v13, v0, Landroid/support/v7/widget/db;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    .line 14
    sget v6, Landroid/support/v7/a/f;->abG:I
    ...
    .line 16
    :cond_0
    sget v6, Landroid/support/v7/a/f;->abq:I
    ...
    .line 18
    :cond_1
    sget v6, Landroid/support/v7/a/f;->abr:I

    if-eq v5, v6, :cond_2

    sget v6, Landroid/support/v7/a/f;->abs:I
    ...
    .line 98
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/da;->onMeasure(II)V
    ...
    .line 37
    invoke-static {v2}, Landroid/support/v7/widget/AlertDialogLayout;->ap(Landroid/view/View;)I
    ...
    .line 91
    iget v9, v6, Landroid/support/v7/widget/db;->height:I
    ...
    .line 94
    iput v9, v6, Landroid/support/v7/widget/db;->height:I
