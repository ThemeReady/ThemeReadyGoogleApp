...
# instance fields
.field public final aqD:Landroid/support/v7/widget/b;
...
.field public aqI:Landroid/support/v4/view/bq;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->aqD:Landroid/support/v7/widget/b;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/a;->aqE:Landroid/content/Context;
    ...
    .line 10
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/a;->aqE:Landroid/content/Context;
...
.method public b(IJ)Landroid/support/v4/view/bq;
    .locals 2
    ...
    .line 46
    iget-object v0, p0, Landroid/support/v7/widget/a;->aqI:Landroid/support/v4/view/bq;
    ...
    .line 51
    :cond_1
    invoke-static {p0}, Landroid/support/v4/view/ag;->s(Landroid/view/View;)Landroid/support/v4/view/bq;

    move-result-object v0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {v0, v1}, Landroid/support/v4/view/bq;->k(F)Landroid/support/v4/view/bq;
    ...
    .line 53
    iget-object v1, p0, Landroid/support/v7/widget/a;->aqD:Landroid/support/v7/widget/b;

    invoke-virtual {v1, v0, p1}, Landroid/support/v7/widget/b;->a(Landroid/support/v4/view/bq;I)Landroid/support/v7/widget/b;
...
.method public bn(I)V
    ...
    .prologue
    .line 43
    iput p1, p0, Landroid/support/v7/widget/a;->aqH:I
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v2, Landroid/support/v7/a/j;->aV:[I
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/a;->bn(I)V

    .line 15
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 16
    iget-object v0, p0, Landroid/support/v7/widget/a;->aqG:Landroid/support/v7/widget/ActionMenuPresenter;
    ...
    .line 18
    iget-boolean v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->arP:Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/a;->eZ()I

    move-result v1

    iput v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->arO:I

    .line 20
    :cond_0
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->dQ:Landroid/support/v7/view/menu/p;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 35
    iput-boolean v2, p0, Landroid/support/v7/widget/a;->aqK:Z

    .line 36
    :cond_0
    iget-boolean v1, p0, Landroid/support/v7/widget/a;->aqK:Z
    ...
    .line 39
    iput-boolean v3, p0, Landroid/support/v7/widget/a;->aqK:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 25
    iput-boolean v3, p0, Landroid/support/v7/widget/a;->aqJ:Z

    .line 26
    :cond_0
    iget-boolean v1, p0, Landroid/support/v7/widget/a;->aqJ:Z
    ...
    .line 29
    iput-boolean v2, p0, Landroid/support/v7/widget/a;->aqJ:Z
