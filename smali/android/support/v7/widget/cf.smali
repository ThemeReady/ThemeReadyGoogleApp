...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/cf;->arF:[I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/cf;->mBounds:Landroid/graphics/Rect;

    .line 3
    sget-object v0, Landroid/support/v7/widget/cf;->arF:[I
    ...
    iput-object v1, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;

    .line 5
    iget-object v1, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;
    ...
    .line 11
    :cond_1
    iput p2, p0, Landroid/support/v7/widget/cf;->mOrientation:I
...
.method public getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/fl;)V
    ...
    .line 64
    iget-object v0, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;
    ...
    .line 67
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/cf;->mOrientation:I
...
.method public onDraw$51662RJ4E9NMIP1FCTP62S38D5HN6BQ3C5N7COBJ7D662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN4H9N8OBKCKTIILG_0(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 13
    .line 14
    iget-object v0, p2, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/et;
    ...
    .line 31
    iget-object v5, p0, Landroid/support/v7/widget/cf;->mBounds:Landroid/graphics/Rect;
    ...
    .line 34
    iget-object v5, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;
    ...
    .line 35
    iget-object v6, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v6, v1, v5, v0, v4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 36
    iget-object v4, p0, Landroid/support/v7/widget/cf;->on:Landroid/graphics/drawable/Drawable;
    ...
    .line 54
    iget-object v5, p2, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/et;
