...
.field public final synthetic arl:Landroid/support/v7/widget/bd;

.field public aro:Ljava/lang/CharSequence;

.field public final arp:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/support/v7/widget/bd;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/bg;->arl:Landroid/support/v7/widget/bd;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bg;->arp:Landroid/graphics/Rect;

    .line 5
    iput-object p1, p0, Landroid/support/v7/widget/dq;->auX:Landroid/view/View;
    ...
    .line 8
    iput v0, p0, Landroid/support/v7/widget/dq;->auV:I
    ...
    .line 10
    iput-object v0, p0, Landroid/support/v7/widget/dq;->auZ:Landroid/widget/AdapterView$OnItemClickListener;
...
.method final fQ()V
    ...
    .line 20
    iget-object v0, p0, Landroid/support/v7/widget/bg;->arl:Landroid/support/v7/widget/bd;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/il;->aQ(Landroid/view/View;)Z
    ...
    .line 38
    iget v0, v0, Landroid/support/v7/widget/bd;->arj:I
    ...
    .line 40
    iget-object v2, p0, Landroid/support/v7/widget/bg;->arl:Landroid/support/v7/widget/bd;

    iget-object v0, p0, Landroid/support/v7/widget/bg;->Sm:Landroid/widget/ListAdapter;

    check-cast v0, Landroid/widget/SpinnerAdapter;

    .line 42
    iget-object v6, p0, Landroid/support/v7/widget/dq;->avg:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/bg;->arl:Landroid/support/v7/widget/bd;
    ...
    .line 62
    iget v2, p0, Landroid/support/v7/widget/dq;->arj:I
    ...
    .line 66
    :goto_4
    iput v0, p0, Landroid/support/v7/widget/dq;->auL:I
    ...
    .line 29
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/bg;->arl:Landroid/support/v7/widget/bd;
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 13
    iput-object p1, p0, Landroid/support/v7/widget/bg;->Sm:Landroid/widget/ListAdapter;
...
.method public final show()V
    ...
    .line 71
    invoke-virtual {p0}, Landroid/support/v7/widget/bg;->fQ()V
    ...
    .line 75
    iget-object v1, p0, Landroid/support/v7/widget/dq;->auJ:Landroid/support/v7/widget/cp;
    ...
    .line 79
    iget-object v2, p0, Landroid/support/v7/widget/dq;->auJ:Landroid/support/v7/widget/cp;
    ...
    .line 84
    iput-boolean v3, v2, Landroid/support/v7/widget/cp;->asU:Z
