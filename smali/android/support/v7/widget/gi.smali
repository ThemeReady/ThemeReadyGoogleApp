...
.field public final axe:[I

.field public axf:Landroid/support/v7/app/c;
...
.method public constructor <init>(Landroid/support/v7/widget/ge;Landroid/content/Context;Landroid/support/v7/app/c;Z)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/gi;->axd:Landroid/support/v7/widget/ge;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/gi;->axe:[I

    .line 4
    iput-object p3, p0, Landroid/support/v7/widget/gi;->axf:Landroid/support/v7/app/c;

    .line 5
    iget-object v0, p0, Landroid/support/v7/widget/gi;->axe:[I
...
.method public onMeasure(II)V
    ...
    .line 26
    iget-object v0, p0, Landroid/support/v7/widget/gi;->axd:Landroid/support/v7/widget/ge;

    iget v0, v0, Landroid/support/v7/widget/ge;->awW:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/gi;->axd:Landroid/support/v7/widget/ge;

    iget v1, v1, Landroid/support/v7/widget/ge;->awW:I
...
.method public final update()V
    ...
    .line 29
    iget-object v3, p0, Landroid/support/v7/widget/gi;->axf:Landroid/support/v7/app/c;
    ...
    .line 36
    :cond_1
    iput-object v4, p0, Landroid/support/v7/widget/gi;->jq:Landroid/view/View;

    .line 37
    iget-object v0, p0, Landroid/support/v7/widget/gi;->jw:Landroid/widget/TextView;
    ...
    .line 38
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/gi;->jx:Landroid/widget/ImageView;
    ...
    .line 42
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/gi;->jq:Landroid/view/View;
    ...
    .line 44
    iput-object v1, p0, Landroid/support/v7/widget/gi;->jq:Landroid/view/View;
    ...
    .line 48
    iget-object v5, p0, Landroid/support/v7/widget/gi;->jx:Landroid/widget/ImageView;
    ...
    .line 54
    iput-object v5, p0, Landroid/support/v7/widget/gi;->jx:Landroid/widget/ImageView;
    ...
    .line 62
    iget-object v5, p0, Landroid/support/v7/widget/gi;->jw:Landroid/widget/TextView;
    ...
    .line 69
    iput-object v5, p0, Landroid/support/v7/widget/gi;->jw:Landroid/widget/TextView;
    ...
    .line 71
    iget-object v4, p0, Landroid/support/v7/widget/gi;->jw:Landroid/widget/TextView;
    ...
    :cond_9
    :goto_3
    iget-object v2, p0, Landroid/support/v7/widget/gi;->jx:Landroid/widget/ImageView;
    ...
    .line 72
    :cond_d
    iget-object v2, p0, Landroid/support/v7/widget/gi;->jw:Landroid/widget/TextView;
