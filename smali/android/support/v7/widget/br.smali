...
.method public final a(Landroid/support/v7/widget/bu;)F
    ...
    .line 40
    iget v0, v0, Landroid/support/v7/widget/ga;->awE:F
...
.method public final a(Landroid/support/v7/widget/bu;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
    ...
    .line 4
    invoke-interface {p1}, Landroid/support/v7/widget/bu;->ga()Landroid/view/View;
...
.method public final b(Landroid/support/v7/widget/bu;F)V
    ...
    .line 17
    invoke-interface {p1}, Landroid/support/v7/widget/bu;->fX()Z
    ...
    .line 19
    iget v3, v0, Landroid/support/v7/widget/ga;->awE:F

    cmpl-float v3, p2, v3

    if-nez v3, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ga;->awF:Z

    if-ne v3, v1, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ga;->awG:Z

    if-eq v3, v2, :cond_1

    .line 20
    :cond_0
    iput p2, v0, Landroid/support/v7/widget/ga;->awE:F

    .line 21
    iput-boolean v1, v0, Landroid/support/v7/widget/ga;->awF:Z

    .line 22
    iput-boolean v2, v0, Landroid/support/v7/widget/ga;->awG:Z
