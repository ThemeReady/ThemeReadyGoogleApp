...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v7/widget/ButtonBarLayout;->aul:I

    .line 3
    iput v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->aum:I
    ...
    .line 6
    :cond_0
    sget-object v1, Landroid/support/v7/a/j;->bu:[I
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->auk:Z
...
.method private final ab(Z)V
    ...
    .line 56
    sget v0, Landroid/support/v7/a/f;->abz:I
...
.method public getMinimumHeight()I
    ...
    .prologue
    .line 53
    iget v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->aum:I
...
.method protected onMeasure(II)V
    ...
    .line 11
    iget-boolean v1, p0, Landroid/support/v7/widget/ButtonBarLayout;->auk:Z

    if-eqz v1, :cond_1

    .line 12
    iget v1, p0, Landroid/support/v7/widget/ButtonBarLayout;->aul:I

    if-le v0, v1, :cond_0

    invoke-direct {p0}, Landroid/support/v7/widget/ButtonBarLayout;->gq()Z
    ...
    .line 13
    invoke-direct {p0, v3}, Landroid/support/v7/widget/ButtonBarLayout;->ab(Z)V

    .line 14
    :cond_0
    iput v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->aul:I
    ...
    .line 21
    iget-boolean v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->auk:Z
    ...
    .line 26
    invoke-direct {p0, v2}, Landroid/support/v7/widget/ButtonBarLayout;->ab(Z)V
    ...
    .line 31
    :cond_3
    invoke-direct {p0, v3}, Landroid/support/v7/widget/ButtonBarLayout;->bx(I)I
    ...
    invoke-direct {p0, v1}, Landroid/support/v7/widget/ButtonBarLayout;->bx(I)I
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/view/ar;->z(Landroid/view/View;)I
