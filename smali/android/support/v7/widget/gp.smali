...
.method constructor <init>(Landroid/support/v7/widget/SearchView;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/gp;->aAG:Landroid/support/v7/widget/SearchView;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 2
    iget-object v1, p0, Landroid/support/v7/widget/gp;->aAG:Landroid/support/v7/widget/SearchView;

    iget-object v1, v1, Landroid/support/v7/widget/SearchView;->azO:Landroid/widget/ImageView;

    if-ne p1, v1, :cond_1

    .line 3
    iget-object v0, p0, Landroid/support/v7/widget/gp;->aAG:Landroid/support/v7/widget/SearchView;

    invoke-virtual {v0}, Landroid/support/v7/widget/SearchView;->hk()V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/SearchView;->azQ:Landroid/widget/ImageView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/SearchView;->hj()V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/SearchView;->azP:Landroid/widget/ImageView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/SearchView;->hi()V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/SearchView;->azR:Landroid/widget/ImageView;

    if-ne p1, v1, :cond_9

    .line 9
    iget-object v5, p0, Landroid/support/v7/widget/gp;->aAG:Landroid/support/v7/widget/SearchView;

    .line 10
    iget-object v1, v5, Landroid/support/v7/widget/SearchView;->aAv:Landroid/app/SearchableInfo;

    if-eqz v1, :cond_0

    .line 11
    iget-object v6, v5, Landroid/support/v7/widget/SearchView;->aAv:Landroid/app/SearchableInfo;
    ...
    .line 13
    iget-object v1, v5, Landroid/support/v7/widget/SearchView;->aAc:Landroid/content/Intent;
    ...
    .line 23
    iget-object v1, v5, Landroid/support/v7/widget/SearchView;->aAd:Landroid/content/Intent;
    ...
    .line 29
    iget-object v2, v5, Landroid/support/v7/widget/SearchView;->aAw:Landroid/os/Bundle;
    ...
    iget-object v3, v5, Landroid/support/v7/widget/SearchView;->aAw:Landroid/os/Bundle;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/SearchView;->azK:Landroid/support/v7/widget/SearchView$SearchAutoComplete;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/SearchView;->hm()V
