...
.field public asX:Landroid/support/v4/view/bo;

.field public asY:Landroid/support/v4/widget/al;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 2
    iput-boolean p2, p0, Landroid/support/v7/widget/cp;->asV:Z
...
.method public b(Landroid/view/MotionEvent;I)Z
    ...
    .line 66
    :cond_1
    iput-boolean v1, p0, Landroid/support/v7/widget/cp;->asW:Z
    ...
    .line 69
    iget v0, p0, Landroid/support/v7/widget/cp;->avo:I
    ...
    .line 72
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/cp;->asX:Landroid/support/v4/view/bo;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/cp;->asX:Landroid/support/v4/view/bo;
    ...
    .line 76
    iget-object v0, p0, Landroid/support/v7/widget/cp;->asY:Landroid/support/v4/widget/al;
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/al;-><init>(Landroid/widget/ListView;)V

    iput-object v0, p0, Landroid/support/v7/widget/cp;->asY:Landroid/support/v4/widget/al;

    .line 78
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/cp;->asY:Landroid/support/v4/widget/al;

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/al;->s(Z)Landroid/support/v4/widget/a;

    .line 79
    iget-object v0, p0, Landroid/support/v7/widget/cp;->asY:Landroid/support/v4/widget/al;

    invoke-virtual {v0, p0, p1}, Landroid/support/v4/widget/al;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    .line 24
    iput-boolean v2, p0, Landroid/support/v7/widget/cp;->asW:Z
    ...
    .line 34
    :cond_a
    iput v6, p0, Landroid/support/v7/widget/cp;->avo:I
    ...
    .line 53
    invoke-static {v8, v9, v10}, Landroid/support/v4/graphics/a/a;->a(Landroid/graphics/drawable/Drawable;FF)V
    ...
    .line 56
    invoke-static {v0, v5, v4}, Landroid/support/v4/graphics/a/a;->a(Landroid/graphics/drawable/Drawable;FF)V

    .line 57
    :cond_f
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/cp;->V(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/al;->s(Z)Landroid/support/v4/widget/a;
...
.method protected final gl()Z
    .locals 1

    .prologue
    .line 83
    iget-boolean v0, p0, Landroid/support/v7/widget/cp;->asW:Z

    if-nez v0, :cond_0

    invoke-super {p0}, Landroid/support/v7/widget/dy;->gl()Z
...
.method public hasFocus()Z
    ...
    .prologue
    .line 87
    iget-boolean v0, p0, Landroid/support/v7/widget/cp;->asV:Z
...
.method public isInTouchMode()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/cp;->asU:Z
