...
# instance fields
.field public axU:Landroid/support/v7/widget/ea;

.field public final axV:I

.field public final axW:I

.field public axX:Landroid/view/MenuItem;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 6
    iput v3, p0, Landroid/support/v7/widget/ec;->axV:I

    .line 7
    iput v4, p0, Landroid/support/v7/widget/ec;->axW:I
    ...
    .line 8
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/ec;->axV:I

    .line 9
    iput v3, p0, Landroid/support/v7/widget/ec;->axW:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 28
    iget-object v0, p0, Landroid/support/v7/widget/ec;->axU:Landroid/support/v7/widget/ea;
    ...
    .line 43
    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/o;->bh(I)Landroid/support/v7/view/menu/t;

    move-result-object v1

    .line 44
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/ec;->axX:Landroid/view/MenuItem;

    .line 45
    if-eq v2, v1, :cond_1

    .line 47
    iget-object v0, v0, Landroid/support/v7/view/menu/o;->apc:Landroid/support/v7/view/menu/p;

    .line 49
    if-eqz v2, :cond_0

    .line 50
    iget-object v3, p0, Landroid/support/v7/widget/ec;->axU:Landroid/support/v7/widget/ea;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/ea;->b(Landroid/support/v7/view/menu/p;Landroid/view/MenuItem;)V

    .line 51
    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/ec;->axX:Landroid/view/MenuItem;

    .line 52
    if-eqz v1, :cond_1

    .line 53
    iget-object v2, p0, Landroid/support/v7/widget/ec;->axU:Landroid/support/v7/widget/ea;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ec;->axV:I
    ...
    .line 14
    iget-object v2, v0, Landroid/support/v7/view/menu/ListMenuItemView;->dk:Landroid/support/v7/view/menu/t;
    ...
    iget v0, p0, Landroid/support/v7/widget/ec;->axW:I
