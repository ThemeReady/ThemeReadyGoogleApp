...
.field public final atl:Landroid/widget/ImageView;

.field public atm:Landroid/support/v7/widget/gg;

.field public atn:Landroid/support/v7/widget/gg;
...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v7/widget/al;->atl:Landroid/widget/ImageView;
...
.method public final a(Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iget-object v0, p0, Landroid/support/v7/widget/al;->atl:Landroid/widget/ImageView;

    invoke-virtual {v0}, Landroid/widget/ImageView;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/a/j;->bk:[I
    ...
    .line 11
    iget-object v2, p0, Landroid/support/v7/widget/al;->atl:Landroid/widget/ImageView;
    ...
    .line 18
    sget-object v3, Landroid/support/v4/widget/ag;->Ue:Landroid/support/v4/widget/ai;

    invoke-interface {v3, v0, v2}, Landroid/support/v4/widget/ai;->a(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    sget v2, Landroid/support/v7/a/j;->acO:I
    ...
    invoke-interface {v3, v0, v2}, Landroid/support/v4/widget/ai;->a(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method final c(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 51
    iget-object v0, p0, Landroid/support/v7/widget/al;->atn:Landroid/support/v7/widget/gg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/al;->atn:Landroid/support/v7/widget/gg;
    ...
    .line 55
    invoke-virtual {p0}, Landroid/support/v7/widget/al;->gg()V

    .line 56
    return-void
.end method

.method final dt()Landroid/content/res/ColorStateList;
    .locals 1
...
.method final du()Landroid/graphics/PorterDuff$Mode;
    .locals 1
...
.method final gg()V
    ...
    .line 60
    invoke-static {v3}, Landroid/support/v7/widget/cg;->p(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 65
    iget-object v2, p0, Landroid/support/v7/widget/al;->atm:Landroid/support/v7/widget/gg;
    ...
    .line 71
    iget-object v2, p0, Landroid/support/v7/widget/al;->asN:Landroid/support/v7/widget/gg;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/al;->asN:Landroid/support/v7/widget/gg;
    ...
    .line 75
    iget-object v4, p0, Landroid/support/v7/widget/al;->atl:Landroid/widget/ImageView;

    .line 76
    sget-object v5, Landroid/support/v4/widget/ag;->Ue:Landroid/support/v4/widget/ai;

    invoke-interface {v5, v4}, Landroid/support/v4/widget/ai;->a(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v5, v4}, Landroid/support/v4/widget/ai;->b(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/al;->atl:Landroid/widget/ImageView;
    ...
    .line 97
    :cond_b
    iget-object v0, p0, Landroid/support/v7/widget/al;->atm:Landroid/support/v7/widget/gg;
