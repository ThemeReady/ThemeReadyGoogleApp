...
# static fields
.field public static axi:Ljava/lang/reflect/Method;

.field public static axj:Ljava/lang/reflect/Method;

.field public static axk:Ljava/lang/reflect/Method;
...
.field public apW:Landroid/graphics/Rect;

.field public atK:I

.field public ats:Z

.field public axA:Landroid/graphics/drawable/Drawable;

.field public axB:Landroid/widget/AdapterView$OnItemClickListener;

.field public final axC:Landroid/support/v7/widget/dx;

.field public final axD:Landroid/support/v7/widget/dw;

.field public final axE:Landroid/support/v7/widget/dv;

.field public final axF:Landroid/support/v7/widget/dt;

.field public axG:Ljava/lang/Runnable;

.field public axH:Z

.field public axI:Landroid/widget/PopupWindow;

.field public axl:Landroid/support/v7/widget/cp;
...
.field public axy:Landroid/database/DataSetObserver;

.field public axz:Landroid/view/View;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/dq;->axi:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sput-object v0, Landroid/support/v7/widget/dq;->axj:Ljava/lang/reflect/Method;
    :try_end_1
    ...
    sput-object v0, Landroid/support/v7/widget/dq;->axk:Ljava/lang/reflect/Method;
    :try_end_2
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 7
    iput v0, p0, Landroid/support/v7/widget/dq;->atK:I

    .line 8
    const/16 v0, 0x3ea

    iput v0, p0, Landroid/support/v7/widget/dq;->axp:I

    .line 9
    iput-boolean v3, p0, Landroid/support/v7/widget/dq;->axr:Z

    .line 10
    iput v2, p0, Landroid/support/v7/widget/dq;->aot:I

    .line 11
    iput-boolean v2, p0, Landroid/support/v7/widget/dq;->axt:Z

    .line 12
    iput-boolean v2, p0, Landroid/support/v7/widget/dq;->axu:Z

    .line 13
    const v0, 0x7fffffff

    iput v0, p0, Landroid/support/v7/widget/dq;->axv:I

    .line 14
    iput v2, p0, Landroid/support/v7/widget/dq;->axx:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axC:Landroid/support/v7/widget/dx;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axD:Landroid/support/v7/widget/dw;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axE:Landroid/support/v7/widget/dv;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axF:Landroid/support/v7/widget/dt;
    ...
    .line 22
    sget-object v0, Landroid/support/v7/a/j;->bQ:[I
    ...
    iput v1, p0, Landroid/support/v7/widget/dq;->axn:I

    .line 24
    sget v1, Landroid/support/v7/a/j;->acY:I

    invoke-virtual {v0, v1, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/widget/dq;->axo:I

    .line 25
    iget v1, p0, Landroid/support/v7/widget/dq;->axo:I

    if-eqz v1, :cond_0

    .line 26
    iput-boolean v3, p0, Landroid/support/v7/widget/dq;->axq:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axI:Landroid/widget/PopupWindow;
...
.method private final getMaxAvailableHeight(Landroid/view/View;IZ)I
    ...
    .prologue
    .line 233
    sget-object v0, Landroid/support/v7/widget/dq;->axj:Ljava/lang/reflect/Method;
...
.method public final clearListSelection()V
    ...
    .prologue
    .line 223
    iget-object v0, p0, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;
    ...
    .line 226
    iput-boolean v1, v0, Landroid/support/v7/widget/cp;->avw:Z
...
.method public final dismiss()V
    ...
    .line 210
    iget-object v0, p0, Landroid/support/v7/widget/dq;->axw:Landroid/view/View;
    ...
    .line 214
    iget-object v1, p0, Landroid/support/v7/widget/dq;->axw:Landroid/view/View;
    ...
    .line 216
    iput-object v2, p0, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;

    .line 217
    iget-object v0, p0, Landroid/support/v7/widget/dq;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/dq;->axC:Landroid/support/v7/widget/dx;
...
.method public final getVerticalOffset()I
    ...
    .prologue
    .line 46
    iget-boolean v0, p0, Landroid/support/v7/widget/dq;->axq:Z
    ...
    :cond_0
    iget v0, p0, Landroid/support/v7/widget/dq;->axo:I
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .prologue
    .line 31
    iget-object v0, p0, Landroid/support/v7/widget/dq;->axy:Landroid/database/DataSetObserver;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axy:Landroid/database/DataSetObserver;

    .line 35
    :cond_0
    :goto_0
    iput-object p1, p0, Landroid/support/v7/widget/dq;->UR:Landroid/widget/ListAdapter;

    .line 36
    iget-object v0, p0, Landroid/support/v7/widget/dq;->UR:Landroid/widget/ListAdapter;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/dq;->UR:Landroid/widget/ListAdapter;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/dq;->axy:Landroid/database/DataSetObserver;
...
.method public final setContentWidth(I)V
    ...
    .line 57
    :cond_0
    iput p1, p0, Landroid/support/v7/widget/dq;->atK:I
...
.method public final setModal(Z)V
    ...
    .prologue
    .line 41
    iput-boolean p1, p0, Landroid/support/v7/widget/dq;->axH:Z
...
.method public final setVerticalOffset(I)V
    ...
    .prologue
    .line 49
    iput p1, p0, Landroid/support/v7/widget/dq;->axo:I

    .line 50
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/widget/dq;->axq:Z
...
.method public show()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axG:Ljava/lang/Runnable;

    .line 64
    iget-boolean v0, p0, Landroid/support/v7/widget/dq;->axH:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;

    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/dq;->axA:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/dq;->axA:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/dq;->UR:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/dq;->axB:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/dq;->axE:Landroid/support/v7/widget/dv;
    ...
    .line 76
    iget-object v7, p0, Landroid/support/v7/widget/dq;->axw:Landroid/view/View;
    ...
    .line 81
    iget v8, p0, Landroid/support/v7/widget/dq;->axx:I
    ...
    .line 89
    :goto_1
    iget v0, p0, Landroid/support/v7/widget/dq;->atK:I
    ...
    .line 99
    :goto_3
    iget-object v5, p0, Landroid/support/v7/widget/dq;->axI:Landroid/widget/PopupWindow;

    invoke-virtual {v5, v4}, Landroid/widget/PopupWindow;->setContentView(Landroid/view/View;)V

    .line 107
    :goto_4
    iget-object v4, p0, Landroid/support/v7/widget/dq;->axI:Landroid/widget/PopupWindow;
    ...
    .line 111
    iget-boolean v5, p0, Landroid/support/v7/widget/dq;->axq:Z
    ...
    iput v5, p0, Landroid/support/v7/widget/dq;->axo:I
    ...
    .line 118
    :goto_6
    iget-object v7, p0, Landroid/support/v7/widget/dq;->axz:Landroid/view/View;

    .line 119
    iget v8, p0, Landroid/support/v7/widget/dq;->axo:I
    ...
    .line 120
    iget-boolean v7, p0, Landroid/support/v7/widget/dq;->axt:Z

    if-nez v7, :cond_3

    iget v7, p0, Landroid/support/v7/widget/dq;->axm:I
    ...
    iget v4, p0, Landroid/support/v7/widget/dq;->axp:I
    ...
    .line 143
    iget-object v3, p0, Landroid/support/v7/widget/dq;->axz:Landroid/view/View;

    .line 145
    sget-object v4, Landroid/support/v4/view/af;->Oj:Landroid/support/v4/view/aq;

    invoke-virtual {v4, v3}, Landroid/support/v4/view/aq;->J(Landroid/view/View;)Z
    ...
    .line 102
    iget-object v4, p0, Landroid/support/v7/widget/dq;->axw:Landroid/view/View;
    ...
    .line 122
    :cond_a
    iget v7, p0, Landroid/support/v7/widget/dq;->atK:I

    packed-switch v7, :pswitch_data_1

    .line 131
    iget v3, p0, Landroid/support/v7/widget/dq;->atK:I
    ...
    .line 132
    :goto_9
    iget-object v7, p0, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;

    sub-int/2addr v5, v0

    invoke-virtual {v7, v3, v5, v6}, Landroid/support/v7/widget/cp;->i(III)I
    ...
    .line 134
    iget-object v5, p0, Landroid/support/v7/widget/dq;->axl:Landroid/support/v7/widget/cp;
    ...
    .line 155
    :goto_a
    iget v3, p0, Landroid/support/v7/widget/dq;->axm:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/dq;->axu:Z

    if-nez v3, :cond_17

    iget-boolean v3, p0, Landroid/support/v7/widget/dq;->axt:Z
    ...
    .line 167
    iget-object v1, p0, Landroid/support/v7/widget/dq;->axz:Landroid/view/View;

    .line 168
    iget v2, p0, Landroid/support/v7/widget/dq;->axn:I

    iget v3, p0, Landroid/support/v7/widget/dq;->axo:I
    ...
    .line 164
    :cond_16
    iget v0, p0, Landroid/support/v7/widget/dq;->axm:I
    ...
    .line 177
    :goto_10
    iget v4, p0, Landroid/support/v7/widget/dq;->axm:I
    ...
    .line 185
    sget-object v3, Landroid/support/v7/widget/dq;->axi:Ljava/lang/reflect/Method;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/dq;->axD:Landroid/support/v7/widget/dw;

    invoke-virtual {v0, v1}, Landroid/widget/PopupWindow;->setTouchInterceptor(Landroid/view/View$OnTouchListener;)V

    .line 192
    iget-boolean v0, p0, Landroid/support/v7/widget/dq;->axs:Z
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/dq;->ats:Z

    invoke-static {v0, v1}, Landroid/support/v4/widget/ao;->a(Landroid/widget/PopupWindow;Z)V

    .line 194
    :cond_1b
    sget-object v0, Landroid/support/v7/widget/dq;->axk:Ljava/lang/reflect/Method;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/dq;->apW:Landroid/graphics/Rect;
    ...
    iget v4, p0, Landroid/support/v7/widget/dq;->aot:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/dq;->axF:Landroid/support/v7/widget/dt;
