...
.method public constructor <init>(Landroid/support/v7/widget/k;Landroid/content/Context;Landroid/support/v7/view/menu/ap;Landroid/view/View;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v7/widget/l;->aph:Landroid/support/v7/widget/k;
    ...
    .line 5
    iget-object v0, p1, Landroid/support/v7/widget/k;->aoM:Landroid/support/v7/widget/o;

    if-nez v0, :cond_1

    .line 6
    iget-object v0, p1, Landroid/support/v7/widget/k;->alD:Landroid/support/v7/view/menu/ah;
    ...
    .line 9
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/k;->apf:Landroid/support/v7/widget/r;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/l;->b(Landroid/support/v7/view/menu/ag;)V
...
.method protected final onDismiss()V
    ...
    .prologue
    .line 11
    iget-object v0, p0, Landroid/support/v7/widget/l;->aph:Landroid/support/v7/widget/k;

    const/4 v1, 0x0

    iput-object v1, v0, Landroid/support/v7/widget/k;->apc:Landroid/support/v7/widget/l;
    ...
    iput v1, v0, Landroid/support/v7/widget/k;->apg:I
