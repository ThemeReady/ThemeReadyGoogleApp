...
.field public auA:Landroid/graphics/PointF;

.field public final auB:F

.field public auC:I

.field public auD:I

.field public final auz:Landroid/view/animation/LinearInterpolator;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/do;->auz:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/do;->QU:Landroid/view/animation/DecelerateInterpolator;

    .line 4
    iput v1, p0, Landroid/support/v7/widget/do;->auC:I

    iput v1, p0, Landroid/support/v7/widget/do;->auD:I
    ...
    iput v0, p0, Landroid/support/v7/widget/do;->auB:F
...
.method protected final a(IILandroid/support/v7/widget/fr;)V
    ...
    .line 53
    :cond_1
    iget v0, p0, Landroid/support/v7/widget/do;->auC:I

    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/do;->I(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/do;->auC:I

    .line 54
    iget v0, p0, Landroid/support/v7/widget/do;->auD:I

    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/do;->I(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/do;->auD:I
    ...
    .line 58
    iget v0, p0, Landroid/support/v7/widget/fq;->awc:I
    ...
    .line 65
    iput v0, p3, Landroid/support/v7/widget/fr;->awg:I
    ...
    .line 72
    iput-object v0, p0, Landroid/support/v7/widget/do;->auA:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/do;->bw(I)I

    move-result v0

    .line 76
    iget v1, p0, Landroid/support/v7/widget/do;->auC:I
    ...
    iget v2, p0, Landroid/support/v7/widget/do;->auD:I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/do;->auz:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/fr;)V
    ...
    .line 7
    .line 8
    iget-object v0, p0, Landroid/support/v7/widget/do;->auA:Landroid/graphics/PointF;
    ...
    .line 44
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/do;->bv(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/do;->QU:Landroid/view/animation/DecelerateInterpolator;
    ...
    .line 23
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/do;->b(IIIII)I
...
.method protected final bv(I)I
    .locals 4

    .prologue
    .line 82
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/do;->bw(I)I
...
.method protected final bw(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/do;->auB:F
