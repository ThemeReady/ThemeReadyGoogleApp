...
# instance fields
.field public final aql:Landroid/support/v7/widget/am;

.field public aqm:I

.field public aqn:Landroid/support/v7/widget/hj;
...
.method constructor <init>(Landroid/view/View;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/ai;->aqm:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ai;->aql:Landroid/support/v7/widget/am;
...
.method final a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 46
    iget-object v0, p0, Landroid/support/v7/widget/ai;->aqo:Landroid/support/v7/widget/hj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ai;->aqo:Landroid/support/v7/widget/hj;
    ...
    .line 50
    invoke-virtual {p0}, Landroid/support/v7/widget/ai;->fK()V
...
.method final a(Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Landroid/support/v7/a/j;->cQ:[I
    ...
    .line 9
    iget-object v0, p0, Landroid/support/v7/widget/ai;->aql:Landroid/support/v7/widget/am;
    ...
    iget v3, p0, Landroid/support/v7/widget/ai;->aqm:I
    ...
    sget v2, Landroid/support/v7/a/j;->acH:I
    ...
    .line 17
    :cond_1
    sget v0, Landroid/support/v7/a/j;->acI:I
    ...
    invoke-virtual {v3, v0, v2}, Landroid/support/v4/view/ap;->a(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method final bY()Landroid/content/res/ColorStateList;
    .locals 1
...
.method final bZ()Landroid/graphics/PorterDuff$Mode;
    .locals 1
...
.method final bk(I)V
    ...
    .prologue
    .line 29
    iput p1, p0, Landroid/support/v7/widget/ai;->aqm:I
...
.method final f(Landroid/content/res/ColorStateList;)V
    ...
    .line 96
    iget-object v0, p0, Landroid/support/v7/widget/ai;->aqn:Landroid/support/v7/widget/hj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ai;->aqn:Landroid/support/v7/widget/hj;
...
.method final fK()V
    ...
    .line 58
    iget-object v2, p0, Landroid/support/v7/widget/ai;->aqn:Landroid/support/v7/widget/hj;
    ...
    .line 64
    iget-object v2, p0, Landroid/support/v7/widget/ai;->aqp:Landroid/support/v7/widget/hj;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ai;->aqp:Landroid/support/v7/widget/hj;
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/view/ap;->Q(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v5, v4}, Landroid/support/v4/view/ap;->R(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
