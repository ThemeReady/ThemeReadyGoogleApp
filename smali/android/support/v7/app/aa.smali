...
.field public Wg:Landroid/support/v7/app/ac;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/s;)V
    ...
    iput v0, p0, Landroid/support/v7/app/aa;->Wd:I

    .line 3
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/app/aa;->Wf:Z
...
.method private final dC()V
    ...
    .prologue
    .line 81
    iget-object v0, p0, Landroid/support/v7/app/aa;->Wg:Landroid/support/v7/app/ac;
    ...
    .line 83
    sget-object v2, Landroid/support/v7/app/bh;->XR:Landroid/support/v7/app/bh;
    ...
    sput-object v3, Landroid/support/v7/app/bh;->XR:Landroid/support/v7/app/bh;

    .line 87
    :cond_0
    sget-object v0, Landroid/support/v7/app/bh;->XR:Landroid/support/v7/app/bh;

    .line 88
    invoke-direct {v1, p0, v0}, Landroid/support/v7/app/ac;-><init>(Landroid/support/v7/app/aa;Landroid/support/v7/app/bh;)V

    iput-object v1, p0, Landroid/support/v7/app/aa;->Wg:Landroid/support/v7/app/ac;
...
.method private final dD()Z
    ...
    .line 90
    iget-boolean v2, p0, Landroid/support/v7/app/aa;->We:Z
...
.method aM(I)I
    ...
    .line 66
    :sswitch_0
    invoke-direct {p0}, Landroid/support/v7/app/aa;->dC()V
    ...
    .line 69
    iget-boolean v0, v0, Landroid/support/v7/app/ac;->Wj:Z
...
.method public final dz()Z
    ...
    .line 10
    .line 12
    iget v0, p0, Landroid/support/v7/app/aa;->Wd:I
    ...
    .line 15
    :goto_0
    invoke-virtual {p0, v1}, Landroid/support/v7/app/aa;->aM(I)I
    ...
    .line 23
    invoke-direct {p0}, Landroid/support/v7/app/aa;->dD()Z
    ...
    .line 46
    iget-object v1, p0, Landroid/support/v7/app/aa;->Wg:Landroid/support/v7/app/ac;

    .line 47
    invoke-virtual {v1}, Landroid/support/v7/app/ac;->dE()V

    .line 48
    iget-object v3, v1, Landroid/support/v7/app/ac;->Wk:Landroid/content/BroadcastReceiver;
    ...
    iput-object v3, v1, Landroid/support/v7/app/ac;->Wk:Landroid/content/BroadcastReceiver;

    .line 50
    :cond_1
    iget-object v3, v1, Landroid/support/v7/app/ac;->Wl:Landroid/content/IntentFilter;
    ...
    iput-object v3, v1, Landroid/support/v7/app/ac;->Wl:Landroid/content/IntentFilter;
    ...
    .line 55
    :cond_2
    iget-object v3, v1, Landroid/support/v7/app/ac;->Wh:Landroid/support/v7/app/aa;

    iget-object v3, v3, Landroid/support/v7/app/aa;->mContext:Landroid/content/Context;

    iget-object v4, v1, Landroid/support/v7/app/ac;->Wk:Landroid/content/BroadcastReceiver;

    iget-object v1, v1, Landroid/support/v7/app/ac;->Wl:Landroid/content/IntentFilter;

    invoke-virtual {v3, v4, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 56
    :cond_3
    iput-boolean v2, p0, Landroid/support/v7/app/aa;->We:Z
    ...
    .line 13
    :cond_4
    sget v0, Landroid/support/v7/app/t;->VJ:I
...
.method public final onDestroy()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/ac;->dE()V
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Landroid/support/v7/app/aa;->Wd:I
...
.method public final onStart()V
    ...
    .line 59
    invoke-virtual {p0}, Landroid/support/v7/app/aa;->dz()Z
