...
# interfaces
.implements Landroid/support/v4/app/ec;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/v7/app/r;->WZ:I
...
.method public final bE()Landroid/content/Intent;
    .locals 1
...
.method public closeOptionsMenu()V
    ...
    .line 161
    invoke-virtual {v0}, Landroid/support/v7/app/a;->dx()Z
...
.method public final dC()Z
    ...
    .line 75
    new-instance v5, Landroid/support/v4/app/eb;

    invoke-direct {v5, p0}, Landroid/support/v4/app/eb;-><init>(Landroid/content/Context;)V

    .line 80
    instance-of v0, p0, Landroid/support/v4/app/ec;
    ...
    .line 81
    check-cast v0, Landroid/support/v4/app/ec;

    invoke-interface {v0}, Landroid/support/v4/app/ec;->bE()Landroid/content/Intent;
    ...
    .line 87
    iget-object v0, v5, Landroid/support/v4/app/eb;->vn:Landroid/content/Context;
    ...
    .line 88
    :cond_0
    invoke-virtual {v5, v0}, Landroid/support/v4/app/eb;->a(Landroid/content/ComponentName;)Landroid/support/v4/app/eb;

    .line 90
    iget-object v0, v5, Landroid/support/v4/app/eb;->mIntents:Ljava/util/ArrayList;
    ...
    iget-object v3, v5, Landroid/support/v4/app/eb;->mIntents:Ljava/util/ArrayList;
    ...
    .line 97
    iget-object v2, v5, Landroid/support/v4/app/eb;->vn:Landroid/content/Context;
...
.method public final dD()Landroid/support/v7/app/t;
    ...
    .prologue
    .line 120
    iget-object v0, p0, Landroid/support/v7/app/r;->WY:Landroid/support/v7/app/t;
    ...
    .line 123
    iput-object v0, p0, Landroid/support/v7/app/r;->WY:Landroid/support/v7/app/t;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/t;->dE()Landroid/support/v7/app/a;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    .line 134
    new-instance v0, Landroid/support/v7/widget/hb;

    invoke-super {p0}, Landroid/support/v4/app/y;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/hb;-><init>(Landroid/content/Context;Landroid/content/res/Resources;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget v0, p0, Landroid/support/v7/app/r;->WZ:I
    ...
    iget v1, p0, Landroid/support/v7/app/r;->WZ:I
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    .line 50
    invoke-virtual {p0}, Landroid/support/v7/app/r;->dC()Z
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/t;->dF()V
...
.method public openOptionsMenu()V
    ...
    .line 154
    invoke-virtual {v0}, Landroid/support/v7/app/a;->dw()Z
...
.method public setTheme(I)V
    ...
    .line 13
    iput p1, p0, Landroid/support/v7/app/r;->WZ:I
