...
.field public final ZR:Landroid/content/Context;

.field public ZS:Landroid/support/v7/view/c;
...
.method public constructor <init>(Landroid/support/v7/app/bj;Landroid/content/Context;Landroid/support/v7/view/c;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v7/app/bn;->ZQ:Landroid/support/v7/app/bj;

    invoke-direct {p0}, Landroid/support/v7/view/b;-><init>()V

    .line 2
    iput-object p2, p0, Landroid/support/v7/app/bn;->ZR:Landroid/content/Context;

    .line 3
    iput-object p3, p0, Landroid/support/v7/app/bn;->ZS:Landroid/support/v7/view/c;
    ...
    .line 6
    iput v1, v0, Landroid/support/v7/view/menu/p;->apG:I

    .line 8
    iput-object v0, p0, Landroid/support/v7/app/bn;->dQ:Landroid/support/v7/view/menu/p;

    .line 9
    iget-object v0, p0, Landroid/support/v7/app/bn;->dQ:Landroid/support/v7/view/menu/p;
...
.method public final a(Landroid/support/v7/view/menu/p;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 62
    iget-object v0, p0, Landroid/support/v7/app/bn;->ZS:Landroid/support/v7/view/c;
...
.method public final b(Landroid/support/v7/view/menu/p;)V
    ...
    .line 68
    iget-object v0, p0, Landroid/support/v7/app/bn;->ZQ:Landroid/support/v7/app/bj;

    iget-object v0, v0, Landroid/support/v7/app/bj;->Zv:Landroid/support/v7/widget/ActionBarContextView;
...
.method public final dV()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/bn;->dQ:Landroid/support/v7/view/menu/p;
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/p;->fs()V
...
.method public final finish()V
    ...
    iget-object v0, v0, Landroid/support/v7/app/bj;->ZA:Landroid/support/v7/app/bn;
    ...
    iget-boolean v0, v0, Landroid/support/v7/app/bj;->ZG:Z

    iget-object v1, p0, Landroid/support/v7/app/bn;->ZQ:Landroid/support/v7/app/bj;

    iget-boolean v1, v1, Landroid/support/v7/app/bj;->ZH:Z
    ...
    iput-object p0, v0, Landroid/support/v7/app/bj;->ZB:Landroid/support/v7/view/b;

    .line 17
    iget-object v0, p0, Landroid/support/v7/app/bn;->ZQ:Landroid/support/v7/app/bj;

    iget-object v1, p0, Landroid/support/v7/app/bn;->ZS:Landroid/support/v7/view/c;

    iput-object v1, v0, Landroid/support/v7/app/bj;->ZC:Landroid/support/v7/view/c;

    .line 19
    :goto_1
    iput-object v3, p0, Landroid/support/v7/app/bn;->ZS:Landroid/support/v7/view/c;

    .line 20
    iget-object v0, p0, Landroid/support/v7/app/bn;->ZQ:Landroid/support/v7/app/bj;

    invoke-virtual {v0, v2}, Landroid/support/v7/app/bj;->O(Z)V
    ...
    .line 22
    iget-object v1, v0, Landroid/support/v7/widget/ActionBarContextView;->aqX:Landroid/view/View;
    ...
    iget-object v0, v0, Landroid/support/v7/app/bj;->YV:Landroid/support/v7/widget/bt;
    ...
    iget-boolean v1, v1, Landroid/support/v7/app/bj;->ZM:Z
    ...
    iput-object v3, v0, Landroid/support/v7/app/bj;->ZA:Landroid/support/v7/app/bn;
...
.method public final getCustomView()Landroid/view/View;
    ...
    .prologue
    .line 61
    iget-object v0, p0, Landroid/support/v7/app/bn;->ZT:Ljava/lang/ref/WeakReference;
...
.method public final getMenuInflater()Landroid/view/MenuInflater;
    ...
    iget-object v1, p0, Landroid/support/v7/app/bn;->ZR:Landroid/content/Context;
...
.method public final getSubtitle()Ljava/lang/CharSequence;
    ...
    .line 53
    iget-object v0, v0, Landroid/support/v7/widget/ActionBarContextView;->Ls:Ljava/lang/CharSequence;
...
.method public final isTitleOptional()Z
    ...
    .line 59
    iget-boolean v0, v0, Landroid/support/v7/widget/ActionBarContextView;->arc:Z
...
.method public final setCustomView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/bn;->ZT:Ljava/lang/ref/WeakReference;
...
.method public final setTitleOptionalHint(Z)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ActionBarContextView;->Z(Z)V
