...
# static fields
.field public static VL:Z

.field public static final VM:Z

.field public static final VN:[I


# instance fields
.field public final Uu:Landroid/view/Window;

.field public final VO:Landroid/view/Window$Callback;

.field public final VP:Landroid/view/Window$Callback;

.field public final VQ:Landroid/support/v7/app/s;

.field public VR:Landroid/support/v7/app/a;
...
.method static constructor <clinit>()V
    ...
    .line 44
    :goto_0
    sput-boolean v0, Landroid/support/v7/app/u;->VM:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Landroid/support/v7/app/u;->VL:Z
    ...
    .line 47
    sput-boolean v1, Landroid/support/v7/app/u;->VL:Z
    ...
    sput-object v0, Landroid/support/v7/app/u;->VN:[I
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/s;)V
    ...
    .line 3
    iput-object p2, p0, Landroid/support/v7/app/u;->Uu:Landroid/view/Window;

    .line 4
    iput-object p3, p0, Landroid/support/v7/app/u;->VQ:Landroid/support/v7/app/s;
    ...
    iput-object v0, p0, Landroid/support/v7/app/u;->VO:Landroid/view/Window$Callback;
    ...
    iput-object v0, p0, Landroid/support/v7/app/u;->VP:Landroid/view/Window$Callback;

    .line 9
    iget-object v0, p0, Landroid/support/v7/app/u;->Uu:Landroid/view/Window;

    iget-object v1, p0, Landroid/support/v7/app/u;->VP:Landroid/view/Window$Callback;
    ...
    sget-object v1, Landroid/support/v7/app/u;->VN:[I
...
.method abstract aK(I)V
.end method

.method abstract aL(I)Z
.end method

.method abstract b(Landroid/support/v7/view/c;)Landroid/support/v7/view/b;
.end method

.method abstract dA()V
.end method

.method final dB()Landroid/content/Context;
    .locals 2
    ...
    .line 26
    invoke-virtual {p0}, Landroid/support/v7/app/u;->dw()Landroid/support/v7/app/a;
...
.method public final dw()Landroid/support/v7/app/a;
    .locals 1

    .prologue
    .line 18
    invoke-virtual {p0}, Landroid/support/v7/app/u;->dA()V
...
.method public final getMenuInflater()Landroid/view/MenuInflater;
    ...
    .prologue
    .line 20
    iget-object v0, p0, Landroid/support/v7/app/u;->VS:Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/v7/app/u;->VS:Landroid/view/MenuInflater;
...
.method public onDestroy()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/u;->VZ:Z
...
.method public onStart()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/u;->VY:Z
