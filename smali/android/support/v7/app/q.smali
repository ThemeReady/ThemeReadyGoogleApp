...
# instance fields
.field public final VG:Landroid/support/v7/app/i;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/q;->VG:Landroid/support/v7/app/i;

    .line 6
    iput p2, p0, Landroid/support/v7/app/q;->oq:I
...
.method public final a(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/q;
    ...
    .prologue
    .line 16
    iget-object v0, p0, Landroid/support/v7/app/q;->VG:Landroid/support/v7/app/i;

    iget-object v1, p0, Landroid/support/v7/app/q;->VG:Landroid/support/v7/app/i;
    ...
    iput-object p2, v0, Landroid/support/v7/app/i;->Vg:Landroid/content/DialogInterface$OnClickListener;
...
.method public final aI(I)Landroid/support/v7/app/q;
    .locals 2
...
.method public final aJ(I)Landroid/support/v7/app/q;
    .locals 2
    ...
    iput-object v1, v0, Landroid/support/v7/app/i;->Uv:Ljava/lang/CharSequence;
...
.method public final b(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/q;
    ...
    iput-object p2, v0, Landroid/support/v7/app/i;->Vh:Landroid/content/DialogInterface$OnClickListener;
...
.method public final c(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/q;
    ...
    iput-object v1, v0, Landroid/support/v7/app/i;->Vi:Ljava/lang/CharSequence;

    .line 29
    iget-object v0, p0, Landroid/support/v7/app/q;->VG:Landroid/support/v7/app/i;

    iput-object p2, v0, Landroid/support/v7/app/i;->Vj:Landroid/content/DialogInterface$OnClickListener;
...
.method public final c(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/q;
    ...
    iput-object p1, v0, Landroid/support/v7/app/i;->Vi:Ljava/lang/CharSequence;
...
.method public final dr()Landroid/support/v7/app/p;
    .locals 15
    ...
    iget v1, p0, Landroid/support/v7/app/q;->oq:I
    ...
    iget-object v13, v14, Landroid/support/v7/app/p;->VF:Landroid/support/v7/app/AlertController;

    .line 36
    iget-object v0, v1, Landroid/support/v7/app/i;->UQ:Landroid/view/View;
    ...
    .line 38
    iput-object v0, v13, Landroid/support/v7/app/AlertController;->UQ:Landroid/view/View;

    .line 59
    :cond_0
    :goto_0
    iget-object v0, v1, Landroid/support/v7/app/i;->Uv:Ljava/lang/CharSequence;
    ...
    .line 61
    iput-object v0, v13, Landroid/support/v7/app/AlertController;->Uv:Ljava/lang/CharSequence;

    .line 62
    iget-object v2, v13, Landroid/support/v7/app/AlertController;->dq:Landroid/widget/TextView;
    ...
    iget-object v3, v1, Landroid/support/v7/app/i;->Vg:Landroid/content/DialogInterface$OnClickListener;
    ...
    iget-object v3, v1, Landroid/support/v7/app/i;->Vh:Landroid/content/DialogInterface$OnClickListener;
    ...
    .line 68
    :cond_3
    iget-object v0, v1, Landroid/support/v7/app/i;->Vi:Ljava/lang/CharSequence;
    ...
    iget-object v2, v1, Landroid/support/v7/app/i;->Vi:Ljava/lang/CharSequence;

    iget-object v3, v1, Landroid/support/v7/app/i;->Vj:Landroid/content/DialogInterface$OnClickListener;
    ...
    iget-object v0, v1, Landroid/support/v7/app/i;->uu:Landroid/database/Cursor;

    if-nez v0, :cond_5

    iget-object v0, v1, Landroid/support/v7/app/i;->UR:Landroid/widget/ListAdapter;
    ...
    iget v2, v13, Landroid/support/v7/app/AlertController;->UV:I
    ...
    .line 74
    iget-boolean v0, v1, Landroid/support/v7/app/i;->Vq:Z
    ...
    iget v3, v13, Landroid/support/v7/app/AlertController;->UW:I

    const v4, 0x1020014

    iget-object v5, v1, Landroid/support/v7/app/i;->Vn:[Ljava/lang/CharSequence;
    ...
    .line 86
    :goto_1
    iput-object v7, v13, Landroid/support/v7/app/AlertController;->UR:Landroid/widget/ListAdapter;

    .line 87
    iget v0, v1, Landroid/support/v7/app/i;->US:I

    iput v0, v13, Landroid/support/v7/app/AlertController;->US:I

    .line 88
    iget-object v0, v1, Landroid/support/v7/app/i;->Vo:Landroid/content/DialogInterface$OnClickListener;
    ...
    :cond_6
    :goto_2
    iget-object v0, v1, Landroid/support/v7/app/i;->Vv:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 94
    :cond_7
    iget-boolean v0, v1, Landroid/support/v7/app/i;->Vr:Z
    ...
    :cond_8
    :goto_3
    iput-object v6, v13, Landroid/support/v7/app/AlertController;->Uw:Landroid/widget/ListView;
    ...
    .line 100
    iget-boolean v0, v1, Landroid/support/v7/app/i;->UC:Z
    ...
    iget v2, v1, Landroid/support/v7/app/i;->Uy:I

    iget v3, v1, Landroid/support/v7/app/i;->Uz:I

    iget v4, v1, Landroid/support/v7/app/i;->UA:I

    iget v1, v1, Landroid/support/v7/app/i;->UB:I
    ...
    iput v0, v13, Landroid/support/v7/app/AlertController;->Ux:I

    .line 104
    const/4 v0, 0x1

    iput-boolean v0, v13, Landroid/support/v7/app/AlertController;->UC:Z

    .line 105
    iput v2, v13, Landroid/support/v7/app/AlertController;->Uy:I

    .line 106
    iput v3, v13, Landroid/support/v7/app/AlertController;->Uz:I

    .line 107
    iput v4, v13, Landroid/support/v7/app/AlertController;->UA:I

    .line 108
    iput v1, v13, Landroid/support/v7/app/AlertController;->UB:I
    ...
    iget-boolean v0, v0, Landroid/support/v7/app/i;->eL:Z
    ...
    iget-object v0, v0, Landroid/support/v7/app/i;->Vk:Landroid/content/DialogInterface$OnCancelListener;
    ...
    iget-object v0, v0, Landroid/support/v7/app/i;->Vl:Landroid/content/DialogInterface$OnDismissListener;
    ...
    iget-object v0, v0, Landroid/support/v7/app/i;->Vm:Landroid/content/DialogInterface$OnKeyListener;
    ...
    iput v2, v13, Landroid/support/v7/app/AlertController;->UO:I

    .line 46
    iget-object v2, v13, Landroid/support/v7/app/AlertController;->jE:Landroid/widget/ImageView;
    ...
    :cond_f
    :goto_5
    iget v0, v1, Landroid/support/v7/app/i;->UO:I
    ...
    .line 53
    :cond_10
    iget v0, v1, Landroid/support/v7/app/i;->Vf:I
    ...
    .line 50
    :cond_11
    iget-object v0, v13, Landroid/support/v7/app/AlertController;->jE:Landroid/widget/ImageView;
    ...
    iget-object v10, v1, Landroid/support/v7/app/i;->uu:Landroid/database/Cursor;
    ...
    .line 79
    iget v9, v13, Landroid/support/v7/app/AlertController;->UX:I
    ...
    iget-object v2, v1, Landroid/support/v7/app/i;->Vt:Ljava/lang/String;
    ...
    .line 80
    :cond_14
    iget v9, v13, Landroid/support/v7/app/AlertController;->UY:I
    ...
    .line 84
    iget-object v7, v1, Landroid/support/v7/app/i;->UR:Landroid/widget/ListAdapter;
    ...
    iget-object v3, v1, Landroid/support/v7/app/i;->Vn:[Ljava/lang/CharSequence;
    ...
    .line 90
    :cond_17
    iget-object v0, v1, Landroid/support/v7/app/i;->Vs:Landroid/content/DialogInterface$OnMultiChoiceClickListener;
    ...
    .line 115
    :cond_1a
    iget v0, v1, Landroid/support/v7/app/i;->Ux:I
...
.method public final ds()Landroid/support/v7/app/p;
    .locals 1

    .prologue
    .line 128
    invoke-virtual {p0}, Landroid/support/v7/app/q;->dr()Landroid/support/v7/app/p;
...
.method public final p(Ljava/lang/CharSequence;)Landroid/support/v7/app/q;
    ...
    iput-object p1, v0, Landroid/support/v7/app/i;->Uv:Ljava/lang/CharSequence;
