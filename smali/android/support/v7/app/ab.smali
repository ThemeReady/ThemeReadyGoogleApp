...
.method constructor <init>(Landroid/support/v7/app/aa;Landroid/view/Window$Callback;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v7/app/ab;->Xx:Landroid/support/v7/app/aa;
...
.method final a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-object v1, p0, Landroid/support/v7/app/ab;->Xx:Landroid/support/v7/app/aa;
    ...
    .line 14
    :cond_0
    iget-object v2, v1, Landroid/support/v7/app/ag;->XJ:Landroid/support/v7/view/b;
    ...
    .line 17
    invoke-virtual {v1}, Landroid/support/v7/app/ag;->dE()Landroid/support/v7/app/a;
    ...
    iput-object v3, v1, Landroid/support/v7/app/ag;->XJ:Landroid/support/v7/view/b;

    .line 20
    :cond_2
    iget-object v3, v1, Landroid/support/v7/app/ag;->XJ:Landroid/support/v7/view/b;
    ...
    iput-object v2, v1, Landroid/support/v7/app/ag;->XJ:Landroid/support/v7/view/b;

    .line 22
    :cond_3
    iget-object v1, v1, Landroid/support/v7/app/ag;->XJ:Landroid/support/v7/view/b;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    .prologue
    .line 4
    iget-object v0, p0, Landroid/support/v7/app/ab;->Xx:Landroid/support/v7/app/aa;

    .line 5
    iget-boolean v0, v0, Landroid/support/v7/app/aa;->Xv:Z
