...
# instance fields
.field public agy:Landroid/support/v7/e/aj;

.field public agz:Landroid/support/v7/e/am;
...
.method public final C(Ljava/lang/Object;)V
    ...
    .prologue
    .line 3
    invoke-virtual {p0, p1}, Landroid/support/v7/e/bg;->G(Ljava/lang/Object;)I
    ...
    .line 5
    iget-object v1, p0, Landroid/support/v7/e/bg;->agq:Ljava/util/ArrayList;
    ...
    .line 7
    invoke-static {p1}, Landroid/support/v7/e/an;->E(Ljava/lang/Object;)Landroid/view/Display;
    ...
    .line 11
    invoke-virtual {v2}, Landroid/support/v7/e/a;->dM()I
    ...
    .line 13
    invoke-virtual {v2, v1}, Landroid/support/v7/e/b;->aU(I)Landroid/support/v7/e/b;
    ...
    .line 15
    invoke-virtual {p0}, Landroid/support/v7/e/bg;->en()V
...
.method protected a(Landroid/support/v7/e/be;Landroid/support/v7/e/b;)V
    ...
    .line 22
    iget-object v1, p2, Landroid/support/v7/e/b;->aej:Landroid/os/Bundle;
    ...
    .line 27
    invoke-static {v0}, Landroid/support/v7/e/an;->E(Ljava/lang/Object;)Landroid/view/Display;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v7/e/b;->aU(I)Landroid/support/v7/e/b;
...
.method protected b(Landroid/support/v7/e/be;)Z
    ...
    .prologue
    .line 53
    iget-object v0, p0, Landroid/support/v7/e/bg;->agz:Landroid/support/v7/e/am;
    ...
    iput-object v0, p0, Landroid/support/v7/e/bg;->agz:Landroid/support/v7/e/am;

    .line 55
    :cond_0
    iget-object v0, p0, Landroid/support/v7/e/bg;->agz:Landroid/support/v7/e/am;

    iget-object v1, p1, Landroid/support/v7/e/be;->agu:Ljava/lang/Object;

    invoke-virtual {v0, v1}, Landroid/support/v7/e/am;->D(Ljava/lang/Object;)Z
...
.method protected eo()V
    ...
    .line 31
    invoke-super {p0}, Landroid/support/v7/e/bc;->eo()V

    .line 32
    iget-object v0, p0, Landroid/support/v7/e/bg;->agy:Landroid/support/v7/e/aj;
    ...
    .line 37
    iget-object v3, p0, Landroid/support/v7/e/d;->aep:Landroid/support/v7/e/f;

    .line 38
    invoke-direct {v0, v2, v3}, Landroid/support/v7/e/aj;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v0, p0, Landroid/support/v7/e/bg;->agy:Landroid/support/v7/e/aj;

    .line 39
    :cond_0
    iget-object v2, p0, Landroid/support/v7/e/bg;->agy:Landroid/support/v7/e/aj;

    iget-boolean v0, p0, Landroid/support/v7/e/bg;->ago:Z

    if-eqz v0, :cond_2

    iget v0, p0, Landroid/support/v7/e/bg;->agn:I
    ...
    .line 41
    iget-boolean v0, v2, Landroid/support/v7/e/aj;->afx:Z

    if-nez v0, :cond_1

    .line 42
    iget-object v0, v2, Landroid/support/v7/e/aj;->afw:Ljava/lang/reflect/Method;
    ...
    iput-boolean v0, v2, Landroid/support/v7/e/aj;->afx:Z
    ...
    .line 47
    iput-boolean v1, v2, Landroid/support/v7/e/aj;->afx:Z
...
.method protected final ep()Ljava/lang/Object;
    .locals 1
