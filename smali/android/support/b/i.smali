...
.method public constructor <init>(Landroid/support/b/l;)V
    ...
    .line 5
    iput-object v0, p0, Landroid/support/b/i;->L:Ljava/util/ArrayList;

    .line 6
    iput-object v0, p0, Landroid/support/b/i;->M:Landroid/os/Bundle;

    .line 7
    iput-object v0, p0, Landroid/support/b/i;->N:Ljava/util/ArrayList;

    .line 8
    const/4 v1, 0x1

    iput-boolean v1, p0, Landroid/support/b/i;->O:Z
    ...
    .line 15
    :cond_1
    iget-object v0, p1, Landroid/support/b/l;->Q:Landroid/support/b/m;
...
.method public final b()Landroid/support/b/h;
    ...
    .prologue
    .line 30
    iget-object v0, p0, Landroid/support/b/i;->L:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/support/b/i;->L:Ljava/util/ArrayList;

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;

    .line 32
    :cond_0
    iget-object v0, p0, Landroid/support/b/i;->N:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/support/b/i;->N:Ljava/util/ArrayList;
    ...
    iget-boolean v2, p0, Landroid/support/b/i;->O:Z
    ...
    iget-object v2, p0, Landroid/support/b/i;->M:Landroid/os/Bundle;
