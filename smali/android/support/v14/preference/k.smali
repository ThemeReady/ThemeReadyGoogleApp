...
.method constructor <init>(Landroid/support/v14/preference/h;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v14/preference/k;->om:Landroid/support/v14/preference/h;
    ...
    iput-boolean v0, p0, Landroid/support/v14/preference/k;->op:Z
...
.method private final a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView;)Z
    ...
    .line 18
    invoke-virtual {p2, p1}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/fo;
    ...
    .line 21
    iget-boolean v0, v0, Landroid/support/v7/preference/y;->aks:Z
    ...
    .line 25
    :cond_1
    iget-boolean v0, p0, Landroid/support/v14/preference/k;->op:Z
    ...
    .line 29
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/fo;
    ...
    .line 32
    iget-boolean v0, v0, Landroid/support/v7/preference/y;->akr:Z
...
.method public final getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/fl;)V
    ...
    .line 16
    iget v0, p0, Landroid/support/v14/preference/k;->oo:I
...
.method public final onDrawOver$51662RJ4E9NMIP1FCTP62S38D5HN6BQ3C5N7COBJ7D662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN7D662RJ4E9NMIP1FEDQN0S3FE9Q2UTHN5TRMIP37CLQ2UKJ5CDSM6R35E9B6IPBN4H9N8OBKCKTIILG_0(Landroid/graphics/Canvas;Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 3
    iget-object v0, p0, Landroid/support/v14/preference/k;->on:Landroid/graphics/drawable/Drawable;
    ...
    .line 11
    iget-object v5, p0, Landroid/support/v14/preference/k;->on:Landroid/graphics/drawable/Drawable;

    iget v6, p0, Landroid/support/v14/preference/k;->oo:I
    ...
    .line 12
    iget-object v4, p0, Landroid/support/v14/preference/k;->on:Landroid/graphics/drawable/Drawable;
