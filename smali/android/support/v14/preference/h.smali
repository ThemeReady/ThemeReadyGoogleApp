...
.field public of:Landroid/support/v7/widget/RecyclerView;

.field public og:Z

.field public oh:Z

.field public oi:Landroid/content/Context;

.field public final oj:Landroid/support/v14/preference/k;

.field public final ok:Ljava/lang/Runnable;

.field public ol:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    .line 2
    sget v0, Landroid/support/v7/preference/ab;->akC:I
    ...
    .line 5
    iput-object v0, p0, Landroid/support/v14/preference/h;->oj:Landroid/support/v14/preference/k;
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->ok:Ljava/lang/Runnable;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    .prologue
    .line 191
    sget v0, Landroid/support/v7/preference/ab;->akD:I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/RecyclerView;->setAccessibilityDelegateCompat(Landroid/support/v7/widget/fp;)V
...
.method public a(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 135
    iget-object v2, v0, Landroid/support/v7/preference/r;->aki:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 138
    :cond_0
    iput-object p1, v0, Landroid/support/v7/preference/r;->aki:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 142
    iput-boolean v1, p0, Landroid/support/v14/preference/h;->og:Z

    .line 143
    iget-boolean v0, p0, Landroid/support/v14/preference/h;->oh:Z
...
.method public final ar()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 149
    iget-object v0, v0, Landroid/support/v7/preference/r;->aki:Landroid/support/v7/preference/PreferenceScreen;
...
.method final at()V
    ...
    .line 185
    iget-object v1, p0, Landroid/support/v14/preference/h;->of:Landroid/support/v7/widget/RecyclerView;
...
.method public b(Landroid/support/v7/preference/Preference;)V
    ...
    .line 205
    invoke-interface {v0}, Landroid/support/v14/preference/l;->au()Z
...
.method public final b(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 172
    invoke-interface {v0}, Landroid/support/v14/preference/n;->av()Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 94
    iget-object v1, v1, Landroid/support/v7/preference/r;->aki:Landroid/support/v7/preference/PreferenceScreen;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget v2, Landroid/support/v7/preference/z;->aku:I
    ...
    iput-object v1, p0, Landroid/support/v14/preference/h;->oi:Landroid/content/Context;

    .line 16
    new-instance v0, Landroid/support/v7/preference/r;

    iget-object v1, p0, Landroid/support/v14/preference/h;->oi:Landroid/content/Context;
    ...
    .line 18
    iput-object p0, v0, Landroid/support/v7/preference/r;->akm:Landroid/support/v7/preference/t;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 25
    iget-object v0, p0, Landroid/support/v14/preference/h;->oi:Landroid/content/Context;

    const/4 v1, 0x0

    sget-object v2, Landroid/support/v14/preference/o;->ow:[I
    ...
    .line 26
    invoke-static {v3, v4, v5}, Landroid/support/v4/content/a/g;->d(Landroid/content/Context;II)I
    ...
    .line 28
    sget v1, Landroid/support/v14/preference/o;->oB:I
    ...
    .line 29
    sget v1, Landroid/support/v14/preference/o;->oz:I
    ...
    .line 30
    sget v2, Landroid/support/v14/preference/o;->oA:I
    ...
    .line 31
    sget v3, Landroid/support/v14/preference/o;->oy:I
    ...
    sget v5, Landroid/support/v7/preference/z;->aku:I
    ...
    .line 46
    :cond_1
    iput-object v4, p0, Landroid/support/v14/preference/h;->of:Landroid/support/v7/widget/RecyclerView;

    .line 47
    iget-object v6, p0, Landroid/support/v14/preference/h;->oj:Landroid/support/v14/preference/k;

    .line 49
    iget-object v7, v4, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/et;
    ...
    invoke-virtual {v7, v8}, Landroid/support/v7/widget/et;->assertNotInLayoutOrScroll(Ljava/lang/String;)V
    ...
    .line 61
    iget-object v1, p0, Landroid/support/v14/preference/h;->oj:Landroid/support/v14/preference/k;

    .line 62
    iput v2, v1, Landroid/support/v14/preference/k;->oo:I

    .line 63
    iget-object v1, v1, Landroid/support/v14/preference/k;->om:Landroid/support/v14/preference/h;
    ...
    .line 67
    iput-boolean v3, v1, Landroid/support/v14/preference/k;->op:Z
    ...
    iget-object v1, p0, Landroid/support/v14/preference/h;->ok:Ljava/lang/Runnable;
...
.method public onDestroyView()V
    ...
    .line 113
    iget-boolean v0, p0, Landroid/support/v14/preference/h;->og:Z
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->of:Landroid/support/v7/widget/RecyclerView;
...
.method public onStart()V
    ...
    .line 101
    iput-object p0, v0, Landroid/support/v7/preference/r;->akk:Landroid/support/v7/preference/u;

    .line 102
    iget-object v0, p0, Landroid/support/v14/preference/h;->mPreferenceManager:Landroid/support/v7/preference/r;

    .line 103
    iput-object p0, v0, Landroid/support/v7/preference/r;->akl:Landroid/support/v7/preference/s;
...
.method public onStop()V
    ...
    .line 107
    iput-object v1, v0, Landroid/support/v7/preference/r;->akk:Landroid/support/v7/preference/u;

    .line 108
    iget-object v0, p0, Landroid/support/v14/preference/h;->mPreferenceManager:Landroid/support/v7/preference/r;

    .line 109
    iput-object v1, v0, Landroid/support/v7/preference/r;->akl:Landroid/support/v7/preference/s;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 82
    invoke-virtual {p0}, Landroid/support/v14/preference/h;->at()V

    .line 83
    iget-object v0, p0, Landroid/support/v14/preference/h;->ol:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->ol:Ljava/lang/Runnable;

    .line 86
    :cond_0
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v14/preference/h;->oh:Z
...
.method public final setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 71
    iget-object v0, p0, Landroid/support/v14/preference/h;->oj:Landroid/support/v14/preference/k;
    ...
    iput v1, v0, Landroid/support/v14/preference/k;->oo:I

    .line 75
    :goto_0
    iput-object p1, v0, Landroid/support/v14/preference/k;->on:Landroid/graphics/drawable/Drawable;

    .line 76
    iget-object v0, v0, Landroid/support/v14/preference/k;->om:Landroid/support/v14/preference/h;
