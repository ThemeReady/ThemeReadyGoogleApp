...
.field public mP:Landroid/support/v7/widget/RecyclerView;
...
.field public mS:Landroid/content/Context;

.field public final mT:Landroid/support/v14/preference/k;

.field public final mU:Ljava/lang/Runnable;

.field public mV:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    .line 2
    sget v0, Landroid/support/v7/preference/ab;->akg:I
    ...
    .line 5
    iput-object v0, p0, Landroid/support/v14/preference/h;->mT:Landroid/support/v14/preference/k;
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->mU:Ljava/lang/Runnable;
...
.method public a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    .prologue
    .line 191
    sget v0, Landroid/support/v7/preference/ab;->akh:I
...
.method public a(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 135
    iget-object v2, v0, Landroid/support/v7/preference/r;->ajM:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 138
    :cond_0
    iput-object p1, v0, Landroid/support/v7/preference/r;->ajM:Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 142
    iput-boolean v1, p0, Landroid/support/v14/preference/h;->mQ:Z

    .line 143
    iget-boolean v0, p0, Landroid/support/v14/preference/h;->mR:Z
...
.method public final ak()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 149
    iget-object v0, v0, Landroid/support/v7/preference/r;->ajM:Landroid/support/v7/preference/PreferenceScreen;
...
.method final am()V
    ...
    .line 185
    iget-object v1, p0, Landroid/support/v14/preference/h;->mP:Landroid/support/v7/widget/RecyclerView;
...
.method public b(Landroid/support/v7/preference/Preference;)V
    ...
    .line 205
    invoke-interface {v0}, Landroid/support/v14/preference/l;->an()Z
...
.method public final b(Landroid/support/v7/preference/PreferenceScreen;)V
    ...
    .line 172
    invoke-interface {v0}, Landroid/support/v14/preference/n;->ao()Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 94
    iget-object v1, v1, Landroid/support/v7/preference/r;->ajM:Landroid/support/v7/preference/PreferenceScreen;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    sget v2, Landroid/support/v7/preference/z;->ajY:I
    ...
    iput-object v1, p0, Landroid/support/v14/preference/h;->mS:Landroid/content/Context;
    ...
    .line 18
    iput-object p0, v0, Landroid/support/v7/preference/r;->ajQ:Landroid/support/v7/preference/t;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 25
    iget-object v0, p0, Landroid/support/v14/preference/h;->mS:Landroid/content/Context;

    const/4 v1, 0x0

    sget-object v2, Landroid/support/v14/preference/o;->ng:[I

    iget-object v3, p0, Landroid/support/v14/preference/h;->mS:Landroid/content/Context;
    ...
    .line 28
    sget v1, Landroid/support/v14/preference/o;->nl:I
    ...
    .line 29
    sget v1, Landroid/support/v14/preference/o;->nj:I
    ...
    .line 30
    sget v2, Landroid/support/v14/preference/o;->nk:I
    ...
    .line 31
    sget v3, Landroid/support/v14/preference/o;->ni:I
    ...
    sget v5, Landroid/support/v7/preference/z;->ajY:I
    ...
    .line 46
    :cond_1
    iput-object v4, p0, Landroid/support/v14/preference/h;->mP:Landroid/support/v7/widget/RecyclerView;

    .line 47
    iget-object v6, p0, Landroid/support/v14/preference/h;->mT:Landroid/support/v14/preference/k;
    ...
    .line 61
    iget-object v1, p0, Landroid/support/v14/preference/h;->mT:Landroid/support/v14/preference/k;

    .line 62
    iput v2, v1, Landroid/support/v14/preference/k;->mY:I

    .line 63
    iget-object v1, v1, Landroid/support/v14/preference/k;->mW:Landroid/support/v14/preference/h;

    .line 64
    iget-object v1, v1, Landroid/support/v14/preference/h;->mP:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 67
    iput-boolean v3, v1, Landroid/support/v14/preference/k;->mZ:Z
    ...
    iget-object v1, p0, Landroid/support/v14/preference/h;->mU:Ljava/lang/Runnable;
...
.method public onDestroyView()V
    ...
    .line 113
    iget-boolean v0, p0, Landroid/support/v14/preference/h;->mQ:Z
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->mP:Landroid/support/v7/widget/RecyclerView;
...
.method public onStart()V
    ...
    .line 101
    iput-object p0, v0, Landroid/support/v7/preference/r;->ajO:Landroid/support/v7/preference/u;

    .line 102
    iget-object v0, p0, Landroid/support/v14/preference/h;->mPreferenceManager:Landroid/support/v7/preference/r;

    .line 103
    iput-object p0, v0, Landroid/support/v7/preference/r;->ajP:Landroid/support/v7/preference/s;
...
.method public onStop()V
    ...
    .line 107
    iput-object v1, v0, Landroid/support/v7/preference/r;->ajO:Landroid/support/v7/preference/u;

    .line 108
    iget-object v0, p0, Landroid/support/v14/preference/h;->mPreferenceManager:Landroid/support/v7/preference/r;

    .line 109
    iput-object v1, v0, Landroid/support/v7/preference/r;->ajP:Landroid/support/v7/preference/s;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    .line 82
    invoke-virtual {p0}, Landroid/support/v14/preference/h;->am()V

    .line 83
    iget-object v0, p0, Landroid/support/v14/preference/h;->mV:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/support/v14/preference/h;->mV:Ljava/lang/Runnable;

    .line 86
    :cond_0
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v14/preference/h;->mR:Z
...
.method public final setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    .prologue
    .line 71
    iget-object v0, p0, Landroid/support/v14/preference/h;->mT:Landroid/support/v14/preference/k;
    ...
    iput v1, v0, Landroid/support/v14/preference/k;->mY:I

    .line 75
    :goto_0
    iput-object p1, v0, Landroid/support/v14/preference/k;->mX:Landroid/graphics/drawable/Drawable;

    .line 76
    iget-object v0, v0, Landroid/support/v14/preference/k;->mW:Landroid/support/v14/preference/h;

    .line 77
    iget-object v0, v0, Landroid/support/v14/preference/h;->mP:Landroid/support/v7/widget/RecyclerView;
