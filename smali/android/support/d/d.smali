...
.method static a(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    .line 14
    invoke-static/range {p0 .. p0}, Landroid/support/d/d;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .line 35
    invoke-static {v10}, Landroid/support/d/d;->closeQuietly(Ljava/io/Closeable;)V

    .line 36
    :cond_2
    invoke-static {v12}, Landroid/support/d/d;->closeQuietly(Ljava/io/Closeable;)V
    ...
    .line 44
    invoke-static {v4}, Landroid/support/d/d;->closeQuietly(Ljava/io/Closeable;)V
...
.method private static a(Landroid/content/Context;Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    iput-wide v10, v8, Landroid/support/d/f;->nS:J
    ...
    iget-wide v0, v8, Landroid/support/d/f;->nS:J
    ...
    iget-wide v4, v8, Landroid/support/d/f;->nS:J
...
.method private static a(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    iput-wide v0, v9, Landroid/support/d/f;->nS:J
    :try_end_1
    ...
    iget-wide v12, v9, Landroid/support/d/f;->nS:J
...
.method private static a(Landroid/content/Context;JJLjava/util/List;)V
    ...
    .prologue
    .line 131
    invoke-static {p0}, Landroid/support/d/d;->g(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-wide v6, v0, Landroid/support/d/f;->nS:J
...
.method private static a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Landroid/support/d/d;->closeQuietly(Ljava/io/Closeable;)V
