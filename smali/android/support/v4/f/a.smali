...
# static fields
.field public static Nm:Landroid/support/v4/f/i;

.field public static final Nn:Ljava/lang/String;

.field public static final No:Ljava/lang/String;

.field public static final Np:Landroid/support/v4/f/a;

.field public static final Nq:Landroid/support/v4/f/a;


# instance fields
.field public final Nr:Z

.field public final Ns:Landroid/support/v4/f/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/f/a;->Nm:Landroid/support/v4/f/i;
    ...
    sput-object v0, Landroid/support/v4/f/a;->Nn:Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/v4/f/a;->No:Ljava/lang/String;
    ...
    sget-object v2, Landroid/support/v4/f/a;->Nm:Landroid/support/v4/f/i;

    invoke-direct {v0, v1, v3, v2}, Landroid/support/v4/f/a;-><init>(ZILandroid/support/v4/f/i;)V

    sput-object v0, Landroid/support/v4/f/a;->Np:Landroid/support/v4/f/a;
    ...
    sput-object v0, Landroid/support/v4/f/a;->Nq:Landroid/support/v4/f/a;
...
.method constructor <init>(ZILandroid/support/v4/f/i;)V
    ...
    .line 5
    iput-boolean p1, p0, Landroid/support/v4/f/a;->Nr:Z

    .line 6
    iput p2, p0, Landroid/support/v4/f/a;->mFlags:I

    .line 7
    iput-object p3, p0, Landroid/support/v4/f/a;->Ns:Landroid/support/v4/f/i;
...
.method public static a(Ljava/util/Locale;)Landroid/support/v4/f/a;
    ...
    invoke-virtual {v0}, Landroid/support/v4/f/b;->ch()Landroid/support/v4/f/a;
...
.method public static cg()Landroid/support/v4/f/a;
    .locals 1
...
.method private static l(Ljava/lang/CharSequence;)I
    ...
    iput v0, v5, Landroid/support/v4/f/c;->Nw:I
    ...
    :goto_0
    :pswitch_0
    iget v6, v5, Landroid/support/v4/f/c;->Nw:I

    if-lez v6, :cond_1

    .line 48
    invoke-virtual {v5}, Landroid/support/v4/f/c;->ci()B
...
.method private static m(Ljava/lang/CharSequence;)I
    ...
    .line 73
    iput v1, v8, Landroid/support/v4/f/c;->Nw:I
    ...
    :goto_0
    :pswitch_0
    iget v6, v8, Landroid/support/v4/f/c;->Nw:I
    ...
    iget v9, v8, Landroid/support/v4/f/c;->Nw:I

    invoke-interface {v6, v9}, Ljava/lang/CharSequence;->charAt(I)C

    move-result v6

    iput-char v6, v8, Landroid/support/v4/f/c;->Nx:C

    .line 80
    iget-char v6, v8, Landroid/support/v4/f/c;->Nx:C
    ...
    iput v9, v8, Landroid/support/v4/f/c;->Nw:I
    ...
    iput v6, v8, Landroid/support/v4/f/c;->Nw:I
    ...
    .line 86
    iget-boolean v9, v8, Landroid/support/v4/f/c;->Nv:Z

    if-eqz v9, :cond_0

    .line 87
    iget-char v9, v8, Landroid/support/v4/f/c;->Nx:C
    ...
    iget v10, v8, Landroid/support/v4/f/c;->Nw:I

    add-int/lit8 v11, v10, 0x1

    iput v11, v8, Landroid/support/v4/f/c;->Nw:I

    invoke-interface {v9, v10}, Ljava/lang/CharSequence;->charAt(I)C

    move-result v9

    iput-char v9, v8, Landroid/support/v4/f/c;->Nx:C
    ...
    iget v11, v8, Landroid/support/v4/f/c;->Nw:I

    add-int/lit8 v12, v11, 0x1

    iput v12, v8, Landroid/support/v4/f/c;->Nw:I

    invoke-interface {v10, v11}, Ljava/lang/CharSequence;->charAt(I)C

    move-result v10

    iput-char v10, v8, Landroid/support/v4/f/c;->Nx:C
    ...
    .line 99
    iput-char v13, v8, Landroid/support/v4/f/c;->Nx:C
    ...
    iput v10, v8, Landroid/support/v4/f/c;->Nw:I
    ...
    :cond_e
    :goto_4
    iget v3, v8, Landroid/support/v4/f/c;->Nw:I

    if-lez v3, :cond_10

    .line 133
    invoke-virtual {v8}, Landroid/support/v4/f/c;->ci()B
...
.method public static x(Z)Landroid/support/v4/f/a;
    .locals 1
...
.method public final a(Ljava/lang/String;Landroid/support/v4/f/i;Z)Ljava/lang/String;
    ...
    .line 19
    iget-boolean v5, p0, Landroid/support/v4/f/a;->Nr:Z
    ...
    .line 20
    :cond_2
    sget-object v0, Landroid/support/v4/f/a;->Nn:Ljava/lang/String;
    ...
    .line 25
    :cond_3
    iget-boolean v0, p0, Landroid/support/v4/f/a;->Nr:Z
    ...
    .line 33
    iget-boolean v3, p0, Landroid/support/v4/f/a;->Nr:Z
    ...
    .line 22
    :cond_9
    sget-object v0, Landroid/support/v4/f/a;->No:Ljava/lang/String;
    ...
    .line 35
    :cond_e
    iget-boolean v2, p0, Landroid/support/v4/f/a;->Nr:Z
...
.method public final unicodeWrap(Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 41
    iget-object v0, p0, Landroid/support/v4/f/a;->Ns:Landroid/support/v4/f/i;
