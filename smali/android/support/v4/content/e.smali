...
.field public final up:Landroid/support/v4/content/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public uv:Landroid/support/v4/d/b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/content/e;->up:Landroid/support/v4/content/j;
...
.method public final cancelLoadInBackground()V
    ...
    .line 27
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/content/e;->uv:Landroid/support/v4/d/b;
...
.method public final deliverResult(Landroid/database/Cursor;)V
    ...
    .line 36
    :cond_1
    iget-object v0, p0, Landroid/support/v4/content/e;->uu:Landroid/database/Cursor;

    .line 37
    iput-object p1, p0, Landroid/support/v4/content/e;->uu:Landroid/database/Cursor;
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 70
    iget-object v0, p0, Landroid/support/v4/content/e;->uq:[Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/content/e;->ur:Ljava/lang/String;
    ...
    .line 73
    iget-object v0, p0, Landroid/support/v4/content/e;->us:[Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/content/e;->ut:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Landroid/support/v4/content/e;->uG:Z
...
.method public loadInBackground()Landroid/database/Cursor;
    ...
    iput-object v0, p0, Landroid/support/v4/content/e;->uv:Landroid/support/v4/d/b;
    ...
    iget-object v2, p0, Landroid/support/v4/content/e;->uq:[Ljava/lang/String;

    iget-object v3, p0, Landroid/support/v4/content/e;->ur:Ljava/lang/String;

    iget-object v4, p0, Landroid/support/v4/content/e;->us:[Ljava/lang/String;

    iget-object v5, p0, Landroid/support/v4/content/e;->ut:Ljava/lang/String;

    iget-object v6, p0, Landroid/support/v4/content/e;->uv:Landroid/support/v4/d/b;
    ...
    .line 13
    iget-object v0, p0, Landroid/support/v4/content/e;->up:Landroid/support/v4/content/j;
    ...
    :try_start_6
    iput-object v1, p0, Landroid/support/v4/content/e;->uv:Landroid/support/v4/d/b;
...
.method protected final onReset()V
    ...
    iput-object v0, p0, Landroid/support/v4/content/e;->uu:Landroid/database/Cursor;
