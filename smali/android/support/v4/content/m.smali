...
.field public static uE:Landroid/support/v4/content/m;
...
.field public final uB:Ljava/util/HashMap;
...
.field public final uC:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field public final uD:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/m;->uC:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/m;->uD:Ljava/util/ArrayList;

    .line 10
    iput-object p1, p0, Landroid/support/v4/content/m;->uA:Landroid/content/Context;
...
.method public static j(Landroid/content/Context;)Landroid/support/v4/content/m;
    .locals 3
    ...
    .line 2
    :try_start_0
    sget-object v0, Landroid/support/v4/content/m;->uE:Landroid/support/v4/content/m;
    ...
    sput-object v0, Landroid/support/v4/content/m;->uE:Landroid/support/v4/content/m;
...
.method public final a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .prologue
    .line 13
    iget-object v2, p0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    .line 15
    iget-object v0, p0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    .line 18
    iget-object v1, p0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    .line 22
    iget-object v0, p0, Landroid/support/v4/content/m;->uC:Ljava/util/HashMap;
    ...
    .line 25
    iget-object v5, p0, Landroid/support/v4/content/m;->uC:Ljava/util/HashMap;
...
.method public final b(Landroid/content/Intent;)Z
    ...
    iget-object v13, v0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    iget-object v1, v0, Landroid/support/v4/content/m;->uA:Landroid/content/Context;
    ...
    iget-object v1, v0, Landroid/support/v4/content/m;->uC:Ljava/util/HashMap;
    ...
    .line 69
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/content/p;->uI:Z
    ...
    iput-boolean v7, v9, Landroid/support/v4/content/p;->uI:Z
    ...
    iput-boolean v3, v1, Landroid/support/v4/content/p;->uI:Z
    ...
    iget-object v1, v0, Landroid/support/v4/content/m;->uD:Ljava/util/ArrayList;
...
.method final bx()V
    ...
    .line 101
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/content/m;->uD:Ljava/util/ArrayList;
    ...
    .line 110
    iget-object v0, v5, Landroid/support/v4/content/o;->uG:Ljava/util/ArrayList;
    ...
    .line 113
    iget-boolean v7, v0, Landroid/support/v4/content/p;->uJ:Z

    if-nez v7, :cond_2

    .line 114
    iget-object v0, v0, Landroid/support/v4/content/p;->uH:Landroid/content/BroadcastReceiver;

    iget-object v7, p0, Landroid/support/v4/content/m;->uA:Landroid/content/Context;
...
.method public final unregisterReceiver(Landroid/content/BroadcastReceiver;)V
    ...
    .prologue
    .line 29
    iget-object v7, p0, Landroid/support/v4/content/m;->uB:Ljava/util/HashMap;
    ...
    iput-boolean v2, v1, Landroid/support/v4/content/p;->uJ:Z
    ...
    .line 38
    iget-object v2, p0, Landroid/support/v4/content/m;->uC:Ljava/util/HashMap;
    ...
    .line 42
    iget-object v9, v3, Landroid/support/v4/content/p;->uH:Landroid/content/BroadcastReceiver;
    ...
    iput-boolean v9, v3, Landroid/support/v4/content/p;->uJ:Z
