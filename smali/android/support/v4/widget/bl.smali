.class public Landroid/support/v4/widget/bl;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field public static TW:Ljava/lang/reflect/Field;

.field public static TX:Z

.field public static TY:Ljava/lang/reflect/Field;

.field public static TZ:Z
...
.method public b(Landroid/widget/TextView;)I
    ...
    .line 17
    sget-boolean v0, Landroid/support/v4/widget/bl;->TZ:Z
    ...
    invoke-static {v0}, Landroid/support/v4/widget/bl;->m(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v0

    sput-object v0, Landroid/support/v4/widget/bl;->TY:Ljava/lang/reflect/Field;

    .line 19
    sput-boolean v1, Landroid/support/v4/widget/bl;->TZ:Z

    .line 20
    :cond_0
    sget-object v0, Landroid/support/v4/widget/bl;->TY:Ljava/lang/reflect/Field;

    if-eqz v0, :cond_2

    sget-object v0, Landroid/support/v4/widget/bl;->TY:Ljava/lang/reflect/Field;

    invoke-static {v0, p1}, Landroid/support/v4/widget/bl;->a(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I
    ...
    .line 21
    sget-boolean v0, Landroid/support/v4/widget/bl;->TX:Z
    ...
    sput-object v0, Landroid/support/v4/widget/bl;->TW:Ljava/lang/reflect/Field;

    .line 23
    sput-boolean v1, Landroid/support/v4/widget/bl;->TX:Z

    .line 24
    :cond_1
    sget-object v0, Landroid/support/v4/widget/bl;->TW:Ljava/lang/reflect/Field;
