...
.method constructor <init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v4/widget/q;->TP:Landroid/support/v4/widget/DrawerLayout;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/q;->mTmpRect:Landroid/graphics/Rect;
...
.method public final dispatchPopulateAccessibilityEvent(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    .line 72
    iget-object v1, p0, Landroid/support/v4/widget/q;->TP:Landroid/support/v4/widget/DrawerLayout;

    invoke-virtual {v1}, Landroid/support/v4/widget/DrawerLayout;->dh()Landroid/view/View;
    ...
    .line 74
    iget-object v2, p0, Landroid/support/v4/widget/q;->TP:Landroid/support/v4/widget/DrawerLayout;
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/support/v4/view/a/e;)V
    ...
    .line 64
    sget-object v0, Landroid/support/v4/view/a/f;->Ro:Landroid/support/v4/view/a/f;

    invoke-virtual {p2, v0}, Landroid/support/v4/view/a/e;->b(Landroid/support/v4/view/a/f;)Z

    .line 65
    sget-object v0, Landroid/support/v4/view/a/f;->Rp:Landroid/support/v4/view/a/f;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/ar;->x(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    .line 15
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/q;->mTmpRect:Landroid/graphics/Rect;
    ...
    .line 22
    iget-object v0, v2, Landroid/support/v4/view/a/e;->Rm:Landroid/view/accessibility/AccessibilityNodeInfo;
