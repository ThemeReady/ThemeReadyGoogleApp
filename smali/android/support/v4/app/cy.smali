...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cy;->ts:Landroid/app/Notification$Builder;
    ...
    .line 39
    iget-object v7, p0, Landroid/support/v4/app/cy;->ts:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/app/cy;->sH:Landroid/widget/RemoteViews;

    .line 42
    move-object/from16 v0, p29

    iput-object v0, p0, Landroid/support/v4/app/cy;->sI:Landroid/widget/RemoteViews;

    .line 43
    move-object/from16 v0, p30

    iput-object v0, p0, Landroid/support/v4/app/cy;->sJ:Landroid/widget/RemoteViews;

    .line 44
    move/from16 v0, p31

    iput v0, p0, Landroid/support/v4/app/cy;->sO:I
...
.method public final a(Landroid/support/v4/app/dc;)V
    ...
    .prologue
    .line 46
    iget-object v0, p0, Landroid/support/v4/app/cy;->ts:Landroid/app/Notification$Builder;
...
.method public final build()Landroid/app/Notification;
    ...
    .line 51
    iget-object v1, p0, Landroid/support/v4/app/cy;->sH:Landroid/widget/RemoteViews;
    ...
    .line 53
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/cy;->sI:Landroid/widget/RemoteViews;
    ...
    .line 55
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/cy;->sJ:Landroid/widget/RemoteViews;
    ...
    .line 57
    :cond_2
    iget v1, p0, Landroid/support/v4/app/cy;->sO:I
