...
# static fields
.field public static final oX:Z


# instance fields
.field public mName:Ljava/lang/String;

.field public final oY:Landroid/support/v4/app/ag;
...
.field public pl:Ljava/lang/CharSequence;

.field public pm:I

.field public pn:Ljava/lang/CharSequence;

.field public po:Ljava/util/ArrayList;

.field public pp:Ljava/util/ArrayList;

.field public pq:Z

.field public pr:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v4/app/j;->oX:Z
...
.method public constructor <init>(Landroid/support/v4/app/ag;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/j;->oZ:Ljava/util/ArrayList;

    .line 79
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v4/app/j;->ph:Z
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/j;->pq:Z

    .line 82
    iput-object p1, p0, Landroid/support/v4/app/j;->oY:Landroid/support/v4/app/ag;
...
.method private final a(ILandroid/support/v4/app/s;Ljava/lang/String;I)V
    ...
    iput-object v0, p2, Landroid/support/v4/app/s;->qd:Landroid/support/v4/app/ag;

    .line 102
    if-eqz p3, :cond_3

    .line 103
    iget-object v0, p2, Landroid/support/v4/app/s;->qk:Ljava/lang/String;
    ...
    iget-object v2, p2, Landroid/support/v4/app/s;->qk:Ljava/lang/String;
    ...
    .line 105
    :cond_2
    iput-object p3, p2, Landroid/support/v4/app/s;->qk:Ljava/lang/String;
    ...
    .line 109
    :cond_4
    iget v0, p2, Landroid/support/v4/app/s;->qi:I
    ...
    iget v2, p2, Landroid/support/v4/app/s;->qi:I
    ...
    .line 111
    :cond_5
    iput p1, p2, Landroid/support/v4/app/s;->qi:I

    iput p1, p2, Landroid/support/v4/app/s;->qj:I
...
.method static b(Landroid/support/v4/app/k;)Z
    ...
    .prologue
    .line 332
    iget-object v0, p0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    .line 333
    if-eqz v0, :cond_0

    iget-boolean v1, v0, Landroid/support/v4/app/s;->pW:Z
    ...
    iget-boolean v1, v0, Landroid/support/v4/app/s;->qm:Z

    if-nez v1, :cond_0

    iget-boolean v1, v0, Landroid/support/v4/app/s;->ql:Z

    if-nez v1, :cond_0

    .line 334
    invoke-virtual {v0}, Landroid/support/v4/app/s;->aS()Z
...
.method final L(I)V
    ...
    .prologue
    .line 124
    iget-boolean v0, p0, Landroid/support/v4/app/j;->pg:Z
    ...
    .line 130
    iget-object v3, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;
    ...
    iget v4, v3, Landroid/support/v4/app/s;->qc:I

    add-int/2addr v4, p1

    iput v4, v3, Landroid/support/v4/app/s;->qc:I
    ...
    iget-object v5, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;
    ...
    iget-object v0, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    iget v0, v0, Landroid/support/v4/app/s;->qc:I
...
.method final M(I)Z
    ...
    .line 175
    iget-object v4, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    if-eqz v4, :cond_0

    iget-object v0, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    iget v0, v0, Landroid/support/v4/app/s;->qj:I
...
.method final a(Ljava/util/ArrayList;Landroid/support/v4/app/s;)Landroid/support/v4/app/s;
    ...
    .line 274
    iget v2, v0, Landroid/support/v4/app/k;->ps:I
    ...
    .line 277
    :pswitch_2
    iget-object v2, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;
    ...
    .line 279
    iget-object v2, p0, Landroid/support/v4/app/j;->oZ:Ljava/util/ArrayList;
    ...
    .line 282
    :pswitch_3
    iget-object v6, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    .line 283
    iget v7, v6, Landroid/support/v4/app/s;->qj:I
    ...
    .line 287
    iget v8, v1, Landroid/support/v4/app/s;->qj:I
    ...
    .line 291
    iget-object v3, p0, Landroid/support/v4/app/j;->oZ:Ljava/util/ArrayList;
    ...
    .line 295
    iget v9, v0, Landroid/support/v4/app/k;->pu:I

    iput v9, v8, Landroid/support/v4/app/k;->pu:I

    .line 296
    iget v9, v0, Landroid/support/v4/app/k;->pw:I

    iput v9, v8, Landroid/support/v4/app/k;->pw:I

    .line 297
    iget v9, v0, Landroid/support/v4/app/k;->pv:I

    iput v9, v8, Landroid/support/v4/app/k;->pv:I

    .line 298
    iget v9, v0, Landroid/support/v4/app/k;->px:I

    iput v9, v8, Landroid/support/v4/app/k;->px:I

    .line 299
    iget-object v9, p0, Landroid/support/v4/app/j;->oZ:Ljava/util/ArrayList;
    ...
    iput v1, v0, Landroid/support/v4/app/k;->ps:I
    ...
    .line 311
    iget-object p2, v0, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;
...
.method final a(Landroid/support/v4/app/k;)V
    ...
    .line 85
    iget v0, p0, Landroid/support/v4/app/j;->pa:I

    iput v0, p1, Landroid/support/v4/app/k;->pu:I

    .line 86
    iget v0, p0, Landroid/support/v4/app/j;->pb:I

    iput v0, p1, Landroid/support/v4/app/k;->pv:I

    .line 87
    iget v0, p0, Landroid/support/v4/app/j;->pc:I

    iput v0, p1, Landroid/support/v4/app/k;->pw:I

    .line 88
    iget v0, p0, Landroid/support/v4/app/j;->pd:I

    iput v0, p1, Landroid/support/v4/app/k;->px:I
...
.method public final a(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v4/app/j;->pi:Z

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Z)V

    .line 18
    iget v0, p0, Landroid/support/v4/app/j;->pe:I
    ...
    .line 22
    iget v0, p0, Landroid/support/v4/app/j;->pf:I
    ...
    .line 33
    :cond_4
    iget v0, p0, Landroid/support/v4/app/j;->pk:I

    if-nez v0, :cond_5

    iget-object v0, p0, Landroid/support/v4/app/j;->pl:Ljava/lang/CharSequence;
    ...
    .line 38
    :cond_6
    iget v0, p0, Landroid/support/v4/app/j;->pm:I

    if-nez v0, :cond_7

    iget-object v0, p0, Landroid/support/v4/app/j;->pn:Ljava/lang/CharSequence;
    ...
    .line 49
    iget v1, v0, Landroid/support/v4/app/k;->ps:I
    ...
    iget v4, v0, Landroid/support/v4/app/k;->ps:I
    ...
    .line 65
    iget v1, v0, Landroid/support/v4/app/k;->pu:I

    if-nez v1, :cond_9

    iget v1, v0, Landroid/support/v4/app/k;->pv:I
    ...
    .line 70
    :cond_a
    iget v1, v0, Landroid/support/v4/app/k;->pw:I

    if-nez v1, :cond_b

    iget v1, v0, Landroid/support/v4/app/k;->px:I
...
.method final a(Ljava/util/ArrayList;II)Z
    ...
    iget v2, v0, Landroid/support/v4/app/s;->qj:I
    ...
    .line 194
    iget-object v9, v1, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    if-eqz v9, :cond_2

    iget-object v1, v1, Landroid/support/v4/app/k;->pt:Landroid/support/v4/app/s;

    iget v1, v1, Landroid/support/v4/app/s;->qj:I
...
.method public final a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    .line 168
    iget-object v1, v0, Landroid/support/v4/app/ag;->rs:Ljava/util/ArrayList;
    ...
    iput-object v1, v0, Landroid/support/v4/app/ag;->rs:Ljava/util/ArrayList;

    .line 170
    :cond_1
    iget-object v0, v0, Landroid/support/v4/app/ag;->rs:Ljava/util/ArrayList;
...
.method public final aw()Landroid/support/v4/app/ay;
    .locals 2
...
.method public final ax()V
    ...
    .prologue
    .line 135
    iget-object v0, p0, Landroid/support/v4/app/j;->pr:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Landroid/support/v4/app/j;->pr:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/support/v4/app/j;->pr:Ljava/util/ArrayList;
...
.method final ay()V
    ...
    .line 206
    iget v5, p0, Landroid/support/v4/app/j;->pe:I

    iget v6, p0, Landroid/support/v4/app/j;->pf:I

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/app/s;->h(II)V

    .line 207
    :cond_0
    iget v5, v0, Landroid/support/v4/app/k;->ps:I
    ...
    iget v0, v0, Landroid/support/v4/app/k;->ps:I
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/s;->O(I)V

    .line 209
    iget-object v5, p0, Landroid/support/v4/app/j;->oY:Landroid/support/v4/app/ag;

    invoke-virtual {v5, v4, v2}, Landroid/support/v4/app/ag;->a(Landroid/support/v4/app/s;Z)V

    .line 231
    :goto_1
    iget-boolean v5, p0, Landroid/support/v4/app/j;->pq:Z
    ...
    .line 211
    :pswitch_2
    iget v5, v0, Landroid/support/v4/app/k;->pv:I
    ...
    .line 234
    :cond_2
    iget-boolean v0, p0, Landroid/support/v4/app/j;->pq:Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/j;->oY:Landroid/support/v4/app/ag;
...
.method public final commit()I
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/j;->i(Z)I
...
.method public final commitNow()V
    ...
    .prologue
    .line 143
    invoke-virtual {p0}, Landroid/support/v4/app/j;->aw()Landroid/support/v4/app/ay;
...
.method final i(Z)I
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/j;->pi:Z
...
.method final j(Z)V
    ...
    .line 241
    iget v3, p0, Landroid/support/v4/app/j;->pe:I

    invoke-static {v3}, Landroid/support/v4/app/ag;->S(I)I

    move-result v3

    iget v4, p0, Landroid/support/v4/app/j;->pf:I

    invoke-virtual {v2, v3, v4}, Landroid/support/v4/app/s;->h(II)V

    .line 242
    :cond_0
    iget v3, v0, Landroid/support/v4/app/k;->ps:I
    ...
    .line 243
    :pswitch_1
    iget v3, v0, Landroid/support/v4/app/k;->px:I

    invoke-virtual {v2, v3}, Landroid/support/v4/app/s;->O(I)V

    .line 244
    iget-object v3, p0, Landroid/support/v4/app/j;->oY:Landroid/support/v4/app/ag;

    invoke-virtual {v3, v2}, Landroid/support/v4/app/ag;->i(Landroid/support/v4/app/s;)V

    .line 266
    :goto_1
    iget-boolean v3, p0, Landroid/support/v4/app/j;->pq:Z
    ...
    .line 246
    :pswitch_2
    iget v3, v0, Landroid/support/v4/app/k;->pw:I
...
.method public final toString()Ljava/lang/String;
    ...
    .line 4
    iget v1, p0, Landroid/support/v4/app/j;->pj:I
