...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cu;->uA:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cu;->mExtras:Landroid/os/Bundle;

    .line 32
    if-eqz p20, :cond_0

    .line 33
    iget-object v4, p0, Landroid/support/v4/app/cu;->mExtras:Landroid/os/Bundle;
    ...
    .line 35
    iget-object v5, p0, Landroid/support/v4/app/cu;->mExtras:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/cu;->tT:Landroid/widget/RemoteViews;

    .line 39
    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/v4/app/cu;->tU:Landroid/widget/RemoteViews;

    .line 40
    move/from16 v0, p26

    iput v0, p0, Landroid/support/v4/app/cu;->tZ:I
...
.method public final a(Landroid/support/v4/app/cz;)V
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v4/app/cu;->uA:Landroid/app/Notification$Builder;
...
.method public final build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/cu;->mExtras:Landroid/os/Bundle;
    ...
    .line 47
    iget-object v1, p0, Landroid/support/v4/app/cu;->tT:Landroid/widget/RemoteViews;
    ...
    .line 49
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/cu;->tU:Landroid/widget/RemoteViews;
    ...
    .line 51
    :cond_1
    iget v1, p0, Landroid/support/v4/app/cu;->tZ:I
    ...
    .line 53
    invoke-direct {p0, v0}, Landroid/support/v4/app/cu;->c(Landroid/app/Notification;)V
