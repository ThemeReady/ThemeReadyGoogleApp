...
.field public final sa:Landroid/app/PendingIntent;

.field public sb:Ljava/util/ArrayList;
...
.method private constructor <init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/support/v4/app/dr;Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/bz;->rX:Z

    .line 5
    iput p1, p0, Landroid/support/v4/app/bz;->rZ:I
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/app/bz;->sa:Landroid/app/PendingIntent;
    ...
    .line 10
    :goto_0
    iput-object v0, p0, Landroid/support/v4/app/bz;->sb:Ljava/util/ArrayList;

    .line 11
    iput-boolean p6, p0, Landroid/support/v4/app/bz;->rX:Z
...
# virtual methods
.method public final bs()Landroid/support/v4/app/bx;
    .locals 9
    ...
    .line 15
    iget-object v0, p0, Landroid/support/v4/app/bz;->sb:Ljava/util/ArrayList;
    ...
    .line 19
    iget-boolean v3, v1, Landroid/support/v4/app/dr;->tY:Z

    .line 20
    if-nez v3, :cond_1

    .line 22
    iget-object v3, v1, Landroid/support/v4/app/dr;->tX:[Ljava/lang/CharSequence;
    ...
    .line 27
    :cond_0
    iget-object v3, v1, Landroid/support/v4/app/dr;->tZ:Ljava/util/Set;
    ...
    iget v1, p0, Landroid/support/v4/app/bz;->rZ:I

    iget-object v2, p0, Landroid/support/v4/app/bz;->mTitle:Ljava/lang/CharSequence;

    iget-object v3, p0, Landroid/support/v4/app/bz;->sa:Landroid/app/PendingIntent;

    iget-object v4, p0, Landroid/support/v4/app/bz;->mExtras:Landroid/os/Bundle;

    iget-boolean v7, p0, Landroid/support/v4/app/bz;->rX:Z
