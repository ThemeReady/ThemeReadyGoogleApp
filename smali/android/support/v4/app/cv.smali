...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/cv;->uA:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/cv;->mExtras:Landroid/os/Bundle;

    .line 36
    if-eqz p21, :cond_0

    .line 37
    iget-object v4, p0, Landroid/support/v4/app/cv;->mExtras:Landroid/os/Bundle;
    ...
    .line 39
    iget-object v7, p0, Landroid/support/v4/app/cv;->uA:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/app/cv;->tT:Landroid/widget/RemoteViews;

    .line 42
    move-object/from16 v0, p29

    iput-object v0, p0, Landroid/support/v4/app/cv;->tU:Landroid/widget/RemoteViews;

    .line 43
    move-object/from16 v0, p30

    iput-object v0, p0, Landroid/support/v4/app/cv;->tV:Landroid/widget/RemoteViews;

    .line 44
    move/from16 v0, p31

    iput v0, p0, Landroid/support/v4/app/cv;->tZ:I
...
.method public final a(Landroid/support/v4/app/cz;)V
    ...
    .prologue
    .line 46
    iget-object v0, p0, Landroid/support/v4/app/cv;->uA:Landroid/app/Notification$Builder;

    invoke-static {v0, p1}, Landroid/support/v4/app/ct;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/cz;)V
...
.method public final build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/cv;->mExtras:Landroid/os/Bundle;
    ...
    .line 51
    iget-object v1, p0, Landroid/support/v4/app/cv;->tT:Landroid/widget/RemoteViews;
    ...
    .line 53
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/cv;->tU:Landroid/widget/RemoteViews;
    ...
    .line 55
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/cv;->tV:Landroid/widget/RemoteViews;
    ...
    .line 57
    :cond_2
    iget v1, p0, Landroid/support/v4/app/cv;->tZ:I
    ...
    .line 59
    invoke-direct {p0, v0}, Landroid/support/v4/app/cv;->c(Landroid/app/Notification;)V
