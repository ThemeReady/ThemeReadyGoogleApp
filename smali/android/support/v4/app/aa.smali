...
# instance fields
.field public final synthetic re:Landroid/support/v4/app/y;
...
.method public constructor <init>(Landroid/support/v4/app/y;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v4/app/aa;->re:Landroid/support/v4/app/y;
...
.method public final a(Landroid/support/v4/app/s;Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    .line 10
    iget-object v1, p0, Landroid/support/v4/app/aa;->re:Landroid/support/v4/app/y;

    .line 11
    const/4 v0, 0x1

    iput-boolean v0, v1, Landroid/support/v4/app/y;->pA:Z
    ...
    .line 14
    iput-boolean v4, v1, Landroid/support/v4/app/y;->pA:Z
    ...
    :cond_0
    :try_start_1
    invoke-static {p3}, Landroid/support/v4/app/y;->N(I)V

    .line 18
    iget-object v0, v1, Landroid/support/v4/app/y;->rd:Landroid/support/v4/g/z;
    ...
    iget v2, v1, Landroid/support/v4/app/y;->rc:I

    invoke-virtual {v0, v2}, Landroid/support/v4/g/z;->indexOfKey(I)I
    ...
    .line 21
    iget v0, v1, Landroid/support/v4/app/y;->rc:I
    ...
    iput v0, v1, Landroid/support/v4/app/y;->rc:I
    ...
    .line 23
    iget-object v2, v1, Landroid/support/v4/app/y;->rd:Landroid/support/v4/g/z;

    iget-object v3, p1, Landroid/support/v4/app/s;->pR:Ljava/lang/String;

    invoke-virtual {v2, v0, v3}, Landroid/support/v4/g/z;->put(ILjava/lang/Object;)V
    ...
    iput v2, v1, Landroid/support/v4/app/y;->rc:I
...
.method public final aZ()Z
    ...
    .prologue
    .line 6
    iget-object v0, p0, Landroid/support/v4/app/aa;->re:Landroid/support/v4/app/y;
...
.method public final ba()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/y;->aW()V
