...
.method public static a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/app/bi;-><init>(ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p0, v0}, Landroid/support/v4/app/dn;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroid/support/v4/app/dn;
...
.method public static a(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/app/bl;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 39
    invoke-static {p1, v0}, Landroid/support/v4/app/bf;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 40
    new-instance v1, Landroid/support/v4/app/bg;

    invoke-direct {v1, v0}, Landroid/support/v4/app/bg;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    .line 13
    invoke-static {v6, v0, v2}, Landroid/support/v4/app/bf;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    .line 22
    invoke-static {v6, v9, v2}, Landroid/support/v4/app/bf;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    .line 29
    invoke-static {p0, p2}, Landroid/support/v4/app/bf;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroid/support/v4/app/bk;-><init>(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 54
    invoke-static {v2, p1}, Landroid/support/v4/app/bf;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 56
    :cond_2
    invoke-static {p0}, Landroid/support/v4/app/bf;->a(Landroid/transition/Transition;)Z
    ...
    .line 58
    invoke-static {v1}, Landroid/support/v4/app/bf;->c(Ljava/util/List;)Z
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 127
    invoke-static {p0, p1, p2}, Landroid/support/v4/app/bf;->b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    .line 103
    invoke-static {p0, v2}, Landroid/support/v4/app/bf;->a(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    .line 117
    invoke-static {p0, v2}, Landroid/support/v4/app/bf;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/app/bf;->c(Ljava/util/List;)Z
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 135
    invoke-static {v2, p1, p2}, Landroid/support/v4/app/bf;->b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
