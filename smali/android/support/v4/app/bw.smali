...
# static fields
.field public static final rL:Landroid/support/v4/app/ct;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/bw;->rL:Landroid/support/v4/app/ct;
...
.method static a(Landroid/support/v4/app/bv;Landroid/support/v4/app/cu;)V
    ...
    .line 8
    iget-object v0, p1, Landroid/support/v4/app/cb;->sV:Ljava/lang/CharSequence;

    iget-boolean v1, p1, Landroid/support/v4/app/cb;->sX:Z

    iget-object v2, p1, Landroid/support/v4/app/cb;->sW:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/cb;->rW:Ljava/lang/CharSequence;
    ...
    .line 11
    iget-object v0, p1, Landroid/support/v4/app/ci;->sV:Ljava/lang/CharSequence;

    iget-boolean v1, p1, Landroid/support/v4/app/ci;->sX:Z

    iget-object v2, p1, Landroid/support/v4/app/ci;->sW:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/ci;->sQ:Ljava/util/ArrayList;
    ...
    .line 14
    iget-object v1, p1, Landroid/support/v4/app/ca;->sV:Ljava/lang/CharSequence;

    iget-boolean v2, p1, Landroid/support/v4/app/ca;->sX:Z

    iget-object v3, p1, Landroid/support/v4/app/ca;->sW:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/ca;->rT:Landroid/graphics/Bitmap;

    iget-object v5, p1, Landroid/support/v4/app/ca;->rU:Landroid/graphics/Bitmap;

    iget-boolean v6, p1, Landroid/support/v4/app/ca;->rV:Z
...
.method static b(Landroid/support/v4/app/bv;Landroid/support/v4/app/cu;)V
    ...
    .line 24
    iget-object v0, p1, Landroid/support/v4/app/cj;->sT:Ljava/util/List;
    ...
    .line 27
    :cond_0
    iget-object v1, p1, Landroid/support/v4/app/cj;->sR:Ljava/lang/CharSequence;

    iget-object v2, p1, Landroid/support/v4/app/cj;->sS:Ljava/lang/CharSequence;
