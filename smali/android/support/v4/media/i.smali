...
.field public final La:Landroid/content/ComponentName;

.field public final Lb:Landroid/support/v4/media/b;

.field public Lc:Landroid/support/v4/media/k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/ComponentName;Landroid/support/v4/media/b;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/i;->KV:Landroid/support/v4/media/a;
    ...
    iput-object v0, p0, Landroid/support/v4/media/i;->KW:Landroid/support/v4/g/a;
    ...
    .line 12
    iput-object p2, p0, Landroid/support/v4/media/i;->La:Landroid/content/ComponentName;

    .line 13
    iput-object p3, p0, Landroid/support/v4/media/i;->Lb:Landroid/support/v4/media/b;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v4/media/i;->KU:Landroid/os/Bundle;
...
.method private final a(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    .line 103
    iget-object v1, p0, Landroid/support/v4/media/i;->KY:Landroid/os/Messenger;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->La:Landroid/content/ComponentName;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->KY:Landroid/os/Messenger;
...
.method public final a(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    invoke-static {v2}, Landroid/support/v4/media/i;->aa(I)Ljava/lang/String;
    ...
    .line 42
    :cond_2
    iput-object p2, p0, Landroid/support/v4/media/i;->Ld:Ljava/lang/String;

    .line 43
    iput-object p3, p0, Landroid/support/v4/media/i;->KZ:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 49
    :cond_3
    iget-object v0, p0, Landroid/support/v4/media/i;->Lb:Landroid/support/v4/media/b;

    invoke-virtual {v0}, Landroid/support/v4/media/b;->onConnected()V

    .line 50
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/media/i;->KW:Landroid/support/v4/g/a;
    ...
    .line 57
    iget-object v5, v0, Landroid/support/v4/media/q;->Lk:Ljava/util/List;
    ...
    .line 60
    iget-object v6, p0, Landroid/support/v4/media/i;->KX:Landroid/support/v4/media/p;
    ...
    .line 61
    iget-object v7, v0, Landroid/support/v4/media/r;->Lm:Landroid/os/IBinder;
    ...
    iget-object v8, p0, Landroid/support/v4/media/i;->KY:Landroid/os/Messenger;
...
.method public final b(Landroid/os/Messenger;)V
    ...
    .line 82
    :cond_1
    invoke-virtual {p0}, Landroid/support/v4/media/i;->bU()V
...
.method public final bT()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 36
    :cond_1
    iget-object v0, p0, Landroid/support/v4/media/i;->KZ:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method final bU()V
    ...
    .line 22
    iget-object v0, p0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    iget-object v1, p0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    .line 25
    iput-object v2, p0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;

    .line 26
    iput-object v2, p0, Landroid/support/v4/media/i;->KX:Landroid/support/v4/media/p;

    .line 27
    iput-object v2, p0, Landroid/support/v4/media/i;->KY:Landroid/os/Messenger;

    .line 28
    iget-object v0, p0, Landroid/support/v4/media/i;->KV:Landroid/support/v4/media/a;

    invoke-virtual {v0, v2}, Landroid/support/v4/media/a;->a(Landroid/os/Messenger;)V

    .line 29
    iput-object v2, p0, Landroid/support/v4/media/i;->Ld:Ljava/lang/String;

    .line 30
    iput-object v2, p0, Landroid/support/v4/media/i;->KZ:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method final dump()V
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->Lb:Landroid/support/v4/media/b;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->KU:Landroid/os/Bundle;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->KX:Landroid/support/v4/media/p;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->Ld:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v4/media/i;->KZ:Landroid/support/v4/media/session/MediaSessionCompat$Token;
