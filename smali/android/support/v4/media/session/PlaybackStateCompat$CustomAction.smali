...
# instance fields
.field public final MA:Ljava/lang/CharSequence;

.field public MB:Ljava/lang/Object;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->Mz:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->MA:Ljava/lang/CharSequence;
    ...
    iput v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->to:I
...
.method constructor <init>(Ljava/lang/String;Ljava/lang/CharSequence;ILandroid/os/Bundle;)V
    ...
    .line 2
    iput-object p1, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->Mz:Ljava/lang/String;

    .line 3
    iput-object p2, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->MA:Ljava/lang/CharSequence;

    .line 4
    iput p3, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->to:I
...
.method public static r(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    .line 34
    iput-object p0, v1, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->MB:Ljava/lang/Object;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->MA:Ljava/lang/CharSequence;
    ...
    iget v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->to:I
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    .prologue
    .line 13
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->Mz:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/os/Parcel;->writeString(Ljava/lang/String;)V

    .line 14
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->MA:Ljava/lang/CharSequence;

    invoke-static {v0, p1, p2}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V

    .line 15
    iget v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->to:I
