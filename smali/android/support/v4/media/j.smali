...
# instance fields
.field public final synthetic Le:Landroid/support/v4/media/i;
...
.method constructor <init>(Landroid/support/v4/media/i;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/j;->Le:Landroid/support/v4/media/i;
...
.method public run()V
    ...
    .prologue
    .line 2
    iget-object v0, p0, Landroid/support/v4/media/j;->Le:Landroid/support/v4/media/i;
    ...
    iget-object v0, v0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    iget-object v2, p0, Landroid/support/v4/media/j;->Le:Landroid/support/v4/media/i;
    ...
    iget-object v2, v2, Landroid/support/v4/media/i;->KX:Landroid/support/v4/media/p;
    ...
    iget-object v0, v0, Landroid/support/v4/media/i;->KY:Landroid/os/Messenger;
    ...
    iget-object v0, v0, Landroid/support/v4/media/i;->La:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/j;->Le:Landroid/support/v4/media/i;

    invoke-direct {v2, v3}, Landroid/support/v4/media/k;-><init>(Landroid/support/v4/media/i;)V

    iput-object v2, v0, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    iget-object v3, v3, Landroid/support/v4/media/i;->Lc:Landroid/support/v4/media/k;
    ...
    invoke-virtual {v0}, Landroid/support/v4/media/i;->bU()V
    ...
    iget-object v3, v3, Landroid/support/v4/media/i;->La:Landroid/content/ComponentName;
