.class public Landroid/support/v4/graphics/d;
...
.method constructor <init>(C[F)V
    ...
    .line 2
    iput-char p1, p0, Landroid/support/v4/graphics/d;->Ip:C

    .line 3
    iput-object p2, p0, Landroid/support/v4/graphics/d;->Iq:[F

    .line 4
    return-void
.end method

.method constructor <init>(Landroid/support/v4/graphics/d;)V
    .locals 3
    ...
    .line 6
    iget-char v0, p1, Landroid/support/v4/graphics/d;->Ip:C

    iput-char v0, p0, Landroid/support/v4/graphics/d;->Ip:C

    .line 7
    iget-object v0, p1, Landroid/support/v4/graphics/d;->Iq:[F

    const/4 v1, 0x0

    iget-object v2, p1, Landroid/support/v4/graphics/d;->Iq:[F

    array-length v2, v2

    invoke-static {v0, v1, v2}, Landroid/support/v4/graphics/b;->copyOfRange([FII)[F

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/graphics/d;->Iq:[F
...
.method private static a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v3 .. v21}, Landroid/support/v4/graphics/d;->a(Landroid/graphics/Path;DDDDDDDDD)V
...
.method public static a([Landroid/support/v4/graphics/d;Landroid/graphics/Path;)V
    .locals 23
    ...
    iget-char v0, v4, Landroid/support/v4/graphics/d;->Ip:C

    move/from16 v20, v0

    aget-object v4, p0, v13

    iget-object v0, v4, Landroid/support/v4/graphics/d;->Iq:[F
    ...
    invoke-static/range {v3 .. v12}, Landroid/support/v4/graphics/d;->a(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    iget-char v4, v3, Landroid/support/v4/graphics/d;->Ip:C
...
# virtual methods
.method public final a(Landroid/support/v4/graphics/d;Landroid/support/v4/graphics/d;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Landroid/support/v4/graphics/d;->Iq:[F
    ...
    .line 166
    iget-object v1, p0, Landroid/support/v4/graphics/d;->Iq:[F
    ...
    iget-object v3, p2, Landroid/support/v4/graphics/d;->Iq:[F
