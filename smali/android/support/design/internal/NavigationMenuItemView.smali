...
.field public final di:Landroid/widget/CheckedTextView;
...
.field public dn:Landroid/graphics/drawable/Drawable;

.field public final do:Landroid/support/v4/view/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->do:Landroid/support/v4/view/b;
    ...
    sget v1, Landroid/support/design/g;->ay:I
    ...
    sget v1, Landroid/support/design/c;->ad:I
    ...
    .line 10
    sget v0, Landroid/support/design/e;->am:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/widget/CheckedTextView;

    .line 11
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->do:Landroid/support/v4/view/b;
...
.method public final a(Landroid/support/v7/view/menu/t;I)V
    ...
    .line 14
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dk:Landroid/support/v7/view/menu/t;
    ...
    .line 30
    iget-boolean v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->dh:Z

    if-eq v5, v0, :cond_1

    .line 31
    iput-boolean v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dh:Z

    .line 32
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->do:Landroid/support/v4/view/b;

    iget-object v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/widget/CheckedTextView;
    ...
    .line 41
    iget-boolean v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->dm:Z
    ...
    .line 44
    :goto_2
    sget-object v5, Landroid/support/v4/a/a/a;->IU:Landroid/support/v4/a/a/f;

    invoke-virtual {v5, v0}, Landroid/support/v4/a/a/f;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 46
    iget-object v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->dl:Landroid/content/res/ColorStateList;

    invoke-static {v0, v5}, Landroid/support/v4/a/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v5, v0, v3, v3, v3}, Landroid/support/v4/widget/bf;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 59
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dj:Landroid/widget/FrameLayout;

    if-nez v0, :cond_4

    .line 60
    sget v0, Landroid/support/design/e;->al:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dj:Landroid/widget/FrameLayout;
    ...
    .line 66
    :cond_5
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dk:Landroid/support/v7/view/menu/t;
    ...
    .line 74
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dj:Landroid/widget/FrameLayout;
    ...
    .line 48
    :cond_a
    iget-boolean v5, p0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Z

    if-eqz v5, :cond_3

    .line 49
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dn:Landroid/graphics/drawable/Drawable;
    ...
    sget v5, Landroid/support/design/d;->aj:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dn:Landroid/graphics/drawable/Drawable;
...
.method protected onCreateDrawableState(I)[I
    ...
    .line 85
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dk:Landroid/support/v7/view/menu/t;
