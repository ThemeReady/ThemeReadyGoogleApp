...
.field public gI:Landroid/graphics/PorterDuff$Mode;
...
.field public final gP:Landroid/graphics/Rect;

.field public final gQ:Landroid/graphics/Rect;

.field public gR:Landroid/support/v7/widget/at;

.field public gS:Landroid/support/design/widget/az;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gP:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gQ:Landroid/graphics/Rect;

    .line 8
    invoke-static {p1}, Landroid/support/design/widget/cv;->a(Landroid/content/Context;)V

    .line 9
    sget-object v0, Landroid/support/design/j;->cr:[I

    sget v1, Landroid/support/design/i;->ay:I
    ...
    .line 11
    sget v1, Landroid/support/design/j;->aT:I

    invoke-virtual {v0, v1}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->gH:Landroid/content/res/ColorStateList;

    .line 12
    sget v1, Landroid/support/design/j;->aU:I
    ...
    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->gI:Landroid/graphics/PorterDuff$Mode;

    .line 15
    sget v1, Landroid/support/design/j;->aZ:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->gK:I

    .line 16
    sget v1, Landroid/support/design/j;->aX:I

    invoke-virtual {v0, v1, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->gL:I

    .line 17
    sget v1, Landroid/support/design/j;->aV:I

    invoke-virtual {v0, v1, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->gJ:I

    .line 18
    sget v1, Landroid/support/design/j;->aW:I
    ...
    .line 19
    sget v2, Landroid/support/design/j;->aY:I
    ...
    .line 21
    sget v3, Landroid/support/design/j;->ba:I

    invoke-virtual {v0, v3, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Landroid/support/design/widget/FloatingActionButton;->gO:Z
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gR:Landroid/support/v7/widget/at;

    .line 24
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gR:Landroid/support/v7/widget/at;
    ...
    sget v3, Landroid/support/design/c;->U:I
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->gN:I

    .line 26
    invoke-direct {p0}, Landroid/support/design/widget/FloatingActionButton;->E()Landroid/support/design/widget/az;

    move-result-object v0

    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->gH:Landroid/content/res/ColorStateList;

    iget-object v4, p0, Landroid/support/design/widget/FloatingActionButton;->gI:Landroid/graphics/PorterDuff$Mode;

    iget v5, p0, Landroid/support/design/widget/FloatingActionButton;->gK:I

    iget v6, p0, Landroid/support/design/widget/FloatingActionButton;->gJ:I
    ...
    .line 29
    iget v3, v0, Landroid/support/design/widget/az;->hf:F
    ...
    .line 30
    iput v1, v0, Landroid/support/design/widget/az;->hf:F

    .line 31
    iget v3, v0, Landroid/support/design/widget/az;->hg:F
    ...
    .line 33
    iget v1, v0, Landroid/support/design/widget/az;->hg:F
    ...
    .line 34
    iput v2, v0, Landroid/support/design/widget/az;->hg:F

    .line 35
    iget v1, v0, Landroid/support/design/widget/az;->hf:F
...
.method private final E()Landroid/support/design/widget/az;
    .locals 2

    .prologue
    .line 176
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gS:Landroid/support/design/widget/az;
    ...
    .line 181
    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gS:Landroid/support/design/widget/az;
...
.method private final t(I)I
    ...
    .line 130
    :pswitch_0
    sget v1, Landroid/support/design/c;->W:I
    ...
    .line 129
    :pswitch_2
    sget v1, Landroid/support/design/c;->V:I
...
.method final D()I
    ...
    .prologue
    .line 121
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->gL:I
...
.method final a(Landroid/support/design/widget/ax;Z)V
    ...
    .line 71
    iget-object v4, v2, Landroid/support/design/widget/az;->hi:Landroid/support/design/widget/db;
    ...
    .line 72
    iget v4, v2, Landroid/support/design/widget/az;->gY:I
    ...
    .line 75
    iget-object v0, v2, Landroid/support/design/widget/az;->hi:Landroid/support/design/widget/db;
    ...
    .line 76
    invoke-virtual {v2}, Landroid/support/design/widget/az;->N()Z
    ...
    .line 77
    iput v7, v2, Landroid/support/design/widget/az;->gY:I
    ...
    .line 95
    invoke-interface {v3}, Landroid/support/design/widget/bf;->F()V
...
.method final b(Landroid/support/design/widget/ax;Z)V
    ...
    .line 105
    iput v1, v2, Landroid/support/design/widget/az;->gY:I
    ...
    .line 114
    :cond_3
    iget-object v1, v2, Landroid/support/design/widget/az;->hi:Landroid/support/design/widget/db;
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gH:Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .prologue
    .line 54
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->gI:Landroid/graphics/PorterDuff$Mode;
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/az;->I()V
...
.method protected onAttachedToWindow()V
    ...
    .line 133
    invoke-virtual {v0}, Landroid/support/design/widget/az;->J()Z
    ...
    .line 135
    iget-object v1, v0, Landroid/support/design/widget/az;->hk:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v1, v0, Landroid/support/design/widget/az;->hk:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iget-object v0, v0, Landroid/support/design/widget/az;->hk:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v2, v0, Landroid/support/design/widget/az;->hk:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onMeasure(II)V
    ...
    .prologue
    .line 37
    invoke-virtual {p0}, Landroid/support/design/widget/FloatingActionButton;->D()I

    move-result v0

    .line 38
    iget v1, p0, Landroid/support/design/widget/FloatingActionButton;->gN:I

    sub-int v1, v0, v1

    div-int/lit8 v1, v1, 0x2

    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->gM:I
    ...
    .line 43
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->gP:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    add-int/2addr v1, v0

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->gP:Landroid/graphics/Rect;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 162
    :pswitch_0
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->gQ:Landroid/graphics/Rect;

    .line 164
    sget-object v2, Landroid/support/v4/view/ae;->LB:Landroid/support/v4/view/ap;

    invoke-virtual {v2, p0}, Landroid/support/v4/view/ap;->J(Landroid/view/View;)Z
    ...
    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->gP:Landroid/graphics/Rect;
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 47
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->gH:Landroid/content/res/ColorStateList;
    ...
    .line 49
    iget-object v1, v0, Landroid/support/design/widget/az;->hb:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v1, p1}, Landroid/support/v4/graphics/a/a;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 52
    iget-object v0, v0, Landroid/support/design/widget/az;->hd:Landroid/support/design/widget/aj;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 56
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->gI:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 59
    iget-object v0, v0, Landroid/support/design/widget/az;->hb:Landroid/graphics/drawable/Drawable;
