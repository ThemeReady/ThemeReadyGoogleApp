...
.field public ji:Landroid/animation/ValueAnimator;
...
.method constructor <init>(Landroid/support/design/widget/TabLayout;Landroid/content/Context;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/design/widget/ch;->ja:Landroid/support/design/widget/TabLayout;
    ...
    .line 4
    iput v0, p0, Landroid/support/design/widget/ch;->jf:I

    .line 5
    iput v0, p0, Landroid/support/design/widget/ch;->jg:I

    .line 6
    iput v0, p0, Landroid/support/design/widget/ch;->jh:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/ch;->jd:Landroid/graphics/Paint;
...
.method final W()V
    ...
    .line 59
    iget v2, p0, Landroid/support/design/widget/ch;->je:F
    ...
    .line 61
    iget v3, p0, Landroid/support/design/widget/ch;->je:F
    ...
    iget v4, p0, Landroid/support/design/widget/ch;->je:F
...
.method final d(II)V
    ...
    .prologue
    .line 68
    iget v0, p0, Landroid/support/design/widget/ch;->jg:I

    if-ne p1, v0, :cond_0

    iget v0, p0, Landroid/support/design/widget/ch;->jh:I

    if-eq p2, v0, :cond_1

    .line 69
    :cond_0
    iput p1, p0, Landroid/support/design/widget/ch;->jg:I

    .line 70
    iput p2, p0, Landroid/support/design/widget/ch;->jh:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Landroid/support/design/widget/ch;->jg:I
    ...
    iget v2, p0, Landroid/support/design/widget/ch;->jc:I
    ...
    iget-object v5, p0, Landroid/support/design/widget/ch;->jd:Landroid/graphics/Paint;
...
.method final e(II)V
    ...
    .line 74
    iget-object v0, p0, Landroid/support/design/widget/ch;->ji:Landroid/animation/ValueAnimator;
    ...
    .line 81
    invoke-virtual {p0}, Landroid/support/design/widget/ch;->W()V
    ...
    .line 86
    iget v2, p0, Landroid/support/design/widget/ch;->jg:I

    .line 87
    iget v4, p0, Landroid/support/design/widget/ch;->jh:I
    ...
    iput-object v6, p0, Landroid/support/design/widget/ch;->ji:Landroid/animation/ValueAnimator;

    .line 97
    sget-object v0, Landroid/support/design/widget/a;->do:Landroid/view/animation/Interpolator;
    ...
    .line 88
    :cond_5
    iget-object v1, p0, Landroid/support/design/widget/ch;->ja:Landroid/support/design/widget/TabLayout;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v4, p0, Landroid/support/design/widget/ch;->ji:Landroid/animation/ValueAnimator;
...
.method protected onMeasure(II)V
    ...
    .line 19
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/ch;->ja:Landroid/support/design/widget/TabLayout;
    ...
    iget v0, v0, Landroid/support/design/widget/TabLayout;->iP:I
    ...
    iput v2, v0, Landroid/support/design/widget/TabLayout;->iP:I
...
.method public onRtlPropertiesChanged(I)V
    ...
    .line 12
    iget v0, p0, Landroid/support/design/widget/ch;->jf:I
    ...
    .line 14
    iput p1, p0, Landroid/support/design/widget/ch;->jf:I
