...
# instance fields
.field public hW:Landroid/support/design/widget/ax;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->hX:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    sget-object v0, Landroid/support/design/j;->bM:[I
    ...
    iput-boolean v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->hX:Z
...
.method private final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 38
    invoke-static {p1, p2, v1}, Landroid/support/design/widget/cz;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, p2}, Landroid/support/v4/view/ar;->z(Landroid/view/View;)I
    ...
    .line 54
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->hW:Landroid/support/design/widget/ax;
    ...
    invoke-virtual {v4, v1}, Landroid/support/v4/view/ar;->z(Landroid/view/View;)I
...
.method private final a(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 22
    iget-boolean v2, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->hX:Z
    ...
    .line 25
    :cond_0
    iget v0, v0, Landroid/support/design/widget/aq;->hp:I
    ...
    .line 29
    :cond_1
    iget v0, p2, Landroid/support/design/widget/de;->lW:I
...
.method private final b(Landroid/view/View;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 61
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$Behavior;->hW:Landroid/support/design/widget/ax;
...
.method public final a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/FloatingActionButton;I)Z
    ...
    .line 75
    iget-object v3, p2, Landroid/support/design/widget/FloatingActionButton;->hP:Landroid/graphics/Rect;
    ...
    .line 90
    invoke-static {p2, v2}, Landroid/support/v4/view/ag;->m(Landroid/view/View;I)V
    ...
    .line 92
    invoke-static {p2, v1}, Landroid/support/v4/view/ag;->n(Landroid/view/View;I)V
    ...
    .line 70
    :cond_4
    invoke-static {v0}, Landroid/support/design/widget/FloatingActionButton$Behavior;->m(Landroid/view/View;)Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    .line 95
    iget-object v0, p2, Landroid/support/design/widget/FloatingActionButton;->hP:Landroid/graphics/Rect;
...
.method public final synthetic c(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 108
    :cond_1
    invoke-static {p3}, Landroid/support/design/widget/FloatingActionButton$Behavior;->m(Landroid/view/View;)Z
