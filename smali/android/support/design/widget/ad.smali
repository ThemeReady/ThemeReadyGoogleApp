...
# instance fields
.field public fD:Landroid/support/design/widget/BottomSheetBehavior;
...
.field public fH:Landroid/support/design/widget/aa;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    sget v2, Landroid/support/design/a;->S:I
    ...
    .line 11
    iput-boolean v3, p0, Landroid/support/design/widget/ad;->fE:Z

    .line 12
    iput-boolean v3, p0, Landroid/support/design/widget/ad;->fF:Z
    ...
    iput-object v0, p0, Landroid/support/design/widget/ad;->fH:Landroid/support/design/widget/aa;

    .line 14
    invoke-virtual {p0, v3}, Landroid/support/design/widget/ad;->aV(I)Z
    ...
    .line 8
    :cond_1
    sget p2, Landroid/support/design/i;->aN:I
...
.method private final a(ILandroid/view/View;Landroid/view/ViewGroup$LayoutParams;)Landroid/view/View;
    ...
    sget v1, Landroid/support/design/g;->az:I
    ...
    .line 46
    :cond_0
    sget v1, Landroid/support/design/e;->ap:I
    ...
    iput-object v2, p0, Landroid/support/design/widget/ad;->fD:Landroid/support/design/widget/BottomSheetBehavior;

    .line 48
    iget-object v2, p0, Landroid/support/design/widget/ad;->fD:Landroid/support/design/widget/BottomSheetBehavior;

    iget-object v3, p0, Landroid/support/design/widget/ad;->fH:Landroid/support/design/widget/aa;

    .line 49
    iput-object v3, v2, Landroid/support/design/widget/BottomSheetBehavior;->fw:Landroid/support/design/widget/aa;

    .line 50
    iget-object v2, p0, Landroid/support/design/widget/ad;->fD:Landroid/support/design/widget/BottomSheetBehavior;

    iget-boolean v3, p0, Landroid/support/design/widget/ad;->fE:Z

    .line 51
    iput-boolean v3, v2, Landroid/support/design/widget/BottomSheetBehavior;->fn:Z
    ...
    .line 55
    :goto_0
    sget v2, Landroid/support/design/e;->ax:I
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/ag;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public onStart()V
    ...
    .line 33
    iget-object v0, p0, Landroid/support/design/widget/ad;->fD:Landroid/support/design/widget/BottomSheetBehavior;
...
.method public setCancelable(Z)V
    ...
    .line 26
    iget-boolean v0, p0, Landroid/support/design/widget/ad;->fE:Z

    if-eq v0, p1, :cond_0

    .line 27
    iput-boolean p1, p0, Landroid/support/design/widget/ad;->fE:Z
    ...
    .line 30
    iput-boolean p1, v0, Landroid/support/design/widget/BottomSheetBehavior;->fn:Z
...
.method public setCanceledOnTouchOutside(Z)V
    ...
    .line 38
    iput-boolean v1, p0, Landroid/support/design/widget/ad;->fE:Z

    .line 39
    :cond_0
    iput-boolean p1, p0, Landroid/support/design/widget/ad;->fF:Z

    .line 40
    iput-boolean v1, p0, Landroid/support/design/widget/ad;->fG:Z
