...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    iput v0, p0, Landroid/support/design/widget/AppBarLayout;->dz:I

    .line 5
    iput v0, p0, Landroid/support/design/widget/AppBarLayout;->dA:I

    .line 6
    iput v0, p0, Landroid/support/design/widget/AppBarLayout;->dB:I

    .line 7
    iput v2, p0, Landroid/support/design/widget/AppBarLayout;->dD:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/AppBarLayout;->dI:[I
    ...
    .line 13
    sget v0, Landroid/support/design/i;->aD:I

    invoke-static {p0, p2, v2, v0}, Landroid/support/design/widget/da;->a(Landroid/view/View;Landroid/util/AttributeSet;II)V

    .line 14
    :cond_0
    sget-object v0, Landroid/support/design/j;->aP:[I

    sget v1, Landroid/support/design/i;->aD:I
...
.method final a(ZZZ)V
    ...
    iput v0, p0, Landroid/support/design/widget/AppBarLayout;->dD:I
...
.method final c(I)V
    ...
    .prologue
    .line 140
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout;->dF:Ljava/util/List;
    ...
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout;->dF:Ljava/util/List;
    ...
    .line 142
    iget-object v2, p0, Landroid/support/design/widget/AppBarLayout;->dF:Ljava/util/List;
...
.method protected final f()Landroid/support/design/widget/f;
    .locals 3
...
.method public final g()I
    ...
    .line 83
    iget v0, p0, Landroid/support/design/widget/AppBarLayout;->dz:I
    ...
    .line 90
    iget v7, v0, Landroid/support/design/widget/f;->dZ:I
    ...
    invoke-virtual {v0, v5}, Landroid/support/v4/view/aq;->y(Landroid/view/View;)I
...
.method protected synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .prologue
    .line 154
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout;->f()Landroid/support/design/widget/f;
...
.method final h()I
    ...
    .line 100
    iget v0, p0, Landroid/support/design/widget/AppBarLayout;->dA:I
    ...
    invoke-virtual {v1, v4}, Landroid/support/v4/view/aq;->y(Landroid/view/View;)I
...
.method final i()I
    ...
    .line 122
    iget v0, p0, Landroid/support/design/widget/AppBarLayout;->dB:I
...
.method final j()I
    ...
    .prologue
    .line 150
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout;->dE:Landroid/support/v4/view/bw;
...
.method protected onCreateDrawableState(I)[I
    ...
    .prologue
    .line 145
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout;->dI:[I
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout;->dG:Z

    if-eqz v0, :cond_0

    sget v0, Landroid/support/design/a;->Q:I
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout;->dH:Z

    if-eqz v0, :cond_1

    sget v0, Landroid/support/design/a;->P:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 32
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout;->e()V

    .line 33
    iput-boolean v2, p0, Landroid/support/design/widget/AppBarLayout;->dC:Z
    ...
    .line 38
    iget-object v0, v0, Landroid/support/design/widget/f;->ea:Landroid/view/animation/Interpolator;

    .line 40
    if-eqz v0, :cond_2

    .line 41
    iput-boolean v1, p0, Landroid/support/design/widget/AppBarLayout;->dC:Z
    ...
    .line 48
    iget v5, v0, Landroid/support/design/widget/f;->dZ:I
    ...
    .line 54
    :goto_3
    iget-boolean v1, p0, Landroid/support/design/widget/AppBarLayout;->dG:Z

    if-eq v1, v0, :cond_1

    .line 55
    iput-boolean v0, p0, Landroid/support/design/widget/AppBarLayout;->dG:Z
