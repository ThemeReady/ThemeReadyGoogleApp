...
# static fields
.field public static jtb:Ljava/util/concurrent/atomic/AtomicInteger;


# instance fields
.field public final hSF:I

.field public final jtc:I
...
.field public final jtg:Z

.field public final jth:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtb:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>(IIIZLcom/google/android/apps/gsa/speech/audio/aj;Z)V
    .locals 3
    .param p5    # Lcom/google/android/apps/gsa/speech/audio/aj;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    .end param
    ...
    .line 3
    iput-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtj:Z

    .line 4
    iput-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->mStarted:Z

    .line 5
    iput p1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->hSF:I

    .line 6
    iput p3, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtd:I
    ...
    iput v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtc:I

    .line 10
    iput-boolean p4, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtg:Z

    .line 11
    if-eqz p5, :cond_0

    :goto_0
    iput-object p5, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jte:Lcom/google/android/apps/gsa/speech/audio/aj;

    .line 12
    iput-boolean p6, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtf:Z

    .line 13
    sget-object v0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtb:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jth:Ljava/lang/String;
...
.method public aJw()Landroid/media/AudioRecord;
    .locals 8
    ...
    .line 16
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtf:Z
    ...
    iget v2, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->hSF:I

    iget v3, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtd:I

    const/4 v4, 0x2

    iget v5, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtc:I
...
.method protected final aJx()Landroid/media/AudioRecord;
    .locals 8
    ...
    .line 27
    iget-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jti:Landroid/media/AudioRecord;

    .line 28
    iget-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtj:Z
    ...
    .line 33
    iget-object v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jte:Lcom/google/android/apps/gsa/speech/audio/aj;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jth:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/google/android/apps/gsa/speech/audio/aj;->km(Ljava/lang/String;)V
    ...
    .line 36
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aJw()Landroid/media/AudioRecord;

    move-result-object v0

    .line 37
    iput-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jti:Landroid/media/AudioRecord;

    .line 38
    iput-boolean v4, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jtj:Z
    ...
    .line 41
    :cond_4
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aJu()V
...
.method public close()V
    ...
    .prologue
    .line 75
    iget-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jte:Lcom/google/android/apps/gsa/speech/audio/aj;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jth:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/android/apps/gsa/speech/audio/aj;->kn(Ljava/lang/String;)V
    ...
    .line 82
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aJv()V
...
.method public read([BII)I
    ...
    .line 61
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aJx()Landroid/media/AudioRecord;
