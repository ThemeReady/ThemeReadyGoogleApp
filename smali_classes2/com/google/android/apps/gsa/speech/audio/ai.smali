...
# static fields
.field public static jlY:Ljava/util/concurrent/atomic/AtomicInteger;


# instance fields
.field public final hLF:I

.field public final jlZ:I
...
.field public final jmd:Z

.field public final jme:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/speech/audio/ai;->jlY:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public constructor <init>(IIIZLcom/google/android/apps/gsa/speech/audio/aj;Z)V
    ...
    .line 3
    iput-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmg:Z

    .line 4
    iput-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->mStarted:Z

    .line 5
    iput p1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->hLF:I

    .line 6
    iput p3, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jma:I
    ...
    iput v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jlZ:I

    .line 10
    iput-boolean p4, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmd:Z

    .line 11
    if-eqz p5, :cond_0

    :goto_0
    iput-object p5, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmb:Lcom/google/android/apps/gsa/speech/audio/aj;

    .line 12
    iput-boolean p6, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmc:Z

    .line 13
    sget-object v0, Lcom/google/android/apps/gsa/speech/audio/ai;->jlY:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jme:Ljava/lang/String;
...
.method public aIX()Landroid/media/AudioRecord;
    .locals 8
    ...
    .line 16
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmc:Z
    ...
    iget v2, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->hLF:I

    iget v3, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jma:I

    const/4 v4, 0x2

    iget v5, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jlZ:I
...
.method protected final aIY()Landroid/media/AudioRecord;
    .locals 8
    ...
    .line 27
    iget-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmf:Landroid/media/AudioRecord;

    .line 28
    iget-boolean v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmg:Z
    ...
    .line 33
    iget-object v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmb:Lcom/google/android/apps/gsa/speech/audio/aj;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jme:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/google/android/apps/gsa/speech/audio/aj;->jM(Ljava/lang/String;)V
    ...
    .line 36
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aIX()Landroid/media/AudioRecord;

    move-result-object v0

    .line 37
    iput-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmf:Landroid/media/AudioRecord;

    .line 38
    iput-boolean v4, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmg:Z
    ...
    .line 41
    :cond_4
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aIV()V
...
.method public close()V
    ...
    .prologue
    .line 75
    iget-object v0, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jmb:Lcom/google/android/apps/gsa/speech/audio/aj;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/speech/audio/ai;->jme:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/google/android/apps/gsa/speech/audio/aj;->jN(Ljava/lang/String;)V
    ...
    .line 82
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aIW()V
...
.method public read([BII)I
    ...
    .line 61
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/speech/audio/ai;->aIY()Landroid/media/AudioRecord;
