...
# static fields
.field public static final idA:Z

.field public static final idB:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/google/android/apps/gsa/shared/util/by;->idA:Z
    ...
    sput-object v0, Lcom/google/android/apps/gsa/shared/util/by;->idB:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;Landroid/webkit/WebView;Z)V
    .locals 5
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;->dumpValue(Lcom/google/android/apps/gsa/shared/util/common/Redactable;)V
    ...
    .line 32
    const-string v0, "Visual X"

    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;->forKey(Ljava/lang/String;)Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper$ValueDumper;

    move-result-object v0

    invoke-virtual {p1}, Landroid/webkit/WebView;->getX()F
    ...
    .line 33
    const-string v0, "Visual Y"

    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper;->forKey(Ljava/lang/String;)Lcom/google/android/apps/gsa/shared/util/debug/dump/Dumper$ValueDumper;

    move-result-object v0

    invoke-virtual {p1}, Landroid/webkit/WebView;->getY()F
    ...
    .line 36
    invoke-virtual {p1}, Landroid/webkit/WebView;->getTranslationX()F
    ...
    .line 39
    invoke-virtual {p1}, Landroid/webkit/WebView;->getTranslationY()F
    ...
    invoke-virtual {p1}, Landroid/webkit/WebView;->getScaleX()F
    ...
    invoke-virtual {p1}, Landroid/webkit/WebView;->getScaleY()F
    ...
    .line 49
    :goto_2
    const-string/jumbo v1, "translated off screen"
    ...
    .line 53
    const-string v0, "layout params height"
    ...
    .line 56
    const-string v0, "layout params width"
    ...
    .line 66
    const-string v1, "Failed to dump WebView"
...
.method public static bc(Landroid/content/Context;)Landroid/webkit/WebView;
    .locals 3
...
.method public static d(Landroid/content/Context;Landroid/util/AttributeSet;I)Landroid/webkit/WebView;
    .locals 3
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
