...
.field public cyU:Landroid/content/SharedPreferences;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/libraries/c/a;Lcom/google/android/apps/gsa/search/core/config/x;)V
    ...
    iput-wide v0, p0, Lcom/google/android/apps/gsa/now/f;->cXb:J

    .line 4
    const/4 v0, 0x0

    iput v0, p0, Lcom/google/android/apps/gsa/now/f;->cXc:I

    .line 5
    iput-object p1, p0, Lcom/google/android/apps/gsa/now/f;->mContext:Landroid/content/Context;

    .line 6
    iput-object p2, p0, Lcom/google/android/apps/gsa/now/f;->blV:Lcom/google/android/libraries/c/a;

    .line 7
    iput-object p3, p0, Lcom/google/android/apps/gsa/now/f;->cWU:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 8
    return-void
.end method

.method private final bw(Ljava/lang/String;)Z
    .locals 4
    ...
    .line 48
    iget-object v2, p0, Lcom/google/android/apps/gsa/now/f;->cWU:Lcom/google/android/apps/gsa/search/core/config/x;

    .line 49
    sget v3, Lcom/google/android/apps/gsa/search/core/config/u;->eiE:I
...
.method public final bv(Ljava/lang/String;)J
    ...
    .line 10
    sget v3, Lcom/google/android/apps/gsa/search/core/config/u;->eiF:I
    ...
    .line 15
    :try_start_0
    iget-object v2, p0, Lcom/google/android/apps/gsa/now/f;->cyU:Landroid/content/SharedPreferences;
    ...
    .line 17
    sget v3, Lcom/google/android/apps/gsa/search/core/config/w;->ejy:I
    ...
    iput-wide v4, p0, Lcom/google/android/apps/gsa/now/f;->cXb:J

    .line 24
    iput v2, p0, Lcom/google/android/apps/gsa/now/f;->cXc:I
    :try_end_1
    ...
    iput-object v2, p0, Lcom/google/android/apps/gsa/now/f;->cyU:Landroid/content/SharedPreferences;

    .line 29
    :cond_2
    iget-object v9, p0, Lcom/google/android/apps/gsa/now/f;->cyU:Landroid/content/SharedPreferences;

    .line 30
    iget-object v2, p0, Lcom/google/android/apps/gsa/now/f;->blV:Lcom/google/android/libraries/c/a;
    ...
    .line 35
    iget-wide v10, p0, Lcom/google/android/apps/gsa/now/f;->cXb:J
    ...
    .line 37
    iget v3, p0, Lcom/google/android/apps/gsa/now/f;->cXc:I

    if-lt v2, v3, :cond_5

    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/now/f;->bw(Ljava/lang/String;)Z
    ...
    .line 38
    iget-wide v0, p0, Lcom/google/android/apps/gsa/now/f;->cXb:J
