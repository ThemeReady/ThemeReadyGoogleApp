...
.field public eTW:Landroid/os/PowerManager;

.field public eTX:Landroid/app/KeyguardManager;

.field public eTY:Lb/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb/a",
            "<",
...
.field public eUb:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUb:Ljava/util/List;
...
.method protected final av(Ljava/util/List;)V
    ...
    .line 54
    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTW:Landroid/os/PowerManager;
    ...
    .line 56
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTX:Landroid/app/KeyguardManager;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .prologue
    .line 60
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUb:Ljava/util/List;

    invoke-static {v0}, Ljava/lang/String;->valueOf(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v0

    iget-boolean v1, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUc:Z
...
.method final f(Landroid/content/Context;Z)V
    ...
    .prologue
    .line 62
    iput-boolean p2, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUc:Z
...
.method final g(Landroid/content/Context;Z)V
    ...
    .line 69
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->cJb:Lcom/google/android/apps/gsa/shared/y/a;

    invoke-virtual {v0}, Lcom/google/android/apps/gsa/shared/y/a;->avX()I
    ...
    .line 71
    iget-object v1, v0, Lcom/google/android/apps/gsa/shared/y/a;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput v2, v0, Lcom/google/android/apps/gsa/shared/y/a;->hMc:I
    ...
    .line 74
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTZ:Lb/a;
    ...
    .line 75
    iget-object v1, v0, Lcom/google/android/apps/gsa/speech/microdetection/j;->cfb:Lb/a;
    ...
    .line 79
    iget-object v0, v0, Lcom/google/android/apps/gsa/speech/microdetection/j;->cfb:Lb/a;
...
.method public onCreate()V
    ...
    .line 7
    invoke-static {p0}, Lcom/google/android/apps/gsa/speech/h/b;->bE(Landroid/content/Context;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTV:Z
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTW:Landroid/os/PowerManager;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTX:Landroid/app/KeyguardManager;
...
.method public onDestroy()V
    ...
    .prologue
    .line 11
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUa:Z
    ...
    iput-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUa:Z
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 16
    .line 17
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTV:Z
    ...
    .line 19
    :cond_2
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eTY:Lb/a;
    ...
    .line 32
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->bSD:Lb/a;
    ...
    .line 41
    iput-boolean v2, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUa:Z

    .line 42
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->eUb:Ljava/util/List;

    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->av(Ljava/util/List;)V

    .line 43
    :cond_8
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/BroadcastListenerService;->cDk:Lb/a;
