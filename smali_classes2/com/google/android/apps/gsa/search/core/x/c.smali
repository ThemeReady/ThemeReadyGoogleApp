.class public Lcom/google/android/apps/gsa/search/core/x/c;
...
.field public final cxC:Lcom/google/android/apps/gsa/configuration/c;
...
.field public final gjR:Lcom/google/android/apps/gsa/search/core/h;
...
.method public constructor <init>(Landroid/content/Context;Lh/a/a;Landroid/content/SharedPreferences;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;Lb/a;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;ILcom/google/android/apps/gsa/configuration/c;Lcom/google/android/apps/gsa/tasks/j;Lb/a;Lb/a;Lcom/google/android/apps/gsa/search/core/h;Lb/a;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->mContext:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/x/c;->bMl:Lh/a/a;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fKY:Landroid/content/SharedPreferences;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cyJ:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;

    .line 6
    iput-object p5, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gkd:Lb/a;

    .line 7
    iput-object p6, p0, Lcom/google/android/apps/gsa/search/core/x/c;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;

    .line 8
    iput p7, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gke:I

    .line 9
    iput-object p8, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cxC:Lcom/google/android/apps/gsa/configuration/c;

    .line 10
    iput-object p9, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cvL:Lcom/google/android/apps/gsa/tasks/j;

    .line 11
    iput-object p10, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fgA:Lb/a;

    .line 12
    iput-object p11, p0, Lcom/google/android/apps/gsa/search/core/x/c;->eUj:Lb/a;

    .line 13
    iput-object p12, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gjR:Lcom/google/android/apps/gsa/search/core/h;

    .line 14
    iput-object p13, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fjO:Lb/a;
...
.method public final d(IZZ)V
    ...
    .line 16
    const-class v3, Lcom/google/android/apps/gsa/search/core/x/c;
    ...
    .line 18
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gkd:Lb/a;
    ...
    .line 19
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->eUj:Lb/a;
    ...
    .line 21
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cvL:Lcom/google/android/apps/gsa/tasks/j;
    ...
    .line 28
    :goto_1
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gjR:Lcom/google/android/apps/gsa/search/core/h;

    const-wide/16 v6, 0x0

    invoke-virtual {v4, v6, v7}, Lcom/google/android/apps/gsa/search/core/h;->R(J)V

    .line 29
    const-string/jumbo v4, "refresh_now_configuration"
    ...
    const-string/jumbo v5, "refresh_now_configuration"
    ...
    .line 35
    :goto_3
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cxC:Lcom/google/android/apps/gsa/configuration/c;
    ...
    .line 36
    const-string/jumbo v4, "refresh_auth_tokens"
    ...
    .line 37
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fgA:Lb/a;
    ...
    invoke-interface {v1, v4}, Lcom/google/android/apps/gsa/tasks/b;->oe(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 40
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cyJ:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    :cond_0
    :goto_4
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fjO:Lb/a;
    ...
    invoke-interface {v1}, Lcom/google/android/apps/gsa/search/core/p/a/c;->RH()V
    ...
    .line 47
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cvL:Lcom/google/android/apps/gsa/tasks/j;
    ...
    .line 50
    invoke-virtual {v5, v6}, Lcom/google/android/apps/gsa/tasks/b/c;->lb(Z)Lcom/google/android/apps/gsa/tasks/b/c;
    ...
    .line 51
    invoke-virtual {v5, v6}, Lcom/google/android/apps/gsa/tasks/b/c;->la(Z)Lcom/google/android/apps/gsa/tasks/b/c;
    ...
    .line 66
    :goto_7
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/x/c;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 73
    invoke-interface {v1, v6}, Lcom/google/android/apps/gsa/tasks/at;->oj(Ljava/lang/String;)Z
    ...
    .line 75
    invoke-virtual {v0, v4, v5}, Lcom/google/android/apps/gsa/tasks/b/c;->cI(J)Lcom/google/android/apps/gsa/tasks/b/c;
    ...
    invoke-virtual {v0, v4, v5}, Lcom/google/android/apps/gsa/tasks/b/c;->cJ(J)Lcom/google/android/apps/gsa/tasks/b/c;
    ...
    sget-object v5, Lcom/google/android/apps/gsa/search/core/google/e/a/c;->flB:Lcom/google/ac/a/g;

    .line 81
    invoke-virtual {v4, v5, v0}, Lcom/google/android/apps/gsa/tasks/b/g;->setExtension(Lcom/google/ac/a/g;Ljava/lang/Object;)Lcom/google/ac/a/f;
    ...
    .line 82
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cvL:Lcom/google/android/apps/gsa/tasks/j;
    ...
    :cond_1
    :goto_8
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->fKY:Landroid/content/SharedPreferences;
    ...
    iget v4, p0, Lcom/google/android/apps/gsa/search/core/x/c;->gke:I
    ...
    .line 93
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->bMl:Lh/a/a;
    ...
    const-string/jumbo v4, "ram_mb"

    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->mContext:Landroid/content/Context;
    ...
    .line 104
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/x/c;->cyJ:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;

    new-instance v1, Lcom/google/android/apps/gsa/search/core/x/d;
    ...
    invoke-direct {v1, p0, v2, v4, v5}, Lcom/google/android/apps/gsa/search/core/x/d;-><init>(Lcom/google/android/apps/gsa/search/core/x/c;Ljava/lang/String;II)V
    ...
    invoke-interface {v0, v4}, Lcom/google/android/apps/gsa/tasks/bk;->on(Ljava/lang/String;)V
    ...
    .line 42
    :cond_8
    const-string/jumbo v1, "refresh_auth_tokens"
