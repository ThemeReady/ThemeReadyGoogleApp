...
# direct methods
.method constructor <init>(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/search/core/work/am/a;Lcom/google/android/apps/gsa/shared/velour/b/a;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->eEF:Lcom/google/android/apps/gsa/search/core/work/am/a;

    .line 3
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->bvQ:Lcom/google/android/apps/gsa/shared/velour/b/a;

    .line 4
    iput-object p4, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->eFI:Ljava/lang/String;
...
.method protected synthetic createControllerScopeFromResource(Ljava/lang/Object;)Lcom/google/android/libraries/gsa/monet/service/AbstractControllerScope;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->bvQ:Lcom/google/android/apps/gsa/shared/velour/b/a;
...
.method protected getResourceLoadingFuture()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 6
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->eEF:Lcom/google/android/apps/gsa/search/core/work/am/a;

    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->eFI:Ljava/lang/String;

    invoke-interface {v0, v1}, Lcom/google/android/apps/gsa/search/core/work/am/a;->eD(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method protected resourceLoadFailure(Ljava/lang/Throwable;)V
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/monet/f/a;->eFI:Ljava/lang/String;
