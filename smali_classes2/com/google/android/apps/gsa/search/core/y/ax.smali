.class public Lcom/google/android/apps/gsa/search/core/y/ax;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lcom/google/android/apps/gsa/assistant/shared/k;Lb/a;Lcom/google/android/apps/gsa/assistant/shared/h;Lcom/google/android/apps/gsa/handsfree/o;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->mContext:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->cok:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->bLh:Lcom/google/android/apps/gsa/assistant/shared/k;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->bro:Lb/a;

    .line 6
    iput-object p5, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->eWo:Lcom/google/android/apps/gsa/assistant/shared/h;

    .line 7
    iput-object p6, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->cFY:Lcom/google/android/apps/gsa/handsfree/o;
...
.method public final a(ZZZZZZLandroid/net/Uri;I)Lcom/google/android/apps/gsa/shared/search/Query;
    ...
    .line 9
    invoke-virtual {p0, p3, p4}, Lcom/google/android/apps/gsa/search/core/y/ax;->q(ZZ)Z
    ...
    .line 11
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->bLh:Lcom/google/android/apps/gsa/assistant/shared/k;
    ...
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/search/core/y/ax;->acY()Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->cok:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/shared/search/Query;->atg()Lcom/google/android/apps/gsa/shared/search/Query;
    ...
    .line 25
    :cond_5
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->bLh:Lcom/google/android/apps/gsa/assistant/shared/k;
    ...
    .line 35
    invoke-virtual {v0, v4}, Lcom/google/android/apps/gsa/shared/search/Query;->kR(I)Lcom/google/android/apps/gsa/shared/search/Query;
...
.method public final d(Lcom/google/android/apps/gsa/shared/search/Query;I)Lcom/google/android/apps/gsa/shared/search/Query;
    ...
    .line 44
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->bro:Lb/a;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->eWo:Lcom/google/android/apps/gsa/assistant/shared/h;
    ...
    .line 48
    :cond_2
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->mContext:Landroid/content/Context;
    ...
    .line 62
    :goto_1
    iget-object v4, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->cFY:Lcom/google/android/apps/gsa/handsfree/o;

    iget-object v5, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/search/core/y/ax;->mContext:Landroid/content/Context;
    ...
    .line 69
    iput-boolean v6, v1, Lcom/google/android/apps/gsa/search/shared/actions/util/TtsRequest;->gwO:Z
