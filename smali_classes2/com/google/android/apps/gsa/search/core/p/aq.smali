.class Lcom/google/android/apps/gsa/search/core/p/aq;
.super Lio/grpc/f;
.source "SourceFile"
...
# instance fields
.field public final fpf:Lcom/google/android/apps/gsa/shared/io/ae;

.field public final fpg:Lio/grpc/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/grpc/f",
            "<TRespT;>;"
...
# direct methods
.method public constructor <init>(Lio/grpc/f;Lcom/google/android/apps/gsa/shared/io/ae;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpg:Lio/grpc/f;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpf:Lcom/google/android/apps/gsa/shared/io/ae;
...
.method public final a(Lio/grpc/Metadata;)V
    ...
    .prologue
    .line 5
    invoke-static {p1}, Lcom/google/android/apps/gsa/shared/io/ae;->b(Lio/grpc/Metadata;)Ljava/util/List;

    move-result-object v0

    .line 6
    iget-object v1, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpf:Lcom/google/android/apps/gsa/shared/io/ae;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/apps/gsa/shared/io/ae;->c(Lcom/google/android/apps/gsa/shared/io/HttpResponseData;)V

    .line 7
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpg:Lio/grpc/f;
...
.method public final a(Lio/grpc/Status;Lio/grpc/Metadata;)V
    ...
    .line 15
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpf:Lcom/google/android/apps/gsa/shared/io/ae;

    invoke-virtual {v0}, Lcom/google/android/apps/gsa/shared/io/ae;->aqS()V
    ...
    .line 17
    instance-of v0, v1, Lorg/chromium/net/aj;
    ...
    .line 51
    iget-object v2, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpg:Lio/grpc/f;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/apps/gsa/shared/io/ae;->a(Lcom/google/android/apps/gsa/shared/exception/GsaIOException;)V
...
.method public final az(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/google/android/apps/gsa/shared/io/ae;->aL(J)V

    .line 11
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/p/aq;->fpg:Lio/grpc/f;

    invoke-virtual {v0, p1}, Lio/grpc/f;->az(Ljava/lang/Object;)V
