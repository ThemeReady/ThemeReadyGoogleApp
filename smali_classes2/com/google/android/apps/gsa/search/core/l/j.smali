.class Lcom/google/android/apps/gsa/search/core/l/j;
...
.field public final fcM:Lcom/google/android/apps/gsa/search/core/y/k;

.field public final fcw:I


# direct methods
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/util/ag;ILcom/google/android/apps/gsa/search/core/y/k;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcL:Lcom/google/android/apps/gsa/shared/util/ag;

    .line 3
    iput p2, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcw:I

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcM:Lcom/google/android/apps/gsa/search/core/y/k;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcM:Lcom/google/android/apps/gsa/search/core/y/k;
    ...
    .line 8
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcL:Lcom/google/android/apps/gsa/shared/util/ag;
    ...
    :cond_0
    :try_start_1
    iget v1, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcw:I
    ...
    .line 11
    :goto_0
    iget v4, p0, Lcom/google/android/apps/gsa/search/core/l/j;->fcw:I
    :try_end_1
    ...
    :goto_1
    :try_start_4
    invoke-virtual {v2, v0}, Lcom/google/android/apps/gsa/search/core/l/v;->c(Lcom/google/android/apps/gsa/shared/exception/GsaError;)Z
    :try_end_4
    ...
    .line 37
    invoke-virtual {v2, v3}, Lcom/google/android/apps/gsa/search/core/l/v;->c(Lcom/google/android/apps/gsa/shared/exception/GsaError;)Z
    ...
    .line 22
    :try_start_7
    invoke-virtual {v2, v3, v1}, Lcom/google/android/apps/gsa/search/core/l/v;->g([BI)V
    ...
    :cond_2
    :try_start_9
    invoke-virtual {v2}, Lcom/google/android/apps/gsa/search/core/l/v;->PF()Z
    :try_end_9
