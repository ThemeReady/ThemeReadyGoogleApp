...
.field public final omA:Lcom/google/android/apps/gsa/search/core/ag;

.field public omB:Lcom/google/android/apps/gsa/s/c/f;

.field public volatile omC:Lcom/google/android/apps/gsa/shared/util/concurrent/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final omD:Ljava/lang/Object;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/search/core/config/q;Landroid/content/res/Resources;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;Lcom/google/android/apps/gsa/search/core/ag;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->omD:Ljava/lang/Object;

    .line 3
    iput-object p1, p0, Lcom/google/android/apps/gsa/s/c/a;->eev:Lcom/google/android/apps/gsa/search/core/config/q;

    .line 4
    iput-object p2, p0, Lcom/google/android/apps/gsa/s/c/a;->mResources:Landroid/content/res/Resources;

    .line 5
    iput-object p3, p0, Lcom/google/android/apps/gsa/s/c/a;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;

    .line 6
    iput-object p4, p0, Lcom/google/android/apps/gsa/s/c/a;->omA:Lcom/google/android/apps/gsa/search/core/ag;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->cDM:Ljava/util/concurrent/CopyOnWriteArrayList;

    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
    ...
    .line 11
    iput-object v2, p0, Lcom/google/android/apps/gsa/s/c/a;->omC:Lcom/google/android/apps/gsa/shared/util/concurrent/k;

    .line 12
    return-void
.end method

.method private static a(Ljava/lang/String;Lcom/google/ay/c/b/a/i;Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt$Editor;)V
    .locals 1
...
.method public static a(Lcom/google/android/apps/gsa/s/c/f;Landroid/content/res/Resources;)Z
    ...
    .line 52
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;
    ...
    .line 65
    :cond_5
    invoke-static {p1}, Lcom/google/android/apps/gsa/s/c/a;->j(Landroid/content/res/Resources;)Lcom/google/ay/c/b/a/i;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;

    .line 66
    const-string v0, "2013_10_04_22_22_03"

    iput-object v0, p0, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;
...
.method private final a(Lc/a;Ljava/lang/String;)[B
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static aB([B)Lcom/google/ay/c/b/a/i;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lcom/google/ay/c/b/a/i;->cd([B)Lcom/google/ay/c/b/a/i;
    :try_end_0
...
.method private final bnj()Lcom/google/ay/c/b/a/i;
    .locals 4
    ...
    .line 42
    :try_start_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/s/c/a;->bni()Lcom/google/android/apps/gsa/shared/util/concurrent/k;
...
.method private static j(Landroid/content/res/Resources;)Lcom/google/ay/c/b/a/i;
    .locals 4
    ...
    .line 69
    :try_start_0
    sget v0, Lcom/google/android/apps/gsa/s/c/h;->omM:I
    ...
    .line 70
    invoke-static {v1}, Lcom/google/common/i/k;->q(Ljava/io/InputStream;)[B

    move-result-object v0

    .line 71
    invoke-static {v0}, Lcom/google/ay/c/b/a/i;->cd([B)Lcom/google/ay/c/b/a/i;
    :try_end_0
...
.method public final a(Lcom/google/android/apps/gsa/s/c/f;)V
    ...
    .line 87
    .line 88
    iget-object v0, p1, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;

    if-nez v0, :cond_0

    iget-object v0, p1, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;

    .line 89
    :goto_0
    iget-object v1, p1, Lcom/google/android/apps/gsa/s/c/f;->omL:Lcom/google/ay/c/b/a/i;

    if-nez v1, :cond_1

    .line 100
    :goto_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/s/c/a;->omD:Ljava/lang/Object;

    monitor-enter v1

    .line 101
    :try_start_0
    iput-object p1, p0, Lcom/google/android/apps/gsa/s/c/a;->omB:Lcom/google/android/apps/gsa/s/c/f;

    .line 102
    iput-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->bWp:Lcom/google/ay/c/b/a/i;
    ...
    .line 91
    :cond_1
    new-instance v1, Lcom/google/ay/c/b/a/i;

    invoke-direct {v1}, Lcom/google/ay/c/b/a/i;-><init>()V
    ...
    .line 96
    invoke-static {v1, v0}, Lcom/google/android/apps/gsa/shared/util/aq;->b(Lcom/google/protobuf/a/p;Lcom/google/protobuf/a/p;)Lcom/google/protobuf/a/p;
...
.method final a(Lcom/google/android/apps/gsa/s/c/f;Lc/a;)Z
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 104
    iget-object v3, p0, Lcom/google/android/apps/gsa/s/c/a;->omA:Lcom/google/android/apps/gsa/search/core/ag;
    ...
    .line 106
    iget-object v4, p1, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;
    ...
    .line 107
    iput-object v2, p1, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;

    .line 108
    iput-object v2, p1, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;
    ...
    .line 115
    :cond_2
    iget-object v4, p0, Lcom/google/android/apps/gsa/s/c/a;->omA:Lcom/google/android/apps/gsa/search/core/ag;
    ...
    .line 119
    :cond_4
    invoke-static {v4}, Lcom/google/android/apps/gsa/s/c/a;->mM(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 123
    :cond_5
    iget-object v7, p1, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;
    ...
    .line 138
    invoke-direct {p0, p2, v2}, Lcom/google/android/apps/gsa/s/c/a;->a(Lc/a;Ljava/lang/String;)[B
    ...
    :cond_9
    :try_start_0
    invoke-static {v4}, Lcom/google/ay/c/b/a/i;->cd([B)Lcom/google/ay/c/b/a/i;
    ...
    .line 144
    iput-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;

    .line 145
    iput-object v4, p1, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;
    :try_end_0
    .catch Lcom/google/protobuf/a/o; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v2}, Lcom/google/protobuf/a/o;->toString()Ljava/lang/String;
    ...
    :cond_a
    :try_start_1
    invoke-static {v2}, Lcom/google/android/apps/gsa/s/c/a;->mM(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p1, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;

    .line 147
    iput-object v4, p1, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;
    :try_end_1
...
.method final afj()V
    ...
    .line 16
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->omD:Ljava/lang/Object;
    ...
    .line 18
    :try_start_0
    iget-object v2, p0, Lcom/google/android/apps/gsa/s/c/a;->bWp:Lcom/google/ay/c/b/a/i;
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->cDM:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 22
    invoke-interface {v0, v2}, Lcom/google/android/apps/gsa/s/c/k;->d(Lcom/google/ay/c/b/a/i;)V
...
.method public final b(Lcom/google/android/apps/gsa/s/c/f;)V
    ...
    .line 205
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->eev:Lcom/google/android/apps/gsa/search/core/config/q;
    ...
    iget-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;

    invoke-static {v2, v3, v0}, Lcom/google/android/apps/gsa/s/c/a;->a(Ljava/lang/String;Lcom/google/ay/c/b/a/i;Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt$Editor;)V

    .line 208
    const-string v2, "gstatic_configuration_expriment_url"

    iget-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;
    ...
    iget-object v3, p1, Lcom/google/android/apps/gsa/s/c/f;->omL:Lcom/google/ay/c/b/a/i;
...
.method public final bnh()Lcom/google/ay/c/b/a/i;
    .locals 2

    .prologue
    .line 25
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->omC:Lcom/google/android/apps/gsa/shared/util/concurrent/k;
    ...
    .line 27
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->bWp:Lcom/google/ay/c/b/a/i;
    ...
    .line 30
    :cond_1
    invoke-direct {p0}, Lcom/google/android/apps/gsa/s/c/a;->bnj()Lcom/google/ay/c/b/a/i;
...
.method public final bni()Lcom/google/android/apps/gsa/shared/util/concurrent/k;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 37
    iget-object v2, p0, Lcom/google/android/apps/gsa/s/c/a;->omC:Lcom/google/android/apps/gsa/shared/util/concurrent/k;

    iget-object v3, p0, Lcom/google/android/apps/gsa/s/c/a;->cvs:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;
...
.method public final bnk()Lcom/google/android/apps/gsa/s/c/f;
    .locals 5
    ...
    .line 179
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/s/c/a;->omB:Lcom/google/android/apps/gsa/s/c/f;
    ...
    .line 181
    iget-object v2, p0, Lcom/google/android/apps/gsa/s/c/a;->omB:Lcom/google/android/apps/gsa/s/c/f;

    .line 182
    iget-object v3, v2, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;

    iput-object v3, v0, Lcom/google/android/apps/gsa/s/c/f;->omH:Ljava/lang/String;

    .line 183
    iget-object v3, v2, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;

    iput-object v3, v0, Lcom/google/android/apps/gsa/s/c/f;->omI:Lcom/google/ay/c/b/a/i;

    .line 184
    iget-object v3, v2, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;

    iput-object v3, v0, Lcom/google/android/apps/gsa/s/c/f;->omJ:Ljava/lang/String;

    .line 185
    iget-object v3, v2, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;

    iput-object v3, v0, Lcom/google/android/apps/gsa/s/c/f;->omK:Lcom/google/ay/c/b/a/i;

    .line 186
    iget-object v2, v2, Lcom/google/android/apps/gsa/s/c/f;->omL:Lcom/google/ay/c/b/a/i;

    iput-object v2, v0, Lcom/google/android/apps/gsa/s/c/f;->omL:Lcom/google/ay/c/b/a/i;
    ...
    invoke-static {v3}, Lcom/google/android/apps/gsa/s/c/a;->aB([B)Lcom/google/ay/c/b/a/i;
    ...
    invoke-static {v2}, Lcom/google/android/apps/gsa/s/c/a;->aB([B)Lcom/google/ay/c/b/a/i;
...
.method public final g(Lc/a;)V
    ...
    .line 79
    :try_start_0
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/s/c/a;->bnk()Lcom/google/android/apps/gsa/s/c/f;

    move-result-object v0

    .line 80
    invoke-virtual {p0, v0, p1}, Lcom/google/android/apps/gsa/s/c/a;->a(Lcom/google/android/apps/gsa/s/c/f;Lc/a;)Z
    ...
    .line 85
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/s/c/a;->afj()V
