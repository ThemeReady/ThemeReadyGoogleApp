...
.super Lcom/google/android/gearhead/sdk/assistant/j;
.source "SourceFile"


# instance fields
.field public final synthetic eIM:Lcom/google/android/apps/gsa/projection/CarAssistantService;
...
.method constructor <init>(Lcom/google/android/apps/gsa/projection/CarAssistantService;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/projection/e;->eIM:Lcom/google/android/apps/gsa/projection/CarAssistantService;

    invoke-direct {p0}, Lcom/google/android/gearhead/sdk/assistant/j;-><init>()V
...
.method private final a(Lcom/google/android/gearhead/sdk/assistant/f;II)Lcom/google/android/gearhead/sdk/assistant/d;
    ...
    const-string/jumbo v1, "registerClient(): API version: %d, UI mode: %d"
    ...
    .line 6
    iget-object v0, p0, Lcom/google/android/apps/gsa/projection/e;->eIM:Lcom/google/android/apps/gsa/projection/CarAssistantService;

    iget-object v0, v0, Lcom/google/android/apps/gsa/projection/CarAssistantService;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    const-string/jumbo v1, "registerClient() called when protocol disabled"
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/projection/CarAssistantService;->Me()Ljava/lang/String;
    ...
    iget-object v8, v0, Lcom/google/android/apps/gsa/projection/CarAssistantService;->btg:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;
...
# virtual methods
.method public final Mf()Lcom/google/android/gearhead/sdk/assistant/SupportedVersionInfo;
    .locals 2
    ...
    iput v1, v0, Lcom/google/android/gearhead/sdk/assistant/SupportedVersionInfo;->pVf:I

    .line 25
    const/4 v1, 0x2

    iput v1, v0, Lcom/google/android/gearhead/sdk/assistant/SupportedVersionInfo;->pVg:I
...
.method public final a(Lcom/google/android/gearhead/sdk/assistant/f;Lcom/google/android/gearhead/sdk/assistant/ClientRegistrationConfig;)Lcom/google/android/gearhead/sdk/assistant/d;
    ...
    .line 4
    iget v0, p2, Lcom/google/android/gearhead/sdk/assistant/ClientRegistrationConfig;->kuw:I

    iget v1, p2, Lcom/google/android/gearhead/sdk/assistant/ClientRegistrationConfig;->bsF:I
