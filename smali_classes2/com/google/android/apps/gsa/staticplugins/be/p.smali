.class public Lcom/google/android/apps/gsa/staticplugins/be/p;
...
# instance fields
.field public final lhd:Lcom/google/android/apps/gsa/staticplugins/be/b/d;


# direct methods
.method public constructor <init>(Lcom/google/android/apps/gsa/staticplugins/be/b/d;)V
    .locals 2
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/be/p;->lhd:Lcom/google/android/apps/gsa/staticplugins/be/b/d;
...
.method public final aaR()V
    ...
    .line 4
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/be/p;->lhd:Lcom/google/android/apps/gsa/staticplugins/be/b/d;

    .line 5
    iget-object v1, v0, Lcom/google/android/apps/gsa/staticplugins/be/b/d;->jMS:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    sget-object v2, Lcom/google/android/apps/gsa/staticplugins/be/b/c;->lhk:Lcom/google/android/apps/gsa/store/AttributeId;
    ...
    invoke-static {v1}, Lcom/google/android/apps/gsa/taskgraph/Done;->m(Lcom/google/common/util/concurrent/ListenableFuture;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v1

    .line 10
    iget-object v2, v0, Lcom/google/android/apps/gsa/staticplugins/be/b/d;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v3, Lcom/google/android/apps/gsa/staticplugins/be/b/g;

    const-string v4, "notifyOnSrpSaved"

    const/4 v5, 0x2

    invoke-direct {v3, v0, v4, v5, v6}, Lcom/google/android/apps/gsa/staticplugins/be/b/g;-><init>(Lcom/google/android/apps/gsa/staticplugins/be/b/d;Ljava/lang/String;II)V
...
.method public final eE(Ljava/lang/String;)V
    ...
    .line 12
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/be/p;->lhd:Lcom/google/android/apps/gsa/staticplugins/be/b/d;

    .line 13
    iget-object v0, v1, Lcom/google/android/apps/gsa/staticplugins/be/b/d;->jMS:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    .line 16
    iget-object v2, v1, Lcom/google/android/apps/gsa/staticplugins/be/b/d;->jMS:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    .line 18
    iget-object v7, v1, Lcom/google/android/apps/gsa/staticplugins/be/b/d;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v0, Lcom/google/android/apps/gsa/staticplugins/be/b/f;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/gsa/staticplugins/be/b/f;-><init>(Lcom/google/android/apps/gsa/staticplugins/be/b/d;Ljava/lang/String;IILjava/lang/String;)V
