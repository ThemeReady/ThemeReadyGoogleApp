...
.method private final b(Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;Landroid/widget/RemoteViews;I)V
    ...
    .line 85
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->blO:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 89
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/d;->hGo:I

    invoke-virtual {p2, p3, v0}, Landroid/widget/RemoteViews;->setImageViewResource(II)V

    .line 91
    iget-object v0, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->hLf:Landroid/app/PendingIntent;
    ...
    .line 96
    :cond_1
    invoke-static {v4}, Lcom/google/android/apps/gsa/shared/t/c;->kj(I)Landroid/content/Intent;
    ...
    .line 98
    iget-object v2, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->hLa:Landroid/app/PendingIntent;
    ...
    .line 102
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->mContext:Landroid/content/Context;
...
.method public final a(Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;Landroid/widget/RemoteViews;IIII)Z
    ...
    .line 3
    invoke-virtual {p0, p5, p6}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->cq(II)Z
    ...
    .line 7
    iget-object v0, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->hKY:Ljava/lang/CharSequence;
    ...
    .line 16
    sget v3, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHq:I

    invoke-virtual {p0, p2, v3}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->a(Landroid/widget/RemoteViews;I)V

    .line 17
    const/16 v3, 0x32

    sget v4, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHr:I

    invoke-virtual {p0, p2, p6, v3, v4}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->a(Landroid/widget/RemoteViews;III)V

    .line 18
    sget v3, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHo:I
    ...
    .line 19
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHs:I
    ...
    .line 20
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHq:I
    ...
    .line 23
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHp:I

    invoke-static {p1, p2, v0}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->a(Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;Landroid/widget/RemoteViews;I)V

    .line 24
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHn:I

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->b(Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;Landroid/widget/RemoteViews;I)V

    .line 26
    iget-object v0, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->dQO:Lcom/google/q/b/c/eg;

    .line 27
    invoke-static {v0}, Lcom/google/common/base/ay;->j(Ljava/lang/Object;)Ljava/lang/Object;

    .line 30
    iget v0, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->hLg:I

    .line 33
    iget-object v1, p1, Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;->dQO:Lcom/google/q/b/c/eg;

    .line 35
    iget v1, v1, Lcom/google/q/b/c/eg;->bkq:I

    .line 37
    invoke-static {v0, v1, v2, p4, p3}, Lcom/google/android/apps/gsa/staticplugins/ce/b/h;->d(IIIII)V
    ...
    .line 42
    sget v3, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHK:I
    ...
    sget v4, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHM:I
    ...
    .line 48
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHL:I
    ...
    .line 55
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHJ:I

    invoke-static {p1, p2, v0}, Lcom/google/android/apps/gsa/staticplugins/ce/b/c;->a(Lcom/google/android/apps/gsa/sidekick/main/topdeck/Topdeck;Landroid/widget/RemoteViews;I)V

    .line 56
    sget v0, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHI:I
    ...
    .line 69
    invoke-static {v0, v3, v1, p4, p3}, Lcom/google/android/apps/gsa/staticplugins/ce/b/h;->d(IIIII)V

    goto :goto_1

    .line 51
    :cond_2
    sget v3, Lcom/google/android/apps/gsa/staticplugins/ce/b/e;->mHL:I
