...
.field public final jDT:Lcom/google/common/util/concurrent/cb;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/util/concurrent/cb",
            "<",
...
.method constructor <init>(Lcom/google/common/util/concurrent/cb;Lcom/google/common/util/concurrent/cb;Lcom/google/common/util/concurrent/cb;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDT:Lcom/google/common/util/concurrent/cb;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDN:Lcom/google/common/util/concurrent/cb;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDO:Lcom/google/common/util/concurrent/cb;
...
.method private static a(Lcom/google/common/util/concurrent/cb;Ljava/lang/Throwable;)V
    ...
    .line 24
    invoke-virtual {p0, p1}, Lcom/google/common/util/concurrent/d;->m(Ljava/lang/Throwable;)Z
...
.method public final a(Lcom/google/android/apps/gsa/shared/search/Query;Lcom/google/android/apps/gsa/search/core/l/ab;)V
    ...
    .prologue
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDN:Lcom/google/common/util/concurrent/cb;
...
.method public final a(Lcom/google/android/apps/gsa/shared/search/Query;Lcom/google/android/apps/gsa/search/shared/actions/SearchError;)V
    ...
    .line 15
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDT:Lcom/google/common/util/concurrent/cb;

    invoke-static {v1, v0}, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->a(Lcom/google/common/util/concurrent/cb;Ljava/lang/Throwable;)V

    .line 16
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDN:Lcom/google/common/util/concurrent/cb;

    invoke-static {v1, v0}, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->a(Lcom/google/common/util/concurrent/cb;Ljava/lang/Throwable;)V

    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDO:Lcom/google/common/util/concurrent/cb;
...
.method public final a(Lcom/google/android/apps/gsa/shared/search/Query;[B)V
    ...
    .prologue
    .line 21
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDO:Lcom/google/common/util/concurrent/cb;
...
.method public final m(Lcom/google/android/apps/gsa/shared/search/Query;)V
    ...
    .line 12
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/a/b/s;->jDT:Lcom/google/common/util/concurrent/cb;
