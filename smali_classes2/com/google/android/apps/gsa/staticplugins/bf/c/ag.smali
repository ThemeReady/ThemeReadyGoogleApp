.class public Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;
...
.field public final mrf:Lcom/google/m/b/d/ft;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lcom/google/m/b/d/ek;Lcom/google/m/b/d/hu;Lcom/google/android/apps/gsa/staticplugins/bf/a;Lcom/google/android/libraries/c/a;Lcom/google/android/apps/gsa/shared/v/a/a;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpd:Lcom/google/m/b/d/fs;
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mrf:Lcom/google/m/b/d/ft;
    ...
    iget-object v1, p1, Lcom/google/m/b/d/ek;->wpQ:Lcom/google/m/b/d/rb;

    :cond_0
    iput-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpk:Lcom/google/m/b/d/rb;
...
.method public final b(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mrf:Lcom/google/m/b/d/ft;
...
.method protected final bbp()I
    ...
    .line 90
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mrf:Lcom/google/m/b/d/ft;
...
.method public final bp(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    .line 8
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mog:Lcom/google/android/apps/gsa/sidekick/shared/util/bo;
    ...
    .line 11
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpd:Lcom/google/m/b/d/fs;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpd:Lcom/google/m/b/d/fs;

    invoke-virtual {v1}, Lcom/google/m/b/d/fs;->crP()Z
    ...
    .line 13
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpk:Lcom/google/m/b/d/rb;

    .line 14
    if-nez v1, :cond_8

    .line 16
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mog:Lcom/google/android/apps/gsa/sidekick/shared/util/bo;
    ...
    .line 18
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->mpd:Lcom/google/m/b/d/fs;
    ...
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->bmA:Lcom/google/android/libraries/c/a;
    ...
    .line 31
    sget v0, Lcom/google/android/apps/gsa/staticplugins/bf/c/z;->mqZ:I
    ...
    invoke-static {p1, v1, v2}, Lcom/google/android/apps/gsa/shared/aa/c;->b(Landroid/content/Context;IZ)Ljava/lang/String;
    ...
    .line 34
    :cond_4
    sget v4, Lcom/google/android/apps/gsa/staticplugins/bf/c/z;->mqX:I
    ...
    .line 43
    iget-wide v6, v5, Lcom/google/m/b/d/fs;->wsK:J
    ...
    .line 50
    :cond_8
    iget-wide v6, v1, Lcom/google/m/b/d/rb;->wNX:J
    ...
    .line 58
    :cond_9
    iget-object v0, v1, Lcom/google/m/b/d/rb;->wNW:Lcom/google/m/b/d/ra;
    ...
    .line 64
    iget-wide v4, v1, Lcom/google/m/b/d/rb;->wNX:J
    ...
    .line 68
    :cond_a
    sget v4, Lcom/google/android/apps/gsa/staticplugins/bf/c/z;->mqV:I
    ...
    .line 72
    invoke-static {p1, v6, v7, v3}, Lcom/google/android/apps/gsa/shared/aa/c;->a(Landroid/content/Context;JI)Ljava/lang/CharSequence;
...
.method public final br(Landroid/content/Context;)Landroid/support/v4/app/cr;
    ...
    .line 83
    invoke-virtual {p0, p1}, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->bp(Landroid/content/Context;)Ljava/lang/CharSequence;

    move-result-object v2

    .line 84
    invoke-virtual {v0, v2}, Landroid/support/v4/app/ch;->i(Ljava/lang/CharSequence;)Landroid/support/v4/app/ch;

    move-result-object v0

    .line 85
    invoke-virtual {v0, v1}, Landroid/support/v4/app/ch;->i(Ljava/lang/CharSequence;)Landroid/support/v4/app/ch;
...
.method public final c(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 88
    invoke-virtual {p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/bf/c/ag;->b(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
