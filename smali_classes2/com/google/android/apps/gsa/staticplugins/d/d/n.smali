...
.method constructor <init>(Lcom/google/android/apps/gsa/staticplugins/d/d/m;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/n;->ksn:Lcom/google/android/apps/gsa/staticplugins/d/d/m;
...
.method public run()V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/n;->ksn:Lcom/google/android/apps/gsa/staticplugins/d/d/m;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/n;->ksn:Lcom/google/android/apps/gsa/staticplugins/d/d/m;
    ...
    sget v4, Lcom/google/android/apps/gsa/staticplugins/d/d/b;->bwS:I
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/n;->ksn:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 11
    iget-object v1, v1, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->dcP:Landroid/net/Uri;
    ...
    sget v4, Lcom/google/android/apps/gsa/staticplugins/d/d/f;->krM:I
    ...
    .line 21
    iget-boolean v3, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->ksg:Z

    if-eqz v3, :cond_0

    iget-boolean v3, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->ksh:Z
    ...
    .line 26
    sget-object v4, Lcom/google/android/apps/gsa/assist/AssistEntryPoint;->bpC:Lcom/google/android/apps/gsa/shared/x/a;

    .line 27
    invoke-virtual {v4, v3}, Lcom/google/android/apps/gsa/shared/x/a;->T(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    sget v6, Lcom/google/android/apps/gsa/staticplugins/d/d/f;->krJ:I

    sget v7, Lcom/google/android/apps/gsa/staticplugins/d/d/c;->kry:I

    invoke-direct {v4, v3, v5, v6, v7}, Landroid/content/pm/LabeledIntent;-><init>(Landroid/content/Intent;Ljava/lang/String;II)V

    .line 30
    iget-object v3, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->krZ:Landroid/widget/ImageView;
    ...
    iget v6, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->ksk:I

    iget v7, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->hVZ:I

    invoke-direct {v5, v10, v10, v6, v7}, Landroid/graphics/Rect;-><init>(IIII)V

    .line 33
    iget-object v6, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->krZ:Landroid/widget/ImageView;
    ...
    .line 34
    iget-object v7, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->krZ:Landroid/widget/ImageView;
    ...
    .line 35
    iget v8, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->ksk:I
    ...
    iget v9, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->hVZ:I
    ...
    .line 39
    iget v7, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->ksk:I
    ...
    iget v7, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->nk:F
    ...
    .line 49
    sget-object v3, Lcom/google/android/apps/gsa/assist/AssistEntryPoint;->bpA:Lcom/google/android/apps/gsa/shared/x/a;

    .line 50
    invoke-virtual {v3, v1}, Lcom/google/android/apps/gsa/shared/x/a;->T(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    sget v6, Lcom/google/android/apps/gsa/staticplugins/d/d/f;->krI:I

    sget v7, Lcom/google/android/apps/gsa/staticplugins/d/d/c;->krx:I
