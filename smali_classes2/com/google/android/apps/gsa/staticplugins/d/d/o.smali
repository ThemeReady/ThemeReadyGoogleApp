...
.method constructor <init>(Lcom/google/android/apps/gsa/staticplugins/d/d/m;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;
...
.method public final a(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 3
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->aQA()V

    .line 4
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 5
    iput-object p1, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->kll:Landroid/graphics/Bitmap;

    .line 7
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 8
    iput-object p2, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->klm:Landroid/graphics/Rect;

    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 11
    iput-object p3, v0, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->bvu:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 21
    iget-object v1, v1, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->kll:Landroid/graphics/Bitmap;

    .line 22
    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 23
    iget-object v2, v2, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->klm:Landroid/graphics/Rect;

    .line 24
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/d/d/o;->kln:Lcom/google/android/apps/gsa/staticplugins/d/d/m;

    .line 25
    iget-object v3, v3, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->bvu:Landroid/graphics/Rect;
...
.method public final b(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    .line 31
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->aQz()V
    ...
    .line 36
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/staticplugins/d/d/m;->asl()Landroid/app/Activity;
