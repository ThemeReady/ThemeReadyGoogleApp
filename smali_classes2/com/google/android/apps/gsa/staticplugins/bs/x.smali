.class public Lcom/google/android/apps/gsa/staticplugins/bs/x;
...
.field public final mjF:Ljava/util/Map;
...
.field public final mjG:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public constructor <init>(Lcom/android/launcher3/compat/UserManagerCompat;Lcom/android/launcher3/compat/LauncherAppsCompat;Ljava/util/concurrent/Executor;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjD:Lcom/android/launcher3/compat/UserManagerCompat;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjE:Lcom/android/launcher3/compat/LauncherAppsCompat;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjG:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjF:Ljava/util/Map;

    .line 6
    new-instance v0, Lcom/google/android/apps/gsa/staticplugins/bs/y;

    invoke-direct {v0, p0}, Lcom/google/android/apps/gsa/staticplugins/bs/y;-><init>(Lcom/google/android/apps/gsa/staticplugins/bs/x;)V
...
.method private final a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .prologue
    .line 48
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjF:Ljava/util/Map;

    monitor-enter v1

    .line 49
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjF:Ljava/util/Map;
...
.method private final a([Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .line 45
    invoke-direct {p0, v2, p2}, Lcom/google/android/apps/gsa/staticplugins/bs/x;->a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
...
.method private final lf(Ljava/lang/String;)Z
    .locals 9
    ...
    .line 9
    sget-object v0, Lcom/google/android/apps/gsa/shared/r/a;->gOS:Ljava/util/regex/Pattern;
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjD:Lcom/android/launcher3/compat/UserManagerCompat;
    ...
    .line 24
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjE:Lcom/android/launcher3/compat/LauncherAppsCompat;
    ...
    .line 25
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bs/x;->mjG:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final ld(Ljava/lang/String;)Z
    ...
    .prologue
    .line 8
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/staticplugins/bs/x;->lf(Ljava/lang/String;)Z
...
.method public onPackageAdded(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .prologue
    .line 31
    invoke-direct {p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/bs/x;->a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
