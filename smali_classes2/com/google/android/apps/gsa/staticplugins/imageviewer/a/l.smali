...
.field public final kQH:Lcom/google/android/apps/gsa/shared/util/br;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final kQI:Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/m;

.field public kQJ:Landroid/net/Uri;

.field public mDrawable:Landroid/graphics/drawable/Drawable;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/br;Lcom/google/android/apps/gsa/search/core/google/cx;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->eVc:Lcom/google/android/apps/gsa/search/core/google/cx;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQH:Lcom/google/android/apps/gsa/shared/util/br;
    ...
    iput-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQI:Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/m;
    ...
    .line 7
    :goto_0
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQJ:Landroid/net/Uri;
    ...
    .line 5
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->eVc:Lcom/google/android/apps/gsa/search/core/google/cx;
...
.method public final b(Lcom/android/ex/photo/c/c;)V
    ...
    .line 27
    .line 28
    iget-boolean v0, p0, Landroid/support/v4/content/i;->uF:Z
...
.method public final onStartLoading()V
    ...
    .line 20
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQJ:Landroid/net/Uri;

    .line 21
    if-eqz v0, :cond_1

    .line 22
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQH:Lcom/google/android/apps/gsa/shared/util/br;

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQH:Lcom/google/android/apps/gsa/shared/util/br;

    .line 23
    invoke-virtual {v2, v0}, Lcom/google/android/apps/gsa/shared/util/br;->I(Landroid/net/Uri;)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v0

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/l;->kQI:Lcom/google/android/apps/gsa/staticplugins/imageviewer/a/m;
