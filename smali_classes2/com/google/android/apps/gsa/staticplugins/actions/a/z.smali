...
.field public final jJX:Lcom/google/android/apps/gsa/shared/util/az;

.field public final jJY:Lcom/google/android/apps/gsa/staticplugins/actions/a/aj;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/az;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lb/a;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/az;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lb/a;Lcom/google/android/apps/gsa/staticplugins/actions/a/aj;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->jJX:Lcom/google/android/apps/gsa/shared/util/az;

    .line 6
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->cok:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 8
    iput-object p5, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->czm:Lb/a;

    .line 9
    iput-object p6, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->jJY:Lcom/google/android/apps/gsa/staticplugins/actions/a/aj;
...
# virtual methods
.method final ay(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/apps/gsa/search/shared/actions/e;
    .locals 4

    .prologue
    .line 11
    invoke-virtual {p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->az(Ljava/lang/String;Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-static {v0}, Lcom/google/android/apps/gsa/search/shared/actions/e;->hZ(I)Lcom/google/android/apps/gsa/search/shared/actions/e;
...
.method final az(Ljava/lang/String;Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 21
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->cok:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    invoke-virtual {v5, v1}, Lcom/google/android/apps/gsa/staticplugins/actions/a/ag;->m(Ljava/lang/Runnable;)V
    ...
    .line 24
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->jJX:Lcom/google/android/apps/gsa/shared/util/az;

    .line 25
    iget-object v0, v0, Lcom/google/android/apps/gsa/shared/util/az;->icQ:Landroid/telephony/SmsManager;
    ...
    invoke-virtual {v5, v0}, Lcom/google/android/apps/gsa/staticplugins/actions/a/ag;->m(Ljava/lang/Runnable;)V
    ...
    .line 36
    :try_start_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actions/a/z;->jJY:Lcom/google/android/apps/gsa/staticplugins/actions/a/aj;
    ...
    .line 30
    invoke-virtual {v5}, Lcom/google/android/apps/gsa/staticplugins/actions/a/ag;->DP()V
    ...
    .line 62
    :goto_2
    iget-object v0, v6, Lcom/google/android/apps/gsa/staticplugins/actions/a/ah;->jKk:Lcom/google/common/util/concurrent/cb;
