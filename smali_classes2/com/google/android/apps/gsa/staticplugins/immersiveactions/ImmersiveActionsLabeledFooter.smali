...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    sget v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cp;->iZB:I

    iput v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jhR:I

    .line 3
    sget v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cp;->iZB:I

    iput v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jhS:I
...
.method protected final a(IILandroid/transition/TransitionSet;)V
    ...
    .line 36
    invoke-static {v0, v1, v3, v4}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/bs;->a(ZILandroid/util/DisplayMetrics;[Ljava/lang/Object;)Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;
...
.method public final a(ILcom/google/android/apps/gsa/search/shared/ui/actions/e;)V
    ...
    .line 14
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->aKC()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/dk;
    ...
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->iWE:Landroid/widget/TextView;
...
.method protected final aLg()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/dk;->aLI()Z
    ...
    .line 22
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->aLi()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
    ...
    :cond_0
    invoke-super {p0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/ModularActionCardLabeledFooter;->aLg()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
...
.method public final bM(II)Landroid/util/Pair;
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->iWE:Landroid/widget/TextView;

    aput-object v4, v2, v3

    const/4 v3, 0x2

    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jhO:Landroid/widget/TextView;

    aput-object v4, v2, v3

    const/4 v3, 0x3

    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->iWA:Landroid/widget/TextView;
