...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    sget v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cs;->jVd:I

    iput v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->kds:I

    .line 3
    sget v0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/cs;->jVd:I

    iput v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->kdt:I
...
.method protected final a(IILandroid/transition/TransitionSet;)V
    ...
    .line 36
    invoke-static {v0, v1, v3, v4}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/bv;->a(ZILandroid/util/DisplayMetrics;[Ljava/lang/Object;)Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/eh;
...
.method public final a(ILcom/google/android/apps/gsa/search/shared/ui/actions/e;)V
    ...
    .line 14
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->aOX()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/dk;
    ...
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jSt:Landroid/widget/TextView;
...
.method protected final aPB()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/dk;->aQd()Z
    ...
    .line 22
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->aPD()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
    ...
    :cond_0
    invoke-super {p0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/ModularActionCardLabeledFooter;->aPB()Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/as;
...
.method public final bR(II)Landroid/util/Pair;
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jSt:Landroid/widget/TextView;

    aput-object v4, v2, v3

    const/4 v3, 0x2

    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->kdp:Landroid/widget/TextView;

    aput-object v4, v2, v3

    const/4 v3, 0x3

    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/ImmersiveActionsLabeledFooter;->jSp:Landroid/widget/TextView;

    aput-object v4, v2, v3

    .line 28
    invoke-static {v1, v2}, Lcom/google/android/apps/gsa/staticplugins/immersiveactions/bv;->a(Landroid/content/res/Resources;[Ljava/lang/Object;)Landroid/transition/TransitionSet;
