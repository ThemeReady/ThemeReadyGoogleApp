.class public Lcom/google/android/apps/gsa/staticplugins/bq/h/d;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/store/ContentStore;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mXM:Lcom/google/android/apps/gsa/store/ContentStore;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
...
# virtual methods
.method public final LS()Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 7
    ...
    sget-object v5, Lcom/google/android/apps/gsa/staticplugins/bq/h/j;->mYM:Lcom/google/android/apps/gsa/staticplugins/bq/h/p;

    const-class v6, Lcom/google/n/b/c/dp;
...
.method public final LT()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 36
    invoke-static {}, Lcom/google/android/apps/gsa/staticplugins/bq/h/t;->bhQ()Ljava/lang/String;
    ...
    sget-object v2, Lcom/google/android/apps/gsa/staticplugins/bq/h/l;->mYM:Lcom/google/android/apps/gsa/staticplugins/bq/h/p;

    invoke-virtual {p0, v0, v1, v2}, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->a(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/apps/gsa/staticplugins/bq/h/p;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final LU()Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 39
    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mE(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final a(JLjava/lang/String;Lcom/google/android/apps/gsa/staticplugins/bq/h/p;Ljava/lang/Class;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
            ...
            ">(J",
            "Ljava/lang/String;",
            "Lcom/google/android/apps/gsa/staticplugins/bq/h/p",
            "<[BTT;",
    ...
    .prologue
    .line 48
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mXM:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    .line 52
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mXM:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    .line 54
    iget-object v7, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v0, Lcom/google/android/apps/gsa/staticplugins/bq/h/n;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/apps/gsa/staticplugins/bq/h/n;-><init>(Ljava/lang/String;IILjava/lang/Class;Lcom/google/android/apps/gsa/staticplugins/bq/h/p;)V
...
.method public final a(Lcom/google/android/apps/sidekick/c/a/a;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-virtual {p0, v1, v0, v2, v3}, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->a(Ljava/lang/String;[BJ)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final a(Lcom/google/n/b/c/dp;JLjava/util/concurrent/TimeUnit;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 17
    iget-wide v4, p1, Lcom/google/n/b/c/dp;->wbt:J

    .line 18
    invoke-static {v4, v5}, Lcom/google/common/o/i;->fn(J)[B

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/google/common/h/g;->bx([B)Lcom/google/common/h/d;
    ...
    sget-object v1, Lcom/google/android/apps/gsa/staticplugins/bq/h/r;->mZl:Lcom/google/android/apps/gsa/staticplugins/bq/h/r;
    ...
    .line 26
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mXM:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    new-instance v3, Lcom/google/android/apps/gsa/staticplugins/bq/h/o;

    invoke-direct {v3, v2}, Lcom/google/android/apps/gsa/staticplugins/bq/h/o;-><init>(Ljava/lang/Object;)V
...
.method public final a(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/apps/gsa/staticplugins/bq/h/p;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    new-instance v2, Lcom/google/android/apps/gsa/staticplugins/bq/h/m;

    const/4 v3, 0x1

    const/16 v4, 0x8

    invoke-direct {v2, p2, v3, v4, p3}, Lcom/google/android/apps/gsa/staticplugins/bq/h/m;-><init>(Ljava/lang/String;IILcom/google/android/apps/gsa/staticplugins/bq/h/p;)V
...
.method public final a(Ljava/lang/String;[BJ)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 42
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->eIh:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mXM:Lcom/google/android/apps/gsa/store/ContentStore;
    ...
    new-instance v2, Lcom/google/android/apps/gsa/staticplugins/bq/h/o;

    invoke-direct {v2, p1}, Lcom/google/android/apps/gsa/staticplugins/bq/h/o;-><init>(Ljava/lang/Object;)V
...
.method public final bhL()Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final ck(J)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)",
    ...
    sget-object v4, Lcom/google/android/apps/gsa/staticplugins/bq/h/q;->miM:Lcom/google/android/apps/gsa/store/AttributeId;
    ...
    invoke-direct {v2, v3}, Lcom/google/android/apps/gsa/staticplugins/bq/h/o;-><init>(Ljava/lang/Object;)V
...
.method public final mD(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v1, Lcom/google/android/apps/gsa/staticplugins/bq/h/r;->mZh:Lcom/google/android/apps/gsa/staticplugins/bq/h/r;
    ...
    .line 12
    invoke-virtual {p0, p1}, Lcom/google/android/apps/gsa/staticplugins/bq/h/d;->mE(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public final mE(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
