.class public Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;
...
.field public final lgc:Lcom/google/q/b/c/fp;
...
.method public constructor <init>(Lcom/google/q/b/c/eg;Lcom/google/q/b/c/hq;Lcom/google/android/apps/gsa/staticplugins/bd/a;Lcom/google/android/libraries/c/a;Lcom/google/android/apps/gsa/shared/w/a/a;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->leg:Lcom/google/q/b/c/fo;
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->lgc:Lcom/google/q/b/c/fp;
    ...
    iget-object v1, p1, Lcom/google/q/b/c/eg;->ucI:Lcom/google/q/b/c/qs;

    :cond_0
    iput-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->lem:Lcom/google/q/b/c/qs;
...
.method protected final aVC()I
    ...
    .line 90
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->lgc:Lcom/google/q/b/c/fp;
    ...
    .line 94
    :cond_0
    iget v1, v1, Lcom/google/q/b/c/fp;->tsZ:I
...
.method public final aY(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    .line 8
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->kKG:Lcom/google/android/apps/gsa/sidekick/shared/util/bl;
    ...
    .line 11
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->leg:Lcom/google/q/b/c/fo;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->leg:Lcom/google/q/b/c/fo;

    invoke-virtual {v1}, Lcom/google/q/b/c/fo;->bZN()Z
    ...
    .line 13
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->lem:Lcom/google/q/b/c/qs;

    .line 14
    if-nez v1, :cond_8

    .line 16
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->kKG:Lcom/google/android/apps/gsa/sidekick/shared/util/bl;
    ...
    .line 18
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->leg:Lcom/google/q/b/c/fo;
    ...
    iget-object v5, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->blV:Lcom/google/android/libraries/c/a;
    ...
    .line 31
    sget v0, Lcom/google/android/apps/gsa/staticplugins/bd/c/z;->lfY:I
    ...
    invoke-static {p1, v1, v2}, Lcom/google/android/apps/gsa/shared/ab/c;->b(Landroid/content/Context;IZ)Ljava/lang/String;
    ...
    .line 34
    :cond_4
    sget v4, Lcom/google/android/apps/gsa/staticplugins/bd/c/z;->lfW:I
    ...
    .line 43
    iget-wide v6, v5, Lcom/google/q/b/c/fo;->ufG:J
    ...
    .line 50
    :cond_8
    iget-wide v6, v1, Lcom/google/q/b/c/qs;->uAz:J
    ...
    .line 58
    :cond_9
    iget-object v0, v1, Lcom/google/q/b/c/qs;->uAy:Lcom/google/q/b/c/qr;
    ...
    .line 64
    iget-wide v4, v1, Lcom/google/q/b/c/qs;->uAz:J
    ...
    .line 68
    :cond_a
    sget v4, Lcom/google/android/apps/gsa/staticplugins/bd/c/z;->lfU:I
    ...
    .line 72
    invoke-static {p1, v6, v7, v3}, Lcom/google/android/apps/gsa/shared/ab/c;->a(Landroid/content/Context;JI)Ljava/lang/CharSequence;
...
.method public final b(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->lgc:Lcom/google/q/b/c/fp;
...
.method public final ba(Landroid/content/Context;)Landroid/support/v4/app/cu;
    ...
    .line 83
    invoke-virtual {p0, p1}, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->aY(Landroid/content/Context;)Ljava/lang/CharSequence;
...
.method public final c(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 88
    invoke-virtual {p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/bd/c/ag;->b(Landroid/content/Context;Lcom/google/android/sidekick/shared/remoteapi/CardRenderingContext;)Ljava/lang/CharSequence;
