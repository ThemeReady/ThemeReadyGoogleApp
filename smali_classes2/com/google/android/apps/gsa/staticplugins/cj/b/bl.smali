.class Lcom/google/android/apps/gsa/staticplugins/cj/b/bl;
...
.method private static a(Lcom/google/android/apps/gsa/store/Operation;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    .line 9
    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/store/Operation;->nqO:Lcom/google/android/apps/gsa/store/AttributeId;
    ...
    .line 14
    iget-object v1, p0, Lcom/google/android/apps/gsa/store/Operation;->nqU:Lcom/google/common/collect/ck;
    ...
    .line 26
    sget-object v4, Lcom/google/android/apps/gsa/store/x;->nrz:Lcom/google/common/base/Function;
    ...
    invoke-static {v1}, Lcom/google/android/apps/gsa/store/Expressions;->bZ(Ljava/util/List;)Lcom/google/android/apps/gsa/store/Expression;
    ...
    .line 30
    iget-object v4, p0, Lcom/google/android/apps/gsa/store/Operation;->nqT:Lcom/google/common/collect/ck;

    .line 33
    invoke-virtual {v4, v2}, Lcom/google/common/collect/ck;->zR(I)Lcom/google/common/collect/is;
    ...
    .line 36
    invoke-virtual {v6, v1}, Lcom/google/android/apps/gsa/staticplugins/cj/b/l;->a(Lcom/google/android/apps/gsa/store/Expression;)V
    ...
    .line 39
    :cond_3
    iget-object v1, v6, Lcom/google/android/apps/gsa/staticplugins/cj/b/l;->mNr:Landroid/util/SparseArray;
    ...
    .line 46
    invoke-interface {v0, v7, v8, v1, p1}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cd;->a(Lcom/google/common/base/au;Lcom/google/common/base/au;Ljava/lang/StringBuilder;Ljava/util/List;)V

    .line 47
    new-instance v7, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;

    invoke-direct {v7}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;-><init>()V

    .line 49
    iget-object v0, v5, Lcom/google/android/apps/gsa/store/Expression;->nrl:Lcom/google/common/collect/ck;
    ...
    .line 52
    invoke-virtual {v7, v0}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;->lt(Ljava/lang/String;)Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;
    ...
    invoke-static {v2}, Lcom/google/android/apps/gsa/store/Expressions;->bZ(Ljava/util/List;)Lcom/google/android/apps/gsa/store/Expression;

    move-result-object v2

    .line 56
    invoke-virtual {v0, v2, v3}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;->a(Lcom/google/android/apps/gsa/store/Expression;Z)Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;
    ...
    .line 70
    invoke-virtual {v7, p1}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;->e(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    .line 59
    :cond_5
    invoke-virtual {v7, v6}, Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;->a(Lcom/google/android/apps/gsa/staticplugins/cj/b/l;)Lcom/google/android/apps/gsa/staticplugins/cj/b/cv;
    ...
    .line 60
    invoke-virtual {v6, v2}, Lcom/google/android/apps/gsa/staticplugins/cj/b/l;->rW(I)I
    ...
    .line 64
    invoke-virtual {v6}, Lcom/google/android/apps/gsa/staticplugins/cj/b/l;->bge()Lcom/google/android/apps/gsa/store/Expression;
...
.method static a(Lcom/google/android/apps/gsa/store/Operation;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 2
    invoke-static {p0, v0}, Lcom/google/android/apps/gsa/staticplugins/cj/b/bl;->a(Lcom/google/android/apps/gsa/store/Operation;Ljava/util/ArrayList;)Ljava/lang/String;
