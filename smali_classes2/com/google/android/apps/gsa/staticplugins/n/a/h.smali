...
.field public final jzn:Lcom/google/android/apps/gsa/staticplugins/n/a/g;

.field public final jzo:Ljava/util/Map;
...
.field public jzp:Landroid/graphics/Bitmap;

.field public jzq:Landroid/graphics/Bitmap;

.field public jzr:Landroid/graphics/Bitmap;

.field public jzs:Landroid/graphics/Bitmap;

.field public jzt:Landroid/graphics/Bitmap;

.field public jzu:Landroid/graphics/Bitmap;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/projection/b;Lcom/google/android/apps/gsa/staticplugins/n/a/g;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzo:Ljava/util/Map;
    ...
    .line 7
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jfh:Lcom/google/android/apps/gsa/search/shared/ui/actions/e;

    .line 8
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzn:Lcom/google/android/apps/gsa/staticplugins/n/a/g;
...
.method public final a(JLcom/google/android/gearhead/sdk/assistant/component/Contact;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzo:Ljava/util/Map;
    ...
    .line 22
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzp:Landroid/graphics/Bitmap;
...
.method public final d(Lcom/google/ad/a/a/hy;)Landroid/graphics/Bitmap;
    .locals 2

    .prologue
    .line 26
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jfh:Lcom/google/android/apps/gsa/search/shared/ui/actions/e;

    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->mContext:Landroid/content/Context;

    invoke-virtual {v0, p1, v1}, Lcom/google/android/apps/gsa/search/shared/ui/actions/e;->a(Lcom/google/ad/a/a/hy;Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public final ov(I)Landroid/graphics/Bitmap;
    .locals 1
    ...
    .line 13
    :pswitch_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzs:Landroid/graphics/Bitmap;

    goto :goto_0

    .line 14
    :pswitch_2
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzr:Landroid/graphics/Bitmap;

    goto :goto_0

    .line 15
    :pswitch_3
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzt:Landroid/graphics/Bitmap;

    goto :goto_0

    .line 16
    :pswitch_4
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzu:Landroid/graphics/Bitmap;

    goto :goto_0

    .line 17
    :pswitch_5
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/a/h;->jzq:Landroid/graphics/Bitmap;
...
.method final ow(I)Landroid/graphics/Bitmap;
    .locals 1
