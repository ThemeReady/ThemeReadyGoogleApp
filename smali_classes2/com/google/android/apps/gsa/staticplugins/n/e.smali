...
.method constructor <init>(Lcom/google/android/apps/gsa/staticplugins/n/b;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/n/e;->jyF:Lcom/google/android/apps/gsa/staticplugins/n/b;
...
.method private final a(Ljava/lang/String;Lcom/google/android/apps/gsa/shared/util/concurrent/UiRunnable;)V
    ...
    .prologue
    .line 42
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/e;->jyF:Lcom/google/android/apps/gsa/staticplugins/n/b;
...
.method public final a(Lcom/google/android/gearhead/sdk/assistant/VoiceSessionConfig;Lcom/google/android/gearhead/sdk/assistant/ClientStateSnapshot;Lcom/google/android/gearhead/sdk/assistant/k;Lcom/google/android/gearhead/sdk/assistant/b;)V
    ...
    const-string/jumbo v1, "startVoiceSession()"
    ...
    .line 4
    iput-object p3, v0, Lcom/google/android/apps/gsa/staticplugins/n/b;->jyD:Lcom/google/android/gearhead/sdk/assistant/k;

    .line 6
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/n/e;->jyF:Lcom/google/android/apps/gsa/staticplugins/n/b;

    .line 7
    iput-object p4, v0, Lcom/google/android/apps/gsa/staticplugins/n/b;->jyE:Lcom/google/android/gearhead/sdk/assistant/b;

    .line 9
    const-string/jumbo v0, "startVoiceSession()"
...
.method public final aNs()V
    ...
    const-string/jumbo v1, "stopVoiceSession()"
    ...
    .line 12
    const-string/jumbo v0, "stopVoiceSession()"
...
.method public final aNt()V
    ...
    const-string/jumbo v1, "setSetting() not implemented"
...
.method public final os(I)Lcom/google/android/gearhead/sdk/assistant/CarAssistantSetting;
    .locals 5
    ...
    .line 15
    iput p1, v2, Lcom/google/android/gearhead/sdk/assistant/CarAssistantSetting;->oNC:I
    ...
    iput-boolean v0, v2, Lcom/google/android/gearhead/sdk/assistant/CarAssistantSetting;->oND:Z
    ...
    .line 22
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/n/e;->jyF:Lcom/google/android/apps/gsa/staticplugins/n/b;

    .line 24
    iget-object v3, v3, Lcom/google/android/apps/gsa/staticplugins/n/b;->jys:Lcom/google/android/apps/gsa/projection/b;
    ...
    .line 27
    iget-object v3, v3, Lcom/google/android/apps/gsa/staticplugins/n/b;->jyx:Lcom/google/android/apps/gsa/staticplugins/n/q;

    .line 28
    invoke-virtual {v3}, Lcom/google/android/apps/gsa/staticplugins/n/q;->aNC()Z
    ...
    iput-object v0, v2, Lcom/google/android/gearhead/sdk/assistant/CarAssistantSetting;->oNF:Ljava/lang/String;
