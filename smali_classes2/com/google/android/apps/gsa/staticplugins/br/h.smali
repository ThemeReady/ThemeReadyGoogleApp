.class Lcom/google/android/apps/gsa/staticplugins/br/h;
...
.method constructor <init>(Lcom/google/android/apps/gsa/staticplugins/br/a;Ljava/lang/String;IILjava/lang/String;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/br/h;->lZQ:Lcom/google/android/apps/gsa/staticplugins/br/a;

    iput-object p5, p0, Lcom/google/android/apps/gsa/staticplugins/br/h;->bQw:Ljava/lang/String;
...
.method private final a(Lcom/google/android/apps/gsa/plugins/lobby/c/a/b;)[B
    .locals 6
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/br/h;->lZQ:Lcom/google/android/apps/gsa/staticplugins/br/a;

    .line 44
    iget-object v0, v0, Lcom/google/android/apps/gsa/staticplugins/br/a;->cvV:Lc/a;
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/br/h;->bQw:Ljava/lang/String;

    .line 4
    invoke-virtual {v0, v2}, Lcom/google/android/apps/gsa/staticplugins/br/a;->kX(Ljava/lang/String;)Ljava/io/File;
    :try_end_0
    ...
    .line 16
    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/br/h;->lZQ:Lcom/google/android/apps/gsa/staticplugins/br/a;

    .line 17
    iget-object v4, v2, Lcom/google/android/apps/gsa/staticplugins/br/a;->mLock:Ljava/lang/Object;
    ...
    .line 19
    :try_start_1
    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/staticplugins/br/h;->a(Lcom/google/android/apps/gsa/plugins/lobby/c/a/b;)[B
    ...
    invoke-direct {v2, v3}, Landroid/support/v4/f/e;-><init>(Ljava/io/File;)V
    :try_end_2
    ...
    .line 27
    invoke-virtual {v2, v0}, Landroid/support/v4/f/e;->finishWrite(Ljava/io/FileOutputStream;)V
    :try_end_4
    ...
    .line 31
    invoke-virtual {v1, v0}, Landroid/support/v4/f/e;->failWrite(Ljava/io/FileOutputStream;)V
    :try_end_5
