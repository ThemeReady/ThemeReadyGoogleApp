.class final enum Lcom/google/android/apps/gsa/staticplugins/ci/w;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;IZ)Landroid/app/PendingIntent;
    ...
    .line 3
    invoke-static {p1, p2}, Lcom/google/android/apps/gsa/shared/ad/b/a;->u(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    .line 4
    invoke-static {p1, v0, p3, p5, p6}, Lcom/google/android/apps/gsa/staticplugins/ci/s;->d(Landroid/content/Context;Landroid/content/Intent;IIZ)Landroid/app/PendingIntent;
    ...
    :cond_0
    invoke-super/range {p0 .. p6}, Lcom/google/android/apps/gsa/staticplugins/ci/t;->a(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;IZ)Landroid/app/PendingIntent;
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lb/a;IIZ)Landroid/app/PendingIntent;
    ...
    .line 43
    invoke-static {p1, v0, p5, p6, p7}, Lcom/google/android/apps/gsa/staticplugins/ci/s;->d(Landroid/content/Context;Landroid/content/Intent;IIZ)Landroid/app/PendingIntent;
    ...
    .line 46
    invoke-static {p1, p2}, Lcom/google/android/apps/gsa/shared/ad/b/a;->x(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 58
    invoke-static {v0, p5, p7}, Lcom/google/android/apps/gsa/staticplugins/ci/s;->b(Landroid/content/Intent;IZ)V
...
.method public final b(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;IZ)Landroid/app/PendingIntent;
    ...
    .line 8
    invoke-static {p1, p2, v0, v1}, Lcom/google/android/apps/gsa/shared/ad/b/a;->a(Landroid/content/Context;Ljava/lang/String;ZZ)Landroid/content/Intent;
    ...
    .line 13
    invoke-static {p2}, Lcom/google/android/apps/gsa/shared/ad/b/a;->iZ(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 14
    :cond_3
    invoke-static {p1, p2}, Lcom/google/android/apps/gsa/shared/ad/b/a;->w(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
