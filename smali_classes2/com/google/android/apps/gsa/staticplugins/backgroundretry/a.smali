...
.field public final koe:Landroid/support/v4/app/cc;

.field public kof:Landroid/app/PendingIntent;
...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/c/a;Landroid/content/Context;Lb/a;Landroid/app/NotificationManager;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->bnK:Lcom/google/android/libraries/c/a;
    ...
    .line 5
    iput-object p3, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->fLj:Lb/a;

    .line 6
    iput-object p4, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->tI:Landroid/app/NotificationManager;
    ...
    .line 16
    invoke-static {v2, v3}, Lcom/google/android/apps/gsa/search/core/y/s;->l(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iput-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->kof:Landroid/app/PendingIntent;

    .line 19
    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->mContext:Landroid/content/Context;

    .line 20
    invoke-static {v2}, Lcom/google/android/apps/gsa/shared/o/a;->aI(Landroid/content/Context;)Landroid/support/v4/app/cc;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->mResources:Landroid/content/res/Resources;

    sget v4, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/k;->bKT:I
    ...
    .line 22
    iput v3, v2, Landroid/support/v4/app/cc;->sE:I

    .line 24
    sget v3, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/l;->koC:I

    .line 25
    invoke-virtual {v2, v3}, Landroid/support/v4/app/cc;->Q(I)Landroid/support/v4/app/cc;
    ...
    .line 32
    iput-boolean v5, v0, Landroid/support/v4/app/cc;->sA:Z

    .line 36
    iput-boolean v5, v0, Landroid/support/v4/app/cc;->sp:Z

    .line 39
    invoke-virtual {v0, v6}, Landroid/support/v4/app/cc;->l(Z)Landroid/support/v4/app/cc;

    move-result-object v0

    .line 41
    iput v5, v0, Landroid/support/v4/app/cc;->so:I

    .line 43
    sget v1, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/l;->iaq:I

    iget-object v2, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->mResources:Landroid/content/res/Resources;

    sget v3, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/n;->koI:I
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->kof:Landroid/app/PendingIntent;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->koe:Landroid/support/v4/app/cc;
...
.method public final aQZ()V
    ...
    .prologue
    .line 47
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->tI:Landroid/app/NotificationManager;
...
.method public final ed(Z)V
    ...
    .line 49
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->fLj:Lb/a;
    ...
    .line 56
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->aQZ()V
    ...
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/search/core/preferences/e;->Tb()[Ljava/lang/String;
    ...
    sget v3, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/m;->koE:I
    ...
    invoke-virtual {v0, v6}, Lcom/google/common/base/ap;->f([Ljava/lang/Object;)Ljava/lang/String;
    ...
    iput-object v0, v8, Landroid/support/v4/app/ci;->te:Ljava/lang/CharSequence;
    ...
    sget v3, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/m;->koD:I
    ...
    .line 76
    :cond_4
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->koe:Landroid/support/v4/app/cc;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/cc;->R(I)Landroid/support/v4/app/cc;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/cc;->k(Z)Landroid/support/v4/app/cc;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->bnK:Lcom/google/android/libraries/c/a;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/staticplugins/backgroundretry/a;->koe:Landroid/support/v4/app/cc;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/app/cc;->R(I)Landroid/support/v4/app/cc;
