...
.method private final aKx()Ljava/lang/CharSequence;
    .locals 6
...
.method private final aKy()Landroid/graphics/drawable/Drawable;
    .locals 6
...
.method protected final ahD()V
    ...
    .prologue
    .line 4
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/dr;->ahG()Lcom/google/android/apps/gsa/search/shared/ui/actions/c;
    ...
    .line 11
    iget-object v1, v1, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fCc:Lcom/google/android/apps/gsa/search/shared/actions/q;

    .line 12
    sget-object v2, Lcom/google/android/apps/gsa/search/shared/actions/q;->fCe:Lcom/google/android/apps/gsa/search/shared/actions/q;

    if-ne v1, v2, :cond_3

    .line 14
    iget-object v2, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fCb:Ljava/lang/String;
    ...
    .line 18
    invoke-interface {v0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/ds;->aKw()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 22
    invoke-static {v2}, Lcom/google/android/apps/gsa/sidekick/shared/util/q;->hZ(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v2}, Lcom/google/android/apps/gsa/sidekick/shared/util/q;->b(Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    :cond_0
    :goto_0
    iget-object v2, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBW:Ljava/lang/String;

    .line 31
    iget-object v3, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBY:Ljava/lang/String;

    .line 33
    iget-object v4, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBX:Ljava/lang/String;
    ...
    .line 39
    :cond_3
    iget-object v1, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBW:Ljava/lang/String;

    .line 42
    iget-object v2, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBY:Ljava/lang/String;

    .line 45
    iget-object v3, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fBX:Ljava/lang/String;

    .line 47
    invoke-direct {p0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/dr;->aKx()Ljava/lang/CharSequence;

    move-result-object v4

    .line 48
    invoke-direct {p0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/dr;->aKy()Landroid/graphics/drawable/Drawable;

    move-result-object v5

    .line 50
    iget-object v6, v6, Lcom/google/android/apps/gsa/search/shared/actions/SoundSearchResult;->fCd:Landroid/graphics/Bitmap;
