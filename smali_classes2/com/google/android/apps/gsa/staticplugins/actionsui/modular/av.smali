...
# instance fields
.field public final huN:Lcom/google/android/apps/gsa/search/shared/actions/util/d;

.field public final jeo:Landroid/widget/AdapterView$OnItemClickListener;

.field public final jfL:Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IZ)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->jeo:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->jfL:Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/h;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->huN:Lcom/google/android/apps/gsa/search/shared/actions/util/d;
...
.method public final ahE()V
    ...
    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->jfL:Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/h;
    ...
    iget-object v6, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->huN:Lcom/google/android/apps/gsa/search/shared/actions/util/d;

    .line 24
    invoke-virtual {v6, v2, v3, v8}, Lcom/google/android/apps/gsa/search/shared/actions/util/d;->i(JZ)Ljava/util/List;

    move-result-object v6

    .line 25
    invoke-static {v6}, Lcom/google/android/apps/gsa/search/shared/actions/util/d;->an(Ljava/util/List;)[Lcom/google/android/apps/gsa/shared/util/k/k;
    ...
    .line 30
    invoke-static {v2, v3}, Lcom/google/android/apps/gsa/search/shared/actions/util/d;->aq(J)Z
    ...
    .line 31
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->huN:Lcom/google/android/apps/gsa/search/shared/actions/util/d;
    ...
    .line 35
    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->P(Ljava/lang/CharSequence;)V

    .line 36
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->jfL:Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/h;
    ...
    invoke-static {v4, v5, v6, v7}, Lcom/google/android/apps/gsa/shared/util/bn;->o(JJ)Z
    ...
    .line 57
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/search/shared/actions/modular/arguments/DateArgument;->adv()I
    ...
    .line 59
    :pswitch_0
    invoke-virtual {p0, v1}, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->P(Ljava/lang/CharSequence;)V
    ...
    sget v2, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/dy;->jkQ:I
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->huN:Lcom/google/android/apps/gsa/search/shared/actions/util/d;

    .line 66
    invoke-virtual {v1, v2, v3, v8}, Lcom/google/android/apps/gsa/search/shared/actions/util/d;->i(JZ)Ljava/util/List;
...
.method final d(Ljava/util/Calendar;)V
    ...
    .line 76
    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/apps/gsa/search/shared/actions/modular/arguments/DateArgument;->z(III)V
...
.method protected final onClick()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/actionsui/modular/av;->jeo:Landroid/widget/AdapterView$OnItemClickListener;
