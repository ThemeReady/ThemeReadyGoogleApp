...
.field public volatile kbQ:Lcom/google/android/apps/gsa/staticplugins/av/v;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->mContext:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    .line 4
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->ecB:Landroid/os/PowerManager;
    ...
    .line 7
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->gzl:Lcom/google/android/apps/gsa/shared/util/common/d;

    .line 8
    const v0, 0x2bf20

    iput v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->kbR:I
...
.method public run()V
    ...
    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->kbQ:Lcom/google/android/apps/gsa/staticplugins/av/v;
    ...
    .line 12
    :try_start_0
    iget v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->kbR:I
    ...
    .line 13
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->ecB:Landroid/os/PowerManager;
    ...
    .line 25
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->kbQ:Lcom/google/android/apps/gsa/staticplugins/av/v;

    invoke-virtual {v4}, Lcom/google/android/apps/gsa/staticplugins/av/v;->isStarted()Z
    ...
    .line 27
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/av/a;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v2, Lcom/google/android/apps/gsa/staticplugins/av/b;

    const-string v3, "ForceStopMicroDetector"

    invoke-direct {v2, p0, v3}, Lcom/google/android/apps/gsa/staticplugins/av/b;-><init>(Lcom/google/android/apps/gsa/staticplugins/av/a;Ljava/lang/String;)V
