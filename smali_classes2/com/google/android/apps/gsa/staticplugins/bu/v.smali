.class public Lcom/google/android/apps/gsa/staticplugins/bu/v;
...
# instance fields
.field public final nxU:Lcom/android/launcher3/compat/UserManagerCompat;

.field public final nxV:Lcom/android/launcher3/compat/LauncherAppsCompat;

.field public final nxW:Ljava/util/Map;

.field public final nxX:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public constructor <init>(Lcom/android/launcher3/compat/UserManagerCompat;Lcom/android/launcher3/compat/LauncherAppsCompat;Ljava/util/concurrent/Executor;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxU:Lcom/android/launcher3/compat/UserManagerCompat;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxV:Lcom/android/launcher3/compat/LauncherAppsCompat;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxX:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxW:Ljava/util/Map;

    .line 6
    new-instance v0, Lcom/google/android/apps/gsa/staticplugins/bu/w;

    invoke-direct {v0, p0}, Lcom/google/android/apps/gsa/staticplugins/bu/w;-><init>(Lcom/google/android/apps/gsa/staticplugins/bu/v;)V
...
.method private final a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .prologue
    .line 48
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxW:Ljava/util/Map;

    monitor-enter v1

    .line 49
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxW:Ljava/util/Map;
...
.method private final a([Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .line 45
    invoke-direct {p0, v2, p2}, Lcom/google/android/apps/gsa/staticplugins/bu/v;->a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
...
.method private final nC(Ljava/lang/String;)Z
    .locals 9
    ...
    .line 9
    sget-object v0, Lcom/google/android/apps/gsa/shared/q/a;->hML:Ljava/util/regex/Pattern;
    ...
    iget-object v4, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxU:Lcom/android/launcher3/compat/UserManagerCompat;
    ...
    .line 24
    iget-object v0, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxV:Lcom/android/launcher3/compat/LauncherAppsCompat;
    ...
    .line 25
    :cond_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nxX:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final nA(Ljava/lang/String;)Z
    ...
    .prologue
    .line 8
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/staticplugins/bu/v;->nC(Ljava/lang/String;)Z
...
.method public onPackageAdded(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
    ...
    .prologue
    .line 31
    invoke-direct {p0, p1, p2}, Lcom/google/android/apps/gsa/staticplugins/bu/v;->a(Ljava/lang/String;Lcom/android/launcher3/compat/UserHandleCompat;)V
