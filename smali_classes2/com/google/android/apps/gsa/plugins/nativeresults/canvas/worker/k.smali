...
# static fields
.field public static final dAA:Lcom/google/android/apps/gsa/plugins/a/c/c;

.field public static final dAz:Ljava/util/regex/Pattern;
...
.field public final dAB:Lcom/google/android/apps/gsa/search/core/nativesrpui/worker/CanvasRefinementHandler;

.field public final dAC:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

.field public final dAD:Lcom/google/android/libraries/velour/api/SafePendingIntent;

.field public final dao:Lcom/google/android/apps/gsa/search/core/google/SearchDomainProperties;

.field public final dhF:Lcom/google/android/libraries/velour/api/ActivityIntentStarter;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAz:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAA:Lcom/google/android/apps/gsa/plugins/a/c/c;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;Lcom/google/android/apps/gsa/search/core/nativesrpui/worker/CanvasRefinementHandler;Lcom/google/android/libraries/velour/api/ActivityIntentStarter;Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;Lcom/google/android/apps/gsa/search/core/google/SearchDomainProperties;Landroid/content/Context;Lcom/google/android/libraries/velour/api/SafePendingIntent;Lcom/google/android/apps/gsa/shared/config/ConfigFlags;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bzn:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAB:Lcom/google/android/apps/gsa/search/core/nativesrpui/worker/CanvasRefinementHandler;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dhF:Lcom/google/android/libraries/velour/api/ActivityIntentStarter;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAC:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    .line 6
    iput-object p5, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dao:Lcom/google/android/apps/gsa/search/core/google/SearchDomainProperties;

    .line 7
    iput-object p6, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->mContext:Landroid/content/Context;

    .line 8
    iput-object p7, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAD:Lcom/google/android/libraries/velour/api/SafePendingIntent;

    .line 9
    iput-object p8, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bCW:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
...
.method final a(ILjava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 17
    :try_start_0
    invoke-static {p2}, Lcom/google/android/libraries/gsa/util/a/a;->st(Ljava/lang/String;)Landroid/content/Intent;
    ...
    .line 20
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dao:Lcom/google/android/apps/gsa/search/core/google/SearchDomainProperties;
    ...
    .line 21
    sget-object v1, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAz:Ljava/util/regex/Pattern;
    ...
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAD:Lcom/google/android/libraries/velour/api/SafePendingIntent;
    ...
    :cond_3
    :try_start_1
    sget-object v0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAA:Lcom/google/android/apps/gsa/plugins/a/c/c;

    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bCW:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
    ...
    :cond_6
    :try_start_3
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dAC:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    const/4 v2, 0x2

    invoke-interface {v1, v0, v2}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;->av(II)V
    :try_end_3
    ...
    .line 61
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bzn:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;
    ...
    .line 66
    invoke-static {v0}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/i;->h(Ljava/lang/Throwable;)Landroid/os/Bundle;
...
.method public final a(ILjava/lang/String;ZLandroid/os/Bundle;)V
    ...
    .prologue
    .line 11
    iget-object v6, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bzn:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;
...
.method final c(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 73
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->dhF:Lcom/google/android/libraries/velour/api/ActivityIntentStarter;
...
.method public final d(ILandroid/content/Intent;)V
    ...
    .prologue
    .line 14
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/k;->bzn:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerUi;
