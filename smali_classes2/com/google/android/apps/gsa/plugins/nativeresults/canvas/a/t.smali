.class public Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;
.super Lcom/google/android/apps/gsa/search/shared/nativesrpui/CanvasTimingLogger;
.source "SourceFile"

# interfaces
.implements Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/s;


# instance fields
.field public final eqm:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

.field public final eqn:I
...
.method public constructor <init>(Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;I)V
    ...
    iput-wide v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqo:J

    .line 3
    const-string v0, ""

    iput-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqp:Ljava/lang/String;

    .line 4
    iput-object p1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqm:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    .line 5
    iput p2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqn:I
...
.method public final a(ILjava/lang/Throwable;)V
    ...
    .line 86
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqm:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    iget v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqn:I
...
.method public final a(Lcom/google/android/apps/gsa/shared/search/Query;JJJ[B)V
    ...
    .line 7
    :try_start_0
    iget-wide v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqo:J
    ...
    .line 11
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqm:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;
    ...
    .line 12
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->reset()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Lcom/google/android/libraries/componentview/services/application/LogData;)V
    ...
    .line 18
    :try_start_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqp:Ljava/lang/String;
    ...
    .line 19
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqp:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    invoke-static {}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/AgsaLogData;->Ju()Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/b;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/b;->cV(Ljava/lang/String;)Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/b;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/b;->Jv()Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/AgsaLogData;
...
.method public final a(Lcom/google/android/libraries/componentview/services/application/bd;)V
    .locals 6
    ...
    .line 57
    :cond_0
    new-instance v0, Lcom/google/common/l/e/a/c;

    invoke-direct {v0}, Lcom/google/common/l/e/a/c;-><init>()V

    .line 58
    new-instance v4, Lcom/google/common/l/e/a/b;

    invoke-direct {v4}, Lcom/google/common/l/e/a/b;-><init>()V

    .line 59
    iput-object v0, v4, Lcom/google/common/l/e/a/b;->vyX:Lcom/google/common/l/e/a/c;
    ...
    :cond_1
    :try_start_1
    iget v0, v4, Lcom/google/common/l/e/a/b;->aEl:I

    or-int/lit8 v0, v0, 0x1

    iput v0, v4, Lcom/google/common/l/e/a/b;->aEl:I

    .line 65
    iput-object v2, v4, Lcom/google/common/l/e/a/b;->pBG:Ljava/lang/String;
    ...
    .line 71
    iput-object v3, v4, Lcom/google/common/l/e/a/b;->tZN:Ljava/lang/String;
    ...
    .line 73
    :cond_5
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqm:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    iget v3, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqn:I
    ...
    .line 75
    iget v5, v5, Lcom/google/android/libraries/componentview/api/external/a;->itM:I
...
.method public final a(Lcom/google/common/l/c/cg;)V
    .locals 4
    ...
    invoke-interface {v1, v0}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;->r([B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final cT(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;->cT(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final q([B)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;->q([B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setFirstByteElapsedTimeNanos(J)V
    ...
    .line 108
    :cond_0
    iput-wide p1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqo:J
...
.method public setPrefetchRequestId(Ljava/lang/String;)V
    ...
    .line 114
    :cond_0
    iput-object p1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/a/t;->eqp:Ljava/lang/String;
