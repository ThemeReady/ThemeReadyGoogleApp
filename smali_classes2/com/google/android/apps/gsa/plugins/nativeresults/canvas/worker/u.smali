...
.field public final synthetic dAU:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ag;

.field public final synthetic dAV:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;
...
.method constructor <init>(Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;Ljava/lang/String;IILandroid/net/Uri;ZLjava/util/Map;ILcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ag;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAV:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;

    iput-object p5, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->val$uri:Landroid/net/Uri;

    iput-boolean p6, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAS:Z

    iput-object p7, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAT:Ljava/util/Map;

    iput p8, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAG:I

    iput-object p9, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAU:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ag;
...
.method public run()V
    ...
    iget-boolean v1, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAS:Z
    ...
    .line 6
    sget-object v1, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;->dAR:Lcom/google/android/apps/gsa/shared/io/ResponseCodePredicate;
    ...
    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAT:Ljava/util/Map;
    ...
    .line 18
    :try_start_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAV:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;

    .line 19
    iget-object v0, v0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;->dAC:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/am;

    .line 20
    iget v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAG:I
    ...
    .line 24
    :goto_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAU:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ag;

    .line 25
    invoke-static {}, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;->Gk()Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ParcelableFetcherResponse;
    ...
    .line 31
    iget-object v0, v0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;->crI:Lcom/google/android/apps/gsa/shared/io/HttpEngine;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAV:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;

    .line 35
    iget-object v3, v3, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/t;->crI:Lcom/google/android/apps/gsa/shared/io/HttpEngine;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/u;->dAU:Lcom/google/android/apps/gsa/plugins/nativeresults/canvas/worker/ag;
