...
# direct methods
.method constructor <init>(Ljava/lang/String;IILjava/lang/String;Ljava/util/Date;Lcom/google/android/apps/gsa/search/api/SearchProcessApi;Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;Lcom/google/common/util/concurrent/SettableFuture;)V
    .locals 0

    .prologue
    .line 1
    iput-object p4, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->etc:Ljava/lang/String;

    iput-object p5, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->etd:Ljava/util/Date;

    iput-object p6, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->equ:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;

    iput-object p7, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->eqB:Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;

    iput-object p8, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->eqz:Lcom/google/common/util/concurrent/SettableFuture;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->etc:Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->etd:Ljava/util/Date;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->etd:Ljava/util/Date;
    ...
    .line 9
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->equ:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->equ:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->eqB:Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;
    ...
    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/cd;->eqz:Lcom/google/common/util/concurrent/SettableFuture;
