...
.field public final synthetic dFj:Ljava/lang/String;

.field public final synthetic dFk:Ljava/util/Date;
...
.method constructor <init>(Ljava/lang/String;IILjava/lang/String;Ljava/util/Date;Lcom/google/android/apps/gsa/search/api/SearchProcessApi;Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;Lcom/google/common/util/concurrent/cb;)V
    ...
    .prologue
    .line 1
    iput-object p4, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFj:Ljava/lang/String;

    iput-object p5, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFk:Ljava/util/Date;

    iput-object p6, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dCN:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;

    iput-object p7, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFl:Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;

    iput-object p8, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dDQ:Lcom/google/common/util/concurrent/cb;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFj:Ljava/lang/String;
    ...
    .line 5
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFk:Ljava/util/Date;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFk:Ljava/util/Date;
    ...
    .line 9
    :cond_0
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dCN:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;
    ...
    iget-object v3, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dCN:Lcom/google/android/apps/gsa/search/api/SearchProcessApi;
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dFl:Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;
    ...
    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/podcastplayer/bv;->dDQ:Lcom/google/common/util/concurrent/cb;
