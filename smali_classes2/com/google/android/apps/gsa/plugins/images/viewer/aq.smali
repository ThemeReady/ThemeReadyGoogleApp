.class public Lcom/google/android/apps/gsa/plugins/images/viewer/aq;
...
.field public final daZ:Landroid/util/LruCache;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;Lcom/google/android/apps/gsa/shared/io/HttpEngine;Landroid/util/LruCache;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mContext:Landroid/content/Context;

    .line 3
    iput-object p3, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->crI:Lcom/google/android/apps/gsa/shared/io/HttpEngine;

    .line 4
    iput-object p2, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->daZ:Landroid/util/LruCache;
...
.method static synthetic a(Lcom/google/android/apps/gsa/plugins/images/viewer/aq;[BIIZ)Landroid/graphics/drawable/Drawable;
    .locals 1

    .prologue
    .line 77
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->a([BIIZ)Landroid/graphics/drawable/Drawable;
...
.method private final a([BIIZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 62
    invoke-direct {p0, v0, p2, p3}, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->a(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mContext:Landroid/content/Context;
...
.method private final a(Landroid/net/Uri;IIZ)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 41
    new-instance v0, Lcom/google/android/apps/gsa/plugins/images/viewer/as;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/android/apps/gsa/plugins/images/viewer/as;-><init>(Lcom/google/android/apps/gsa/plugins/images/viewer/aq;Ljava/lang/String;IIIIZLcom/google/common/util/concurrent/cb;)V

    .line 42
    iget-object v10, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v1, Lcom/google/android/apps/gsa/plugins/images/viewer/at;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/google/android/apps/gsa/plugins/images/viewer/at;-><init>(Lcom/google/android/apps/gsa/plugins/images/viewer/aq;Ljava/lang/String;IILcom/google/android/apps/gsa/shared/io/HttpRequestData;Lcom/google/android/apps/gsa/shared/util/concurrent/NamedFutureCallback;)V
...
.method public final a(Ljava/lang/String;Lcom/google/android/apps/gsa/shared/util/concurrent/NamedUiFutureCallback;Lcom/google/common/util/concurrent/FutureCallback;Z)V
    ...
    .line 7
    .line 8
    invoke-virtual {p0, p1, v0, v0, p4}, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->c(Ljava/lang/String;IIZ)Lcom/google/common/util/concurrent/ListenableFuture;

    move-result-object v0

    .line 9
    iget-object v1, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
    ...
    .line 12
    invoke-static {v0, p3, v1}, Lcom/google/common/util/concurrent/ay;->a(Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/common/util/concurrent/FutureCallback;Ljava/util/concurrent/Executor;)V
...
.method final c(Ljava/lang/String;IIZ)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 15
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->daZ:Landroid/util/LruCache;
    ...
    .line 20
    :cond_1
    invoke-direct {p0, v5, p2, p3, p4}, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->a(Landroid/net/Uri;IIZ)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 30
    iget-object v0, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v1, Lcom/google/android/apps/gsa/plugins/images/viewer/ar;

    const-string v2, "Remove URI on fail"

    invoke-direct {v1, p0, v2, v5}, Lcom/google/android/apps/gsa/plugins/images/viewer/ar;-><init>(Lcom/google/android/apps/gsa/plugins/images/viewer/aq;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 25
    iget-object v9, p0, Lcom/google/android/apps/gsa/plugins/images/viewer/aq;->mTaskRunner:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v0, Lcom/google/android/apps/gsa/plugins/images/viewer/au;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/android/apps/gsa/plugins/images/viewer/au;-><init>(Lcom/google/android/apps/gsa/plugins/images/viewer/aq;Ljava/lang/String;IILandroid/net/Uri;IILcom/google/common/util/concurrent/cb;)V
