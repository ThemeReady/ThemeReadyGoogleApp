...
.field public final giL:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;
...
.field public giO:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public final giy:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giM:Ljava/lang/Object;
    ...
    .line 5
    iput-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giN:Ljava/util/LinkedList;

    .line 6
    iput-object p1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giL:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;

    .line 7
    iput-object p2, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giy:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;

    .line 8
    iput-object p3, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->dRg:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
...
.method public acceptRequest(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Z
    ...
    .line 10
    .line 11
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giO:Ljava/util/List;
...
.method public final synthetic am(Ljava/lang/Object;)V
    ...
    .line 74
    invoke-virtual {p1}, Lcom/google/android/apps/gsa/searchbox/root/v;->aiW()I

    move-result v0

    iput v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giP:I
...
.method public fetchSuggestionsThrottled(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .prologue
    .line 31
    iget-object v7, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giM:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giN:Ljava/util/LinkedList;

    invoke-virtual {v0}, Ljava/util/LinkedList;->size()I

    move-result v0

    iget v1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giP:I
    ...
    :cond_0
    :try_start_1
    iget-object v1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giL:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;

    .line 35
    iget-object v0, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->ggA:Lcom/google/android/apps/gsa/searchbox/root/logging/Logging;
    ...
    .line 36
    iget-object v0, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->dRg:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 37
    iget-object v0, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->giy:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;

    iget-object v2, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->ggA:Lcom/google/android/apps/gsa/searchbox/root/logging/Logging;

    iget-object v3, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->gip:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/CompleteServerResponseParser;
    ...
    .line 43
    :goto_1
    iget-object v8, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->dRl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
    ...
    iget-object v1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giM:Ljava/lang/Object;

    invoke-static {v6, v0, v1}, Lcom/google/android/apps/gsa/searchbox/root/sources/h;->a(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/util/LinkedList;Ljava/lang/Object;)V
...
.method public getImmediateSuggestions(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootResponse;
    ...
    .line 20
    :cond_2
    iget-object v0, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->giz:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/CompleteServerResponseCache;
    ...
    .line 24
    iget-object v1, v1, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->ggA:Lcom/google/android/apps/gsa/searchbox/root/logging/Logging;
...
.method public getRequestDelay()I
    ...
    .prologue
    .line 54
    iget-object v3, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giL:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;

    .line 55
    iget v1, v3, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->giB:I

    .line 56
    iget-object v0, v3, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->ggA:Lcom/google/android/apps/gsa/searchbox/root/logging/Logging;
    ...
    .line 59
    :cond_0
    iget v1, v3, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->giC:I

    if-ge v0, v1, :cond_1

    .line 60
    iget v0, v3, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/d;->giC:I
...
.method public removeSuggestion(Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;)I
    ...
    .line 69
    iget-object v1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giy:Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;

    invoke-interface {v1, p1}, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/a;->e(Lcom/google/android/apps/gsa/shared/searchbox/Suggestion;)Z
...
.method public synthetic setDependencies(Ljava/lang/Object;)V
    ...
    .line 78
    iget-object v0, p1, Lcom/google/android/apps/gsa/searchbox/root/DynamicRootComponents;->gge:Lcom/google/common/collect/ck;

    .line 79
    iput-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->giO:Ljava/util/List;
...
.method public shouldFallbackToBackgroundFetchUponCancel()Z
    ...
    .prologue
    .line 63
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/completeserver/h;->dRg:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
