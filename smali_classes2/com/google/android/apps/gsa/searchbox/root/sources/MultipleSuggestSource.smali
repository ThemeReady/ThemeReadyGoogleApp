...
.field public ghX:Lcom/google/android/apps/gsa/searchbox/root/sources/g;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;)V
    ...
    .line 3
    iput-object p1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->dRl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    .line 4
    return-void
.end method

.method private final declared-synchronized a(Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
    .locals 1
    ...
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->ghX:Lcom/google/android/apps/gsa/searchbox/root/sources/g;
    ...
    .line 34
    :cond_0
    iput-object p1, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->ghX:Lcom/google/android/apps/gsa/searchbox/root/sources/g;
    :try_end_0
...
# virtual methods
.method final a(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;Ljava/util/concurrent/ConcurrentLinkedQueue;Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
    .locals 7
    ...
    invoke-virtual {p3, v0}, Lcom/google/android/apps/gsa/searchbox/root/sources/g;->b(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootResponse;)V

    .line 40
    iget-object v6, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->dRl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v0, Lcom/google/android/apps/gsa/searchbox/root/sources/d;
...
.method final declared-synchronized b(Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->ghX:Lcom/google/android/apps/gsa/searchbox/root/sources/g;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final fetchSuggestionsThrottled(Lcom/google/android/apps/gsa/searchbox/root/data_objects/RootRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 20
    new-instance v5, Lcom/google/android/apps/gsa/searchbox/root/sources/g;
    ...
    invoke-direct {v5, v0, v6, v1}, Lcom/google/android/apps/gsa/searchbox/root/sources/g;-><init>(ILcom/google/common/util/concurrent/cb;Z)V

    .line 22
    invoke-direct {p0, v5}, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->a(Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
    ...
    .line 25
    iget-object v9, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->dRl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;
    ...
    .line 27
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;->dRl:Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunner;

    new-instance v1, Lcom/google/android/apps/gsa/searchbox/root/sources/f;

    invoke-direct {v1, p0, v6, v5}, Lcom/google/android/apps/gsa/searchbox/root/sources/f;-><init>(Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;Lcom/google/common/util/concurrent/ListenableFuture;Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
    ...
    new-instance v1, Lcom/google/android/apps/gsa/searchbox/root/sources/c;

    invoke-direct {v1, p0, v5}, Lcom/google/android/apps/gsa/searchbox/root/sources/c;-><init>(Lcom/google/android/apps/gsa/searchbox/root/sources/MultipleSuggestSource;Lcom/google/android/apps/gsa/searchbox/root/sources/g;)V
