...
# instance fields
.field public final cdk:Lcom/google/android/apps/gsa/assistant/settings/payments/az;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/payments/EditAddressLayout;->cdk:Lcom/google/android/apps/gsa/assistant/settings/payments/az;
...
.method private final a(Lcom/google/common/base/ax;Landroid/view/View;)V
    .locals 4
    ...
    sget-object v2, Lcom/google/r/a/a/g;->wZI:Lcom/google/r/a/a/g;

    if-ne v1, v2, :cond_1

    invoke-virtual {v0}, Lcom/google/android/apps/gsa/assistant/settings/payments/ay;->sq()Z
    ...
    .line 72
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/payments/EditAddressLayout;->sp()Lcom/google/android/apps/gsa/assistant/settings/payments/ay;
...
# virtual methods
.method final a(Landroid/view/ViewGroup;Lcom/google/common/base/ax;Lcom/google/common/base/ax;Lcom/google/android/apps/gsa/assistant/settings/payments/j;Lcom/google/common/base/ax;)Landroid/support/design/widget/TextInputLayout;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Lcom/google/r/a/a/g;",
            ">;",
            "Lcom/google/android/apps/gsa/assistant/settings/payments/j;",
            "Lcom/google/common/base/ax",
            "<",
            "Ljava/lang/Integer;",
            ">;)",
    ...
    .line 86
    invoke-virtual {v0, v2}, Lcom/google/android/apps/gsa/assistant/settings/payments/AddressFieldTextInputLayout;->c(Z)V

    .line 88
    :cond_0
    iput-object p3, v0, Lcom/google/android/apps/gsa/assistant/settings/payments/AddressFieldTextInputLayout;->cbE:Lcom/google/common/base/ax;

    .line 89
    invoke-virtual {v0, v2}, Lcom/google/android/apps/gsa/assistant/settings/payments/AddressFieldTextInputLayout;->d(Z)V
    ...
    .line 81
    :cond_1
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/payments/ec;->cgJ:I
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 14
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/payments/EditAddressLayout;->cdk:Lcom/google/android/apps/gsa/assistant/settings/payments/az;

    .line 15
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/assistant/settings/payments/az;->sr()Lcom/google/common/base/ax;
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/payments/ee;->cgY:I
    ...
    :cond_1
    :goto_1
    invoke-interface {v4}, Lcom/google/android/apps/gsa/assistant/settings/payments/j;->rW()Lcom/google/common/base/ax;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/android/apps/gsa/assistant/settings/payments/EditAddressLayout;->a(Lcom/google/common/base/ax;Landroid/view/View;)V
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/payments/ee;->cgX:I
    ...
    .line 41
    :goto_2
    iput-object p1, v1, Lcom/google/android/apps/gsa/assistant/settings/payments/i;->cbD:Lcom/google/android/apps/gsa/assistant/settings/payments/AddressFieldSpinner;

    .line 42
    invoke-virtual {v1, p1}, Lcom/google/android/apps/gsa/assistant/settings/payments/i;->addView(Landroid/view/View;)V

    .line 44
    iget-object v0, p1, Lcom/google/android/apps/gsa/assistant/settings/payments/AddressFieldSpinner;->cbA:Lcom/google/r/a/a/g;
    ...
    .line 45
    invoke-direct {p0, v0, v1}, Lcom/google/android/apps/gsa/assistant/settings/payments/EditAddressLayout;->a(Lcom/google/common/base/ax;Landroid/view/View;)V
    ...
    iput-object v1, v0, Lcom/google/android/apps/gsa/assistant/settings/payments/az;->cdl:Lcom/google/common/base/ax;
...
.method final sp()Lcom/google/android/apps/gsa/assistant/settings/payments/ay;
    .locals 2
