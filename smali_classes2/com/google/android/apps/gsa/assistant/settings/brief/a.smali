...
# instance fields
.field public final bLg:Lcom/google/android/apps/gsa/shared/customization/api/InterestPickerIntentBuilder;

.field public final bLh:Lcom/google/android/apps/gsa/assistant/shared/k;

.field public bLi:Lcom/google/android/apps/gsa/assistant/settings/shared/DescriptionPreferenceCategory;

.field public bLj:Landroid/support/v7/preference/PreferenceCategory;

.field public bLk:Landroid/support/v7/preference/PreferenceCategory;

.field public bLl:Landroid/support/v7/preference/Preference;

.field public final mAssistantSettingsHelper:Lcom/google/android/apps/gsa/assistant/settings/shared/o;


# direct methods
.method public constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/shared/o;Lcom/google/android/apps/gsa/shared/customization/api/InterestPickerIntentBuilder;Lcom/google/android/apps/gsa/assistant/shared/k;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLg:Lcom/google/android/apps/gsa/shared/customization/api/InterestPickerIntentBuilder;

    .line 4
    iput-object p3, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLh:Lcom/google/android/apps/gsa/assistant/shared/k;
...
.method private final qX()V
    ...
    .line 105
    new-instance v3, Lcom/google/assistant/f/a/v;

    invoke-direct {v3}, Lcom/google/assistant/f/a/v;-><init>()V

    .line 106
    new-instance v4, Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLj:Landroid/support/v7/preference/PreferenceCategory;
    ...
    iput-object v0, v3, Lcom/google/assistant/f/a/v;->ubf:[Ljava/lang/String;

    .line 113
    :goto_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLk:Landroid/support/v7/preference/PreferenceCategory;
    ...
    .line 119
    :cond_2
    iget v1, v3, Lcom/google/assistant/f/a/v;->aEl:I

    or-int/lit8 v1, v1, 0x2

    iput v1, v3, Lcom/google/assistant/f/a/v;->aEl:I

    .line 120
    iput-object v0, v3, Lcom/google/assistant/f/a/v;->ubg:Ljava/lang/String;
    ...
    .line 124
    iput-object v3, v0, Lcom/google/assistant/f/a/x;->ubh:Lcom/google/assistant/f/a/v;
    ...
    .line 126
    iput-object v0, v1, Lcom/google/assistant/f/a/ef;->uhU:Lcom/google/assistant/f/a/x;

    .line 127
    const/4 v0, 0x0

    invoke-virtual {p0, v1, v0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->a(Lcom/google/assistant/f/a/ef;Lcom/google/android/apps/gsa/assistant/settings/base/f;)Lcom/google/android/apps/gsa/assistant/shared/b/h;
...
# virtual methods
.method final a(Lcom/google/android/apps/gsa/assistant/settings/brief/BriefItemPreference;Lcom/google/assistant/f/a/u;)V
    .locals 11
    ...
    .line 32
    .line 33
    iget-object v0, p2, Lcom/google/assistant/f/a/u;->ubb:[Ljava/lang/String;

    if-eqz v0, :cond_8

    .line 34
    iget-object v5, p2, Lcom/google/assistant/f/a/u;->ubb:[Ljava/lang/String;
    ...
    .line 46
    :cond_3
    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLg:Lcom/google/android/apps/gsa/shared/customization/api/InterestPickerIntentBuilder;
    ...
    invoke-virtual {v8}, Lcom/google/android/apps/gsa/assistant/settings/shared/o;->ty()Ljava/util/Set;
    ...
    .line 57
    invoke-virtual {v1}, Lcom/google/android/apps/gsa/assistant/settings/shared/o;->tw()I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/google/android/libraries/assistant/a/b;->yc(I)Lcom/google/android/libraries/assistant/a/b;
    ...
    .line 66
    :cond_8
    iget-object v0, p2, Lcom/google/assistant/f/a/u;->ubc:Ljava/lang/String;

    .line 69
    iget-object v4, p2, Lcom/google/assistant/f/a/u;->ubc:Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/assistant/settings/shared/o;->ty()Ljava/util/Set;
    ...
    .line 85
    iget-object v0, p2, Lcom/google/assistant/f/a/u;->ubd:Ljava/lang/String;
...
.method public final a(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 93
    invoke-direct {p0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->qX()V
...
.method public final dk()V
    ...
    .line 23
    invoke-virtual {v0, v2}, Lcom/google/assistant/f/a/ee;->ot(Z)Lcom/google/assistant/f/a/ee;
    ...
    .line 25
    iput-boolean v2, v0, Lcom/google/assistant/f/a/ee;->uhE:Z
...
.method public final onResume()V
    ...
    .line 19
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->dk()V
...
.method public final p(Landroid/os/Bundle;)V
    ...
    .line 7
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/brief/n;->bLE:I

    .line 8
    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->ef(I)Landroid/support/v7/preference/Preference;

    move-result-object v0

    check-cast v0, Lcom/google/android/apps/gsa/assistant/settings/shared/DescriptionPreferenceCategory;

    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLi:Lcom/google/android/apps/gsa/assistant/settings/shared/DescriptionPreferenceCategory;

    .line 9
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLi:Lcom/google/android/apps/gsa/assistant/settings/shared/DescriptionPreferenceCategory;

    sget v1, Lcom/google/android/apps/gsa/assistant/settings/brief/k;->bLv:I

    sget v2, Lcom/google/android/apps/gsa/assistant/settings/brief/k;->bLv:I

    sget v3, Lcom/google/android/apps/gsa/assistant/settings/brief/k;->bLv:I

    sget v4, Lcom/google/android/apps/gsa/assistant/settings/brief/k;->bLw:I
    ...
    .line 10
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/brief/n;->bLG:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLj:Landroid/support/v7/preference/PreferenceCategory;

    .line 12
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/brief/n;->bLH:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLk:Landroid/support/v7/preference/PreferenceCategory;

    .line 14
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/brief/n;->bLF:I

    invoke-virtual {p0, v0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->ef(I)Landroid/support/v7/preference/Preference;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLl:Landroid/support/v7/preference/Preference;

    .line 15
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->ak()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/brief/a;->bLl:Landroid/support/v7/preference/Preference;
