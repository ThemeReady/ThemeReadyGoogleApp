...
.method constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/services/ak;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/aq;->cic:Lcom/google/android/apps/gsa/assistant/settings/services/ak;
...
# virtual methods
.method public final a(Lcom/google/assistant/f/a/dl;)V
    .locals 5

    .prologue
    .line 2
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/services/aq;->cic:Lcom/google/android/apps/gsa/assistant/settings/services/ak;

    .line 4
    iget-object v1, p1, Lcom/google/assistant/f/a/dl;->seF:Ljava/lang/String;
    ...
    .line 8
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->aj()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 10
    iget-object v2, v0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cgW:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
    ...
    invoke-virtual {v2}, Lcom/google/android/apps/gsa/assistant/settings/shared/o;->sM()Landroid/accounts/Account;
    ...
    .line 14
    :cond_0
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->pV()Lcom/google/android/apps/gsa/shared/util/starter/IntentStarter;
...
.method public final b(Lcom/google/assistant/f/a/dl;)V
    .locals 7
    ...
    .line 20
    invoke-virtual {v0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->qp()Landroid/support/v7/app/q;
    ...
    .line 22
    sget v3, Lcom/google/android/apps/gsa/assistant/settings/services/ac;->chW:I
    ...
    .line 24
    iget-object v6, p1, Lcom/google/assistant/f/a/dl;->qAm:Ljava/lang/String;
    ...
    .line 28
    sget v3, Lcom/google/android/apps/gsa/assistant/settings/services/ac;->chV:I
    ...
    invoke-direct {v5, v0, p1}, Lcom/google/android/apps/gsa/assistant/settings/services/am;-><init>(Lcom/google/android/apps/gsa/assistant/settings/services/ak;Lcom/google/assistant/f/a/dl;)V
    ...
    .line 35
    invoke-virtual {v2}, Landroid/support/v7/app/q;->da()Landroid/support/v7/app/p;
