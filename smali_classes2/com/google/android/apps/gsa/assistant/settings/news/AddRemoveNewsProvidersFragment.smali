...
.field public cam:Lcom/google/android/apps/gsa/assistant/settings/news/a;

.field public can:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;

.field public cao:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 8
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->can:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cae:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cao:Ljava/util/List;
    ...
    .line 14
    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cae:Ljava/util/List;

    invoke-interface {v5, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 15
    iget-object v3, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cao:Ljava/util/List;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .prologue
    .line 18
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->cbi:I
    ...
    .line 20
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/aj;->cbd:I
    ...
    sget v4, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->abf:I

    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cao:Ljava/util/List;
    ...
    .line 24
    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cam:Lcom/google/android/apps/gsa/assistant/settings/news/a;

    .line 25
    iput-object v0, v2, Lcom/google/android/apps/gsa/assistant/settings/news/a;->caf:Landroid/widget/Spinner;

    .line 26
    invoke-virtual {v0, v2}, Landroid/widget/Spinner;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 27
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cam:Lcom/google/android/apps/gsa/assistant/settings/news/a;

    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/AddRemoveNewsProvidersFragment;->cae:Ljava/util/List;

    .line 28
    iput-object v2, v0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->cae:Ljava/util/List;

    .line 29
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/news/aj;->cbf:I
