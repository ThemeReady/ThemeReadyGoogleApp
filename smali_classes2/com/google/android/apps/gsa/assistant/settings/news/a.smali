...
.field public bYk:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public bYl:Landroid/widget/Spinner;

.field public bYm:I

.field public final bYn:Lcom/google/android/apps/gsa/assistant/settings/news/n;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/shared/ad;Lcom/google/android/apps/gsa/assistant/settings/news/n;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYj:Ljava/util/ArrayList;

    .line 3
    const/4 v0, 0x0

    iput v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYm:I

    .line 4
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bFY:Lcom/google/android/apps/gsa/assistant/settings/shared/ad;

    .line 5
    iput-object p2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYn:Lcom/google/android/apps/gsa/assistant/settings/news/n;

    .line 6
    return-void
.end method

.method private final a(Lcom/google/android/apps/gsa/assistant/settings/base/e;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYk:Ljava/util/List;

    iget v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYm:I
    ...
    .line 38
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYj:Ljava/util/ArrayList;
    ...
    .line 41
    invoke-virtual {p0, v0, p1}, Lcom/google/android/apps/gsa/assistant/settings/news/a;->a(Lcom/google/assistant/f/a/dx;Lcom/google/android/apps/gsa/assistant/settings/base/e;)Lcom/google/android/apps/gsa/assistant/shared/b/h;
...
.method public final a(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v1}, Lcom/google/android/apps/gsa/assistant/settings/news/a;->an(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/assistant/settings/news/a;->a(Lcom/google/android/apps/gsa/assistant/settings/base/e;)V
    ...
    invoke-direct {p0, v0}, Lcom/google/android/apps/gsa/assistant/settings/news/a;->an(Ljava/lang/String;)I
    ...
    .line 23
    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYj:Ljava/util/ArrayList;
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .prologue
    .line 28
    iget v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYm:I

    if-eq p3, v0, :cond_0

    .line 29
    iput p3, p0, Lcom/google/android/apps/gsa/assistant/settings/news/a;->bYm:I
...
.method final refresh()V
    ...
    .prologue
    .line 10
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/news/a;->aj()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 12
    invoke-virtual {v0, v1}, Lcom/google/assistant/f/a/dw;->mP(Z)Lcom/google/assistant/f/a/dw;
