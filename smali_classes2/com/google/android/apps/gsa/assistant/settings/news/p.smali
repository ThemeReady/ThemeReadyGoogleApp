...
.field public final bYD:Landroid/support/v7/widget/a/a;

.field public final bYE:Z

.field public bYF:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public bYG:Lcom/google/android/apps/gsa/assistant/settings/news/j;

.field public bYH:Landroid/view/View$OnClickListener;

.field public bYI:Landroid/support/v7/widget/RecyclerView;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;ZZLcom/google/android/apps/gsa/assistant/settings/shared/v;Lcom/google/android/apps/gsa/assistant/settings/shared/o;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYF:Ljava/util/List;
    ...
    .line 5
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYI:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 7
    iput-boolean p2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYE:Z

    .line 8
    iput-boolean p3, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bSK:Z
    ...
    iput-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYD:Landroid/support/v7/widget/a/a;

    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYD:Landroid/support/v7/widget/a/a;

    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYI:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/a/a;->b(Landroid/support/v7/widget/RecyclerView;)V

    .line 11
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYI:Landroid/support/v7/widget/RecyclerView;
...
.method public final b(Landroid/support/v7/widget/fw;Landroid/support/v7/widget/fw;)Z
    ...
    .line 22
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYF:Ljava/util/List;
    ...
    .line 24
    iget-object v4, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYG:Lcom/google/android/apps/gsa/assistant/settings/news/j;
...
.method public final getItemCount()I
    ...
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYE:Z
    ...
    iget-boolean v3, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bSK:Z
...
.method public final getItemViewType(I)I
    ...
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bSK:Z
...
.method public final synthetic onBindViewHolder(Landroid/support/v7/widget/fw;I)V
    ...
    .line 39
    iget-object v2, p1, Lcom/google/android/apps/gsa/assistant/settings/news/v;->bYL:Landroid/widget/TextView;

    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYF:Ljava/util/List;
    ...
    .line 40
    iget-object v2, p1, Lcom/google/android/apps/gsa/assistant/settings/news/v;->bYM:Landroid/widget/TextView;
    ...
    iget-object v2, p1, Lcom/google/android/apps/gsa/assistant/settings/news/v;->bYO:Landroid/widget/ImageView;
    ...
    sget v4, Lcom/google/android/apps/gsa/assistant/settings/news/ai;->bZe:I
    ...
    .line 45
    iget-boolean v1, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYE:Z

    if-eqz v1, :cond_1

    .line 46
    iget-object v0, p1, Lcom/google/android/apps/gsa/assistant/settings/news/v;->bYN:Landroid/widget/ImageView;

    sget v1, Lcom/google/android/apps/gsa/assistant/settings/news/ai;->bZd:I
    ...
    .line 48
    :cond_1
    iget-object v1, p1, Lcom/google/android/apps/gsa/assistant/settings/news/v;->bYN:Landroid/widget/ImageView;

    sget v2, Lcom/google/android/apps/gsa/assistant/settings/news/ai;->bZc:I
    ...
    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYI:Landroid/support/v7/widget/RecyclerView;
    ...
    sget v3, Lcom/google/android/apps/gsa/assistant/settings/news/al;->bZv:I
...
.method public final synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/fw;
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->bZm:I
    ...
    .line 63
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/news/p;->bYH:Landroid/view/View$OnClickListener;
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/news/ak;->bZp:I
