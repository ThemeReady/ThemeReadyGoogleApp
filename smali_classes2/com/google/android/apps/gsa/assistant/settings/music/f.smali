...
.field public final bXt:Lcom/google/android/apps/gsa/assistant/settings/music/b;

.field public bXu:Lcom/google/android/apps/gsa/assistant/settings/music/a;

.field public bXv:Landroid/support/v7/preference/PreferenceCategory;

.field public bXw:Landroid/support/v7/preference/PreferenceCategory;

.field public final mAssistantSettingsHelper:Lcom/google/android/apps/gsa/assistant/settings/shared/o;


# direct methods
.method public constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/shared/ad;Lcom/google/android/apps/gsa/assistant/settings/music/b;Lcom/google/android/apps/gsa/assistant/settings/shared/o;Lcom/google/android/apps/gsa/shared/config/ConfigFlags;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/music/f;->bFY:Lcom/google/android/apps/gsa/assistant/settings/shared/ad;

    .line 3
    iput-object p2, p0, Lcom/google/android/apps/gsa/assistant/settings/music/f;->bXt:Lcom/google/android/apps/gsa/assistant/settings/music/b;
    ...
    .line 5
    iput-object p4, p0, Lcom/google/android/apps/gsa/assistant/settings/music/f;->bCW:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
...
.method final a(Lcom/google/android/apps/gsa/assistant/settings/music/a;)V
    ...
    .line 92
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/music/f;->qp()Landroid/support/v7/app/q;
    ...
    .line 94
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bYc:I
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXN:I
    ...
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bYb:I
...
.method final a(Lcom/google/android/apps/gsa/assistant/settings/music/a;Z)V
    ...
    .prologue
    .line 76
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/music/f;->bXu:Lcom/google/android/apps/gsa/assistant/settings/music/a;
    ...
    .line 80
    :cond_1
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/music/f;->bXu:Lcom/google/android/apps/gsa/assistant/settings/music/a;
    ...
    .line 86
    :cond_2
    new-instance v1, Lcom/google/assistant/f/a/bj;

    invoke-direct {v1}, Lcom/google/assistant/f/a/bj;-><init>()V

    .line 87
    invoke-virtual {v1, v0}, Lcom/google/assistant/f/a/bj;->tG(Ljava/lang/String;)Lcom/google/assistant/f/a/bj;
    ...
    .line 89
    iput-object v1, v0, Lcom/google/assistant/f/a/dx;->sgO:Lcom/google/assistant/f/a/bj;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/android/apps/gsa/assistant/settings/music/f;->a(Lcom/google/assistant/f/a/dx;Lcom/google/android/apps/gsa/assistant/settings/base/e;)Lcom/google/android/apps/gsa/assistant/shared/b/h;
...
.method public final a(Landroid/support/v7/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 30
    sget v2, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXV:I
    ...
    .line 31
    sget v6, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXW:I
    ...
    .line 33
    sget v7, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXU:I
    ...
    sget v2, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXQ:I
    ...
    .line 37
    sget v2, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bYa:I
    ...
    .line 38
    sget v6, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXZ:I
    ...
    .line 40
    sget v2, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXM:I
    ...
    .line 41
    sget v6, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXL:I
    ...
    .line 43
    sget v2, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXS:I
    ...
    .line 45
    sget v7, Lcom/google/android/apps/gsa/assistant/settings/music/v;->bXR:I
...
.method final refresh()V
    ...
    .prologue
    .line 65
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/music/f;->aj()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 69
    iput-boolean v1, v0, Lcom/google/assistant/f/a/dw;->sgt:Z
