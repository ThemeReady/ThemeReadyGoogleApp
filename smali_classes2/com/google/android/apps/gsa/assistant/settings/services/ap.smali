...
.method constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/services/ak;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->ckx:Lcom/google/android/apps/gsa/assistant/settings/services/ak;
...
.method public final synthetic onSuccess(Ljava/lang/Object;)V
    ...
    .line 3
    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->ckx:Lcom/google/android/apps/gsa/assistant/settings/services/ak;
    ...
    .line 8
    iget-object v1, v1, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cjq:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
    ...
    iget-object v1, v1, Lcom/google/assistant/f/a/dv;->ugE:[Lcom/google/assistant/f/a/dg;
    ...
    .line 10
    iget-object v4, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->ckx:Lcom/google/android/apps/gsa/assistant/settings/services/ak;

    iget-object v1, p1, Lcom/google/assistant/f/a/ed;->uhf:Lcom/google/assistant/f/a/dv;

    .line 12
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->sS()Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;

    move-result-object v5

    .line 14
    iget-object v2, v1, Lcom/google/assistant/f/a/dv;->ugF:Ljava/lang/String;
    ...
    .line 16
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ak()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 18
    iget-object v7, v1, Lcom/google/assistant/f/a/dv;->ugE:[Lcom/google/assistant/f/a/dg;
    ...
    .line 19
    iget-object v2, v4, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ckv:Lcom/google/android/apps/gsa/assistant/settings/services/w;
    ...
    check-cast v1, Lcom/google/assistant/f/a/dg;

    iget-object v2, v2, Lcom/google/android/apps/gsa/assistant/settings/services/w;->caK:Lh/a/a;
    ...
    invoke-direct {v10, v0, v1, v2}, Lcom/google/android/apps/gsa/assistant/settings/services/AgentListingPreference;-><init>(Landroid/content/Context;Lcom/google/assistant/f/a/dg;Lcom/google/android/apps/gsa/assistant/settings/shared/v;)V
    ...
    invoke-static {v9}, Lcom/google/android/apps/gsa/shared/proto/io/ProtoParcelable;->g(Lcom/google/ac/a/o;)Lcom/google/android/apps/gsa/shared/proto/io/ProtoParcelable;
    ...
    .line 28
    iget-object v2, v9, Lcom/google/assistant/f/a/dg;->puQ:Ljava/lang/String;
    ...
    .line 34
    :cond_0
    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->ckx:Lcom/google/android/apps/gsa/assistant/settings/services/ak;

    iget-object v1, p1, Lcom/google/assistant/f/a/ed;->uhf:Lcom/google/assistant/f/a/dv;

    .line 36
    invoke-virtual {v5}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->sS()Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;
    ...
    .line 40
    invoke-virtual {v5}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ak()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 41
    iget-object v7, v1, Lcom/google/assistant/f/a/dv;->ugD:[Lcom/google/assistant/f/a/ds;
    ...
    .line 42
    iget-object v3, v5, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cku:Lcom/google/android/apps/gsa/assistant/settings/services/ah;
    ...
    check-cast v1, Lcom/google/assistant/f/a/ds;
    ...
    iget-object v3, v3, Lcom/google/android/apps/gsa/assistant/settings/services/ah;->caK:Lh/a/a;
    ...
    invoke-direct {v9, v0, v1, v2, v3}, Lcom/google/android/apps/gsa/assistant/settings/services/ServicePreference;-><init>(Landroid/content/Context;Lcom/google/assistant/f/a/ds;Lcom/google/android/apps/gsa/assistant/settings/services/ag;Lcom/google/android/apps/gsa/assistant/settings/shared/v;)V
