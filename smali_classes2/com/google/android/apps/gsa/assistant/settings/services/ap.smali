...
.method constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/services/ak;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->cjE:Lcom/google/android/apps/gsa/assistant/settings/services/ak;
...
.method public final synthetic onSuccess(Ljava/lang/Object;)V
    ...
    .line 3
    iget-object v1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->cjE:Lcom/google/android/apps/gsa/assistant/settings/services/ak;
    ...
    .line 8
    iget-object v1, v1, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ciw:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;
    ...
    iget-object v1, v1, Lcom/google/assistant/f/a/ec;->uuE:[Lcom/google/assistant/f/a/dn;
    ...
    .line 10
    iget-object v4, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->cjE:Lcom/google/android/apps/gsa/assistant/settings/services/ak;

    iget-object v1, p1, Lcom/google/assistant/f/a/ek;->uvf:Lcom/google/assistant/f/a/ec;

    .line 12
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->sy()Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;

    move-result-object v5

    .line 14
    iget-object v2, v1, Lcom/google/assistant/f/a/ec;->uuF:Ljava/lang/String;
    ...
    .line 16
    invoke-virtual {v4}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ar()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 18
    iget-object v7, v1, Lcom/google/assistant/f/a/ec;->uuE:[Lcom/google/assistant/f/a/dn;
    ...
    .line 19
    iget-object v2, v4, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cjC:Lcom/google/android/apps/gsa/assistant/settings/services/w;
    ...
    check-cast v1, Lcom/google/assistant/f/a/dn;

    iget-object v2, v2, Lcom/google/android/apps/gsa/assistant/settings/services/w;->bZJ:Ljavax/inject/Provider;
    ...
    invoke-direct {v10, v0, v1, v2}, Lcom/google/android/apps/gsa/assistant/settings/services/AgentListingPreference;-><init>(Landroid/content/Context;Lcom/google/assistant/f/a/dn;Lcom/google/android/apps/gsa/assistant/settings/shared/u;)V
    ...
    invoke-static {v9}, Lcom/google/android/apps/gsa/shared/proto/io/ProtoParcelable;->g(Lcom/google/aa/a/o;)Lcom/google/android/apps/gsa/shared/proto/io/ProtoParcelable;
    ...
    .line 28
    iget-object v2, v9, Lcom/google/assistant/f/a/dn;->pCE:Ljava/lang/String;
    ...
    .line 34
    :cond_0
    iget-object v5, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ap;->cjE:Lcom/google/android/apps/gsa/assistant/settings/services/ak;

    iget-object v1, p1, Lcom/google/assistant/f/a/ek;->uvf:Lcom/google/assistant/f/a/ec;

    .line 36
    invoke-virtual {v5}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->sy()Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;
    ...
    .line 40
    invoke-virtual {v5}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ar()Landroid/support/v7/preference/PreferenceScreen;
    ...
    .line 41
    iget-object v7, v1, Lcom/google/assistant/f/a/ec;->uuD:[Lcom/google/assistant/f/a/dz;
    ...
    .line 42
    iget-object v3, v5, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cjB:Lcom/google/android/apps/gsa/assistant/settings/services/ah;
    ...
    check-cast v1, Lcom/google/assistant/f/a/dz;
    ...
    iget-object v3, v3, Lcom/google/android/apps/gsa/assistant/settings/services/ah;->bZJ:Ljavax/inject/Provider;
    ...
    invoke-direct {v9, v0, v1, v2, v3}, Lcom/google/android/apps/gsa/assistant/settings/services/ServicePreference;-><init>(Landroid/content/Context;Lcom/google/assistant/f/a/dz;Lcom/google/android/apps/gsa/assistant/settings/services/ag;Lcom/google/android/apps/gsa/assistant/settings/shared/u;)V
