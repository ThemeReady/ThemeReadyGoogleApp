...
# instance fields
.field public final synthetic cqp:Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;
...
.method constructor <init>(Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/n;->cqp:Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;
...
.method public final synthetic onSuccess(Ljava/lang/Object;)V
    ...
    .line 3
    iget-object v0, p1, Lcom/google/assistant/f/a/dv;->sgn:Lcom/google/assistant/f/a/fa;

    if-eqz v0, :cond_4

    .line 4
    iget-object v2, p0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/n;->cqp:Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;

    iget-object v3, p1, Lcom/google/assistant/f/a/dv;->sgn:Lcom/google/assistant/f/a/fa;
    ...
    .line 8
    iget-object v1, v2, Lcom/google/android/apps/gsa/assistant/settings/base/b;->mContext:Landroid/content/Context;

    .line 9
    sget v4, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/i;->cqg:I
    ...
    .line 15
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/i;->cqh:I
    ...
    iput-object v0, v2, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->cqn:Landroid/support/v7/preference/PreferenceCategory;

    .line 17
    invoke-virtual {v2}, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->aj()Landroid/support/v7/preference/PreferenceScreen;

    move-result-object v0

    iget-object v1, v2, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->cqn:Landroid/support/v7/preference/PreferenceCategory;

    invoke-virtual {v0, v1}, Landroid/support/v7/preference/PreferenceScreen;->addPreference(Landroid/support/v7/preference/Preference;)Z

    .line 18
    iget-object v4, v3, Lcom/google/assistant/f/a/fa;->sil:[Lcom/google/assistant/f/a/ey;
    ...
    .line 21
    iget-object v6, v0, Lcom/google/assistant/f/a/ey;->qAm:Ljava/lang/String;

    .line 24
    iget-object v7, v0, Lcom/google/assistant/f/a/ey;->aCT:Ljava/lang/String;

    .line 27
    iget-object v8, v0, Lcom/google/assistant/f/a/ey;->rKQ:Ljava/lang/String;

    .line 30
    iget-object v9, v0, Lcom/google/assistant/f/a/ey;->saM:Ljava/lang/String;

    .line 33
    iget-object v10, v0, Lcom/google/assistant/f/a/ey;->scQ:Ljava/lang/String;

    .line 36
    iget v11, v0, Lcom/google/assistant/f/a/ey;->bkq:I

    .line 38
    iget-object v0, v2, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->cql:Lcom/google/android/apps/gsa/assistant/settings/videosphotos/k;
    ...
    .line 66
    iget-object v0, v3, Lcom/google/assistant/f/a/fa;->sil:[Lcom/google/assistant/f/a/ey;
    ...
    .line 68
    :cond_1
    iget-object v0, v2, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->cqn:Landroid/support/v7/preference/PreferenceCategory;
    ...
    .line 54
    :pswitch_0
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/i;->cqe:I

    invoke-virtual {v12, v0}, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/j;->eb(I)V
    ...
    .line 57
    :pswitch_1
    sget v0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/i;->bYh:I
    ...
    .line 72
    :cond_4
    iget-object v0, p1, Lcom/google/assistant/f/a/dv;->sgo:Lcom/google/assistant/f/a/co;

    if-eqz v0, :cond_5

    .line 73
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/n;->cqp:Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;

    iget-object v1, p1, Lcom/google/assistant/f/a/dv;->sgo:Lcom/google/assistant/f/a/co;

    invoke-virtual {v0, v1}, Lcom/google/android/apps/gsa/assistant/settings/videosphotos/m;->a(Lcom/google/assistant/f/a/co;)V
