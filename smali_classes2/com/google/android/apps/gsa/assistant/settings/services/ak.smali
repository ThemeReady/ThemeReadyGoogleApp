...
.field public final chZ:Lcom/google/android/apps/gsa/assistant/settings/services/ah;

.field public final cia:Lcom/google/android/apps/gsa/assistant/settings/services/w;
...
.method public constructor <init>(Lcom/google/common/base/au;Lcom/google/android/apps/gsa/assistant/settings/shared/o;Lcom/google/android/apps/gsa/shared/config/ConfigFlags;Lcom/google/android/apps/gsa/assistant/settings/shared/ad;Lcom/google/android/apps/gsa/assistant/settings/services/ah;Lcom/google/android/apps/gsa/assistant/settings/services/w;)V
    ...
    .line 3
    iput-object p3, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cgW:Lcom/google/android/apps/gsa/shared/config/ConfigFlags;

    .line 4
    iput-object p4, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->bFY:Lcom/google/android/apps/gsa/assistant/settings/shared/ad;

    .line 5
    iput-object p5, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->chZ:Lcom/google/android/apps/gsa/assistant/settings/services/ah;

    .line 6
    iput-object p6, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cia:Lcom/google/android/apps/gsa/assistant/settings/services/w;

    .line 7
    iput-object p1, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cgV:Lcom/google/common/base/au;
...
.method final varargs a(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .prologue
    .line 42
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->aj()Landroid/support/v7/preference/PreferenceScreen;
...
.method public final cT()V
    ...
    iput-boolean v0, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cib:Z

    .line 17
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->ss()V
...
.method public final f(Landroid/support/v7/preference/Preference;)Z
    ...
    .line 30
    iget-object v4, p0, Lcom/google/android/apps/gsa/assistant/settings/base/b;->bIu:Lcom/google/android/apps/gsa/assistant/settings/base/p;

    invoke-interface {v4, v0, v3, v2, v1}, Lcom/google/android/apps/gsa/assistant/settings/base/p;->a(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/CharSequence;I)V
...
.method public final onStart()V
    ...
    .line 12
    iget-boolean v0, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cib:Z

    if-eqz v0, :cond_0

    .line 13
    invoke-virtual {p0}, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->cT()V
...
.method final st()Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;
    .locals 5

    .prologue
    .line 38
    iget-object v0, p0, Lcom/google/android/apps/gsa/assistant/settings/services/ak;->bFY:Lcom/google/android/apps/gsa/assistant/settings/shared/ad;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/apps/gsa/assistant/settings/shared/ad;->G(Landroid/content/Context;)Lcom/google/android/apps/gsa/assistant/settings/shared/CustomPreferenceCategory;

    move-result-object v0

    .line 40
    sget v1, Lcom/google/android/apps/gsa/assistant/settings/services/y;->bJn:I

    sget v2, Lcom/google/android/apps/gsa/assistant/settings/services/y;->bJn:I

    sget v3, Lcom/google/android/apps/gsa/assistant/settings/services/y;->bJn:I

    sget v4, Lcom/google/android/apps/gsa/assistant/settings/services/y;->bJo:I
