...
# static fields
.field public static final cws:Lcom/google/common/base/am;

.field public static final cwt:[Ljava/lang/String;

.field public static final cwu:[Ljava/lang/String;
...
.field public final cww:Landroid/util/LongSparseArray;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->un:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->cws:Lcom/google/common/base/am;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->cwt:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->cwu:[Ljava/lang/String;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/contacts/i;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->cww:Landroid/util/LongSparseArray;
    ...
    .line 7
    iput-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->cwx:Ljava/util/Map;

    .line 8
    iput-object p1, p0, Lcom/google/android/apps/gsa/contacts/example/b;->cwv:Lcom/google/android/apps/gsa/contacts/i;

    .line 9
    return-void
.end method

.method private final n(Landroid/net/Uri;)Ljava/util/List;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/b;->cwv:Lcom/google/android/apps/gsa/contacts/i;

    const/16 v4, 0xa

    sget-object v5, Lcom/google/android/apps/gsa/contacts/example/b;->un:[Ljava/lang/String;
    ...
    .line 22
    iget-object v2, v9, Lcom/google/android/apps/gsa/contacts/example/c;->cwy:Ljava/util/Set;
    ...
    iget-object v4, v0, Lcom/google/android/apps/gsa/contacts/example/b;->cww:Landroid/util/LongSparseArray;

    monitor-enter v4

    .line 24
    :try_start_0
    iget-object v3, v9, Lcom/google/android/apps/gsa/contacts/example/c;->cwy:Ljava/util/Set;
    ...
    iget-object v5, v0, Lcom/google/android/apps/gsa/contacts/example/b;->cww:Landroid/util/LongSparseArray;
    ...
    sget-object v7, Lcom/google/android/apps/gsa/contacts/example/b;->cws:Lcom/google/common/base/am;

    .line 31
    invoke-virtual {v7, v3}, Lcom/google/common/base/am;->B(Ljava/lang/Iterable;)Ljava/lang/String;
    ...
    iget-object v10, v0, Lcom/google/android/apps/gsa/contacts/example/b;->cwv:Lcom/google/android/apps/gsa/contacts/i;

    sget-object v11, Landroid/provider/ContactsContract$Data;->CONTENT_URI:Landroid/net/Uri;

    const/16 v12, 0xa

    sget-object v13, Lcom/google/android/apps/gsa/contacts/example/b;->cwt:[Ljava/lang/String;

    sget-object v15, Lcom/google/android/apps/gsa/contacts/example/b;->cwu:[Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/d;->cwz:Landroid/util/LongSparseArray;
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/b;->cww:Landroid/util/LongSparseArray;
...
# virtual methods
.method public final m(Landroid/net/Uri;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->cwx:Ljava/util/Map;
    ...
    .line 12
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/apps/gsa/contacts/example/b;->n(Landroid/net/Uri;)Ljava/util/List;

    move-result-object v0

    .line 13
    iget-object v1, p0, Lcom/google/android/apps/gsa/contacts/example/b;->cwx:Ljava/util/Map;
