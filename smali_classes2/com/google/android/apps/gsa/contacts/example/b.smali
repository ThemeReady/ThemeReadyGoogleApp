...
# static fields
.field public static final czK:Lcom/google/common/base/ap;

.field public static final czL:[Ljava/lang/String;

.field public static final czM:[Ljava/lang/String;

.field public static final uw:[Ljava/lang/String;


# instance fields
.field public final czN:Lcom/google/android/apps/gsa/contacts/i;

.field public final czO:Landroid/util/LongSparseArray;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->uw:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->czK:Lcom/google/common/base/ap;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->czL:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/apps/gsa/contacts/example/b;->czM:[Ljava/lang/String;
...
.method public constructor <init>(Lcom/google/android/apps/gsa/contacts/i;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->czO:Landroid/util/LongSparseArray;
    ...
    .line 7
    iput-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->czP:Ljava/util/Map;

    .line 8
    iput-object p1, p0, Lcom/google/android/apps/gsa/contacts/example/b;->czN:Lcom/google/android/apps/gsa/contacts/i;
...
.method private final o(Landroid/net/Uri;)Ljava/util/List;
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/b;->czN:Lcom/google/android/apps/gsa/contacts/i;

    const/16 v4, 0xa

    sget-object v5, Lcom/google/android/apps/gsa/contacts/example/b;->uw:[Ljava/lang/String;
    ...
    .line 22
    iget-object v2, v9, Lcom/google/android/apps/gsa/contacts/example/c;->czQ:Ljava/util/Set;
    ...
    iget-object v4, v0, Lcom/google/android/apps/gsa/contacts/example/b;->czO:Landroid/util/LongSparseArray;

    monitor-enter v4

    .line 24
    :try_start_0
    iget-object v3, v9, Lcom/google/android/apps/gsa/contacts/example/c;->czQ:Ljava/util/Set;
    ...
    iget-object v5, v0, Lcom/google/android/apps/gsa/contacts/example/b;->czO:Landroid/util/LongSparseArray;
    ...
    sget-object v7, Lcom/google/android/apps/gsa/contacts/example/b;->czK:Lcom/google/common/base/ap;

    .line 31
    invoke-virtual {v7, v3}, Lcom/google/common/base/ap;->G(Ljava/lang/Iterable;)Ljava/lang/String;
    ...
    iget-object v10, v0, Lcom/google/android/apps/gsa/contacts/example/b;->czN:Lcom/google/android/apps/gsa/contacts/i;

    sget-object v11, Landroid/provider/ContactsContract$Data;->CONTENT_URI:Landroid/net/Uri;

    const/16 v12, 0xa

    sget-object v13, Lcom/google/android/apps/gsa/contacts/example/b;->czL:[Ljava/lang/String;

    sget-object v15, Lcom/google/android/apps/gsa/contacts/example/b;->czM:[Ljava/lang/String;
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/d;->czR:Landroid/util/LongSparseArray;
    ...
    iget-object v2, v0, Lcom/google/android/apps/gsa/contacts/example/b;->czO:Landroid/util/LongSparseArray;
...
.method public final n(Landroid/net/Uri;)Ljava/util/List;
    ...
    .prologue
    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/contacts/example/b;->czP:Ljava/util/Map;
    ...
    .line 13
    iget-object v1, p0, Lcom/google/android/apps/gsa/contacts/example/b;->czP:Ljava/util/Map;
