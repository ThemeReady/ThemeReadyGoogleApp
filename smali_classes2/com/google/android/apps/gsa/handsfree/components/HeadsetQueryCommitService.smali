...
.field public cCb:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;

.field public cCc:Lcom/google/android/apps/gsa/handsfree/o;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 11
    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->uA:Landroid/content/Context;
    ...
    .line 16
    new-instance v0, Lcom/google/android/apps/gsa/search/core/z/ad;

    iget-object v7, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->bQr:Lc/a;

    invoke-direct {v0, v7}, Lcom/google/android/apps/gsa/search/core/z/ad;-><init>(Lc/a;)V

    .line 18
    iget-object v7, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->uA:Landroid/content/Context;

    .line 19
    new-instance v8, Lcom/google/android/apps/gsa/search/core/z/ak;

    invoke-direct {v8, v7}, Lcom/google/android/apps/gsa/search/core/z/ak;-><init>(Landroid/content/Context;)V

    .line 21
    iget-object v7, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->crx:Lcom/google/android/apps/gsa/s/c/i;

    .line 22
    invoke-virtual {v8}, Lcom/google/android/apps/gsa/search/core/z/ak;->Zp()I

    move-result v8

    .line 23
    invoke-virtual {v0, v6, v7, v8}, Lcom/google/android/apps/gsa/search/core/z/ad;->a(ILcom/google/android/apps/gsa/s/c/i;I)Z
    ...
    .line 28
    :cond_3
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->blO:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    .line 30
    iget-object v4, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->cCb:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    .line 43
    :pswitch_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->cCc:Lcom/google/android/apps/gsa/handsfree/o;

    iget-object v2, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->uA:Landroid/content/Context;
    ...
    .line 44
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->cCa:Lc/a;
    ...
    sget v2, Lcom/google/android/apps/gsa/handsfree/components/f;->cCn:I

    .line 46
    invoke-virtual {v0, v2, v5}, Lcom/google/android/apps/gsa/search/core/aa/a/g;->a(ILcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;)V

    goto :goto_2

    .line 48
    :pswitch_1
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->cCb:Lcom/google/android/apps/gsa/search/core/preferences/SharedPreferencesExt;
    ...
    sget v3, Lcom/google/android/apps/gsa/handsfree/components/f;->cCo:I

    .line 54
    invoke-virtual {v0, v3, v5}, Lcom/google/android/apps/gsa/search/core/aa/a/g;->a(ILcom/google/android/apps/gsa/shared/util/concurrent/NonUiRunnable;)V

    .line 55
    :pswitch_2
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->cCc:Lcom/google/android/apps/gsa/handsfree/o;

    iget-object v3, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->uA:Landroid/content/Context;
    ...
    .line 64
    :cond_8
    iget-object v0, p0, Lcom/google/android/apps/gsa/handsfree/components/HeadsetQueryCommitService;->bny:Lc/a;
    ...
    .line 85
    iget v5, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->aBG:I

    or-int/lit8 v5, v5, 0x1

    iput v5, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->aBG:I

    .line 86
    iput-boolean v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVu:Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->eF(Z)Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;

    move-result-object v2

    .line 90
    invoke-static {p1}, Lcom/google/android/apps/gsa/shared/ac/b/a;->ao(Landroid/content/Intent;)Z
    ...
    .line 92
    iput-boolean v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVz:Z
    ...
    .line 97
    iput-boolean v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVv:Z
    ...
    .line 102
    iput-boolean v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVx:Z
    ...
    .line 108
    :cond_d
    iget v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->aBG:I

    or-int/lit8 v3, v3, 0x40

    iput v3, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->aBG:I

    .line 109
    iput-object v0, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVA:Ljava/lang/String;
    ...
    .line 117
    iput-object v0, v2, Lcom/google/android/apps/gsa/search/shared/service/a/a/ji;->fVy:Ljava/lang/String;
    ...
    sget-object v3, Lcom/google/android/apps/gsa/search/shared/service/a/a/jh;->fVt:Lcom/google/protobuf/a/h;
