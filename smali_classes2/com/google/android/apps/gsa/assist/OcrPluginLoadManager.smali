...
.field public final bxI:Lcom/google/common/util/concurrent/ListenableFuture;
...
.field public final bxK:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field public bxL:Lcom/google/android/apps/gsa/search/core/ocr/OcrProcessor;
...
.method constructor <init>(Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;Lcom/google/android/apps/gsa/shared/velour/b/a;Lcom/google/android/apps/gsa/shared/velour/ai;)V
    ...
    iput v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxH:I
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxK:Ljava/util/List;

    .line 4
    iput-object p1, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bnD:Lcom/google/android/apps/gsa/search/core/config/GsaConfigFlags;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxJ:Lcom/google/android/apps/gsa/shared/velour/b/a;
    ...
    iput-object v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxI:Lcom/google/common/util/concurrent/ListenableFuture;

    .line 10
    iget-object v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxI:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method final declared-synchronized a(Lcom/google/android/apps/gsa/shared/util/concurrent/TaskRunnerNonUi;Lcom/google/common/util/concurrent/cb;)V
    ...
    :try_start_0
    iget v2, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxH:I
    ...
    .line 17
    iget-object v1, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxI:Lcom/google/common/util/concurrent/ListenableFuture;
...
.method final a(Lcom/google/common/util/concurrent/cb;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, v0}, Lcom/google/common/util/concurrent/d;->ax(Ljava/lang/Object;)Z
    ...
    .line 25
    :goto_0
    iget-object v0, p0, Lcom/google/android/apps/gsa/assist/OcrPluginLoadManager;->bxK:Ljava/util/List;
